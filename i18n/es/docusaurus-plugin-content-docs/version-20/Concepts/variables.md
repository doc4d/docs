...
The 4D language manages several **system variables**, which allow you to control the execution of different operations. Puedes probar sus valores y usarlos como cualquier variable. All system variables are [process variables](#process-variables).
