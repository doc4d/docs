...
* *Windows*
  ...
  * Carpeta Licenses - Un archivo XML de números de licencia integrados en la aplicación. For more information about this, refer to the [Licenses & Certificate](#licenses--certificate-page) section.
...
The [current version number](#current-version) is set on the Client/Server page of the Build Application dialog box. Los intervalos de números autorizados se definen en el proyecto de aplicación vía las [llaves XML](#build-application-settings) específicas.
