...
Esta segunda técnica de retornar un valor por una subrutina se llama " utilizar una función" Se describe en el párrafo [Funciones](#functions). This is described in the [Returning values](#returned-value) paragraph.
