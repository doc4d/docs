...
<li>When the pop-up menu is **linked**, a simple click on the button only displays the pop-up menu. Sólo la selección de la acción en el menú emergente provoca su ejecución.</li>
