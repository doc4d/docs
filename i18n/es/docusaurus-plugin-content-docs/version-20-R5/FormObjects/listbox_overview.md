...
| On After Sort        | <li>[column](#propiedades-adicionales)</li><li>[columnName](#propiedades-adicionales)</li><li>[headerName](#propiedades-adicionales)</li>                                                                                | _Las fórmulas compuestas no se pueden ordenar. <br/>(e.g., This.firstName + This.lastName)_ |
...
Puedes definir propiedades estándar (texto, color de fondo, etc.) para cada columna del list box; estas propiedades tienen prioridad sobre las del objeto list box.
