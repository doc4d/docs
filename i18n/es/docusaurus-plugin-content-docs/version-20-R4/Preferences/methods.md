...
|                                                   | Descripción                                                                                                                                                              |
| ------------------------------------------------- | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------ |
| **Background color**                              | Color de fondo de la ventana del editor de código.                                                                                                                       |
...
| **Cursor line background color**                  | Color de fondo de la línea que contiene el cursor.                                                                                                                       |
| **Execution line background color**               | Color de fondo de la línea que se está ejecutando en el depurador.                                                                                                       |
| **Highlight of the found words**                  | Color de resaltado de las palabras encontradas en una búsqueda.                                                                                                          |
...
| **Selection back color**                          | Color de fondo de la selección.                                                                                                                                          |
| **Suggested text**                                | Color del texto de autocompletar sugerido por el Editor de Código.                                                                                                       |
