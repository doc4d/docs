...
Consulte [esta página](https://developer.qodly.com/docs/studio/rendering) para obtener información sobre cómo mostrar formularios web en Qodly.
...
[Los botones de renderización](https://developer.qodly.com/docs/studio/rendering#how-to-render-a-webform) están ocultos si las opciones de configuración no están activadas.
...
- Consejos de interfaz de usuario: no se muestran al hacer clic en los iconos ![alt-text](../assets/es/WebServer/tips.png).
...
3. En Qodly Studio, haga clic en el icono **renderización**. Se le advierte que los dos servidores web se están iniciando en esquemas diferentes, pero a pesar de esto, usted hace clic en el botón **Confirm**.
...
- Ejecutar el renderizador en otra pestaña del navegador (introduciendo la URL renderizada de su formulario Web: `IP:port/$lib/renderer/?w=WebFormName`).
