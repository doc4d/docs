...
| Result          | 4D.EntitySelection |  -> | Entity selection including the added _entity_ or _entitySelection_       | <!-- END REF --> |
...
| Result        | Real |  <- | Number of non null _attributePath_ values in the entity selection | <!-- END REF --> |
...
| Result        | 4D.EntitySelection |  <- | New entity selection made up of entities from entity selection meeting the search criteria specified in _queryString_ or _formula_ | <!-- END REF --> |
