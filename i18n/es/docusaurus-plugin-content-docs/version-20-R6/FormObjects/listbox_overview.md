...
| On After Sort        | <li>[column](#propiedades-adicionales)</li><li>[columnName](#propiedades-adicionales)</li><li>[headerName](#propiedades-adicionales)</li>                                                                                | *Las fórmulas compuestas no se pueden ordenar. <br/>(e.g., This.firstName + This.lastName)* |
