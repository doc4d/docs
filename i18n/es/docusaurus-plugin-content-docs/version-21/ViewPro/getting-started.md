...
Vaya a la [tabla Library](../Notes/updates.md#library-table-4d-21-lts) para conocer la versión de SpreadJS integrada en su versión 4D.
...
4. Seleccione **4d/4D-ViewPro** en la [lista de componentes por defecto](../Extensions/overview.md) y (recomendado) **Seguir versión 4D** como [regla de dependencia](../Project/components.md#defining-a-github-dependency-version-range), luego clic **Añadir**.
