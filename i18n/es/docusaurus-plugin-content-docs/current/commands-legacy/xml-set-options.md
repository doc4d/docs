...
| XML DOM case sensitivity       | Entero largo | 8     | Especifica la sensibilidad a mayúsculas y minúsculas con respecto a los nombres de los elementos de los comandos [DOM Get XML element](dom-get-xml-element) y [DOM Count XML elements](dom-count-xml-elements).<br/>Valores posibles:XML case sensitive (valor predeterminado): los comandos distinguen entre mayúsculas y minúsculasXML case insensitive: los comandos no distinguen entre mayúsculas y minúsculas.                                                                                                                                                                                                                                                                                                                                         |
