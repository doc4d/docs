...
<!--REF #_command_.QR Get command status.Syntax-->**QR Get command status** ( *area* : Integer ; *comando* : Integer {; *valor* : Integer} ) : Integer<br/>**QR Get command status** ( *area* : Integer ; *comando* : Integer {; *valor* : Text} ) : Integer<!-- END REF-->
