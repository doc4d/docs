...
Puede establecer la propiedad "Valor máximo" con la lista de propiedades en modo Diseño o utilizando el comando [OBJECT SET MAXIMUM VALUE](object-set-maximum-value).
