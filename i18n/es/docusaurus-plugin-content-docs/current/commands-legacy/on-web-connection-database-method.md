...
La petición debe haber sido aceptada previamente por el [Método base On Web Authentication](../commands/metodo-base-on-web-authentication.md) (si existe) y el servidor web debe lanzarse.
...
**Advertencia:** la llamada de un comando 4D que muestra un elemento de interfaz ([DIALOG](../commands/dialog), [ALERT](../commands/alert.md)...) termina el procesamiento del método.
