...
Puede definir el texto del marcador, ya sea usando la lista de propiedades o utilizando el comando [OBJECT SET PLACEHOLDER](object-set-placeholder).
...
[OBJECT SET PLACEHOLDER](object-set-placeholder)  
