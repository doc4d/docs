...
Si pasa el parámetro opcional *\**, el comando aceptará todo tipo de archivo. Esto significa que puede trabajar con imágenes sin necesariamente disponer de los codecs adecuados (ver la descripción del comando [BLOB TO PICTURE](blob-to-picture)).
