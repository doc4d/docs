...
**Nota:** este mecanismo es el mismo al utilizado por el comando [Select folder](select-folder). Los números de las rutas de acceso memorizadas son compartidos por ambos comandos.
