...
Puede definir la fuente de datos para un objeto en modo Diseño utilizando la Lista de propiedades, o utilizando el comando [OBJECT SET DATA SOURCE](object-set-data-source).  
