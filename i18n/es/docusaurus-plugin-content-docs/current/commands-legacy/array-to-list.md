...
<!--REF #_command_.ARRAY TO LIST.Syntax-->**ARRAY TO LIST** ( *array* : Array ; *lista* : Text {; *refElementos* : Array} )<br/>**ARRAY TO LIST** ( *array* : Array ; *lista* : Integer {; *refElementos* : Array} )<!-- END REF-->
