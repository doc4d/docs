...
Puede pasar en el parámetro opcional *lista*, una lista de selección (cadena) o una referencia de lista jerárquica (refLista). En el segundo caso, esta lista debe haber sido creada previamente (por ejemplo utilizando el comando [New list](new-list)) para que este comando funcione.
