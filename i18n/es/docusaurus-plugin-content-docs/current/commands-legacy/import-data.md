...
<!--REF #_command_.IMPORT DATA.Syntax-->**IMPORT DATA** ( *nomArchivo* : Text {; *proyecto* : Text, Blob {; *}} )<!-- END REF-->
...
* Guarde el proyecto en el disco, luego cárguelo, utilizando por ejemplo el comando [DOM Parse XML source](dom-parse-xml-source), y pase su referencia en el parámetro *proyecto*.
