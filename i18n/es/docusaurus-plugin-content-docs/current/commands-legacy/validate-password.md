...
Este parámetro es particularmente útil cuando se utilizan métodos base de autenticación, en particular el [Método base On 4D Mobile Authentication](metodo-base-on-4d-mobile-authentication).
...
En el [Método base On 4D Mobile Authentication](metodo-base-on-4d-mobile-authentication), usted puede probar una petición de conexión (utilizando los usuarios 4D de la base). Puede escribir:
