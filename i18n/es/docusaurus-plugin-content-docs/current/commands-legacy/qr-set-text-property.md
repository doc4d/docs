...
<!--REF #_command_.QR SET TEXT PROPERTY.Syntax-->**QR SET TEXT PROPERTY** ( *area* : Integer ; *numColumna* : Integer ; *numLinea* : Integer ; *propiedad* : Integer ; *valor* : Integer )<br/>**QR SET TEXT PROPERTY** ( *area* : Integer ; *numColumna* : Integer ; *numLinea* : Integer ; *propiedad* : Integer ; *valor* : Text )<!-- END REF-->
