...
Los eventos formulario se pueden activar/desactivar, ya sea utilizando la lista de propiedades o utilizando el comando [OBJECT SET EVENTS](object-set-events) si se le llama en el proceso actual.
