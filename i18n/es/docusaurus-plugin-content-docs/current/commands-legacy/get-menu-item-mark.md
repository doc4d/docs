...
<!--REF #_command_.Get menu item mark.Syntax-->**Get menu item mark** ( *menu* : Integer ; *lineamenu* : Integer {; *proceso* : Integer} ) : Text<br/>**Get menu item mark** ( *menu* : Text ; *lineamenu* : Integer {; *proceso* : Integer} ) : Text<!-- END REF-->
