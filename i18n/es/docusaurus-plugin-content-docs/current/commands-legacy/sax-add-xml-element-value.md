...
<!--REF #_command_.SAX ADD XML ELEMENT VALUE.Syntax-->**SAX ADD XML ELEMENT VALUE** ( *documento* : Time ; *datos* : Text {; *} )<br/>**SAX ADD XML ELEMENT VALUE** ( *documento* : Time ; *datos* : Variable {; *} )<!-- END REF-->
