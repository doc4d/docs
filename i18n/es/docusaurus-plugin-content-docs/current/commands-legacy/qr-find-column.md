...
<!--REF #_command_.QR Find column.Syntax-->**QR Find column** ( *area* : Integer ; *expresion* : Text ) : Integer<br/>**QR Find column** ( *area* : Integer ; *expresion* : Pointer ) : Integer<!-- END REF-->
