...
<!--REF #_command_.SET DATABASE PARAMETER.Syntax-->**SET DATABASE PARAMETER** ( {*tabla* : Table ;} *selector* : Integer ; *valor* : Real )<br/>**SET DATABASE PARAMETER** ( {*tabla* : Table ;} *selector* : Integer ; *valor* : Text )<!-- END REF-->
