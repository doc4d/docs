...
* Evitar la apertura de la base si no se cumple una condición (por ejemplo, si falta un recurso del sistema) llamando explícitamente [QUIT 4D](../commands/quit-4d.md).
...
Vea el ejemplo en la sección [Método base On Exit](../commands/metodo-base-on-exit.md).

## Ver también 

[Método base On Exit](../commands/metodo-base-on-exit.md)  
