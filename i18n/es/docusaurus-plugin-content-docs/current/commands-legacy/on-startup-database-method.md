...
* Evitar la apertura de la base si no se cumple una condición (por ejemplo, si falta un recurso del sistema) llamando explícitamente [QUIT 4D](quit-4d).
...
Vea el ejemplo en la sección [Método base On Exit](metodo-base-on-exit).
