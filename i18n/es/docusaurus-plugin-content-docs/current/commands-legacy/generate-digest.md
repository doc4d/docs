...
**Nota:** no se recomienda utilizar algoritmos MD5 y SHA para manejar contraseñas; si necesita verificar contraseñas, se recomienda utilizar los comandos [Generate password hash](generate-password-hash) y [Verify password hash ](verify-password-hash).
