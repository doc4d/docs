...
Puede definir el tipo de indicador utilizando la lista de propiedades en modo de diseño o utilizando el comando [OBJECT SET INDICATOR TYPE](object-set-indicator-type).
...
[OBJECT SET INDICATOR TYPE](object-set-indicator-type)  
