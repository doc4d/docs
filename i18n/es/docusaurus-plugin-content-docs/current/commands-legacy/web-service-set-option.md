...
<!--REF #_command_.WEB SERVICE SET OPTION.Syntax-->**WEB SERVICE SET OPTION** ( *opción* : Integer ; *valor* : Integer )<br/>**WEB SERVICE SET OPTION** ( *opción* : Integer ; *valor* : Text )<!-- END REF-->
