...
Puede configurar la opción "Orientación" para un objeto en modo de diseño utilizando la lista de propiedades, o utilizando el comando [OBJECT SET TEXT ORIENTATION](object-set-text-orientation).
