...
Como para el [Método base On Server Open Connection](../commands/metodo-base-on-server-open-connection.md), 4D Server pasa tres parámetros de tipo entero largo al **Método base On Server Close Connection**. Por otra parte, 4D Server no espera un resultado en retorno.
