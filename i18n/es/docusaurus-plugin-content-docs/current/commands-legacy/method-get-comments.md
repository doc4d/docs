...
La documentación modificada por este comando se muestra en el explorador de 4D (no debe confundirse con líneas de comentarios en el código que son recuperadas utilizando [METHOD GET CODE](method-get-code)). 
