...
<!--REF #_command_.Count menu items.Syntax-->**Count menu items** ( *menu* : Integer {; *proceso* : Integer} ) : Integer<br/>**Count menu items** ( *menu* : Text {; *proceso* : Integer} ) : Integer<!-- END REF-->
