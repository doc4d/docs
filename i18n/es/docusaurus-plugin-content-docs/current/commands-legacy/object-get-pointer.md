...
**Nota**: este funcionamiento es estrictamente equivalente al funcionamiento previo del comando [Self](self). El comando [Self](self) se conserva únicamente por razones de compatibilidad.
...
**Nota**: este funcionamiento es estrictamente equivalente al comando [Focus object](focus-object). El comando [Focus object](focus-object) ahora es obsoleto a partir de 4D v12.
...
[OBJECT Get name](object-get-name)  
