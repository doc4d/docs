...
<!--REF #_command_.SET MENU ITEM MARK.Syntax-->**SET MENU ITEM MARK** ( *menu* : Integer ; *lineamenu* : Integer ; *marca* : Text {; *proceso* : Integer} )<br/>**SET MENU ITEM MARK** ( *menu* : Text ; *lineamenu* : Integer ; *marca* : Text {; *proceso* : Integer} )<!-- END REF-->
