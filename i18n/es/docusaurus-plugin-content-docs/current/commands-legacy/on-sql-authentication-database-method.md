...
Si pasa [True](true.md "True") en $result, debe llamar exitosamente al comando [CHANGE CURRENT USER](change-current-user) en el Método base On SQL Authentication para que la petición sea aceptada y para que 4D abra una sesión SQL para el usuario. 
...
Cuando el sistema de contraseñas integrado de 4D no está activo, la ejecución del comando [CHANGE CURRENT USER](change-current-user) no tiene efecto; los usuarios se conectan con los derechos de acceso del Diseñador. 
