...
Si pasa [True](../commands/true.md "True") en $result, debe llamar exitosamente al comando [CHANGE CURRENT USER](../commands/change-current-user) en el Método base On SQL Authentication para que la petición sea aceptada y para que 4D abra una sesión SQL para el usuario. 
