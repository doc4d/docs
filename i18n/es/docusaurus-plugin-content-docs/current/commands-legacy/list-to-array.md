...
<!--REF #_command_.LIST TO ARRAY.Syntax-->**LIST TO ARRAY** ( *lista* : Text ; *array* : Array {; *refElementos* : Array} )<br/>**LIST TO ARRAY** ( *lista* : Integer ; *array* : Array {; *refElementos* : Array} )<!-- END REF-->
