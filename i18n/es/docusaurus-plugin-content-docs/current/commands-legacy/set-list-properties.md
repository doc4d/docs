...
**Nota:** si desea personalizar el icono de cada elemento en la lista, utilice el comando [SET LIST ITEM PROPERTIES](set-list-item-properties).
...
**Nota:** **SET LIST PROPERTIES** afecta la apariencia de los nodos en la lista jerárquica. Si prefiere personalizar el icono de cada elemento en la lista, utilice el comando [SET LIST ITEM PROPERTIES](set-list-item-properties).
...
\- por programación, utilizando los comandos [SELECT LIST ITEMS BY POSITION](select-list-items-by-position) y [SELECT LIST ITEMS BY REFERENCE](select-list-items-by-reference).  
