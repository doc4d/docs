...
<!--REF #_command_.SQL EXECUTE SCRIPT.Syntax-->**SQL EXECUTE SCRIPT** ( *rutaScript* : Text ; *accionError* : Integer {; *nomAtrib* : Text ; *valAtrib* : Text} {; *nomAtrib2* ; *valAtrib2* ; ... ; *nomAtribN* ; *valAtribN*} )<!-- END REF-->
