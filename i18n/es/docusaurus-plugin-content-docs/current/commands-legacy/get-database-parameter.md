...
<!--REF #_command_.Get database parameter.Syntax-->**Get database parameter** ( {*tabla* : Table ;} *selector* : Integer {; *valor* : Text} ) : Real<!-- END REF-->
...
Para más información sobre este formato y sobre el uso del archivo *4DDebugLog*, consulte [*Descripción de archivos de historial*](../Debugging/debugLogFiles). 
...
Esta opción también puede definirse en la [CALL SUBFORM CONTAINER](call-subform-container) de las Preferencias de la base.
...
En el [Método base On Startup](metodo-base-on-startup), usted escribe:
