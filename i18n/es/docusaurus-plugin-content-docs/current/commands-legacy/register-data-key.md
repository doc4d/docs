...
* *curDataKey*: objeto (con propiedad *encodedKey*) que contiene la llave de cifrado de datos. Esta llave puede haberse generado con el comando [New data key](new-data-key).
