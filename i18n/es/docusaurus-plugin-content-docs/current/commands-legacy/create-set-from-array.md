...
<!--REF #_command_.CREATE SET FROM ARRAY.Syntax-->**CREATE SET FROM ARRAY** ( *tabla* : Table ; *arrayReg* : Integer {; *nomConjunto* : Text} )<br/>**CREATE SET FROM ARRAY** ( *tabla* : Table ; *arrayReg* : Boolean array {; *nomConjunto* : Text} )<!-- END REF-->
