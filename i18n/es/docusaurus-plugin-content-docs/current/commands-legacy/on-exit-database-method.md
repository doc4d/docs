...
**Nota**: **Método base On Exit** NO es invocado por 4D Server. Debe utilizar [Método base On Server Shutdown](../commands/metodo-base-on-server-shutdown.md) en este contexto.
...
* Se efectúa una llamada al comando [QUIT 4D](../commands/quit-4d.md).
* Un plug-in 4D hace una llamada al punto de entrada [QUIT 4D](../commands/quit-4d.md).
...
El siguiente ejemplo muestra un caso típico en el que se lanzan uno o más procesos en segundo plano que realizan trabajos regulares, que se ejecutan sin fin, en el [Método base On Startup](../commands/metodo-base-on-startup.md) (o en el [Método base On Server Startup](../commands/metodo-base-on-server-startup.md)). Una bandera en el objeto [Storage](../commands/storage.md) de la aplicación se utiliza para decirles que terminen y para comprobar si han terminado.

* En el [Método base On Startup](../commands/metodo-base-on-startup.md)
...
[Método base On Startup](../commands/metodo-base-on-startup.md)  
[QUIT 4D](../commands/quit-4d.md)  