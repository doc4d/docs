...
**Nota:** el comando no incluye partes del list box. Para analizar un formulario para los objetos del  list box, debe utilizarse [LISTBOX GET OBJECTS](listbox-get-objects) o [LISTBOX GET ARRAYS](listbox-get-arrays) (ver el ejemplo a continuación para una combinación de [FORM GET OBJECTS](form-get-objects), [OBJECT Get type](object-get-type) y [LISTBOX GET OBJECTS](listbox-get-objects)).
