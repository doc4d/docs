...
El parámetro *usuario4D*  devuelto corresponde al nombre del usuario definido en el editor de contraseñas de 4D o el alias de usuario definido con [SET USER ALIAS](set-user-alias) (si lo hay). Si no hay sistema de contraseñas, devuelve “Diseñador”.
