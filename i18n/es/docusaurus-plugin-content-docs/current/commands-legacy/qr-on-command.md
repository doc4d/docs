...
| -------------------- | ------------ | ----- | --------------------------------------------------------------------------- |  
| qr cmd generate      | Entero largo | 2008  | Compatible editor 64 bits (uso del comando [QR RUN](qr-run) recomendado) |  
...
Si quiere que el comando inicial se ejecute, debe incluir la siguiente instrucción en el método: [QR EXECUTE COMMAND](qr-execute-command)($1;$2).
