...
Las propiedades de impresión de tamaño variable se pueden definir utilizando la lista de propiedades o el comando [OBJECT SET PRINT VARIABLE FRAME](object-set-print-variable-frame).  
