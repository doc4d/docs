...
Este comando tiene en cuenta las acciones de selección o deselección efectuadas con el ratón, con el teclado, o utilizando el comando [EDIT ITEM](edit-item) (el cual genera el evento On Getting Focus). Si la selección se modifica utilizando las flechas del teclado, *columna* devuelve 0\. En ese caso, el parámetro *varCol* devuelve [Is nil pointer](is-nil-pointer) si se pasa.
