...
<!--REF #_command_.Is field number valid.Syntax-->**Is field number valid** ( *ptrTabla* ; *numCamp* : Integer ) : Boolean<br/>**Is field number valid** ( *numTabla* ; *numCamp* : Integer ) : Boolean<!-- END REF--> 
