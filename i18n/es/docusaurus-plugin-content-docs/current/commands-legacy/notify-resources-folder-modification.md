...
* localmente, utilizando el comando [SET DATABASE PARAMETER](set-database-parameter) ejecutado en el equipo remoto (selector Auto Synchro Resources Folder). En este caso, "invalida" el de la base y se aplica únicamente al equipo remoto para la sesión.
