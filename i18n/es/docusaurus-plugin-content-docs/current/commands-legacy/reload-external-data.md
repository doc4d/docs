...
<!--REF #_command_.RELOAD EXTERNAL DATA.Syntax-->**RELOAD EXTERNAL DATA** ( *elCampo* : Text )<br/>**RELOAD EXTERNAL DATA** ( *elCampo* : Blob )<br/>**RELOAD EXTERNAL DATA** ( *elCampo* : Picture )<br/>**RELOAD EXTERNAL DATA** ( *elCampo* : Object )<!-- END REF-->
