...
**Nota**: este comando devuelve nombres "reales" para los campos y las tablas, incluso si se ha definido una estructura "virtual" utilizando los comandos [SET TABLE TITLES](set-table-titles) y [SET FIELD TITLES](set-field-titles).
