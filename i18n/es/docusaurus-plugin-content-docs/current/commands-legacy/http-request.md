...
<!--REF #_command_.HTTP Request.Syntax-->**HTTP Request** ( *metodoHTTP* : Text ; *url* : Text ; *contenido* : Text ; *respuesta* : Text {; *nomEncab* : Text array ; *valoresEncab* : Text array}{; *} ) : Integer<br/>**HTTP Request** ( *metodoHTTP* : Text ; *url* : Text ; *contenido* : Text ; *respuesta* : Blob {; *nomEncab* : Text array ; *valoresEncab* : Text array}{; *} ) : Integer<br/>**HTTP Request** ( *metodoHTTP* : Text ; *url* : Text ; *contenido* : Text ; *respuesta* : Picture {; *nomEncab* : Text array ; *valoresEncab* : Text array}{; *} ) : Integer<br/>**HTTP Request** ( *metodoHTTP* : Text ; *url* : Text ; *contenido* : Text ; *respuesta* : Object {; *nomEncab* : Text array ; *valoresEncab* : Text array}{; *} ) : Integer<br/>**HTTP Request** ( *metodoHTTP* : Text ; *url* : Text ; *contenido* : Blob ; *respuesta* : Text {; *nomEncab* : Text array ; *valoresEncab* : Text array}{; *} ) : Integer<br/>**HTTP Request** ( *metodoHTTP* : Text ; *url* : Text ; *contenido* : Blob ; *respuesta* : Blob {; *nomEncab* : Text array ; *valoresEncab* : Text array}{; *} ) : Integer<br/>**HTTP Request** ( *metodoHTTP* : Text ; *url* : Text ; *contenido* : Blob ; *respuesta* : Picture {; *nomEncab* : Text array ; *valoresEncab* : Text array}{; *} ) : Integer<br/>**HTTP Request** ( *metodoHTTP* : Text ; *url* : Text ; *contenido* : Blob ; *respuesta* : Object {; *nomEncab* : Text array ; *valoresEncab* : Text array}{; *} ) : Integer<br/>**HTTP Request** ( *metodoHTTP* : Text ; *url* : Text ; *contenido* : Picture ; *respuesta* : Text {; *nomEncab* : Text array ; *valoresEncab* : Text array}{; *} ) : Integer<br/>**HTTP Request** ( *metodoHTTP* : Text ; *url* : Text ; *contenido* : Picture ; *respuesta* : Blob {; *nomEncab* : Text array ; *valoresEncab* : Text array}{; *} ) : Integer<br/>**HTTP Request** ( *metodoHTTP* : Text ; *url* : Text ; *contenido* : Picture ; *respuesta* : Picture {; *nomEncab* : Text array ; *valoresEncab* : Text array}{; *} ) : Integer<br/>**HTTP Request** ( *metodoHTTP* : Text ; *url* : Text ; *contenido* : Picture ; *respuesta* : Object {; *nomEncab* : Text array ; *valoresEncab* : Text array}{; *} ) : Integer<br/>**HTTP Request** ( *metodoHTTP* : Text ; *url* : Text ; *contenido* : Object ; *respuesta* : Text {; *nomEncab* : Text array ; *valoresEncab* : Text array}{; *} ) : Integer<br/>**HTTP Request** ( *metodoHTTP* : Text ; *url* : Text ; *contenido* : Object ; *respuesta* : Blob {; *nomEncab* : Text array ; *valoresEncab* : Text array}{; *} ) : Integer<br/>**HTTP Request** ( *metodoHTTP* : Text ; *url* : Text ; *contenido* : Object ; *respuesta* : Picture {; *nomEncab* : Text array ; *valoresEncab* : Text array}{; *} ) : Integer<br/>**HTTP Request** ( *metodoHTTP* : Text ; *url* : Text ; *contenido* : Object ; *respuesta* : Object {; *nomEncab* : Text array ; *valoresEncab* : Text array}{; *} ) : Integer<!-- END REF-->
