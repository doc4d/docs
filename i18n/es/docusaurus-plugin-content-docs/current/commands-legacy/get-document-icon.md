...
<!--REF #_command_.GET DOCUMENT ICON.Syntax-->**GET DOCUMENT ICON** ( *rutaDoc* : Text ; *icono* : Picture {; *tamaño* : Integer} )<br/>**GET DOCUMENT ICON** ( *rutaDoc* : Text ; *icono* : Picture {; *tamaño* : Integer} )<!-- END REF-->
