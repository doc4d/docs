...
<!--REF #_command_.SET MENU ITEM.Syntax-->**SET MENU ITEM** ( *menu* : Integer ; *lineamenu* : Integer ; *textoElem* : Text {; *proceso* : Integer}{; *} )<br/>**SET MENU ITEM** ( *menu* : Text ; *lineamenu* : Integer ; *textoElem* : Text {; *proceso* : Integer}{; *} )<!-- END REF-->
