...
Una vez implementado en la base, tenemos todo lo que necesitamos para escribir el método de proyecto CREATE DOCUMENTATION. Utilizamos GET DOCUMENT PROPERTIES y [SET DOCUMENT PROPERTIES](set-document-properties) para administrar la fecha y hora de creación y modificación de los documentos.
