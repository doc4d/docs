...
Este comando tiene un funcionamiento idéntico al del comando [VERIFY DATA FILE](verify-data-file), excepto que sólo aplica al archivo de datos actual de la base de datos abierta. No son necesarios los parámetros que especifican la estructura y los datos.  
Consulte el comando [VERIFY DATA FILE](verify-data-file) para la descripción de los parámetros.
