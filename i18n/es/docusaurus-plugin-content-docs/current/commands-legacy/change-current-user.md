...
<!--REF #_command_.CHANGE CURRENT USER.Syntax-->**CHANGE CURRENT USER** {( *usuario* : Text ; *contraseña* : Text )}<br/>**CHANGE CURRENT USER** {( *usuario* : Integer ; *contraseña* : Text )}<!-- END REF-->
