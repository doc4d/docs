...
<!--REF #_command_.DOM Create XML Ref.Syntax-->**DOM Create XML Ref** ( *raiz* : Text {; *nomEspacio* : Text} {; *nSNom* : Text ; *nSValor* : Text} {; *nSNom2* ; *nSValor2* ; ... ; *nSNomN* ; *nSValorN*} ) : Text<!-- END REF-->
