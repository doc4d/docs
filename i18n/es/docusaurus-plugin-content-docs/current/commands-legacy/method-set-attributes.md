...
**Nota:** el comando existente [METHOD SET ATTRIBUTE](method-set-attribute) aún se soporta pero ya que sólo puede manejar valores booleanos, no se puede utilizar para atributos extendidos tales como propiedades 4D Mobile.
...
[METHOD GET ATTRIBUTES](method-get-attributes)  
