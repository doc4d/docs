...
<!--REF #_command_.FORM SET INPUT.Syntax-->**FORM SET INPUT** ( {*tabla* : Table ;} *form* : Text {; *formUsuario* : Text {; *}} )<br/>**FORM SET INPUT** ( {*tabla* : Table ;} *form* : Object {; *formUsuario* : Text {; *}} )<!-- END REF-->
