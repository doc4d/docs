...
Los comandos [DISPLAY SELECTION](display-selection) y [MODIFY SELECTION](modify-selection) muestran una lista de registros utilizando el formulario de salida. El usuario puede hacer doble clic en un registro en la lista y se muestra el formulario de entrada.

Los comandos de importación [IMPORT TEXT](import-text), [IMPORT SYLK](import-sylk) e [IMPORT DIF](import-dif) utilizan el formulario de entrada actual para importar registros.
