...
**Nota:** este mecanismo es idéntico al utilizado por el comando [Select document](select-document). Los números de rutas de acceso memorizadas se comparten entre los dos comandos.
