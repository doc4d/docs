...
<!--REF #_command_.Select folder.Syntax-->**Select folder** ( {*mensaje* : Text }{;}{ *rutaDefecto* : Text {; *opciones* : Integer}} ) : Text<br/>**Select folder** ( {*mensaje* : Text }{;}{ *rutaDefecto* : Integer {; *opciones* : Integer}} ) : Text<!-- END REF-->
