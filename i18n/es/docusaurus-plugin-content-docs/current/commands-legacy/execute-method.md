...
<!--REF #_command_.EXECUTE METHOD.Syntax-->**EXECUTE METHOD** ( *nomMetodo* : Text {; *result* : Variable {; *param* : Expression}}{; *param2* ; ... ; *paramN*} )<br/>**EXECUTE METHOD** ( *nomMetodo* : Text {; *result* : Operator {; *param* : Expression}}{; *param2* ; ... ; *paramN*} )<!-- END REF-->
