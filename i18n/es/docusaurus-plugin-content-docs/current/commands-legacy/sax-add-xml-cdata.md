...
Si quiere codificar los contenidos de datos, debe utilizar el comando [BASE64 ENCODE](base64-encode). En este caso, por supuesto, debe pasar un BLOB en *datos*. 
