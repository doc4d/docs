...
El valor actual mínimo o máximo de la altura de la fila puede definirse en la lista de propiedades (ver *Altura automática de fila*) o en el proceso actual utilizando el comando [LISTBOX SET AUTO ROW HEIGHT](listbox-set-auto-row-height).
