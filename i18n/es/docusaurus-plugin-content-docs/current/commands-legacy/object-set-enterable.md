...
El comando **OBJECT SET ENTERABLE** también puede utilizarse para activar por programación el modo “Editable en lista” para los subformularios y formularios listados mostrados utilizando los comandos [MODIFY SELECTION](modify-selection) y [DISPLAY SELECTION](display-selection):
...
[OBJECT Get enterable](object-get-enterable)  
