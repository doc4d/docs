...
Dado que el comando también devolverá **False** si el proceso actual no está en transacción, puede que necesite utilizar el comando [In transaction](in-transaction) para saber si el proceso está en transacción.
