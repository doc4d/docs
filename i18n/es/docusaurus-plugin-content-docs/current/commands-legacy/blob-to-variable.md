...
Los datos en el BLOB deben ser compatibles con la variable de destino. Generalmente, usted utilizará los BLOBs que usted ha llenado previamente utilizando el comando [VARIABLE TO BLOB](variable-to-blob).
...
**Nota:** **BLOB TO VARIABLE** soporta las variables objeto y colección de tipo *C\_OBJECT* y *C\_COLLECTION*. Para mayor información, consulte el comando [VARIABLE TO BLOB](variable-to-blob).
