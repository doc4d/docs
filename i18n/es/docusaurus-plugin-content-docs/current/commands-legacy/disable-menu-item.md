...
<!--REF #_command_.DISABLE MENU ITEM.Syntax-->**DISABLE MENU ITEM** ( *menu* : Integer ; *lineamenu* : Integer {; *proceso* : Integer} )<br/>**DISABLE MENU ITEM** ( *menu* : Text ; *lineamenu* : Integer {; *proceso* : Integer} )<!-- END REF-->
