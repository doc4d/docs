...
* el [Método base On Web Legacy Close Session](metodo-base-on-web-legacy-close-session) se llama, permitiéndole guardar la información de la sesión,
...
[Método base On Web Legacy Close Session](metodo-base-on-web-legacy-close-session)  
