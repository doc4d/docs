...
Un termómetro de progresión se muestra mientras se ejecuta **APPLY TO SELECTION**. Para ocultarlo, utilice [MESSAGES OFF](messages-off) antes de llamar a **APPLY TO SELECTION**. Si el termómetro de progreso se muestra, el usuario puede cancelar la operación.
