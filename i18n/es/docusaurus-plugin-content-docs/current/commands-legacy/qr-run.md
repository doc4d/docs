...
El informe se ejecuta en la tabla a la que pertenece el área. Cuando *area* designa un área fuera de la pantalla, es necesario especificar la tabla a utilizar vía el comando [QR SET REPORT TABLE](qr-set-report-table).
