...
El siguiente ejemplo es el método de objeto de un botón de búsqueda ubicado en el área de pie de página de un formulario de salida mostrado por el comando [MODIFY SELECTION](modify-selection). El método busca una tabla; dependiendo de los resultados de búsqueda, activa o desactiva un botón titulado *bEliminar* y cambia su título:
