...
El comando utiliza por defecto el conjunto de caracteres UTF-8\. Usted puede utilizar el comando [USE CHARACTER SET](use-character-set) para modificar este conjunto de caracteres.
