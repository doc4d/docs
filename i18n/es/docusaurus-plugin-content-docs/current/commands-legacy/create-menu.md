...
* Si no pasa el parámetro opcional *menu*, el menú será creado vacío. Debe construirlo y administrarlo utilizando los comandos [RELEASE MENU](release-menu), [SET MENU ITEM](set-menu-item), etc.
...
Un menú creado por este comando puede ser utilizado como barra de menús utilizando el comando [SET MENU BAR](set-menu-bar).

Cuando ya no necesite el menú creado por [Create menu](create-menu), recuerde llamar al comando [RELEASE MENU](release-menu) para liberar la memoria que está siendo utilizada. 
