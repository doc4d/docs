...
Para cerrar la base actual en el servidor, puede seleccionar el comando de menú **Cerrar la base...** en el servidor. También puede elegir el comando **Salir** o llamar al comando [QUIT 4D](../commands/quit-4d.md) dentro de un procedimiento almacenado ejecutado en el servidor.
...
Si quiere que el código se ejecute automáticamente en un equipo cliente cuando un 4D remoto deja de conectarse al servidor, utilice el [Semaphore](../commands/semaphore.md).
