...
El siguiente código ilustra las diferentes posibilidades ofrecidas por los comandos GET FIELD RELATION, [GET AUTOMATIC RELATIONS](get-automatic-relations) y [SET FIELD RELATION](set-field-relation), [SET AUTOMATIC RELATIONS](set-automatic-relations) así como sus efectos:
