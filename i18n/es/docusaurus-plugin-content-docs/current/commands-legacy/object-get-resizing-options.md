...
El comando devuelve las opciones de redimensionamiento actuales, como se definieron en el modo Diseño o para el proceso utilizando el comando [OBJECT SET RESIZING OPTIONS](object-set-resizing-options). Estas opciones definen la visualización del objeto en caso de redimensionamiento de la ventana del formulario.
