...
<!--REF #_command_.CREATE SELECTION FROM ARRAY.Syntax-->**CREATE SELECTION FROM ARRAY** ( *tabla* : Table ; *regArray* : Integer {; *temp* : Text} )<br/>**CREATE SELECTION FROM ARRAY** ( *tabla* : Table ; *regArray* : Boolean array {; *temp* : Text} )<!-- END REF-->
