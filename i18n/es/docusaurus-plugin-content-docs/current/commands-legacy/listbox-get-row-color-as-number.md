...
**Nota:** si desea obtener el color como una cadena CSS, debe utilizar el comando [LISTBOX Get row color](listbox-get-row-color). Para más información sobre los formatos de color, consulte la descripción del comando [OBJECT SET RGB COLORS](object-set-rgb-colors). 
