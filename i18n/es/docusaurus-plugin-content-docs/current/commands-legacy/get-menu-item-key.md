...
<!--REF #_command_.Get menu item key.Syntax-->**Get menu item key** ( *menu* : Integer ; *lineamenu* : Integer {; *proceso* : Integer} ) : Integer<br/>**Get menu item key** ( *menu* : Text ; *lineamenu* : Integer {; *proceso* : Integer} ) : Integer<!-- END REF-->
