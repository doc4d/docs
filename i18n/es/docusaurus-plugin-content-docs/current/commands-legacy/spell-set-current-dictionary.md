...
<!--REF #_command_.SPELL SET CURRENT DICTIONARY.Syntax-->**SPELL SET CURRENT DICTIONARY** ( *diccionario* : Integer )<br/>**SPELL SET CURRENT DICTIONARY** ( *diccionario* : Text )<!-- END REF-->
