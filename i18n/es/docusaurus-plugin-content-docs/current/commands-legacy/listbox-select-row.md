...
* Si quiere que el list box se desplace automáticamente para mostrar la fila seleccionada, utilice el comando [OBJECT SET SCROLL POSITION ](object-set-scroll-position).
* Para pasar una fila a modo edición (para permitir la entrada de datos), utilice el comando [EDIT ITEM](edit-item).
