...
Una vez generado el menú, puede mostrarlo vía el comando de 4D [Dynamic pop up menu](dynamic-pop-up-menu) y puede trabajar con él utilizando los comandos estándar de gestión de menús de 4D. La cadena devuelta por este comando contiene el URL de la página visitada (ver ejemplo).

Llame el comando [RELEASE MENU](release-menu) para borrar un menú de historial del URL cuando ya no sea útil.
...
[WA GET URL HISTORY](wa-get-url-history)  
