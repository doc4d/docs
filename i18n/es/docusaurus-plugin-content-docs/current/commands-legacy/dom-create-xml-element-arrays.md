...
<!--REF #_command_.DOM Create XML element arrays.Syntax-->**DOM Create XML element arrays** ( *refElement* : Text ; *xRuta* : Text {; *arrayNomsAtrib* : Text array ; *arrayValoresAtrib* : Text array} {; *arrayNomsAtrib2* ; *arrayValoresAtrib2* ; ... ; *arrayNomsAtribN* ; *arrayValoresAtribN*} ) : Text<!-- END REF-->
