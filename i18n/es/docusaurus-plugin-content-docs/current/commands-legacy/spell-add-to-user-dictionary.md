...
<!--REF #_command_.SPELL ADD TO USER DICTIONARY.Syntax-->**SPELL ADD TO USER DICTIONARY** ( *palabras* : Text )<br/>**SPELL ADD TO USER DICTIONARY** ( *palabras* : Text array )<!-- END REF-->
