...
**Nota:** si desea obtener el color como un formato entero largo de 4 bytes, debe utilizar el comando [OBJECT SET RGB COLORS](object-set-rgb-colors). Para más información sobre los formatos de color, consulte la descripción del comando [OBJECT SET RGB COLORS](object-set-rgb-colors). 
