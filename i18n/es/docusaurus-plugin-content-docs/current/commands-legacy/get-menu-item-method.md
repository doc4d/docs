...
<!--REF #_command_.Get menu item method.Syntax-->**Get menu item method** ( *menu* : Integer ; *lineaMenu* : Integer {; *proceso* : Integer} ) : Text<br/>**Get menu item method** ( *menu* : Text ; *lineaMenu* : Integer {; *proceso* : Integer} ) : Text<!-- END REF-->
