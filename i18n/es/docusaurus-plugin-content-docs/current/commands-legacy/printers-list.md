...
Utilice los comandos [SET CURRENT PRINTER](set-current-printer) y [Get current printer](get-current-printer) para modificar u obtener la impresora seleccionada en 4D. Debe pasar los nombres devueltos en el primer array (*arrayNoms*).
