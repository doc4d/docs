...
* Este comando espera nombres "reales" para los campos y las tablas, incluso si se ha definido una estructura "virtual" utilizando los comandos [SET TABLE TITLES](set-table-titles) y [SET FIELD TITLES](set-field-titles).
...
Por defecto, los **valores** de expresión se muestran en las áreas de texto multiestilo. Puede forzar la visualización de las **referencias** utilizando el comando [ST SET OPTIONS](st-set-options). 
...
[ST COMPUTE EXPRESSIONS](st-compute-expressions)  
[ST FREEZE EXPRESSIONS](st-freeze-expressions)  
[ST Get expression](st-get-expression)  
