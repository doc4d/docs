...
<!--REF #_command_.OB Get.Syntax-->**OB Get** ( *objeto* : Object ; *propiedad* : Text {; *tipo* : Integer} ) : any<br/>**OB Get** ( *objeto* : Campo Object ; *propiedad* : Text {; *tipo* : Integer} ) : any<!-- END REF-->
