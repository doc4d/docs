...
<!--REF #_command_.DELETE MENU ITEM.Syntax-->**DELETE MENU ITEM** ( *menu* : Integer ; *lineamenu* : Integer {; *proceso* : Integer} )<br/>**DELETE MENU ITEM** ( *menu* : Text ; *lineamenu* : Integer {; *proceso* : Integer} )<!-- END REF-->
