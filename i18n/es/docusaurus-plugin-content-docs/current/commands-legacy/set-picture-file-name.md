...
<!--REF #_command_.SET PICTURE FILE NAME.Syntax-->**SET PICTURE FILE NAME** ( *imagen* : Picture ; *nomArchivo* : Text )<br/>**SET PICTURE FILE NAME** ( *imagen* : Picture ; *nomArchivo* : Text )<!-- END REF-->
