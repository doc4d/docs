...
<!--REF #_command_.QR SET DESTINATION.Syntax-->**QR SET DESTINATION** ( *area* : Integer ; *tipo* : Integer {; *especificos* : Text} )<br/>**QR SET DESTINATION** ( *area* : Integer ; *tipo* : Integer {; *especificos* : Variable} )<!-- END REF-->
