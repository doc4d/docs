...
* Si se llama el comando [SET TABLE TITLES](set-table-titles) sin parámetros, la estructura "virtual" (incluyendo los nombres de tablas y campos personalizados) se elimina completamente del entorno Aplicación.
