...
| XY Screen         | Entero largo | 3     | El origen es la esquina superior izquierda de la pantalla principal (igual que para el comando [SCREEN COORDINATES](screen-coordinates))<br/><br/> |
...
Usted quiere abrir una ventana emergente en la posición del cursor del ratón. En Windows, es necesario convertir las coordenadas desde [MOUSE POSITION](mouse-position) (con el parámetro \*) devolviendo valores basados en la posición de la ventana MDI:
