...
* El alcance de este comando es la sesión actual. Llamar a [CHANGE CURRENT USER](change-current-user) después, por ejemplo, restablecería las membresías definidas.
