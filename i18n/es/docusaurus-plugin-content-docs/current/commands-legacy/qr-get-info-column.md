...
**Nota:** el comando no tiene en cuenta ninguna estructura virtual definida por medio de los comandos [SET TABLE TITLES](set-table-titles) y [SET FIELD TITLES](set-field-titles). El nombre real del campo se devuelve en el parámetro *objeto*. 
