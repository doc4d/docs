...
<!--REF #_command_.DOM Append XML child node.Syntax-->**DOM Append XML child node** ( *refElement* : Text ; *tipoHijo* : Integer ; *valorHijo* : Text ) : Text<br/>**DOM Append XML child node** ( *refElement* : Text ; *tipoHijo* : Integer ; *valorHijo* : Blob ) : Text<!-- END REF-->
