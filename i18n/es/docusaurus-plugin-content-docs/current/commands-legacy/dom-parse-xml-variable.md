...
<!--REF #_command_.DOM Parse XML variable.Syntax-->**DOM Parse XML variable** ( *variable* : Blob {; *validacion* : Boolean {; dtd | esquema}} ) : Text<br/>**DOM Parse XML variable** ( *variable* : Text {; *validacion* : Boolean {; dtd | esquema}} ) : Text<!-- END REF-->
