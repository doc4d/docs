...
**Nota:** estos metadatos son generados automáticamente por el comando [METHOD GET CODE](method-get-code). Para más información sobre los atributos soportados, consulte la descripción del comando [METHOD SET ATTRIBUTES](method-set-attributes).
