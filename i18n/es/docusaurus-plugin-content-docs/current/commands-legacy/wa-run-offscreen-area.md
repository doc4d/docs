...
La variable del sistema OK se define en 0 si se ha alcanzado el tiempo de espera o se ha llamado a [CANCEL](cancel) en *onEvent*, de lo contrario, se define en 1.
