...
**Nota:** este comando es equivalente a utilizar el comando [OBJECT MOVE](object-move) y pasar el segundo parámetro *\**.  
...
**Nota:** si desea mover un objeto con respecto a su posición inicial, se recomienda utilizar el comando existente [OBJECT MOVE](object-move).  
...
* Encabezados y pies de página de formularios de salida mostrados por el comando [MODIFY SELECTION](modify-selection) o [DISPLAY SELECTION](display-selection),
