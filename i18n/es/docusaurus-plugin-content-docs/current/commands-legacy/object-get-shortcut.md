...
El parámetro *tecla* devuelve el carácter asociado a la tecla (en el caso de una tecla estándar) o una cadena entre corchetes que designa la tecla (en el caso de una tecla función). Puede comparar este valor con las constantes del tema *Atajos de teclado* (ver el comando [OBJECT SET SHORTCUT](object-set-shortcut)).  
...
[OBJECT SET SHORTCUT](object-set-shortcut)  
