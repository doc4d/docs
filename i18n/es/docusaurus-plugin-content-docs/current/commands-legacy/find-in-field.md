...
<!--REF #_command_.Find in field.Syntax-->**Find in field** ( *campoObjetivo* : Field ; *valor* : Field ) : Integer<br/>**Find in field** ( *campoObjetivo* : Field ; *valor* : Variable ) : Integer<!-- END REF-->
