...
<!--REF #_command_.Document to text.Syntax-->**Document to text** ( *nomArchivo* : Text {; *conjCaracteres* : Text {; *modoRetorno* : Integer}} ) : Text<br/>**Document to text** ( *nomArchivo* : Text {; *conjCaracteres* : Integer {; *modoRetorno* : Integer}} ) : Text<!-- END REF-->
