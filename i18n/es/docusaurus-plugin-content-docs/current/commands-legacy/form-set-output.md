...
<!--REF #_command_.FORM SET OUTPUT.Syntax-->**FORM SET OUTPUT** ( {*tabla* : Table ;} *form* : Text {; *formUsuario* : Text} )<br/>**FORM SET OUTPUT** ( {*tabla* : Table ;} *form* : Object {; *formUsuario* : Text} )<!-- END REF-->
