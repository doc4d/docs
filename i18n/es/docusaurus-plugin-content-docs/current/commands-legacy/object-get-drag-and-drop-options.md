...
El comando devuelve las opciones de arrastrar y soltar actuales, como están definidas en modo Diseño o para el proceso actual utilizando el comando [OBJECT SET DRAG AND DROP OPTIONS](object-set-drag-and-drop-options).  
