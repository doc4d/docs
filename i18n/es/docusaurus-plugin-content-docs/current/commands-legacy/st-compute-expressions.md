...
Para más información acerca de las expresiones 4D utilizables en áreas de texto de multiestilo o 4D Write Pro, consulte la descripción del comando [ST INSERT EXPRESSION](st-insert-expression).  
...
* cuando están "congeladas" con el comando [ST FREEZE EXPRESSIONS](st-freeze-expressions), si se pasa el segundo parámetro *\**.
