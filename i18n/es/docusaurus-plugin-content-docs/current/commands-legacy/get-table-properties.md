...
<!--REF #_command_.GET TABLE PROPERTIES.Syntax-->**GET TABLE PROPERTIES** ( *PtrTabla* ; *invisible* : Boolean {; *trigGuardarNuevo* : Boolean {; *trigGuardaReg* : Boolean {; *trigBorrarReg* : Boolean {; *trigCargReg* : Boolean}}}} )<br/>**GET TABLE PROPERTIES** ( *numTabla* ; *invisible* : Boolean {; *trigGuardarNuevo* : Boolean {; *trigGuardaReg* : Boolean {; *trigBorrarReg* : Boolean {; *trigCargReg* : Boolean}}}} )<!-- END REF-->
