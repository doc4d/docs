...
<!--REF #_command_.LISTBOX Get locked columns.Summary-->El comando **LISTBOX Get locked columns** devuelve el número de columnas bloqueadas en el list box designado por los parámetros *objeto* y *\**.<!-- END REF-->  
 ...
 Las columnas pueden desbloquearse vía la Lista de propiedades o con la ayuda del comando [LISTBOX SET LOCKED COLUMNS](listbox-set-locked-columns). Para mayor información, consulte el manual de *Diseño*.  
