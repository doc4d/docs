...
La propiedad "Valor mínimo" puede definirse utilizando la Lista de propiedades en modo Diseño, o utilizando el comando [OBJECT SET MINIMUM VALUE](object-set-minimum-value).
