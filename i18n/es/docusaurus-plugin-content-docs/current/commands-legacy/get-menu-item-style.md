...
<!--REF #_command_.Get menu item style.Syntax-->**Get menu item style** ( *menu* : Integer ; *lineamenu* : Integer {; *proceso* : Integer} ) : Integer<br/>**Get menu item style** ( *menu* : Text ; *lineamenu* : Integer {; *proceso* : Integer} ) : Integer<!-- END REF-->
