...
<!--REF #_command_.PRINT SETTINGS.Summary-->PRINT SETTINGS muestra una caja de diálogo de impresión.<!-- END REF--> Este comando debe llamarse antes de una serie de comandos [Print form](../commands/print-form) o el comando [OPEN PRINTING JOB](open-printing-job).
...
**Nota:** la caja de diálogo de impresión contiene la opción **Preview on Screen** que permite al usuario previsualizar su trabajo de impresión. Puede preseleccionar o deseleccionar esta opción llamando [SET PRINT PREVIEW](set-print-preview) antes de llamar PRINT SETTINGS.
