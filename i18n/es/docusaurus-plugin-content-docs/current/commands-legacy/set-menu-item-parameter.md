...
<!--REF #_command_.SET MENU ITEM PARAMETER.Syntax-->**SET MENU ITEM PARAMETER** ( *menu* : Integer ; *lineaMenu* : Integer ; *param* : Text )<br/>**SET MENU ITEM PARAMETER** ( *menu* : Text ; *lineaMenu* : Integer ; *param* : Text )<!-- END REF-->
