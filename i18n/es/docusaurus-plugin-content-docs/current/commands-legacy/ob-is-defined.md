...
<!--REF #_command_.OB Is defined.Syntax-->**OB Is defined** ( *objeto* : Object {; *propiedad* : Text} ) : Boolean<br/>**OB Is defined** ( *objeto* : Campo Object {; *propiedad* : Text} ) : Boolean<!-- END REF-->
