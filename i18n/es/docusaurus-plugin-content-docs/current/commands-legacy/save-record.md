...
* Para guardar un nuevo registro creado con [CREATE RECORD](create-record) o [DUPLICATE RECORD](duplicate-record)
* Para guardar datos desde [RECEIVE RECORD](receive-record)
