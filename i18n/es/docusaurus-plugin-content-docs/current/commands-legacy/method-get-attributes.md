...
<!--REF #_command_.METHOD GET ATTRIBUTES.Syntax-->**METHOD GET ATTRIBUTES** ( *ruta* : Text ; *atributos* : Object {; *} )<br/>**METHOD GET ATTRIBUTES** ( *ruta* : Text ; *atributos* : Object array {; *} )<br/>**METHOD GET ATTRIBUTES** ( *ruta* : Text array ; *atributos* : Object {; *} )<br/>**METHOD GET ATTRIBUTES** ( *ruta* : Text array ; *atributos* : Object array {; *} )<!-- END REF-->
