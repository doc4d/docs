...
<!--REF #_command_.GET PICTURE RESOURCE.Syntax-->**GET PICTURE RESOURCE** ( *resNum* : Integer ; *resDatos* : Field {; *resArchivo* : Time} )<br/>**GET PICTURE RESOURCE** ( *resNum* : Integer ; *resDatos* : Variable {; *resArchivo* : Time} )<!-- END REF-->
