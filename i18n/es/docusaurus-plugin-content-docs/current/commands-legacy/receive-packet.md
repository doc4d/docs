...
<!--REF #_command_.RECEIVE PACKET.Syntax-->**RECEIVE PACKET** ( {*docRef* : Time ;} *varRecep* : Text ; stopCar | numBytes )<br/>**RECEIVE PACKET** ( {*docRef* : Time ;} *varRecep* : Blob ; stopCar | numBytes )<!-- END REF-->
