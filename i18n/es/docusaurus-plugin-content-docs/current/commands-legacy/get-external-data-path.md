...
<!--REF #_command_.Get external data path.Syntax-->**Get external data path** ( *elCampo* : Text ) : Text<br/>**Get external data path** ( *elCampo* : Blob ) : Text<br/>**Get external data path** ( *elCampo* : Picture ) : Text<!-- END REF-->
