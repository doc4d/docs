...
**\*** **Las estructuras virtuales se definen utilizando los comandos [SET TABLE TITLES](set-table-titles) y [SET FIELD TITLES](set-field-titles) (\** **parámetro requerido).* 
