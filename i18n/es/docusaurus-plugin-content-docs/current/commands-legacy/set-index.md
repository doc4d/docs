...
* Los índices creados por este comando no tienen nombres. No pueden ser borrados por el comando [DELETE INDEX](delete-index) utilizando la sintaxis basada en el nombre.
* Este comando no permite crear o borrar índices compuestos.
* Este comando no permite borrar un índice de palabras claves creado por el comando [CREATE INDEX](create-index).
