...
<!--REF #_command_.Get menu item parameter.Syntax-->**Get menu item parameter** ( *menu* : Integer ; *lineaMenu* : Integer ) : Text<br/>**Get menu item parameter** ( *menu* : Text ; *lineaMenu* : Integer ) : Text<!-- END REF-->
