...
Este comando efectúa la operación inversa de [SELECTION TO ARRAY](selection-to-array). Sin embargo, el comando **ARRAY TO SELECTION** no permite utilizar los campos de diferentes tablas, incluyendo tablas relacionadas, incluso cuando existe una relación automática.
...
Como para el comando [QUERY](query), este principio permite romper una instrucción compleja en un conjunto de líneas, lo cual es más fácil de leer y mantener. También es posible insertar instrucciones intermediarias. 
