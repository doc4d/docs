...
El comando utiliza por defecto el conjunto de caracteres UTF-8\. Los documento en formato DIF utilizan por lo general el conjunto de caracteres IBM437, puede utilizar el comando [USE CHARACTER SET](use-character-set) para definir el conjunto de caracteres apropiado.
