...
<!--REF #_command_.Convert to text.Syntax-->**Convert to text** ( *BLOB* : Blob ; *juegoCaracteres* : Text ) : Text<br/>**Convert to text** ( *BLOB* : Blob ; *juegoCaracteres* : Integer ) : Text<!-- END REF-->
