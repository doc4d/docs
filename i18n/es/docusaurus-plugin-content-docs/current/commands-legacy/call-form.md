...
<!--REF #_command_.CALL FORM.Syntax-->**CALL FORM** ( *ventana* : Integer ; *metodo* : Object {; *param* : Expression}{; *param2* ; ... ; *paramN*} )<br/>**CALL FORM** ( *ventana* : Integer ; *metodo* : Text {; *param* : Expression}{; *param2* ; ... ; *paramN*} )<!-- END REF-->
