...
Un clic posterior en la cuadro de zoom o la llamada al comando [MINIMIZE WINDOW](minimize-window) reduce la ventana a su tamaño inicial. En Windows, una llamada a [MINIMIZE WINDOW](minimize-window) sin parámetros hace que todas las ventanas de la aplicación vuelvan a su tamaño inicial.
