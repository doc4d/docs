...
| **Setting** | **Description**                                                         |
| ----------- | ----------------------------------------------------------------------- |
| Comentarios | Not supported. Content is not imported. |
...
| **Setting** | **Description**                                               |
| ----------- | ------------------------------------------------------------- |
| Tablas      | Contiguous tables do not merge automatically. |
...
| **Setting** | **Paragraphs**                                                                                                                                                                                                                                                                                                                                                                                        | **Sections** | **Images** |
| ----------- | ----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- | ------------ | ---------- |
| Expresiones | Only simple 4D expressions such as "Current date" or "Current time", or 4D Write Pro reserved local variables ($wp\_title, $wp\_pageNumber, etc.) are converted to Microsoft Word fields. Other 4D expressions are computed and converted to text or images during the export process. |              |            |
...
| Subrayado    | Semi-transparent underlines will be converted to solid.                                              |                                                                                                 |            |