...
The following example shows the effect of the **Print Variable Frame** option on a 4D Write Pro area embedded in the default output form. Se ejecuta el siguiente código:
