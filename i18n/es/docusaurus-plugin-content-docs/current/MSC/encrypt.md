...
2. Abra la página de encriptación del CSM. Si abre la página sin definir las tablas como **Encriptables**, aparecerá el siguiente mensaje en la página: ![](../assets/en/MSC/MSC_encrypt1.png) En caso contrario, se muestra el siguiente mensaje: ![](../assets/en/MSC/MSC_encrypt2.png)<p>
