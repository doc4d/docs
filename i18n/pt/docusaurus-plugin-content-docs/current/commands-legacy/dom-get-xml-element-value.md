...
<!--REF #_command_.DOM GET XML ELEMENT VALUE.Syntax-->**DOM GET XML ELEMENT VALUE** ( *refElemento* : Text ; *valorElemento* : Variable {; *cDATA* : Variable} )<!-- END REF-->
...
**Nota**: se o elemento designado por refElement for um BLOB processado pelo comando [DOM SET XML ELEMENT VALUE](dom-set-xml-element-value), tiver sido codificado automaticamente em banco64\. Portanto, o comando tentará automaticamente decodificar em base 64.
