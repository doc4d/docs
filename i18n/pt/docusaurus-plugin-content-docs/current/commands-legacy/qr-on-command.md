...
| -------------------- | ------------- | ----- | ---------------------------------------------- |  
| qr cmd generate      | Inteiro longo | 2008  | uso do comando [QR RUN](qr-run) recomendado |  
...
Se deseja que o comando inicial seja executado, deve incluir a seguinte instrução no método: [QR EXECUTE COMMAND](qr-execute-command)($1;$2).  
