...
<!--REF #_command_.SELECTION RANGE TO ARRAY.Syntax-->**SELECTION RANGE TO ARRAY** ( *inicio* : Integer ; *fim* : Integer {; umCampo | umaTabela ; *array* : Array} {; umCampo | umaTabela2 ; *array2* ; ... ; umCampo | umaTabelaN ; *arrayN*} )<!-- END REF-->
