...
As colunas podem ser desbloqueadas via a Lista de propriedades ou com a ajuda do comando [LISTBOX SET LOCKED COLUMNS](listbox-set-locked-columns). Para maior informação, consulte o manual de *Desenho*.
