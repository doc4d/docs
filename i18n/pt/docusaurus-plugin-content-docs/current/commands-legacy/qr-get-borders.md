...
**Nota**: diferente do comando [QR SET BORDERS](qr-set-borders), QR GET BORDERS não aceita um valor acumulado. Deve provar por separado todos os parâmetros para ter uma descrição geral da borda da célula.  
