...
A propriedade "Valor mínimo" pode ser definida utilizando a Lista de propriedades em modo Desenho, ou utilizando o comando [OBJECT SET MINIMUM VALUE](object-set-minimum-value).
