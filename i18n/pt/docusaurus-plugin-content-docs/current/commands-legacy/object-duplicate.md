...
O novo objeto pode ser movido e redimensionado através dos parâmetros *moveH*, *moveV*, *redimH* e *redimV*. Como para o comando [OBJECT MOVE](object-move), o sentido de deslocamento ou redimensionamento é definido pelo signo dos valores passados nos parâmetros *moveH* e *moveV*:
