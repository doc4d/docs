...
<!--REF #_command_.Is field number valid.Syntax-->**Is field number valid** ( *pontTabela* ; *numCampo* : Integer ) : Boolean<br/>**Is field number valid** ( *numTabela* ; *numCampo* : Integer ) : Boolean<!-- END REF--> 
