...
* Se no passa o parâmetro opcional *menu*, o menu será criado vazio. Deve construí-lo e administrá-lo utilizando os comandos [RELEASE MENU](release-menu), [SET MENU ITEM](set-menu-item), etc.
...
Um menu criado por este comando pode ser utilizado como barra de menus utilizando o comando [SET MENU BAR](set-menu-bar).

Quando já não necessite o menu criado por [Create menu](create-menu), lembre chamar o comando [RELEASE MENU](release-menu) para liberar a memória que está sendo utilizada
