...
<!--REF #_command_.USE CHARACTER SET.Syntax-->**USE CHARACTER SET** ( *mapa* : Text {; *mapaEntradaSaida* : Integer} )<br/>**USE CHARACTER SET** ( *mapa* : Operator {; *mapaEntradaSaida* : Integer} )<!-- END REF-->
