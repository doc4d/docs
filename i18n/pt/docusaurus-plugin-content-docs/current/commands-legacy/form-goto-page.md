...
Os botões de ação automática realizam as mesmas tarefas que os comandos [FORM FIRST PAGE](form-first-page), [FORM LAST PAGE](form-last-page), [FORM NEXT PAGE](form-next-page), [FORM PREVIOUS PAGE](form-previous-page) e **FORM GOTO PAGE** que você pode aplicar a objetos tais como abas, list box drop downs, etc. Sempre que seja possível, utilize botões de ação automática ao invés dos comandos. 
...
* Utilize o comando [FORM Get current page](form-get-current-page) para saber que página está sendo mostrada.
