...
**Nota:** Não é recomendado usar algoritmos MD5 e SHA para manejar senhas. Se precisar checar senhas, é recomendado usar os comandos [Generate password hash](generate-password-hash) e [Verify password hash ](verify-password-hash).
