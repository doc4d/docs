...
Pode configurar a opção "Menu contextual" em modo Desenho utilizando a lista de propriedades ou utilizando o comando [OBJECT SET CONTEXT MENU](object-set-context-menu).  
