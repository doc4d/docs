...
<!--REF #_command_.SET PICTURE METADATA.Syntax-->**SET PICTURE METADATA** ( *imagem* : Picture ; *nomeMeta* : Text ; *conteudoMeta* : Variable {; *nomeMeta2* ; *conteudoMeta2* ; ... ; *nomeMetaN* ; *conteudoMetaN*} )<!-- END REF-->
