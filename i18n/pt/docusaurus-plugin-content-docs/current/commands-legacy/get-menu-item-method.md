...
<!--REF #_command_.Get menu item method.Syntax-->**Get menu item method** ( *menu* : Integer ; *menuItem* : Integer {; *processo* : Integer} ) : Text<br/>**Get menu item method** ( *menu* : Text ; *menuItem* : Integer {; *processo* : Integer} ) : Text<!-- END REF-->
