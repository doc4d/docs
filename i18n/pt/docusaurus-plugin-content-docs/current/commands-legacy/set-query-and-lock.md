...
Entretanto, SET QUERY AND LOCK não afeta os outros comandos que modificam a seleção atual tais como as **[ALL RECORDS](all-records), [RELATE MANY](relate-many)** etc.
