...
Para se comunicar entre processos que não mostram formulários, utilize os comandos [GET PROCESS VARIABLE](get-process-variable) e [SET PROCESS VARIABLE](set-process-variable).
