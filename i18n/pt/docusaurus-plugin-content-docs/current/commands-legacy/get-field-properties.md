...
<!--REF #_command_.GET FIELD PROPERTIES.Syntax-->**GET FIELD PROPERTIES** ( *pontCampo* ; *tipoCampo* : Integer {; *tamanhoCampo* : Integer {; *indexado* : Boolean {; *unico* : Boolean {; *invisivel* : Boolean}}}} )<br/>**GET FIELD PROPERTIES** ( *numTabela* ; *numCampo* : Integer ; *tipoCampo* : Integer {; *tamanhoCampo* : Integer {; *indexado* : Boolean {; *unico* : Boolean {; *invisivel* : Boolean}}}} )<!-- END REF-->
