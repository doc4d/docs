...
É inútil passar um número a CLOSE WINDOW quando o utiliza para fechar as janelas abertas por [Open window](open-window.md) ou [Open form window](../commands/open-form-window.md) , já que CLOSE WINDOW sempre fechará a última janela criada por um destes comandos.  
