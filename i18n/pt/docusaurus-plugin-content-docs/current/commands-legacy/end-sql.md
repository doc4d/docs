...
Uma sequência de instruções SQL deve estar rodeada pelas palavras chaves [Begin SQL](begin-sql) e End SQL. Para maior informação, por favor consulte a descrição da palavra chave [Begin SQL](begin-sql).  
