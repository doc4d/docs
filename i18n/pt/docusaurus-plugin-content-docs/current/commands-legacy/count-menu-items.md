...
<!--REF #_command_.Count menu items.Syntax-->**Count menu items** ( *menu* : Integer {; *processo* : Integer} ) : Integer<br/>**Count menu items** ( *menu* : Text {; *processo* : Integer} ) : Integer<!-- END REF-->
