...
**Nota:** o parâmetro do comando [BREAK LEVEL](break-level) deve ser igual ao número de quebras em seu relatório. Para maior informação sobre o processo de quebras, consulte os comandos do capítulo *Imprimir*. 
