...
Quando tiver gerado o menu, pode mostrá-lo através do comando de 4D [Dynamic pop up menu](dynamic-pop-up-menu) e pode trabalhar com ele utilizando os comandos padrão de gestão de menus de 4D. A string retornada por esse comando contém o URL da página visitada (ver exemplo).  
  
Chame o comando [RELEASE MENU](release-menu) para apagar um menu de histórico da URL quando já não for útil.
