...
Para cada tabela, o comando gera um arquivo de texto com as instruções SQL necessárias para a importação dos dados em outro banco. Este arquivo pode ser utilizado diretamente pelo comando [SQL EXECUTE SCRIPT](sql-execute-script) para importar os dados em outro banco 4D.
