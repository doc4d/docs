...
O valor devolvido estará entre 0 (a borda superior da página) e a altura total devolvida pelo comando [GET PRINTABLE AREA](get-printable-area) (o tamanho máximo da área de impressão). 
...
As margens de impressão direita e esquerda não influem no valor devolvido, diferente das margens inferior e superior (as quais podem ser definidas utilizando o comando [SET PRINTABLE MARGIN](set-printable-margin) ).
