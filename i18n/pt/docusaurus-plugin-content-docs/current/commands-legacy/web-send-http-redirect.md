...
Este comando prevalece sobre os comandos de envio de dados ([WEB SEND FILE](web-send-file), [WEB SEND BLOB](web-send-blob), etc.) que possam estar no mesmo método.  
