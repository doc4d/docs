...
**Nota**: este funcionamento é estritamente equivalente ao funcionamento previo do comando [Self](self). O comando [Self](self) se conserva apenas por razões de compatibilidade.
...
**Nota**: este funcionamento é estritamente equivalente ao comando [Focus object](focus-object). Esse comando agora é obsoleto a partir de 4D v12.
