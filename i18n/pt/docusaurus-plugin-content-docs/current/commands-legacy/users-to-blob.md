...
O BLOB gerado é automaticamente encriptografado e apenas pode ser lido utilizando o comando [BLOB TO USERS](blob-to-users). Pode armazenar este BLOB em um arquivo em seu disco duro ou em um campo.
