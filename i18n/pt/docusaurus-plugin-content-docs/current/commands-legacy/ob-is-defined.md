...
<!--REF #_command_.OB Is defined.Syntax-->**OB Is defined** ( *objeto* : Object {; *propriedade* : Text} ) : Boolean<br/>**OB Is defined** ( *objeto* : Campo Object {; *propriedade* : Text} ) : Boolean<!-- END REF-->
