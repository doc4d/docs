...
**Nota**: o idioma atual é definido automáticamente por 4D em função do conteúdo da pasta Resources (vea o comando [Get database localization](get-database-localization) ), ou através do comando [SET DATABASE LOCALIZATION](set-database-localization).
