...
Associado ao comando [Get printed height](get-printed-height), este comando é útil para conhecer o número de píxels disponíveis para a impressão ou para centrar um objeto na página. 
...
* adicionar as margens oferecidas pelo comando [GET PRINTABLE MARGIN](get-printable-margin) aos valores devolvidos por este comando.
