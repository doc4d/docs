...
<!--REF #_command_.Localized string.Syntax-->**Localized string** ( *resNome* : Text ) : Text<!-- END REF-->
...
**Nota:**o comando [Get database localization](get-database-localization) pode ser utilizado para pesquisar a linguagem utilizada pela aplicação.  
