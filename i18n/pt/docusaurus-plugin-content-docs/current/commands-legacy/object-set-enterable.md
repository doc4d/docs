...
O comando **OBJECT SET ENTERABLE** também pode ser utilizado para ativar por programação o modo “Editável em lista” para os subformulários e formulários listados mostrados utilizando os comandos [MODIFY SELECTION](modify-selection) e [DISPLAY SELECTION](display-selection):
