...
<!--REF #_command_.QUERY SELECTION BY ATTRIBUTE.Syntax-->**QUERY SELECTION BY ATTRIBUTE** ( {*umaTabela*}{;}{*operadorConj* : Operator ;} *campoObj* : Field ; *rotaAtributo* : Text ; *operadorPesq* : Text ; *valor* : Text {; *} )<br/>**QUERY SELECTION BY ATTRIBUTE** ( {*umaTabela*}{;}{*operadorConj* : Operator ;} *campoObj* : Field ; *rotaAtributo* : Text ; *operadorPesq* : Text ; *valor* : Real {; *} )<br/>**QUERY SELECTION BY ATTRIBUTE** ( {*umaTabela*}{;}{*operadorConj* : Operator ;} *campoObj* : Field ; *rotaAtributo* : Text ; *operadorPesq* : Text ; *valor* : Date {; *} )<br/>**QUERY SELECTION BY ATTRIBUTE** ( {*umaTabela*}{;}{*operadorConj* : Operator ;} *campoObj* : Field ; *rotaAtributo* : Text ; *operadorPesq* : Text ; *valor* : Time {; *} )<br/>**QUERY SELECTION BY ATTRIBUTE** ( {*umaTabela*}{;}{*operadorConj* : Operator ;} *campoObj* : Field ; *rotaAtributo* : Text ; *operadorPesq* : Operator ; *valor* : Text {; *} )<br/>**QUERY SELECTION BY ATTRIBUTE** ( {*umaTabela*}{;}{*operadorConj* : Operator ;} *campoObj* : Field ; *rotaAtributo* : Text ; *operadorPesq* : Operator ; *valor* : Real {; *} )<br/>**QUERY SELECTION BY ATTRIBUTE** ( {*umaTabela*}{;}{*operadorConj* : Operator ;} *campoObj* : Field ; *rotaAtributo* : Text ; *operadorPesq* : Operator ; *valor* : Date {; *} )<br/>**QUERY SELECTION BY ATTRIBUTE** ( {*umaTabela*}{;}{*operadorConj* : Operator ;} *campoObj* : Field ; *rotaAtributo* : Text ; *operadorPesq* : Operator ; *valor* : Time {; *} )<!-- END REF-->
