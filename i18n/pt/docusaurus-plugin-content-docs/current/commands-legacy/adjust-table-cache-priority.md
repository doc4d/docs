...
Este comando gerencia prioridade somente para dados em campos escalares (data, número, ou tipo string). Prioridade para campos de tipo binário (Blobs, textos, imagens, e objetos) é manejada pelo comando [ADJUST BLOBS CACHE PRIORITY](adjust-blobs-cache-priority). 
