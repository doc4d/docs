...
**Nota**: Estes metadados são gerados automaticamente pelo comando [METHOD GET CODE](method-get-code). Para saber mais sobre atributos suportados, veja o comando [METHOD SET ATTRIBUTES](method-set-attributes).
