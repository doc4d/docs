...
Opcionalmente, o comando permite passar vários pares de atributos e valores de atributos na forma de arrays nos parâmetros *arrayNomsAtrib* e *arrayValoresAtrib*. Em *arrayValoresAtrib*, pode passar arrays de tipo texto, data, numérico e imagem. 4D realiza automaticamente as conversões necessarias; pode modificar estas conversões utilizando o comando [XML SET OPTIONS](xml-set-options).  
