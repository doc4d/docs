...
<!--REF #_command_.Get menu item modifiers.Syntax-->**Get menu item modifiers** ( *menu* : Integer ; *menuItem* : Integer {; *processo* : Integer} ) : Integer<br/>**Get menu item modifiers** ( *menu* : Text ; *menuItem* : Integer {; *processo* : Integer} ) : Integer<!-- END REF-->
