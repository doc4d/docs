...
<!--REF #_command_.GET RELATION PROPERTIES.Syntax-->**GET RELATION PROPERTIES** ( *pontCampo* ; *tabelaUm* : Integer ; *numCampo* : Integer {; *discriminante* : Integer {; *autoUm* : Boolean {; *autoMuitos* : Boolean}}} )<br/>**GET RELATION PROPERTIES** ( *numTabela* ; *numCampo* : Integer ; *tabelaUm* : Integer ; *campoUmo* : Integer {; *discriminante* : Integer {; *autoUm* : Boolean {; *autoMuitos* : Boolean}}} )<!-- END REF-->
