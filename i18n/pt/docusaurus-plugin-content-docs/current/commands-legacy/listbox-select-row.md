...
* Se deseja que o list box tenha rolagem automaticamente para mostrar a fila selecionada, utilize o comando [OBJECT SET SCROLL POSITION ](object-set-scroll-position).
* Para passar uma fila a modo edição (para permitir a entrada de dados), utilize o comando [EDIT ITEM](edit-item).
