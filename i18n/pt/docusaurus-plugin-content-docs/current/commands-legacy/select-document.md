...
<!--REF #_command_.Select document.Syntax-->**Select document** ( *diretorio* : Text ; *tipoArquivos* : Text ; *titulo* : Text ; *opçoes* : Integer {; *selecionados* : Text array} ) : Text<br/>**Select document** ( *diretorio* : Integer ; *tipoArquivos* : Text ; *titulo* : Text ; *opçoes* : Integer {; *selecionados* : Text array} ) : Text<!-- END REF-->
