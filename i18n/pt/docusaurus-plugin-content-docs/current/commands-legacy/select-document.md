...
Nota: este mecanismo é o mesmo que o utilizado pelo comando [Select folder](select-folder).. Os números das rotas de acesso memorizadas são compartidos por ambos comandos.  
