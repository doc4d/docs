...
<!--REF #_command_.CALL FORM.Syntax-->**CALL FORM** ( *janela* : Integer ; *metodo* : Object {; *param* : Expression}{; *param2* ; ... ; *paramN*} )<br/>**CALL FORM** ( *janela* : Integer ; *metodo* : Text {; *param* : Expression}{; *param2* ; ... ; *paramN*} )<!-- END REF-->
