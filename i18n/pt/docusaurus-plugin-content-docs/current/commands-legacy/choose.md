...
<!--REF #_command_.Choose.Syntax-->**Choose** ( *criterio* : Boolean ; *valor* : Expression {; *valor2* ; ... ; *valorN*} )  : any<br/>**Choose** ( *criterio* : Integer ; *valor* : Expression {; *valor2* ; ... ; *valorN*} )  : any<!-- END REF-->
