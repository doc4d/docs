...
Pode configurar a opção "Orientação" para um objeto em modo de desenho utilizando a lista de propriedades, ou utilizando o comando [OBJECT SET TEXT ORIENTATION](object-set-text-orientation).
