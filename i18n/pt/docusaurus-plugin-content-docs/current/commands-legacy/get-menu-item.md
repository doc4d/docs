...
<!--REF #_command_.Get menu item.Syntax-->**Get menu item** ( *menu* : Integer ; *menuItem* : Integer {; *processo* : Integer} ) : Text<br/>**Get menu item** ( *menu* : Text ; *menuItem* : Integer {; *processo* : Integer} ) : Text<!-- END REF-->
