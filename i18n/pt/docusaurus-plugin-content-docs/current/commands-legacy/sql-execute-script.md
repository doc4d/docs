...
<!--REF #_command_.SQL EXECUTE SCRIPT.Syntax-->**SQL EXECUTE SCRIPT** ( *rotaScript* : Text ; *açãoErro* : Integer {; *nomeAtrib* : Text ; *valorAtrib* : Text} {; *nomeAtrib2* ; *valorAtrib2* ; ... ; *nomeAtribN* ; *valorAtribN*} )<!-- END REF-->
