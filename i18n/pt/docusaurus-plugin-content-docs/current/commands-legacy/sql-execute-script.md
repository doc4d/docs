...
**Nota:** os comandos [SQL EXPORT DATABASE](sql-export-database) e [SQL EXPORT SELECTION](sql-export-selection) geram automaticamente este arquivo de script.  
...
Se o arquivo de registro de pedidos de 4D estiver ativo (através dos seletores 28 ou 45 do comando [SET DATABASE PARAMETER](set-database-parameter)), cada comando SQL executado gerará uma entrada com a seguinte informação:  
