...
*qr HTML file* (5): é criado um arquivo HTML utilizando o modelo definido por [QR SET HTML TEMPLATE](qr-set-html-template). Para maior informação sobre o modo de conversão dos dados, consulte o manual de Desenho.
