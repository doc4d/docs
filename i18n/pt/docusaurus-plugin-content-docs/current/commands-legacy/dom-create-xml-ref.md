...
<!--REF #_command_.DOM Create XML Ref.Syntax-->**DOM Create XML Ref** ( *raiz* : Text {; *nomeEspaço* : Text} {; *nSNome* : Text ; *nSValor* : Text} {; *nSNome2* ; *nSValor2* ; ... ; *nSNomeN* ; *nSValorN*} ) : Text<!-- END REF-->
