...
<!--REF #_command_.DOM Parse XML variable.Syntax-->**DOM Parse XML variable** ( *variável* : Blob {; *validaçao* : Boolean {; dtd|schema}} ) : Text<br/>**DOM Parse XML variable** ( *variável* : Text {; *validaçao* : Boolean {; dtd|schema}} ) : Text<!-- END REF-->
