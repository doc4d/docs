...
O nome padrão é usado durante a exportação da imagem em um arquivo de disco. Você pode definir automaticamente com base no nome original do arquivo de imagem importada para o campo ou variável de imagens, ou usando o comando [SET PICTURE FILE NAME](set-picture-file-name). Para maior informação, consulte o manual de *Desenho*. 
