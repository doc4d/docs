...
A diferença do comando [Get print preview](get-print-preview), **Is in print preview** devolve o valor final da opção, depois da validação da caixa de diálogo por parte do usuário. Este comando permite determinar com certeza se a impressão toma lugar em modo "vista previa". 
