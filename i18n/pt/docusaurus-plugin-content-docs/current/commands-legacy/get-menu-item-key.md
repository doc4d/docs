...
<!--REF #_command_.Get menu item key.Syntax-->**Get menu item key** ( *menu* : Integer ; *menuItem* : Integer {; *processo* : Integer} ) : Integer<br/>**Get menu item key** ( *menu* : Text ; *menuItem* : Integer {; *processo* : Integer} ) : Integer<!-- END REF-->
