...
**Nota**: para maior informação sobre o parâmetro da caché do servidor web 4D, consulte a seção [QR DELETE COLUMN](qr-delete-column). .  
...
Pode enviar a página "stats.shtm" utilizando um link URL ou utilizando o comando [WEB SEND FILE](web-send-file).
