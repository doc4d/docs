...
<!--REF #_command_.Append document.Summary-->O comando Append document faz a mesma coisa que [Open document](open-document): permite abrir um documento em disco.<!-- END REF-->  
...
Para maior informação consulte [Open document](open-document) .
