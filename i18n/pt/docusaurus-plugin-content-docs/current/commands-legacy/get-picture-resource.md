...
<!--REF #_command_.GET PICTURE RESOURCE.Syntax-->**GET PICTURE RESOURCE** ( *resNum* : Integer ; *resDados* : Field {; *resArquivo* : Time} )<br/>**GET PICTURE RESOURCE** ( *resNum* : Integer ; *resDados* : Variable {; *resArquivo* : Time} )<!-- END REF-->
