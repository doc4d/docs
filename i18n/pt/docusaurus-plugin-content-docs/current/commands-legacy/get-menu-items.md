...
<!--REF #_command_.GET MENU ITEMS.Syntax-->**GET MENU ITEMS** ( *menu* : Integer ; *arrayTitMenus* : Text array ; *arrayRefMenus* : Text array )<br/>**GET MENU ITEMS** ( *menu* : Text ; *arrayTitMenus* : Text array ; *arrayRefMenus* : Text array )<!-- END REF-->
