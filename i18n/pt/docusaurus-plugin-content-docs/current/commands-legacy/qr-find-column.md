...
<!--REF #_command_.QR Find column.Syntax-->**QR Find column** ( *area* : Integer ; *expressao* : Text ) : Integer<br/>**QR Find column** ( *area* : Integer ; *expressao* : Pointer ) : Integer<!-- END REF-->
