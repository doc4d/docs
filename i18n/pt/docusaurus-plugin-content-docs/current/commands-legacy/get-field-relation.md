...
O código a seguir ilustra as diferentes possibilidades oferecidas pelos comandos GET FIELD RELATION, [GET AUTOMATIC RELATIONS](get-automatic-relations) e [SET FIELD RELATION](set-field-relation), [SET AUTOMATIC RELATIONS](set-automatic-relations) assim como seus efeitos:
