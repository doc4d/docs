...
Utilize os comandos [SET CURRENT PRINTER](set-current-printer) e [Get current printer](get-current-printer) para modificar ou obter a impressora selecionada em 4D. Deve passar os nomes devolvidos no primeiro array (*nomesArray*).  
