...
* *listaClientes* contém a lista dos clientes “registrados” utilizando o comando [REGISTER CLIENT](register-client).
* *metodos* fornece a lista de “cargas de trabalho” de cada cliente. A carga de trabalho é o número de métodos que um cliente 4D deve executar chamando o comando [EXECUTE ON CLIENT](execute-on-client) (para mais informação, consulte la descrição do comando [EXECUTE ON CLIENT](execute-on-client)).
