...
<!--REF #_command_.Get menu item mark.Syntax-->**Get menu item mark** ( *menu* : Integer ; *menuItem* : Integer {; *processo* : Integer} ) : Text<br/>**Get menu item mark** ( *menu* : Text ; *menuItem* : Integer {; *processo* : Integer} ) : Text<!-- END REF-->
