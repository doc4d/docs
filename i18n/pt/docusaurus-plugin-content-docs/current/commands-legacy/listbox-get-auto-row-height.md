...
O valor atual mínimo ou máximo da altura da fila pode ser definido na lista de propriedades (ver *Altura linha automática*) ou no processo atual utilizando o comando [LISTBOX SET AUTO ROW HEIGHT](listbox-set-auto-row-height).
