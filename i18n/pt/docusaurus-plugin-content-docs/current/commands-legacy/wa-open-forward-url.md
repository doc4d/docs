...
<!--REF #_command_.WA OPEN FORWARD URL.Summary-->O comando WA OPEN FORWARD URL carrega na área web designada pelos parâmetros \* e *objeto* a URL passada no parâmetro url.<!-- END REF-->  
 ...
 Se for passada uma string vazia em url, o comando [WA Forward URL available](wa-forward-url-available) não faz nada e não é gerado nenhum erro. Para carregar uma página vazia na área web, passe a cadeia "about:blank" em url.  
