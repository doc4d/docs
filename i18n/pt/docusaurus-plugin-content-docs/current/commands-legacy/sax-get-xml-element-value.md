...
<!--REF #_command_.SAX GET XML ELEMENT VALUE.Syntax-->**SAX GET XML ELEMENT VALUE** ( *documento* : Time ; *valor* : Text )<br/>**SAX GET XML ELEMENT VALUE** ( *documento* : Time ; *valor* : Blob )<!-- END REF-->
