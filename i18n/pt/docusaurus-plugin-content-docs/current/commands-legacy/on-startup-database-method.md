...
* Evitar a abertura do banco se não se cumprirem uma condição (por exemplo, se faltar um recurso do sistema) chamando explicitamente [QUIT 4D](../commands/quit-4d.md).
...
Veja o exemplo na seção [Semaphore](../commands/semaphore.md).

## Ver também 

[Método banco de dados On Exit](../commands/metodo-banco-de-dados-on-exit.md)  
