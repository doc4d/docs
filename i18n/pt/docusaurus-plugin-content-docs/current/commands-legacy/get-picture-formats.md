...
Os identificadores codec devolvidos são definidos por 4D exatamente da mesma maneira que para o comando **PICTURE CODEC LIST**[PICTURE CODEC LIST](picture-codec-list). Podem ser devolvidos das seguintes formas:
