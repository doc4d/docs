...
**Nota:** se quiser obter a cor como uma string CSS, deve utilizar o comando [LISTBOX Get row color](listbox-get-row-color). Para saber mais informação sobre os formatos de cor, consulte a descrição do comando [OBJECT SET RGB COLORS](object-set-rgb-colors).
