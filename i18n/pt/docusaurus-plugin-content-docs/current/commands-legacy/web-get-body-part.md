...
No parâmetro *parte*, passe o número da parte a analisar. Podes obter o número total de partes com comando [WEB Get body part count](web-get-body-part-count).  
...
**Nota**: No contexto de uma petição multi-part, o primeiro de array do comando [WEB GET VARIABLES](web-get-variables) devolve todas as partes do formulário, na mesma ordem que o comando **WEB GET BODY PART**. Pode utilizar-lo para obter diretamente a posição de uma parte de um formulário. 
