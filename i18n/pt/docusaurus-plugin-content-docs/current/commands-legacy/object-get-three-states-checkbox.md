...
A propriedade "Três estados" se pode definir seja usando a lista de propriedades, ou utilizando o comando [OBJECT SET THREE STATES CHECKBOX](object-set-three-states-checkbox) se chama no processo atual.
