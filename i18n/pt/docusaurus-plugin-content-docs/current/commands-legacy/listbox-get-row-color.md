...
**Nota:** se quiser obter a cor como um formato inteiro longo de 4 bytes, deve utilizar o comando [OBJECT SET RGB COLORS](object-set-rgb-colors). Para saber mais sobre os formatos de cor, consulte a descrição do comando [OBJECT SET RGB COLORS](object-set-rgb-colors). 
