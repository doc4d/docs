...
Este comando é útil no contexto da análise de um formulário utilizando os comandos [FORM LOAD](../commands/form-load), [FORM GET OBJECTS](form-get-objects) e [OBJECT Get type](object-get-type). Se pode utilizar, quando seja necessário, para obter os nomes dos sub objetos dos list box.
