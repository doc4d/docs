...
A variável de sistema OK é estabelecida como 0 se o timeout foi alcançaddo ou [CANCEL](cancel) for chamado em *onEvent*, senão é estabelecida como 1.
