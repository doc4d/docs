...
<!--REF #_command_.EXECUTE METHOD.Syntax-->**EXECUTE METHOD** ( *nomeMetodo* : Text {; *resultado* : Variable {; *param* : Expression}}{; *param2* ; ... ; *paramN*} )<br/>**EXECUTE METHOD** ( *nomeMetodo* : Text {; *resultado* : Operator {; *param* : Expression}}{; *param2* ; ... ; *paramN*} )<!-- END REF-->
