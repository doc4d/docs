...
O comando devolve as opções de arrastar e soltar atuais, como estão definidas em modo *Desenho* ou para o processo atual utilizando o comando [OBJECT SET DRAG AND DROP OPTIONS](object-set-drag-and-drop-options).  
