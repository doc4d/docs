...
Este comando gerencia prioridade para dados apenas em campos escalares (data, número ou tipo string). Prioridade para campos de tipo binário (Blobs, textos, imagens e objetos) é manejada pelo comando [SET BLOBS CACHE PRIORITY](set-blobs-cache-priority). 
