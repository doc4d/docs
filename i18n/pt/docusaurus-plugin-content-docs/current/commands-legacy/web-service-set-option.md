...
<!--REF #_command_.WEB SERVICE SET OPTION.Syntax-->**WEB SERVICE SET OPTION** ( *opçao* : Integer ; *valor* : Integer )<br/>**WEB SERVICE SET OPTION** ( *opçao* : Integer ; *valor* : Text )<!-- END REF-->
