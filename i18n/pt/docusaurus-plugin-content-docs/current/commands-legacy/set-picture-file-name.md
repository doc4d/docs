...
<!--REF #_command_.SET PICTURE FILE NAME.Syntax-->**SET PICTURE FILE NAME** ( *imagem* : Picture ; *nomArquivo* : Text )<br/>**SET PICTURE FILE NAME** ( *imagem* : Picture ; *nomArquivo* : Text )<!-- END REF-->
