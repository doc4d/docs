...
* Formulários listados mostrados utilizando os comandos [DISPLAY SELECTION](display-selection) ou [MODIFY SELECTION](modify-selection).

Se o comando é utilizado com um objeto editável que não estiver na lista, age da mesma forma que o comando [GOTO OBJECT](goto-object).  
