...
Pode comparar o valor devolvido com as constantes do tema *Listbox Footer Calculation* (ver o comando [LISTBOX SET FOOTER CALCULATION](listbox-set-footer-calculation)).
