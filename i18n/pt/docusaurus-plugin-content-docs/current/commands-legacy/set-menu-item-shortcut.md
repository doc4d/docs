...
<!--REF #_command_.SET MENU ITEM SHORTCUT.Syntax-->**SET MENU ITEM SHORTCUT** ( *menu* : Integer ; *menuItem* : Integer ; *itemKey* : Text ; *modificadores* : Integer {; *processo* : Integer} )<br/>**SET MENU ITEM SHORTCUT** ( *menu* : Integer ; *menuItem* : Integer ; *itemKey* : Integer ; *modificadores* : Integer {; *processo* : Integer} )<br/>**SET MENU ITEM SHORTCUT** ( *menu* : Text ; *menuItem* : Integer ; *itemKey* : Text ; *modificadores* : Integer {; *processo* : Integer} )<br/>**SET MENU ITEM SHORTCUT** ( *menu* : Text ; *menuItem* : Integer ; *itemKey* : Integer ; *modificadores* : Integer {; *processo* : Integer} )<!-- END REF-->
