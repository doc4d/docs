...
<!--REF #_command_.SET QUERY DESTINATION.Syntax-->**SET QUERY DESTINATION** ( *tipoDestino* : Integer {; *objetoDestino* : Text {; *destPonteiro*}} )<br/>**SET QUERY DESTINATION** ( *tipoDestino* : Integer {; *objetoDestino* : Variable {; *destPonteiro*}} )<!-- END REF-->
