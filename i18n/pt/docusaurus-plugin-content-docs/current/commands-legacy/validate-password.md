...
<!--REF #_command_.Validate password.Syntax-->**Validate password** ( *refUsuario* : Integer ; *senha* : Text {; *digest* : Boolean} ) : Boolean<br/>**Validate password** ( *refUsuario* : Text ; *senha* : Text {; *digest* : Boolean} ) : Boolean<!-- END REF-->
