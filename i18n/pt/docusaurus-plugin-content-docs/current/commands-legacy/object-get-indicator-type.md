...
Pode definir o tipo de indicador utilizando a lista de propriedades em modo de desenho ou utilizando o comando [OBJECT SET INDICATOR TYPE](object-set-indicator-type).
