...
Passe em *nomeIndice*, o nome do índice a criar. É necessário dar nomes aos índices se vários índices de diferentes tipos podem associados a um mesmo campo e se preferir poder apagá-los individualmente com a ajuda do comando [DELETE INDEX](delete-index). Se o índice *nomeIndice* já existir, o comando não faz nada.
