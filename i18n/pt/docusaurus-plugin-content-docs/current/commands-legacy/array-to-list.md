...
<!--REF #_command_.ARRAY TO LIST.Syntax-->**ARRAY TO LIST** ( *array* : Array ; *lista* : Text {; *itemRefs* : Array} )<br/>**ARRAY TO LIST** ( *array* : Array ; *lista* : Integer {; *itemRefs* : Array} )<!-- END REF-->
