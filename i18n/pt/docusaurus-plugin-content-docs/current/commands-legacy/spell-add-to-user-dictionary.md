...
<!--REF #_command_.SPELL ADD TO USER DICTIONARY.Syntax-->**SPELL ADD TO USER DICTIONARY** ( *palavras* : Text )<br/>**SPELL ADD TO USER DICTIONARY** ( *palavras* : Text array )<!-- END REF-->
