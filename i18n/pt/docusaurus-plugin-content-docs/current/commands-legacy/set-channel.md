...
A primeira forma do comando SET CHANNEL abre uma porta serial, atribui o protocolo de criação e informação de outra porta. Os dados podem ser enviados com [SEND PACKET](send-packet.md "SEND PACKET"), [SEND RECORD](send-record.md "SEND RECORD") ou [SEND VARIABLE](send-variable.md "SEND VARIABLE") e recebido com [RECEIVE BUFFER](receive-buffer.md "RECEIVE BUFFER"), [RECEIVE PACKET](receive-packet), [RECEIVE RECORD](receive-record.md "RECEIVE RECORD") ou [RECEIVE VARIABLE](receive-variable.md "RECEIVE VARIABLE").
