...
<!--REF #_command_.SET MENU ITEM PARAMETER.Syntax-->**SET MENU ITEM PARAMETER** ( *menu* : Integer ; *menuItem* : Integer ; *param* : Text )<br/>**SET MENU ITEM PARAMETER** ( *menu* : Text ; *menuItem* : Integer ; *param* : Text )<!-- END REF-->
