...
<!--REF #_command_.BASE64 DECODE.Syntax-->**BASE64 DECODE** ( *textoCodificado* : Text {; *BLOB* : Text}{; *} )<br/>**BASE64 DECODE** ( *textoCodificado* : Text {; *BLOB* : Blob}{; *} )<br/>**BASE64 DECODE** ( *textoCodificado* : Blob {; *BLOB* : Text}{; *} )<br/>**BASE64 DECODE** ( *textoCodificado* : Blob {; *BLOB* : Blob}{; *} )<!-- END REF-->
