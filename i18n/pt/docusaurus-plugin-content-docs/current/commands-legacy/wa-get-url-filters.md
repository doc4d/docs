...
Os filtros são instalados pelo comando WA GET URL FILTERS. Se os arrays se reinicializam durante a sessão, o comando [WA SET URL FILTERS](wa-set-url-filters) pode ser utilizado para conhecer os parâmetros atuais.
