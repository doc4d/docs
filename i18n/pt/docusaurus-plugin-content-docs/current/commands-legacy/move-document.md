...
**Advertência**: utilizando MOVE DOCUMENT, pode mover um documento desde e para qualquer diretório no mesmo volume. Se desejar mover um documento entre dois volumes diferentes, utilize o comando [COPY DOCUMENT](copy-document) para “mover” o documento, e depois apagar a cópia original com o comando [DELETE DOCUMENT](delete-document)..  
