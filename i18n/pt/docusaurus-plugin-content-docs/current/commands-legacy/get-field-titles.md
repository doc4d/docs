...
Se o comando [SET FIELD TITLES](set-field-titles) for chamado durante a sessão, GET FIELD TITLES retorna apenas os nomes “modificados” e os números dos campos definidos utilizando este comando.  
