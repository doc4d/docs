...
<!--REF #_command_.Record number.Syntax-->**Record number** ( *tabela* : Table ) : Integer<!-- END REF-->
...
**Nota:** É recomendado utilizar o comando [Is new record](is-new-record) para verificar se o registro está em processo de criação. 
