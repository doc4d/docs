...
O comando devolve respectivamente o tipo de codificação, a versão e a propiedade “autônoma” do documento nos parâmetros codificacion, version e autonomo. Este comando deve utilizarse no evento do contexto do evento SAX XML Start Document. Para maior informação sobre os eventos SAX, consulte a descrição do comando [SAX Get XML node](sax-get-xml-node).
...
[SAX SET XML DECLARATION](sax-set-xml-declaration)  
