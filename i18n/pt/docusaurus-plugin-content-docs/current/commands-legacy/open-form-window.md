...
<!--REF #_command_.Open form window.Syntax-->**Open form window** ( {*tabela* : Table ;} *nomeForm* : Text {; *tipo* : Integer {; *hPos* : Integer {; *vPos* : Integer {; *}}}} ) : Integer<br/>**Open form window** ( {*tabela* : Table ;} *nomeForm* : Object {; *tipo* : Integer {; *hPos* : Integer {; *vPos* : Integer {; *}}}} ) : Integer<!-- END REF-->
