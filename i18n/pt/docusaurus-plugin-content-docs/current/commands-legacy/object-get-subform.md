...
No parâmetro *pontTabela*, o comando devolve um ponteiro à tabela dele ou dos formulário(s) utilizado(s). Se o sub-formulário utiliza um formulário projeto, o parâmetro contém [Is nil pointer](is-nil-pointer).  
