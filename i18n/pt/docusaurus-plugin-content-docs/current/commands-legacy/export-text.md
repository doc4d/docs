...
Em modo Unicode (modo padrão), o comando utiliza por padrão o conjunto de caracteres UTF-8\. Pode utilizar o comando [USE CHARACTER SET](use-character-set) para modificar este conjunto de caracteres. 
