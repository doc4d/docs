...
Os filtros são instalados pelo comando [WA SET EXTERNAL LINKS FILTERS](wa-set-external-links-filters). Se os arrays forem reinicializados durante a sessão, o comando WA GET EXTERNAL LINKS FILTERS permite conhecer a configuração atual.
