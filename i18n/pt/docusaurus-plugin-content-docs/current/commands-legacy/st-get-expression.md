...
**Nota**: este comando devolve nomes "reais" para os campos e as tabelas, mesmo se tiver sido definida uma estrutura "virtual" utilizando os comandos [SET TABLE TITLES](set-table-titles) e [SET FIELD TITLES](set-field-titles).
