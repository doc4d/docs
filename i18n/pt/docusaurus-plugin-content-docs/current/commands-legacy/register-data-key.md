...
* *curDataKey*: objeto (com propriedade *encodedKey*) que contém a chave de cifrado de dados. Esta chave pode ser gerada com o comando [New data key](new-data-key).
