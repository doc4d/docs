...
<!--REF #_command_.DISABLE MENU ITEM.Syntax-->**DISABLE MENU ITEM** ( *menu* : Integer ; *menuItem* : Integer {; *processo* : Integer} )<br/>**DISABLE MENU ITEM** ( *menu* : Text ; *menuItem* : Integer {; *processo* : Integer} )<!-- END REF-->
