...
Para obter mais informação sobre as expressões 4D utilizadas em áreas de texto de multi estilo ou 4D Write Pro, consulte a descrição do comando [ST INSERT EXPRESSION](st-insert-expression).  
...
* quando estão "congeladas" com o comando [ST FREEZE EXPRESSIONS](st-freeze-expressions), se passar o segundo parâmetro *\**.
