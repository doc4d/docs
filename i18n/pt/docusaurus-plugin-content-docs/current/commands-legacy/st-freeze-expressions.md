...
Para mais informação sobre expressões 4D usadas em áreas de texto multi estilo, ou áreas 4D Write Pro, veja a descrição do comando [ST INSERT EXPRESSION](st-insert-expression).
