...
**Nota:** o parâmetro do comando [BREAK LEVEL](break-level) deve ser igual ao número de quebras em seu relatório. Para maior informação sobre quebras, consulte os comandos do tema *Imprimir*. 
