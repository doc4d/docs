...
**Nota:** Quando o processo contém várias janelas e quer passar ao primeiro plano uma janela específica, é preferível utilizar por exemplo, o comando [SET WINDOW RECT](set-window-rect).
