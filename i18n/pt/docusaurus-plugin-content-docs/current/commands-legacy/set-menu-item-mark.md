...
<!--REF #_command_.SET MENU ITEM MARK.Syntax-->**SET MENU ITEM MARK** ( *menu* : Integer ; *menuItem* : Integer ; *marcar* : Text {; *processo* : Integer} )<br/>**SET MENU ITEM MARK** ( *menu* : Text ; *menuItem* : Integer ; *marcar* : Text {; *processo* : Integer} )<!-- END REF-->
