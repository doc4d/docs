...
Esta função compara a *senha* com um *hash* gerado pela função [Generate password hash](generate-password-hash).
...
Este exemplo verifica um hash de senha previamente criado por [Generate password hash](generate-password-hash) e o armazena em uma tabela \[Users\] com uma nova senha digitada:
