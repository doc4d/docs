...
<!--REF #_command_.METHOD SET COMMENTS.Syntax-->**METHOD SET COMMENTS** ( *rota* : Text ; *Comentarios* : Text {; *} )<br/>**METHOD SET COMMENTS** ( *rota* : Text ; *Comentarios* : Text array {; *} )<br/>**METHOD SET COMMENTS** ( *rota* : Text array ; *Comentarios* : Text {; *} )<br/>**METHOD SET COMMENTS** ( *rota* : Text array ; *Comentarios* : Text array {; *} )<!-- END REF-->
