...
O parâmetro *usuario4D* devolvido corresponde ao nome do usuário do sistema de senha 4D ou o apelido, como definido com [SET USER ALIAS](set-user-alias) (se houver). Se não há sistema de senhas ou um apelido definido, devolve “Desenhista”.  
