...
O efeito deste comando é similar ao de uma sequência [ALL RECORDS](all-records) / [DELETE SELECTION](delete-selection); entretanto, seu funcionamento difere nos seguintes pontos:  
