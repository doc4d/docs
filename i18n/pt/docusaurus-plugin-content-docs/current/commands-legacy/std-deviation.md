...
**Nota:** o parâmetro do comando [BREAK LEVEL](break-level) deve ser igual ao número de quebras de seu relatório. Para maior informação sobre quebras, consulte os comandos do capítulo *Imprimir*. 
