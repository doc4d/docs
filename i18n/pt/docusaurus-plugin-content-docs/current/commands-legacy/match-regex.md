...
<!--REF #_command_.Match regex.Syntax-->**Match regex** ( *padrao* : Text ; *umaCadeia* : Text ; *posiçao* : Integer {; pos_encont ; compr_encont}{; *} ) -> Resultado <br/>
**Match regex** ( *padrao* : Text ; *umaCadeia* : Text ) -> Resultado<!-- END REF-->
