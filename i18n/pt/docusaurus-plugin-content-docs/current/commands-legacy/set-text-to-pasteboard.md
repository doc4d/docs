...
Depois de colocar texto na área de transferência, pode recuperá-lo utilizando o comando [Get text from pasteboard](get-text-from-pasteboard) ou chamando [GET PASTEBOARD DATA](get-pasteboard-data) ("com.4d.text.native";...).
