...
<!--REF #_command_.SPELL SET CURRENT DICTIONARY.Syntax-->**SPELL SET CURRENT DICTIONARY** ( *dicionário* : Integer )<br/>**SPELL SET CURRENT DICTIONARY** ( *dicionário* : Text )<!-- END REF-->
