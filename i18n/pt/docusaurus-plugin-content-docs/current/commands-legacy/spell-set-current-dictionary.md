...
**Nota**: Para maior informação sobre os dicionários Hunspell, consulte [SET DATABASE PARAMETER](set-database-parameter) . Para saber mais, veja *Configuração da correção ortográfica*. 

 Pode utilizar o parâmetro *dicionario* para mudar o dicionário. Pode passar:
* Um número de identificação de dicionário Hunspell (devolvido pelo comando [SPELL GET DICTIONARY LIST](spell-get-dictionary-list)),
