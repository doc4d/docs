...
Em *seletor*, pode passar a constante Additional text ou a constante de ação padrão (localizada no tema “*Listas hierárquicas*”) ou qualquer valor personalizado. Para maior informação sobre os parâmetros *seletor* e *valor*, consulte a descrição do comando [SET LIST ITEM PARAMETER](set-list-item-parameter).
