...
**Nota:** este comando estende as funcionalidades oferecidas pelos operadores clássicos de transformação de imagens (+/, etc., ver a seção [Picture](../Concepts/dt_picture)). Estes operadores permanecem totalmente utilizáveis em 4D v11.
