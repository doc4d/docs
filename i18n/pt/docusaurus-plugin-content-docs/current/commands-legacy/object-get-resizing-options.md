...
O comando devolve as opções de redimensiones atuais, como se definiram no modo Desenho o para o processo utilizando o comando [OBJECT SET RESIZING OPTIONS](object-set-resizing-options). Estas opções definem a visualização do objeto em caso de redimensionamento da janela do formulário.
