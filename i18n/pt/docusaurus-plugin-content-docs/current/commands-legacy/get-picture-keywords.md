...
<!--REF #_command_.GET PICTURE KEYWORDS.Syntax-->**GET PICTURE KEYWORDS** ( *imagem* : Picture ; *arrayPalavrasChaves* : Text array {; *} )<br/>**GET PICTURE KEYWORDS** ( *imagem* : Picture ; *arrayPalavrasChaves* : Text array {; *} )<!-- END REF-->
