...
Get document position devolve a posição, a partir do início do documento, onde ocorrerá a próxima leitura ([RECEIVE PACKET](receive-packet)) ou escrita ([SEND PACKET](send-packet)).
