...
* *objetoChave*: um objeto JSON contendo uma chave de criptografia, com a mesma estrutura que o objeto retornado pelo comando [New data key](new-data-key)
...
*passefrase* e *salt* usados para a descriptografia são idênticos a *passefrase* e *salt* usados para criptografar (ver o exemplo [Encrypt data BLOB](encrypt-data-blob)).
