...
A referência do elemento document permite manipular os nodos "Doctype" e "Processing Instruction". Apenas pode ser utilizado com os comandos [DOM Append XML child node](dom-append-xml-child-node) e [DOM GET XML CHILD NODES](dom-get-xml-child-nodes)  
