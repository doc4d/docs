...
* na unidade atual definida globalmente para as linhas de list box, seja na lista de Propriedades ou mediante uma chamada previa ao comando [LISTBOX SET ROWS HEIGHT](listbox-set-rows-height) quando a altura da linha for fixa,
