...
**Advertência**: a chamada de um comando 4D que mostra um elemento de interface ([DIALOG](../commands/dialog), [ALERT](../commands/alert.md)...) termina o processamento do método.  
