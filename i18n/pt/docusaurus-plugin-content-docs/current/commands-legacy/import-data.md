...
* Salve o projeto no disco, depois carregue-o, utilizando por exemplo o comando [DOM Parse XML source](dom-parse-xml-source), e passe sua referencia no parâmetro *projeto*.
