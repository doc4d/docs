...
O parâmetros associados aos elementos permitem armazenar informação adicional sobre cada elemento. Se definem com a ajuda do comando [SET LIST ITEM PARAMETER](set-list-item-parameter).
