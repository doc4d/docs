...
O funcionamento geral deste comando é idêntico ao do comando [OPEN DATA FILE](open-data-file); a única diferença é que o novo arquivo de dados designado pelo parâmetro *endAcesso* é criado justo depois de que se abre novamente a estrutura.
