...
Quando aplica [SELECTION TO ARRAY](selection-to-array) ou [SELECTION RANGE TO ARRAY](selection-range-to-array) a um campo de tipo Hora, tenha em conta que só são criados um array de tipo Hora se o array não foi definido como outro tipo, tal como Inteiro longo, por exemplo.
