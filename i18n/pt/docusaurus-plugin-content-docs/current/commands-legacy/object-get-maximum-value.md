...
Pode estabelecer a propriedade "Valor máximo" com a lista de propriedades em modo Desenho ou utilizando o comando [OBJECT SET MAXIMUM VALUE](object-set-maximum-value).
