...
A folha de estilo pode ter sido atribuída em modo Desenho utilizando a lista de propriedades ou para o processo atual usando o comando [OBJECT SET STYLE SHEET](object-set-style-sheet).  
