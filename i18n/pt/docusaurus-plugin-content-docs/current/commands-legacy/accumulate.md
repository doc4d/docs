...
<!--REF #_command_.ACCUMULATE.Summary-->ACCUMULATE especifica os campos ou variáveis a acumular em um relatório realizado utilizando [PRINT SELECTION](print-selection).<!-- END REF-->.
...
Ver o exemplo do comando [BREAK LEVEL](break-level) .
