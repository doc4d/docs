...
As propriedades de impressão de tamanho variável podem ser definidas utilizando a lista de propriedades ou o comando [OBJECT SET PRINT VARIABLE FRAME](object-set-print-variable-frame).  
...
[OBJECT SET PRINT VARIABLE FRAME](object-set-print-variable-frame)  
