...
Para guardar um novo registro criado com [CREATE RECORD](create-record) ou [DUPLICATE RECORD](duplicate-record)
* Para guardar dados desde [RECEIVE RECORD](receive-record)
