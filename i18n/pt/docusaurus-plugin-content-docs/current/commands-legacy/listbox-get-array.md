...
Os arrays de estilo, cor ou cor de fundo podem estar associados aos list box de tipo de array usando a lista de propriedades em modo *Desenho* ou o comando [LISTBOX SET ARRAY](listbox-set-array).
...
* [Is nil pointer](is-nil-pointer) Se nenhum array da propriedade solicitada está associado a coluna ou ao list box.
* Um ponteiro ao array da propriedade solicitada, definido pelo usuário.
* Um ponteiro ao array da propriedade solicitada, definido dinamicamente quando se chama ao comando [LISTBOX SET ROW COLOR](listbox-set-row-color) ou [LISTBOX SET ROW FONT STYLE](listbox-set-row-font-style)
