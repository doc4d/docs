...
* A URL foi negado por um filtro (comando [WA SET URL FILTERS](wa-set-url-filters)),
* O link está aberto no navegador por padrão (comando [WA SET EXTERNAL LINKS FILTERS](wa-set-external-links-filters)),
