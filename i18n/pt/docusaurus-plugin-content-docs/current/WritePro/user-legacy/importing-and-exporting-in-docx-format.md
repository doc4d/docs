...
| **Setting**   | **Description** |
| ------------- | --------------- |
| Marca de água | Não compatível  |

#### Expressões

| **Setting**       | **Description**                                                      |
| ----------------- | -------------------------------------------------------------------- |
| MS Word equations | Não suportado. Data is not imported. |
| MS Word charts    | Não suportado. Data is not imported. |
...
| VML shapes or images | Não suportado. VML is obsolete in MS Word and should not be used in documents created with MS Word 2010 or older.              |
...
| **Setting** | **Description**                                                         |
| ----------- | ----------------------------------------------------------------------- |
| Comentários | Não suportado. Content is not imported. |
| Footnotes   | Não suportado. Content is not imported. |

#### Spacing

| **Setting**             | **Description**                                                                                                                        |
| ----------------------- | -------------------------------------------------------------------------------------------------------------------------------------- |
| "At least" line spacing | Não suportado. "At least" line spacing is converted to fixed (single) line spacing. |
| Fit text                | Não suportado. The normal 4D Write Pro style is used.                                                  |

#### Tabelas

| **Setting** | **Description**                                               |
| ----------- | ------------------------------------------------------------- |
| Tabelas     | Contiguous tables do not merge automatically. |

#### Text

| **Setting**                                                 | **Description**                                                                                                                                                                                 |
| ----------------------------------------------------------- | ----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| Temas                                                       | Text themes are not imported. If a color or font definition references a color or font in a theme, the last computed color or font will be used. Otherwise, the |
...
| **Setting** | **Paragraphs**                                                                                                                                                                                                                                                                                                                                                                                        | **Sections** | **Images** |
| ----------- | ----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- | ------------ | ---------- |
| Expressões  | Only simple 4D expressions such as "Current date" or "Current time", or 4D Write Pro reserved local variables ($wp\_title, $wp\_pageNumber, etc.) are converted to Microsoft Word fields. Other 4D expressions are computed and converted to text or images during the export process. |              |            |
...
| Sublinhado   | Semi-transparent underlines will be converted to solid.                                              |                                                                                                 |            |