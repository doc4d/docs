...
| Resultados | Booleano | <- | True if session has *privilege*, False otherwise|<!-- END REF -->
...
| Parameter  | Tipo     |    | Descrição                                                                  |
| ---------- | -------- |:--:| -------------------------------------------------------------------------- |
| Resultados | Booleano | <- | True if session is a Guest one, False otherwise|<!-- END REF -->
...
| settings   | Objeto     | -> | Object with a "privileges" property (string or collection)|<!-- END REF -->
