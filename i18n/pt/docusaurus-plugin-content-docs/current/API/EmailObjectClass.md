...
The `.attachments` property contains a <!-- REF #EmailObjectClass.bodyStructure.Summary -->collection of `4D.<!-- END REF -->. Veja <a href="#handling-body-part">Gestão do corpo</a>.</p>

<p spaces-before="0">O objeto <code>.bodyStructure` contém as seguintes propriedades:
