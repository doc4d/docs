...
| **drop**     | Eliminar dados em qualquer classe de dados.                                          | Delete data in this dataclass.                                                                                                                       | Delete a not null value for this attribute (except for alias and computed attribute).                                 | n/a                                                                                                                                                                                                                                                                      |
