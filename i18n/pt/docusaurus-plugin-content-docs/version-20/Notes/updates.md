...
- Apoio da palavra-chave [`property/1></a>  em definições de classe de utilizador.</li>
<li>Novas funções para bloquear/desbloquear o datastore: <a href="../API/DataStoreClass.md#flushandlock"><code>.flushAndLock()`](../Concepts/classes.md#property), [`.locked()`](../API/DataStoreClass.md#locked), [`.unlock()`](../API/DataStoreClass.md#unlock).
