...
| ---------- | ----------------------- | -------- | ------------------------------ | ----- |
| Equality   | Null `=` Null           | Booleano | a.nullProp `=` b.nullProp      | True  |
|            | Null `=` Undefined      | Booleano | a.nullProp `=` b.undefinedProp | True  |
|            | Null `=` *scalar value* | Booleano | a.nullProp `=` 42              | False |
| Inequality | Null `#` Null           | Booleano | a.nullProp `#` b.nullProp      | False |
...
| Operation            | Syntax                                                | Returns  | Expression                          | Value |
| -------------------- | ----------------------------------------------------- | -------- | ----------------------------------- | ----- |
| Equality             | Undefined `=` Undefined                               | Booleano | a.undefinedProp `=` b.undefinedProp | True  |
|                      | Undefined `=` Null                                    | Booleano | a.undefinedProp `=` c.nullProp      | True  |
|                      | Undefined `=` *other values*                          | Booleano | a.undefinedProp `=` 42              | False |
| Inequality           | Undefined `#` Undefined                               | Booleano | a.undefinedProp `#` b.undefinedProp | False |
