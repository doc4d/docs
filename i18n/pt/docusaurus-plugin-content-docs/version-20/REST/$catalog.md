...
| foreignKey  | Text     | foreignKey|Text   |For a relatedEntity attribute, name of the related attribute.|                                                                                  |
| inverseName | Text     | inverseName |Text |Name of the opposite relation for a relatedEntity or relateEntities attribute.|                                                                 |
