...
The 4D language supports [comments](../Concepts/quick-tour.md#comments), which are inactive lines of code. O editor de código não aplica nenhum estilo específico nos comentários. The length of comments is limited to the maximum size of 32,000 characters per line. The 4D language supports <a href="../Concepts/quick-tour.md#comments">comments</a>, which are inactive lines of code.
