...
|                                                   | Descrição                                                                                                                                                                |
| ------------------------------------------------- | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------ |
| **Background color**                              | Cor de fundo da janela do editor de código.                                                                                                                              |
...
| **Cursor line background color**                  | Cor de fundo da linha que contém o cursor.                                                                                                                               |
| **Execution line background color**               | Cor de fundo da linha que está a ser executada no depurador.                                                                                                             |
| **Highlight of the found words**                  | Cor de destaque das palavras encontradas numa pesquisa.                                                                                                                  |
...
| **Selection back color**                          | Cor de fundo da seleção.                                                                                                                                                 |
| **Suggested text**                                | Cor do texto do preenchimento automático sugerido pelo Editor de código.                                                                                                 |
