...
| Resultados | Object     |  <- | Status of the addFlags operation                                                                                                                                                                            | <!-- END REF --> |
...
| Resultados     | Object |  <- | Status of the append operation                | <!-- END REF --> |
...
| Resultados     | Object     |  <- | Status of the copy operation                                                | <!-- END REF --> |
...
| Resultados | Object |  <- | Status of the mailbox creation operation | <!-- END REF --> |
...
| msgsIDs    | Collection |  -> | Coleção de identificadores únicos de mensagens (strings) |                  |
| allMsgs    | Integer    |  -> | `IMAP all`: All messages in the selected mailbox                            |                  |
| Resultados | Object     |  <- | Status of the delete operation                                              | <!-- END REF --> |
...
| Resultados | Object |  <- | Status of the mailbox deletion operation | <!-- END REF --> |
...
| Parâmetro  | Tipo   |     | Descrição                       |                  |
| ---------- | ------ | :-: | ------------------------------- | ---------------- |
| Resultados | Object |  <- | Status of the expunge operation | <!-- END REF --> |
...
| Versão | Mudanças           |
| ------ | ------------------ |
| v20    | _id_ is returned   |
| v18 R5 | _name_ is optional |
| v18 R4 | Adicionado         |
...
| ---------- | ------ | :-: | ----------------------------- | ---------------- |
| name       | Text   |  -> | Nome da nova caixa de correio |                  |
| Resultados | Object |  <- | boxInfo object                | <!-- END REF --> |
...
| Resultados | Object  |  <- | [Email object](EmailObjectClass.md#email-object) | <!-- END REF --> |
...
| options    | Object     |  -> | Instruções de tratamento de mensagens                                                                                                                                              |                  |
| Resultados | Object     |  <- | Object containing:<br/><ul><li>a collection of [Email objects](EmailObjectClass.md#email-object) and</li><li>a collection of IDs or numbers for missing messages, if any</li></ul> | <!-- END REF --> |
...
| Resultados     | Object     |  <- | Status of the move operation                                                | <!-- END REF --> |
...
| Resultados | Object     |  <- | Status of the removeFlags operation                                                                                                                                                                         | <!-- END REF --> |
...
| Resultados  | Object |  <- | Status of the renaming operation | <!-- END REF --> |
...
| Versão | Mudanças                                     |
| ------ | -------------------------------------------- |
| v20    | _id_, _flags_, _permanentFlags_ are returned |
| v18 R4 | Adicionado                                   |
...
| ---------- | ------ | :-: | --------------------------------- | ---------------- |
| name       | Text   |  -> | Nome da nova caixa de correio     |                  |
| Resultados | Object |  <- | Status of the subscribe operation | <!-- END REF --> |
...
| ---------- | ------ | :-: | ----------------------------------- | ---------------- |
| name       | Text   |  -> | Nome da nova caixa de correio       |                  |
| Resultados | Object |  <- | Status of the unsubscribe operation | <!-- END REF --> |
