...
| OAUTH2   | `IMAP authentication OAUTH2`   | Autenticação usando o protocolo OAuth2   |
...
| Valor    | Constantes                     | Comentário                                                            |
| -------- | ------------------------------ | --------------------------------------------------------------------- |
| APOP     | `POP3 authentication APOP`     | Autenticação usando o protocolo APOP (POP3 apenas) |
...
| PLAIN    | `POP3 authentication plain`    | Autenticação usando o protocolo PLAIN                                 |
...
| ---------- | ------ | :-: | ------------------------------------------- | ---------------- |
| Resultados | Object |  <- | Status of the transporter object connection | <!-- END REF --> |
