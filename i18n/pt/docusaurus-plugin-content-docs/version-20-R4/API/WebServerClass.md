...
| `Web server host database`     | 2     | Servidor Web do banco de dados de host de um componente                        |
| `Web server receiving request` | 3     | Servidor web que recebeu o pedido (servidor Web de destino) |
