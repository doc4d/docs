...
| Resultados | Text   | <- | Message encrypted and encoded using the `options.encodingEncrypted`           | <!-- END REF --> |
...
| Parâmetro  | Tipo |    | Descrição                 |                  |
| ---------- | ---- | -- | ------------------------- | ---------------- |
| Resultados | Text | <- | Private key in PEM format | <!-- END REF --> |
...
| Parâmetro  | Tipo |    | Descrição                |                  |
| ---------- | ---- | -- | ------------------------ | ---------------- |
| Resultados | Text | <- | Public key in PEM format | <!-- END REF --> |
...
| options    | Object | -> | Opções de assinatura                                                                              |                  |
| Resultados | Object | <- | Status of the verification                                                                        | <!-- END REF --> |
