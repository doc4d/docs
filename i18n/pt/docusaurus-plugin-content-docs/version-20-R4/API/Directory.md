...
| Resultados        | 4D. Folder |  <- | Copied file or folder                       | <!-- END REF --> |
...
| Resultados | 4D. File | <- | `File` object (null if invalid path) | <!-- END REF --> |
...
| Resultados | Collection | <- | Collection of children file objects | <!-- END REF --> |
...
| ---------- | ---------- | -- | ----------------------------------------------------------------- | ---------------- |
| path       | Text       | -> | Rota POSIX relativa                                               |                  |
| Resultados | 4D. Folder | <- | Created folder object (null if invalid _path_) | <!-- END REF --> |
...
| Resultados | Collection | <- | Collection of children folder objects | <!-- END REF --> |
