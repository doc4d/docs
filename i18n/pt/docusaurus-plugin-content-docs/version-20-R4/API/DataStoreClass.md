...
| Resultados | cs. DataStore | <- | Reference to the datastore                      | <!-- END REF --> |
...
| Resultados     | cs. DataStore | <- | Datastore object                                                                                | <!-- END REF --> |
...
| Parâmetro  | Tipo   |     | Descrição                                                                   |                  |
| ---------- | ------ | :-: | --------------------------------------------------------------------------- | ---------------- |
| Resultados | Object |  <- | Information about the encryption of the current datastore and of each table | <!-- END REF --> |
...
| Parâmetro  | Tipo       |    | Descrição                                  |                  |
| ---------- | ---------- | -- | ------------------------------------------ | ---------------- |
| Resultados | Collection | <- | Collection of optimization context objects | <!-- END REF --> |
...
| Parâmetro  | Tipo   |     | Descrição            |                  |
| ---------- | ------ | :-: | -------------------- | ---------------- |
| Resultados | Object |  <- | Datastore properties | <!-- END REF --> |
...
| Resultados  | Object | <- | Description of the optimization context | <!-- END REF --> |
...
| Parâmetro  | Tipo       |     | Descrição                                                                                         |                  |
| ---------- | ---------- | :-: | ------------------------------------------------------------------------------------------------- | ---------------- |
| Resultados | Parâmetros |  <- | True if the Data Explorer access is disabled, False if it is enabled (default) | <!-- END REF --> |
...
| Parâmetro  | Tipo       |    | Descrição      |                  |
| ---------- | ---------- | -- | -------------- | ---------------- |
| Resultados | Parâmetros | <- | True if locked | <!-- END REF --> |
...
| Resultados    | Object | <- | Result of the encryption key matching | <!-- END REF --> |
...
| Parâmetro | Tipo       |    | Descrição                                                                                                               |                  |
| --------- | ---------- | -- | ----------------------------------------------------------------------------------------------------------------------- | ---------------- |
| status    | Parâmetros | -> | True to disable Data Explorer access to data on the `webAdmin` port, False (default) to grant access | <!-- END REF --> |
