...
| Resultados          | Collection |  <- | Differences between the entities                 | <!-- END REF --> |
...
| Resultados | Object  |  <- | Result of drop operation                                                        | <!-- END REF --> |
...
| Resultados      | Integer             |  <- | Position of the entity in an entity selection                        | <!-- END REF --> |
...
| Parâmetro  | Tipo       |     | Descrição                                                                             |                  |
| ---------- | ---------- | :-: | ------------------------------------------------------------------------------------- | ---------------- |
| Resultados | Parâmetros |  <- | É verdade se a entidade acabou de ser criada e ainda não foi salva. Otherwise, False. | <!-- END REF --> |
...
| Parâmetro  | Tipo       |     | Descrição                                                                              |                  |
| ---------- | ---------- | :-: | -------------------------------------------------------------------------------------- | ---------------- |
| Resultados | 4D. Entity |  <- | Reference to last entity of an entity selection (Null if not found) | <!-- END REF --> |
...
| Resultados | Object  |  <- | Result of lock operation                                             | <!-- END REF --> |
...
| Parâmetro  | Tipo       |     | Descrição                                                                               |                  |
| ---------- | ---------- | :-: | --------------------------------------------------------------------------------------- | ---------------- |
| Resultados | 4D. Entity |  <- | Reference to next entity in the entity selection (Null if not found) | <!-- END REF --> |
...
| Parâmetro  | Tipo       |     | Descrição                                                                                   |                  |
| ---------- | ---------- | :-: | ------------------------------------------------------------------------------------------- | ---------------- |
| Resultados | 4D. Entity |  <- | Reference to previous entity in the entity selection (Null if not found) | <!-- END REF --> |
...
| Resultados | Object  |  <- | Result of save operation                          | <!-- END REF --> |
...
| Resultados   | Object     |  <- | Object built from the entity                                                                                                                                 | <!-- END REF --> |
...
| Parâmetro  | Tipo       |     | Descrição                                                                             |                  |
| ---------- | ---------- | :-: | ------------------------------------------------------------------------------------- | ---------------- |
| Resultados | Parâmetros |  <- | True if at least one entity attribute has been modified and not yet saved, else False | <!-- END REF --> |
