...
| Name          | Datentyp | Possible Values                         |
| ------------- | -------- | --------------------------------------- |
| customBorderX | Zahl     | For use with "custom" style. Minimum: 0 |
...
| Name          | Datentyp | Possible Values                         |
| ------------- | -------- | --------------------------------------- |
| customBorderY | Zahl     | For use with "custom" style. Minimum: 0 |
