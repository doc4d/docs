...
| [Automatische Größe](https://doc.4d.com/4Dv19/4D/19/Setting-object-display-properties.300-5416671.en.html#148057) (Kontextmenü des Formulareditors) | Ist das Anzeigeformat des Bildes:<ul><li>**[Scaled](FormObjects/properties_Picture.md#scaled-to-fit)** - Das Objekt, das das Bild enthält, wird nach (Anzahl der Pixel des Bildes * dpi des Bildschirms) / (dpi des Bildes) skaliert </li> <li>**Nicht skaliert** - Das Objekt, das das Bild enthält, hat die gleiche Anzahl von Pixel wie das Bild.</li></ul> |
