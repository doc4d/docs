...
| .**accessTokenOAuth2**: TextText string representing OAuth 2 authorization credentials. Used only with OAUTH2 `authenticationMode`. If `accessTokenOAuth2` is used but `authenticationMode` is omitted, the OAuth 2 protocol is used (if allowed by the server). Text string or token object representing OAuth2 authorization credentials. | none                                                                |
...
| **.password** : TextUser password for authentication on the server. Text string or token object representing OAuth2 authorization credentials.                                                                                                                                                                                              | none                                                                |
