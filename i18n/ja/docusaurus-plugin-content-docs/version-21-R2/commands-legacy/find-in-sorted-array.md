...
<!--REF #_command_.Find in sorted array.Syntax-->**Find in sorted array** ( *array* : Array ; *value* : Expression ; *> or <* : Operator {; *posFirst* : Integer {; *posLast* : Integer}} ) : Boolean<!-- END REF-->
