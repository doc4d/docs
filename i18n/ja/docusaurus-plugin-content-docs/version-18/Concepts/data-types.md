...
| [Pointer](Concepts/dt_pointer.md)     | -       | ◯       | `C_POINTER`, `ARRAY POINTER` |
| [Picture](Concepts/dt_picture.md)     | ◯       | ◯       | `C_PICTURE`, `ARRAY PICTURE` |
| [BLOB](Concepts/dt_blob.md)           | ◯       | ◯       | `C_BLOB`, `ARRAY BLOB`       |
| [Result](Concepts/dt_object.md)       | ◯       | ◯       | `C_OBJECT`, `ARRAY OBJECT`   |
...
| Picture | ピクチャーサイズ=0                                                           | ピクチャーサイズ=0                   | ピクチャーサイズ=0                  |
