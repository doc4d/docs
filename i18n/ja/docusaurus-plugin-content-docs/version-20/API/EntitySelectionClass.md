...
| 戻り値 | コレクション | <- | 重複しないパスを格納した新規コレクション|<!-- END REF -->
...
| 引数     | 型    |    | 説明                                                             |
| ------ | ---- | -- | -------------------------------------------------------------- |
| result | テキスト | <- | エンティティセレクションにリンクされたコンテキスト属性 (カンマ区切り)<!-- END REF -->
...
| 戻り値              | オブジェクト             | <- | 呼び出し対象のエンティティセレクション内での位置を取得したい、選別されたエンティティのセレクション|<!-- END REF -->
