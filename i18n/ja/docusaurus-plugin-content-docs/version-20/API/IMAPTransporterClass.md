...
| 戻り値      | オブジェクト | <- | addFlags処理のステータス|<!-- END REF -->
...
| 戻り値            | オブジェクト | <- | append処理のステータス|<!-- END REF -->
...
| 戻り値            | オブジェクト | <- | copy処理のステータス|<!-- END REF -->
...
| 戻り値  | オブジェクト | <- | createBox処理のステータス|<!-- END REF -->
...
| msgsIDs | コレクション | -> | メッセージの固有ID のコレクション (テキスト)                 |
| allMsgs | 整数     | -> | `IMAP all`: 選択されたメールボックスの全メッセージ           |
| 戻り値     | オブジェクト | <- | delete処理のステータス|<!-- END REF -->
...
| 戻り値  | オブジェクト | <- | deleteBox処理のステータス|<!-- END REF -->
...
| 引数  | 型      |    | 説明                                          |
| --- | ------ |:--:| ------------------------------------------- |
| 戻り値 | オブジェクト | <- | expunge処理のステータス |<!-- END REF -->
...
| 戻り値        | コレクション | <- | mailbox オブジェクトのコレクション|<!-- END REF -->
...
| options  | オブジェクト | -> | メッセージ管理オプション                                                                         |
| 戻り値      | オブジェクト | <- | 次のコレクションを格納したオブジェクト:<br/><ul><li>[Email オブジェクト](EmailObjectClass.md#email-オブジェクト) のコレクション</li><li>見つからなかったメッセージの ID または番号のコレクション</li></ul>|<!-- END REF -->
...
| 戻り値            | オブジェクト | <- | move処理のステータス|<!-- END REF -->
...
| startMsg | 整数     | -> | 先頭メッセージのシーケンス番号                         |
| endMsg   | 整数     | -> | 最後のメッセージのシーケンス番号                        |
| 戻り値      | コレクション | <- | 固有ID のコレクション|<!-- END REF -->
...
| 戻り値      | オブジェクト | <- | removeFlags処理のステータス|<!-- END REF -->
...
| 戻り値         | オブジェクト | <- | renameBox処理のステータス|<!-- END REF -->
...
| 戻り値            | コレクション | <- | メッセージ番号のコレクション|<!-- END REF -->
...
| ---- | ------ |:--:| -------------------------------------------- |
| name | テキスト   | -> | メールボックスの名称                                   |
| 戻り値  | オブジェクト | <- | subscribe処理のステータス|<!-- END REF -->
...
| ---- | ------ |:--:| ---------------------------------------------- |
| name | テキスト   | -> | メールボックスの名称                                     |
| 戻り値  | オブジェクト | <- | unsubscribe処理のステータス|<!-- END REF -->
