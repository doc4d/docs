...
| 引数  | 型  |    | 説明                                            |
| --- | -- | -- | --------------------------------------------- |
| 戻り値 | 実数 | <- | ドキュメントのサイズ (バイト単位)|<!-- END REF -->
...
| 引数   | 型  |    | 説明                                               |
| ---- | -- | -- | ------------------------------------------------ |
| size | 実数 | -> | ドキュメントの新しいサイズ (バイト単位)|<!-- END REF -->
...
| 引数           | 型    |    | 説明                                  |
| ------------ | ---- | -- | ----------------------------------- |
| *lineOfText* | テキスト | -> | 書き込むテキスト|<!-- END REF -->
...
| 引数            | 型    |    | 説明                                  |
| ------------- | ---- | -- | ----------------------------------- |
| *textToWrite* | テキスト | -> | 書き込むテキスト|<!-- END REF -->
