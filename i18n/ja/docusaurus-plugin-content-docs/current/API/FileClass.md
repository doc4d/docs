...
| 引数     | タイプ    |    | 詳細                                                                               |
| ------ | ------ | -- | -------------------------------------------------------------------------------- |
| Result | Result | <- | Contents of .exe/.dll version resource or .plist file|<!-- END REF -->
...
| 引数   | タイプ    |    | 詳細                                                                                          |
| ---- | ------ | -- | ------------------------------------------------------------------------------------------- |
| info | Result | -> | Properties to write in .exe/.dll version resource or .plist file|<!-- END REF -->
