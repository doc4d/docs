...
4D Write Pro は、4Dユーザーに対して、4Dデータベースに完全に統合した高度なワードプロセスツールを提供します。 Using 4D Write Pro, you can write pre-formatted emails and/or letters or any documents containing images, tables, bookmarks, a scanned signature, formatted text and placeholders for dynamic variables. また、請求書やレポートを動的に作成し、フォーマット済みのテキストや画像を含めることができます。
