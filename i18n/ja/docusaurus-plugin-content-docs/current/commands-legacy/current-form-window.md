...
カレントフォームウィンドウは[ADD RECORD](add-record.md "ADD RECORD")のようなコマンドを使用すると自動で生成されることがあります。また[Open window](open-window.md "Open window") や [Open form window](../commands/open-form-window.md "Open form window") コマンドでも生成されます。 
