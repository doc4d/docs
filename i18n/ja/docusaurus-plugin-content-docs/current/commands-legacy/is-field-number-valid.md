...
<!--REF #_command_.Is field number valid.Syntax-->**Is field number valid** ( *tablePtr* ; *fieldNum* : Integer ) : Boolean<br/>**Is field number valid** ( *tableNum* ; *fieldNum* : Integer ) : Boolean<!-- END REF-->
