...
<!--REF #_command_.Select folder.Syntax-->**Select folder** ( {*message* : Text }{;}{ *defaultPath* : Text {; *options* : Integer}} ) : Text<br/>**Select folder** ( {*message* : Text }{;}{ *defaultPath* : Integer {; *options* : Integer}} ) : Text<!-- END REF-->
