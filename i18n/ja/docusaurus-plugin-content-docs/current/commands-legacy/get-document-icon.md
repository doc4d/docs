...
<!--REF #_command_.GET DOCUMENT ICON.Syntax-->**GET DOCUMENT ICON** ( *docPath* : Text ; *icon* : Picture {; *size* : Integer} )<br/>**GET DOCUMENT ICON** ( *docPath* : Text ; *icon* : Picture {; *size* : Integer} )<!-- END REF-->
