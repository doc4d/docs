...
<!--REF #_command_.SET LIST ITEM FONT.Syntax-->**SET LIST ITEM FONT** ( {* ;} *list* ; *itemRef* ; *font* )<br/>**SET LIST ITEM FONT** ( * ; *list* ; * ; *font* : Text )<br/>**SET LIST ITEM FONT** ( * ; *list* ; * ; *font* : Integer )<!-- END REF-->
