...
<!--REF #_command_.Choose.Syntax-->**Choose** ( *criterion* : Boolean ; *value* : Expression {; *value2* ; ... ; *valueN*} )  : any<br/>**Choose** ( *criterion* : Integer ; *value* : Expression {; *value2* ; ... ; *valueN*} )  : any<!-- END REF-->
