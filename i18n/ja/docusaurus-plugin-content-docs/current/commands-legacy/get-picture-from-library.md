...
<!--REF #_command_.GET PICTURE FROM LIBRARY.Syntax-->**GET PICTURE FROM LIBRARY** ( *picRef * ; *picture* : Picture )<br/>**GET PICTURE FROM LIBRARY** ( *picName* ; *picture* : Picture )<!-- END REF-->
