...
<!--REF #_command_.TEXT TO DOCUMENT.Syntax-->**TEXT TO DOCUMENT** ( *fileName* : Text ; *text* : Text {; *charSet* : Text {; *breakMode* : Integer}} )<br/>**TEXT TO DOCUMENT** ( *fileName* : Text ; *text* : Text {; *charSet* : Integer {; *breakMode* : Integer}} )<!-- END REF-->
