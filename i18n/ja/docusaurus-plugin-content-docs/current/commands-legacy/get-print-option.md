...
<!--REF #_command_.GET PRINT OPTION.Syntax-->**GET PRINT OPTION** ( *option* : Integer ; *value1* : Integer {; *value2* : Integer} )<br/>**GET PRINT OPTION** ( *option* : Integer ; *value1* : Integer {; *value2* : Text} )<br/>**GET PRINT OPTION** ( *option* : Integer ; *value1* : Text {; *value2* : Integer} )<br/>**GET PRINT OPTION** ( *option* : Integer ; *value1* : Text {; *value2* : Text} )<!-- END REF-->
