...
<!--REF #_command_.QR SET DESTINATION.Syntax-->**QR SET DESTINATION** ( *area* : Integer ; *type* : Integer {; *specifics* : Text} )<br/>**QR SET DESTINATION** ( *area* : Integer ; *type* : Integer {; *specifics* : Variable} )<!-- END REF-->
