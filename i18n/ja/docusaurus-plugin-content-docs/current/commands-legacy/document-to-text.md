...
<!--REF #_command_.Document to text.Syntax-->**Document to text** ( *fileName* : Text {; *charSet* : Text {; *breakMode* : Integer}} ) : Text<br/>**Document to text** ( *fileName* : Text {; *charSet* : Integer {; *breakMode* : Integer}} ) : Text<!-- END REF-->
