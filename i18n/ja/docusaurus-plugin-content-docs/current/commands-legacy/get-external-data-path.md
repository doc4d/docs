...
<!--REF #_command_.Get external data path.Syntax-->**Get external data path** ( *aField* : Text ) : Text<br/>**Get external data path** ( *aField* : Blob ) : Text<br/>**Get external data path** ( *aField* : Picture ) : Text<!-- END REF-->
