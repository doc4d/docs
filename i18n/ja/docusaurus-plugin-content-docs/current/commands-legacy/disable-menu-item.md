...
<!--REF #_command_.DISABLE MENU ITEM.Syntax-->**DISABLE MENU ITEM** ( *menu* : Integer ; *menuItem* : Integer {; *process* : Integer} )<br/>**DISABLE MENU ITEM** ( *menu* : Text ; *menuItem* : Integer {; *process* : Integer} )<!-- END REF-->
