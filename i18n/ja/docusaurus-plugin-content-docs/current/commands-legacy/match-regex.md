...
<!--REF #_command_.Match regex.Syntax-->**Match regex** ( *pattern* : Text ; *aString* : Text ; *start* : Integer {; pos_found ; length_found}{; *} ) -> 戻り値 <br/>
**Match regex** ( *pattern* : Text ; *aString* : Text ) -> 戻り値<!-- END REF-->
