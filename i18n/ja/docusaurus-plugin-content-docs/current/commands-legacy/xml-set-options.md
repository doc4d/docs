...
<!--REF #_command_.XML SET OPTIONS.Syntax-->**XML SET OPTIONS** ( *elementRef*  ; *selector* : Integer ; *value* : Integer {; *selector2* ; *value2* ; ... ; *selectorN* ; *valueN*} )<br/>**XML SET OPTIONS** ( *document*  ; *selector* : Integer ; *value* : Integer {; *selector2* ; *value2* ; ... ; *selectorN* ; *valueN*} )<!-- END REF-->
