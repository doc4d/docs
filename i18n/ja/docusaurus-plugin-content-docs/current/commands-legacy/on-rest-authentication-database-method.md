...
今後は[強制ログイン認証](../commands/../REST/authUsers.md) の使用が強く推奨されます。変換されたプロジェクトにおいては、**[ds.authentify() 関数を通してのREST認証を有効化](../commands/../settings/web.md#アクセス)** 設定ボタンをクリックすることで設定をアップグレードすることができます。コードの移行が必要であれば、その方法については[こちらの blog記事](../commands/https://blog.4d.com/force-login-becomes-default-for-all-rest-auth/) を参照してください。
