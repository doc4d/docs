...
<!--REF #_command_.QR Find column.Syntax-->**QR Find column** ( *area* : Integer ; *expression* : Text ) : Integer<br/>**QR Find column** ( *area* : Integer ; *expression* : Pointer ) : Integer<!-- END REF-->
