...
<!--REF #_command_.SET MENU ITEM METHOD.Syntax-->**SET MENU ITEM METHOD** ( *menu* : Integer ; *menuItem* : Integer ; *methodName* : Text {; *process* : Integer} )<br/>**SET MENU ITEM METHOD** ( *menu* : Text ; *menuItem* : Integer ; *methodName* : Text {; *process* : Integer} )<!-- END REF-->
