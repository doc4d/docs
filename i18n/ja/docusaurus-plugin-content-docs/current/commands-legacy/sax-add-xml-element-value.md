...
<!--REF #_command_.SAX ADD XML ELEMENT VALUE.Syntax-->**SAX ADD XML ELEMENT VALUE** ( *document* : Time ; *data* : Text {; *} )<br/>**SAX ADD XML ELEMENT VALUE** ( *document* : Time ; *data* : Variable {; *} )<!-- END REF-->
