...
**注:** カラーを4-バイト倍長整数フォーマットで取得したい場合、[OBJECT SET RGB COLORS](object-set-rgb-colors) コマンドを使用する必要があります。カラーのフォーマットについての詳細な情報については、[OBJECT SET RGB COLORS](object-set-rgb-colors) コマンドの詳細を参照してください。
