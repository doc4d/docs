...
[Open window](open-window.md "Open window")や[Open form window](../commands/open-form-window.md "Open form window")で事前に開いたウィンドウを閉じる際には、CLOSE WINDOWにウィンドウ参照番号を渡す必要はありません。CLOSE WINDOWは常にこれらのコマンドで開いた最後のウィンドウを閉じます。
