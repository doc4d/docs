...
<!--REF #_command_.ENABLE MENU ITEM.Syntax-->**ENABLE MENU ITEM** ( *menu* : Integer ; *menuItem* : Integer {; *process* : Integer} )<br/>**ENABLE MENU ITEM** ( *menu* : Text ; *menuItem* : Integer {; *process* : Integer} )<!-- END REF-->
