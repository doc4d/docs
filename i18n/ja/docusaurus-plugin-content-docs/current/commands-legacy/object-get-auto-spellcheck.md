...
- [input](../FormObjects/input_overview)のテキスト・タイプのオブジェクトにのみ対応しています、
- [4D Write Pro エリア](../FormObjects/writeProArea_overview)。
...
[OBJECT SET AUTO SPELLCHECK](object-set-auto-spellcheck)  
