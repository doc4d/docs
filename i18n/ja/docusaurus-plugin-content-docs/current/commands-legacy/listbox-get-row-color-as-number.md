...
**注:** カラーをCSS 文字列で取得したい場合、[LISTBOX Get row color](listbox-get-row-color) コマンドを使用する必要があります。カラーフォーマットについての詳細な情報については、[OBJECT SET RGB COLORS](object-set-rgb-colors) コマンドの詳細を参照してください。
