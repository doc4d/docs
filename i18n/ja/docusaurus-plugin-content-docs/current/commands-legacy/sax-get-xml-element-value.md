...
<!--REF #_command_.SAX GET XML ELEMENT VALUE.Syntax-->**SAX GET XML ELEMENT VALUE** ( *document* : Time ; *value* : Text )<br/>**SAX GET XML ELEMENT VALUE** ( *document* : Time ; *value* : Blob )<!-- END REF-->
