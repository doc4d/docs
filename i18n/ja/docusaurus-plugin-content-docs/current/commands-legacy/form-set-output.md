...
<!--REF #_command_.FORM SET OUTPUT.Syntax-->**FORM SET OUTPUT** ( {*aTable* : Table ;} *form* : Text {; *userForm* : Text} )<br/>**FORM SET OUTPUT** ( {*aTable* : Table ;} *form* : Object {; *userForm* : Text} )<!-- END REF-->
