...
<!--REF #_command_.WEB SERVICE SET OPTION.Syntax-->**WEB SERVICE SET OPTION** ( *option* : Integer ; *value* : Integer )<br/>**WEB SERVICE SET OPTION** ( *option* : Integer ; *value* : Text )<!-- END REF-->
