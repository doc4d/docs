...
<!--REF #_command_.GET PICTURE KEYWORDS.Syntax-->**GET PICTURE KEYWORDS** ( *picture* : Picture ; *arrKeywords* : Text array {; *} )<br/>**GET PICTURE KEYWORDS** ( *picture* : Picture ; *arrKeywords* : Text array {; *} )<!-- END REF-->
