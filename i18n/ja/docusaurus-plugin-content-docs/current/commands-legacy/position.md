...
<!--REF #_command_.Position.Syntax-->**Position** ( *find* : Text ; *aString* : Text {; *start* : Integer {; *lengthFound* : Integer}}{; *} ) -> 戻り値 <br/>
**Position** ( *find* : Text ; *aString* : Text ; *start* : Integer ; *lengthFound* : Integer ; *options* : Integer ) -> 戻り値<!-- END REF-->
