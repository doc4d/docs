...
<!--REF #_command_.SPELL SET CURRENT DICTIONARY.Syntax-->**SPELL SET CURRENT DICTIONARY** ( *dictionary* : Integer )<br/>**SPELL SET CURRENT DICTIONARY** ( *dictionary* : Text )<!-- END REF-->
