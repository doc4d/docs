...
<!--REF #_command_.DOM Parse XML source.Syntax-->**DOM Parse XML source** ( *document* : Text {; *validation* : Boolean {; *dtd* }} ) : Text<br/>**DOM Parse XML source** ( *document* : Text {; *validation* : Boolean {; *schema* }} ) : Text<!-- END REF-->
