...
<!--REF #_command_.CONVERT FROM TEXT.Syntax-->**CONVERT FROM TEXT** ( *4Dtext* : Text ; *charSet* : Text ; *convertedBLOB* : Blob )<br/>**CONVERT FROM TEXT** ( *4Dtext* : Text ; *charSet* : Integer ; *convertedBLOB* : Blob )<!-- END REF-->
