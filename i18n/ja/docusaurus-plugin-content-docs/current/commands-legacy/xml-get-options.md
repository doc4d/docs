...
<!--REF #_command_.XML GET OPTIONS.Syntax-->**XML GET OPTIONS** ( *elementRef* ; *selector* : Integer ; *value* : Integer {; *selector2* ; *value2* ; ... ; *selectorN* ; *valueN*} )<br/>**XML GET OPTIONS** ( *document  ; *selector* ; *value* {; *selector2* ; *value2* ; ... ; *selectorN* ; *valueN*} )<!-- END REF-->
