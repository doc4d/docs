...
<!--REF #_command_.QR Get command status.Syntax-->**QR Get command status** ( *area* : Integer ; *command* : Integer {; *value* : Integer} ) : Integer<br/>**QR Get command status** ( *area* : Integer ; *command* : Integer {; *value* : Text} ) : Integer<!-- END REF-->
