...
| 定数                              | 型    | 値 | コメント                                                                                                                                                                                                                                                                       |
| ------------------------------- | ---- | - | -------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| On after host database exit     | 倍長整数 | 4 | ホストデータベースの [Semaphore](../commands/semaphore.md) データベースメソッドが実行を終了したところです。                                                                                                                                                                                                              |
| On after host database startup  | 倍長整数 | 2 | ホストデーターベースの データベースメソッドが実行を終了したところです。                                                                                                                                                                                                                                       |
| On before host database exit    | 倍長整数 | 3 | ホストデータベースは閉じられようとしているところです。ホストデータベースの [Semaphore](../commands/semaphore.md) データベースメソッドはまだ呼び出されていない状態です。<br/>ホストデータベースの [Semaphore](../commands/semaphore.md) データベースは、コンポーネントの [On Host Database Event データベースメソッド](on-host-database-event-database-method.md) データベースメソッドが実行されている間は呼び出されません。 |
