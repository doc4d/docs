...
このコマンドはデザインモードや[OBJECT SET DRAG AND DROP OPTIONS](object-set-drag-and-drop-options)コマンドを使用してカレントプロセスに設定された、現在のドラッグ＆ドロップオプションを返します。

コマンドはデザインモードや[OBJECT SET DRAG AND DROP OPTIONS](object-set-drag-and-drop-options)コマンドを使用してカレントプロセスに設定された現在のドラッグ＆ドロップオプションを返します。
...
[OBJECT SET DRAG AND DROP OPTIONS](object-set-drag-and-drop-options)  
