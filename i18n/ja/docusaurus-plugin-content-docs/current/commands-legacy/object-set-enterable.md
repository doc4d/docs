...
また、サブフォームと[MODIFY SELECTION](modify-selection)や[DISPLAY SELECTION](display-selection)コマンドを用いて表示されたリストフォームに対して、プログラムからリスト更新可モードを有効にするために、**OBJECT SET ENTERABLE**コマンドを使用することもできます:
