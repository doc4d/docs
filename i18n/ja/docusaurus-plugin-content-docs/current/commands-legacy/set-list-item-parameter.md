...
<!--REF #_command_.SET LIST ITEM PARAMETER.Syntax-->**SET LIST ITEM PARAMETER** ( {* ;} *list* ; *itemRef* ; *selector* ; *value* )<br/>**SET LIST ITEM PARAMETER** ( * ; *list* ; * ; *selector* : Text ; *value* : Text )<br/>**SET LIST ITEM PARAMETER** ( * ; *list* ; * ; *selector* : Text ; *value* : Boolean )<br/>**SET LIST ITEM PARAMETER** ( * ; *list* ; * ; *selector* : Text ; *value* : Real )<!-- END REF-->
