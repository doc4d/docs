...
<!--REF #_command_.FORM SET INPUT.Syntax-->**FORM SET INPUT** ( {*aTable* : Table ;} *form* : Text {; *userForm* : Text {; *}} )<br/>**FORM SET INPUT** ( {*aTable* : Table ;} *form* : Object {; *userForm* : Text {; *}} )<!-- END REF-->
