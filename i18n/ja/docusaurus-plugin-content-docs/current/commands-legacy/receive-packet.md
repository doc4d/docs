...
<!--REF #_command_.RECEIVE PACKET.Syntax-->**RECEIVE PACKET** ( {*docRef* ;} *receiveVar* : Text ; *stopChar* )<br/>**RECEIVE PACKET** ( {*docRef* ;} *receiveVar* : Blob ; *stopChar* )<br/>**RECEIVE PACKET** ( {*docRef* ;} *receiveVar* : Text ; *numBytes* )<br/>**RECEIVE PACKET** ( {*docRef* ;} *receiveVar* : Blob ; *numBytes* )<!-- END REF-->
