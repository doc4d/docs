...
2. MSC の暗号化ページを開きます。 どのテーブルにも **暗号化可能** 属性を付けないでページを開こうとした場合、ページに以下のメッセージが表示されます: ![](../assets/en/MSC/MSC_encrypt1.png) そうでない場合には、以下のメッセージが表示されます: ![](../assets/en/MSC/MSC_encrypt2.png)<p>
