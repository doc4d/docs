...
`.4DLink` ファイルを構築するために使用できる XMLキーを定義した DTD が4D より提供されます。 This DTD is named database_link.dtd and is found in the `\Resources\DTD\` subfolder of the 4D application.
