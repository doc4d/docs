...
| 戻り値            | 4D.Folder |  <- | New folder object                                                  | <!-- END REF --> |
...
| 引数  | タイプ     |    | 説明                                                           |                  |
| --- | ------- | -- | ------------------------------------------------------------ | ---------------- |
| 戻り値 | Boolean | <- | True if the folder was created successfully, false otherwise | <!-- END REF --> |
...
| 戻り値               | 4D.File   | <- | Alias or shortcut reference | <!-- END REF --> |
...
| 戻り値               | 4D.Folder | <- | Moved folder     | <!-- END REF --> |
...
| 戻り値     | 4D.Folder | <- | Renamed folder | <!-- END REF --> |
