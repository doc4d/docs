...
| 戻り値          | 4D.File |  <- | New file object                                                    | <!-- END REF --> |
...
| 引数  | タイプ     |    | 説明                                                         |                  |
| --- | ------- | -- | ---------------------------------------------------------- | ---------------- |
| 戻り値 | Boolean | <- | True if the file was created successfully, false otherwise | <!-- END REF --> |
...
| 戻り値               | 4D.File   | <- | Alias or shortcut file reference | <!-- END REF --> |
