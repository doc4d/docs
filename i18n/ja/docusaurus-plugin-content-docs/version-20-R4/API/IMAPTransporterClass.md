...
| 戻り値      | Object     |  <- | Status of the addFlags operation                                                                                                              | <!-- END REF --> |
...
| 戻り値            | Object |  <- | Status of the append operation | <!-- END REF --> |
...
| 戻り値            | Object     |  <- | Status of the copy operation                     | <!-- END REF --> |
...
| 戻り値  | Object |  <- | Status of the mailbox deletion operation | <!-- END REF --> |
...
| 引数  | タイプ  |     | 説明                            |                  |
| --- | ---- | :-: | ----------------------------- | ---------------- |
| 戻り値 | Text |  <- | Hierarchy delimiter character | <!-- END REF --> |
...
| options  | Object     |  -> | メッセージ管理オプション                                                                                                                                                                       |                  |
| 戻り値      | Object     |  <- | Object containing:<br/><ul><li>a collection of [Email objects](EmailObjectClass.md#email-object) and</li><li>a collection of IDs or numbers for missing messages, if any</li></ul> | <!-- END REF --> |
