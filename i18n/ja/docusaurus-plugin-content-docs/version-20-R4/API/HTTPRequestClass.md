...
| ------ | -------------------------------------------------------------- |
| v20    | TLS検証がデフォルトに                                                   |
| v19 R7 | Support of _automaticRedirections_ and _decodeData_ properties |
...
| 戻り値     | 4D.HTTPRequest |  <- | New HTTPRequest object | <!-- END REF --> |
...
| 戻り値  | 4D.HTTPRequest |  <- | HTTPRequest object                    | <!-- END REF --> |
