...
| Result | Result | <- | Result of drop operation|<!-- END REF -->
...
| 引数     | タイプ    |    | 詳細                                                              |
| ------ | ------ |:--:| --------------------------------------------------------------- |
| filler | Result | -> | Object from which to fill the entity|<!-- END REF -->
...
| Result       | Result | <- | エンティティを元にビルドされたオブジェクト|<!-- END REF -->
