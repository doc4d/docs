...
| sheetTabColor        |                        | 文字列     | シートタブの色を指定するカラー文字列 (例: "red"、"#FFFF00"、"rgb(255,0,0)"、"Accent 5")                                                                                                                                                                                                                     |
| frozenlineColor      |                        | 文字列     | 固定化された線の色を指定するカラー文字列 (例: "red"、"#FFFF00"、"rgb(255,0,0)"、"Accent 5")                                                                                                                                                                                                                   |
...
|                      | カラー                    | 文字列     | 枠線の色を表すカラー文字列 (例: "red"、"#FFFF00"、"rgb(255,0,0)"、"Accent 5")                                                                                                                                                                                                                          |
...
| selectionBackColor   |                        | 文字列     | シートにおける選択範囲の背景色。 (RGBAフォーマット推奨)                                                                                                                                                                                                                                                       |
| selectionBorderColor |                        | 文字列     | シートにおける選択範囲の枠線の色。                                                                                                                                                                                                                                                                     |
...
| protectionOptions |                          | オブジェクト | ユーザーにより編集可能な要素を指定します。 null の場合、protectionOptions パラメーターはリセットされます。 |
...
| プロパティ     |        | タイプ     | 詳細                                                                               |
| --------- | ------ | ------- | -------------------------------------------------------------------------------- |
| paperSize |        | オブジェクト  | 印刷に使用する用紙の寸法 (height、width) または規格 (kind)                                         |
...
| プロパティ            | タイプ     | 詳細                                                                                                                                                    |
| ---------------- | ------- | ----------------------------------------------------------------------------------------------------------------------------------------------------- |
| showBorder       | ブール     | Prints the outline border.Default value = "true"                                                                                                      |
...
| プロパティ     |                | タイプ                  | 詳細                                                                                |
| --------- | -------------- | -------------------- | --------------------------------------------------------------------------------- |
| watermark |                | collection-1         | ウォーターマーク設定のコレクション。 デフォルト値: undefined                                              |
...
| プロパティ                                                                      |       | タイプ     | 詳細                                                     | とりうる値                                                                                                                                                                                                                                                                                                                                                            |
| -------------------------------------------------------------------------- | ----- | ------- | ------------------------------------------------------ | ---------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| borderBottom, borderLeft, borderRight, borderTop, diagonalDown, diagonalUp |       | オブジェクト  | それぞれに対応する境界線を定義します。                                    |                                                                                                                                                                                                                                                                                                                                                                  |
...
| labelOptions    |            | オブジェクト  | セルラベルのオプションを定義します (ウォーターマークオプション)                                                                                                                                                                                                                                             |                                                                                                                                                                                                         |
...
| meta         | Result    | 4Dデベロッパー専用の任意コンテンツ    |
| spreadJS     | Result    | 4D View Pro コンポーネント専用 |
...
| ViewPro.callbacks      | Result | インポートやエクスポートなど、コールバックを必要とするコマンドが使用するための一時的な情報を保存します。                                                                                                                                             |
...
| ViewPro.events         | Result | [イベント](Events/overview.md) リスト。                                                                                                                                                                  |
