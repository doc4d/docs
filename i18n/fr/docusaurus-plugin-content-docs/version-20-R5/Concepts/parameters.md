...
This second technique of returning a value by a subroutine is called “using a function.” This is described in the <a href="#returning-values">Returning values</a> paragraph. Ceci est décrit dans le paragraphe [Valeurs retournées](#returning-values).
