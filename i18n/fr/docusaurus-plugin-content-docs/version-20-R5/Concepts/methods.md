...
| **Type**                                            | [**Class functions**](classes.md#function) are called in the context of an object instance                                                     | oui                                | Les fonctions de classes peuvent être intégrées au langage 4D (par exemple `collection.orderBy()` ou `entity.save()`), ou créées par le développeur 4D. See [**Classes**](classes.md)                                |
