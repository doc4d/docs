...
The `.name` property is the <!-- REF #TableThemeOptions.name.Summary -->The `.tableColumns` property<!-- END REF -->.
...
size of the second alternating column <!-- REF #TableThemeOptions.secondColumnStripSize.Summary -->The `.secondColumnStripSize` property is the<!-- END REF -->. Par défaut=1
...
The `.secondRowStripSize` property is the <!-- REF #TableThemeOptions.secondRowStripSize.Summary -->The `.secondColumnStripSize` property is the<!-- END REF -->. Par défaut=1.
