...
- Les points (".") Les points (".") Les points (".") Periods (".") and brackets ("[ ]") are not allowed in table, field, method, or variable names.
...
- Les points (".") Les points (".") Les points (".") Periods (".") and brackets ("[ ]") are not allowed.
