...
Lorsqu'une méthode utilise une commande qui peut appeler un trigger, le compilateur 4D évalue la thread safety du trigger afin de vérifier celle de la méthode :
