...
| **password** : Text<br/>Mot de passe utilisateur pour l'authentification sur le serveur. Not returned in *[SMTP transporter](../API/SMTPTransporterClass.md#smtp-transporter-object)* object.                                                                                                                                                                                                                                                                                                                                                         | aucun                                                                                            |
...
The function returns a [**SMTP transporter object**](../API/SMTPTransporterClass.md#smtp-transporter-object). Toutes les propriétés retournées sont en **lecture seule**.
