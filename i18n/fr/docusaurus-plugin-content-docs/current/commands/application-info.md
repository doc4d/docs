...
| headless                                                                         | boolean    | True si l'application fonctionne en mode headless. Possible values: true, false. For more information, see [Command Line Interface](../Admin/cli.md).                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                  | false                                                                                                                                                                                                                 |
...
| useLegacyNetworkLayer                                                            | boolean    | True si l'ancienne couche réseau est utilisée pour le serveur d'application. Not returned in standalone environment. Possible values: true, false. For more information, see [Network layer](../settings/client-server.md#network-layer).                                                                                                                                                                                                                                                                                                                                                                                                                                                                              | false                                                                                                                                                                                                                 |
