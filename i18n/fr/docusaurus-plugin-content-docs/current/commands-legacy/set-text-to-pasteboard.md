...
Vous pouvez récupérer le texte collé dans le conteneur de données à l'aide de la fonction [Get text from pasteboard](get-text-from-pasteboard) ou en appelant par exemple [GET PASTEBOARD DATA](get-pasteboard-data)("com.4d.private.text.native";...).
