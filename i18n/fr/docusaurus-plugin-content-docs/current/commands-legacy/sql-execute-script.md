...
<!--REF #_command_.SQL EXECUTE SCRIPT.Syntax-->**SQL EXECUTE SCRIPT** ( *cheminScript* : Text ; *actionErreur* : Integer {; *nomAttribut* : Text ; *valAttribut* : Text} {; *nomAttribut2* ; *valAttribut2* ; ... ; *nomAttributN* ; *valAttributN*} )<!-- END REF-->
