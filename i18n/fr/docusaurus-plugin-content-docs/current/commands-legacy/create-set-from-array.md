...
<!--REF #_command_.CREATE SET FROM ARRAY.Syntax-->**CREATE SET FROM ARRAY** ( *laTable* : Table ; *tabEnrg* : Integer {; *nomEnsemble* : Text} )<br/>**CREATE SET FROM ARRAY** ( *laTable* : Table ; *tabEnrg* : Boolean array {; *nomEnsemble* : Text} )<!-- END REF-->
