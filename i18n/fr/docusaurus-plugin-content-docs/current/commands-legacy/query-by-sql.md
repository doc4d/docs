...
Avec la commande [QUERY BY FORMULA](query-by-formula), vous pourriez écrire :
...
**Note :** Les liens 1 vers N et N vers N sont également traités par **QUERY BY SQL** d’une manière différente de [QUERY BY FORMULA](query-by-formula).
