...
<!--REF #_command_.GET FIELD ENTRY PROPERTIES.Syntax-->**GET FIELD ENTRY PROPERTIES** ( *ptrChp* ; *énumération* : Text ; *obligatoire* : Boolean ; *nonSaisissable* : Boolean ; *nonModifiable* : Boolean )<br/>**GET FIELD ENTRY PROPERTIES** ( *numTable* ; *numChamp* : Integer ; *énumération* : Text ; *obligatoire* : Boolean ; *nonSaisissable* : Boolean ; *nonModifiable* : Boolean )<!-- END REF-->
