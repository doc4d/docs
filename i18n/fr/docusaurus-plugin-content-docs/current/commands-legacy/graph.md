...
<!--REF #_command_.GRAPH.Syntax-->**GRAPH** ( *graphImage* : Picture ; *graphNum*  ; *xCatégories* : Array {; *zValeurs* : Array} {; *zValeurs2* ; ... ; *zValeursN*} )<br/>**GRAPH** ( *graphImage* : Picture ; *graphParams* ; *xCatégories* : Array {; *zValeurs* : Array} {; *zValeurs2* ; ... ; *zValeursN*} )<!-- END REF-->
