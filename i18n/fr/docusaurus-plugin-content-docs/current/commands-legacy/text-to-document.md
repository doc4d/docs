...
Si vous souhaitez permettre à l’utilisateur de désigner le nom ou l’emplacement du document, utilisez les commandes [Open document](open-document) ou [Create document](create-document) ainsi que la variable système *Document*.
