...
<!--REF #_command_.TEXT TO DOCUMENT.Syntax-->**TEXT TO DOCUMENT** ( *nomFichier* : Text ; *texte* : Text {; *jeuCaractères* : Text {; *modeRetour* : Integer}} )<br/>**TEXT TO DOCUMENT** ( *nomFichier* : Text ; *texte* : Text {; *jeuCaractères* : Integer {; *modeRetour* : Integer}} )<!-- END REF-->
