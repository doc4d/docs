...
Par défaut, les **valeurs** des expressions sont affichées dans les zones de texte multistyle. Vous pouvez forcer l’affichage des **références** à l’aide de la commande [ST SET OPTIONS](st-set-options). 
