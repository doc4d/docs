...
Les propriétés d’impression en taille variable peuvent être définies via la Liste des propriétés ou la commande [OBJECT SET PRINT VARIABLE FRAME](object-set-print-variable-frame). 
