...
<!--REF #_command_.GET LIST ITEM PARAMETER.Syntax-->**GET LIST ITEM PARAMETER** ( {* ;} *liste* ; *refElément* ; *sélecteur* ; *valeur* )<br/>**GET LIST ITEM PARAMETER** ( * ; *liste* ; * ; *sélecteur* : Text ; *valeur* : Text )<br/>**GET LIST ITEM PARAMETER** ( * ; *liste* ; * ; *sélecteur* : Text ; *valeur* : Boolean )<br/>**GET LIST ITEM PARAMETER** ( * ; *liste* ; * ; *sélecteur* : Text ; *valeur* : Real )<!-- END REF-->
