...
Cette commande est utile dans le contexte de l’analyse d’un formulaire via les commandes [FORM LOAD](../commands/form-load), [FORM GET OBJECTS](form-get-objects) et [OBJECT Get type](object-get-type). Elle permet, si nécessaire, d’obtenir les noms des sous-objets des list box.
