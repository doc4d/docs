...
* sauvegarder le projet sur disque, puis le charger par exemple à l’aide de la commande [DOM Parse XML source](dom-parse-xml-source) et passer sa référence dans le paramètre *projet*.
...
**Note :** Reportez-vous à la commande [EXPORT DATA](export-data) pour un exemple de définition de projet vide. 
