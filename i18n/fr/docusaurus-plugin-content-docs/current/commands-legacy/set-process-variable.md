...
<!--REF #_command_.SET PROCESS VARIABLE.Syntax-->**SET PROCESS VARIABLE** ( *process* : Integer ; *varDestination* : Variable ; *exprSource* : Variable {; *varDestination2* ; *exprSource2* ; ... ; *varDestinationN* ; *exprSourceN*} )<!-- END REF-->
