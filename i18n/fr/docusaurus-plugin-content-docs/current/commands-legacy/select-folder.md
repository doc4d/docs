...
<!--REF #_command_.Select folder.Syntax-->**Select folder** ( {*message* : Text }{;}{ *répertoire* : Text {; *options* : Integer}} ) : Text<br/>**Select folder** ( {*message* : Text }{;}{ *répertoire* : Integer {; *options* : Integer}} ) : Text<!-- END REF-->
