...
<!--REF #_command_.Get menu item.Syntax-->**Get menu item** ( *menu* : Integer ; *ligneMenu* : Integer {; *process* : Integer} ) : Text<br/>**Get menu item** ( *menu* : Text ; *ligneMenu* : Integer {; *process* : Integer} ) : Text<!-- END REF-->
