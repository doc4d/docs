...
<!--REF #_command_.Get menu item modifiers.Syntax-->**Get menu item modifiers** ( *menu* : Integer ; *ligneMenu* : Integer {; *process* : Integer} ) : Integer<br/>**Get menu item modifiers** ( *menu* : Text ; *ligneMenu* : Integer {; *process* : Integer} ) : Integer<!-- END REF-->
