...
Le raccourci standard est composé de la touche **Commande** (macOS) ou **Ctrl** (Windows) et d’une touche personnalisée. Le raccourci standard est géré via les commandes [SET MENU ITEM SHORTCUT](set-menu-item-shortcut) et [Get menu item key](get-menu-item-key).
...
Reportez-vous à l'exemple de la commande [Get menu item key](get-menu-item-key). 
