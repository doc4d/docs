...
La propriété "Trois états" peut avoir été définie soit via la Liste des propriétés, soit via la commande [OBJECT SET THREE STATES CHECKBOX](object-set-three-states-checkbox) si elle a été appelée dans le process courant.

## Voir aussi 

[OBJECT SET THREE STATES CHECKBOX](object-set-three-states-checkbox)  
