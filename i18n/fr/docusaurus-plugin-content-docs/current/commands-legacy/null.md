...
| --------------------------------------------------------------- | --------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| Valeurs de propriétés d'objets                                  | La comparaison de **Null** avec une propriété d'objet vaut Vrai si la valeur de la propriété est null et Faux dans les autres cas. Par soucis de simplicité, comparer **Null** sera également Vrai si la propriété n'existe pas dans l'objet (i.e. est [Undefined](undefined)), voir exemple 4\. |
...
| Variables de type image (*C\_PICTURE*)            | (\*) Affecter la valeur **null** à une variable de ce type efface son contenu. Cela a le même effet qu'appeler la commande [CLEAR VARIABLE](clear-variable)                                                                                                                                      |
| variables variant (*C\_VARIANT*)                  |                                                                                                                                                                                                                                                                                                     |

**Note :** Cette commande ne peut pas être utilisée avec les champs scalaires de la base de données. Les valeurs Null dans les champs de la base sont prises en charge par le moteur SQL, et sont gérés via les commandes [Is field value Null](is-field-value-null) et [SET FIELD VALUE NULL](set-field-value-null),
...
Cet exemple compare les différents résultats de la commande [Undefined](undefined) et de la commande [Null](null) appliquées aux propriétés d'objets, en fonction du contexte :
