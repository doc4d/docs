...
<!--REF #_command_.GET DOCUMENT ICON.Syntax-->**GET DOCUMENT ICON** ( *cheminDoc* : Text ; *icône* : Picture {; *taille* : Integer} )<br/>**GET DOCUMENT ICON** ( *cheminDoc* : Text ; *icône* : Picture {; *taille* : Integer} )<!-- END REF-->
