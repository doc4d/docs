...
* Utilisez la commande [SHOW WINDOW](show-window) et passez-lui le numéro de référence de la fenêtre.
...
Si vous souhaitez cacher toutes les fenêtres d'un process, utilisez la commande [HIDE PROCESS](hide-process).
