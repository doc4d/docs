...
<!--REF #_command_.GET PROCESS VARIABLE.Syntax-->**GET PROCESS VARIABLE** ( *process* : Integer ; *varSource* : Variable ; *varDestination* : Variable {; *varSource2* ; *varDestination2* ; ... ; *varSourceN* ; *varDestinationN*} )<!-- END REF-->
