...
<!--REF #_command_.CHANGE CURRENT USER.Syntax-->**CHANGE CURRENT USER** {( *utilisateur* : Text ; *motDePasse* : Text )}<br/>**CHANGE CURRENT USER** {( *utilisateur* : Integer ; *motDePasse* : Text )}<!-- END REF-->
