...
<!--REF #_command_.Get menu item style.Syntax-->**Get menu item style** ( *menu* : Integer ; *ligneMenu* : Integer {; *process* : Integer} ) : Integer<br/>**Get menu item style** ( *menu* : Text ; *ligneMenu* : Integer {; *process* : Integer} ) : Integer<!-- END REF-->
