...
<!--REF #_command_.CONVERT FROM TEXT.Syntax-->**CONVERT FROM TEXT** ( *texte4D* : Text ; *jeuCaractères* : Text ; *blobConverti* : Blob )<br/>**CONVERT FROM TEXT** ( *texte4D* : Text ; *jeuCaractères* : Integer ; *blobConverti* : Blob )<!-- END REF-->
