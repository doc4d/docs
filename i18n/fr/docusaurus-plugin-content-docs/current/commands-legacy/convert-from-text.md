...
Après l’exécution de la commande, le texte converti est retourné dans le BLOB *blobConverti*. Ce BLOB pourra être relu par la commande [Convert to text](convert-to-text). 
