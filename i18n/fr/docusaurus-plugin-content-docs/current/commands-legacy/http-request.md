...
<!--REF #_command_.HTTP Request.Syntax-->**HTTP Request** ( *méthodeHTTP* : Text ; *url* : Text ; *contenu* : Text ; *réponse* : Text {; *nomsEnTêtes* : Text array ; *valeursEnTêtes* : Text array}{; *} ) : Integer<br/>**HTTP Request** ( *méthodeHTTP* : Text ; *url* : Text ; *contenu* : Text ; *réponse* : Blob {; *nomsEnTêtes* : Text array ; *valeursEnTêtes* : Text array}{; *} ) : Integer<br/>**HTTP Request** ( *méthodeHTTP* : Text ; *url* : Text ; *contenu* : Text ; *réponse* : Picture {; *nomsEnTêtes* : Text array ; *valeursEnTêtes* : Text array}{; *} ) : Integer<br/>**HTTP Request** ( *méthodeHTTP* : Text ; *url* : Text ; *contenu* : Text ; *réponse* : Object {; *nomsEnTêtes* : Text array ; *valeursEnTêtes* : Text array}{; *} ) : Integer<br/>**HTTP Request** ( *méthodeHTTP* : Text ; *url* : Text ; *contenu* : Blob ; *réponse* : Text {; *nomsEnTêtes* : Text array ; *valeursEnTêtes* : Text array}{; *} ) : Integer<br/>**HTTP Request** ( *méthodeHTTP* : Text ; *url* : Text ; *contenu* : Blob ; *réponse* : Blob {; *nomsEnTêtes* : Text array ; *valeursEnTêtes* : Text array}{; *} ) : Integer<br/>**HTTP Request** ( *méthodeHTTP* : Text ; *url* : Text ; *contenu* : Blob ; *réponse* : Picture {; *nomsEnTêtes* : Text array ; *valeursEnTêtes* : Text array}{; *} ) : Integer<br/>**HTTP Request** ( *méthodeHTTP* : Text ; *url* : Text ; *contenu* : Blob ; *réponse* : Object {; *nomsEnTêtes* : Text array ; *valeursEnTêtes* : Text array}{; *} ) : Integer<br/>**HTTP Request** ( *méthodeHTTP* : Text ; *url* : Text ; *contenu* : Picture ; *réponse* : Text {; *nomsEnTêtes* : Text array ; *valeursEnTêtes* : Text array}{; *} ) : Integer<br/>**HTTP Request** ( *méthodeHTTP* : Text ; *url* : Text ; *contenu* : Picture ; *réponse* : Blob {; *nomsEnTêtes* : Text array ; *valeursEnTêtes* : Text array}{; *} ) : Integer<br/>**HTTP Request** ( *méthodeHTTP* : Text ; *url* : Text ; *contenu* : Picture ; *réponse* : Picture {; *nomsEnTêtes* : Text array ; *valeursEnTêtes* : Text array}{; *} ) : Integer<br/>**HTTP Request** ( *méthodeHTTP* : Text ; *url* : Text ; *contenu* : Picture ; *réponse* : Object {; *nomsEnTêtes* : Text array ; *valeursEnTêtes* : Text array}{; *} ) : Integer<br/>**HTTP Request** ( *méthodeHTTP* : Text ; *url* : Text ; *contenu* : Object ; *réponse* : Text {; *nomsEnTêtes* : Text array ; *valeursEnTêtes* : Text array}{; *} ) : Integer<br/>**HTTP Request** ( *méthodeHTTP* : Text ; *url* : Text ; *contenu* : Object ; *réponse* : Blob {; *nomsEnTêtes* : Text array ; *valeursEnTêtes* : Text array}{; *} ) : Integer<br/>**HTTP Request** ( *méthodeHTTP* : Text ; *url* : Text ; *contenu* : Object ; *réponse* : Picture {; *nomsEnTêtes* : Text array ; *valeursEnTêtes* : Text array}{; *} ) : Integer<br/>**HTTP Request** ( *méthodeHTTP* : Text ; *url* : Text ; *contenu* : Object ; *réponse* : Object {; *nomsEnTêtes* : Text array ; *valeursEnTêtes* : Text array}{; *} ) : Integer<!-- END REF-->
