...
<!--REF #_command_.SET MENU ITEM ICON.Syntax-->**SET MENU ITEM ICON** ( *menu* : Integer ; *ligneMenu* : Integer ; *refIcône* : Text {; *process* : Integer} )<br/>**SET MENU ITEM ICON** ( *menu* : Integer ; *ligneMenu* : Integer ; *refIcône* : Integer {; *process* : Integer} )<br/>**SET MENU ITEM ICON** ( *menu* : Text ; *ligneMenu* : Integer ; *refIcône* : Text {; *process* : Integer} )<br/>**SET MENU ITEM ICON** ( *menu* : Text ; *ligneMenu* : Integer ; *refIcône* : Integer {; *process* : Integer} )<!-- END REF-->
