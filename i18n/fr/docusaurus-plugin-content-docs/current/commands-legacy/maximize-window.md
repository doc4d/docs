...
Un clic ultérieur sur la case de zoom ou l'appel de la commande [MINIMIZE WINDOW](minimize-window) provoque le retour de la fenêtre à sa taille initiale. Sous Windows, si la fenêtre a été maximisée, un clic sur la case de zoom ou l'appel de la commande [MINIMIZE WINDOW](minimize-window) (sans paramètre) entraîne le retour à leur taille initiale de toutes les fenêtres de l'application.
