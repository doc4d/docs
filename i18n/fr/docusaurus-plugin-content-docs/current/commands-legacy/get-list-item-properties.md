...
<!--REF #_command_.GET LIST ITEM PROPERTIES.Syntax-->**GET LIST ITEM PROPERTIES** ( {* ;} *liste* ; *refElément* ; *saisissable* {; *style* {; *icône* {; *couleur*}}} )<br/>**GET LIST ITEM PROPERTIES** ( * ; *liste* ; * ; *saisissable* : Boolean {; *style* : Integer {; *icône* : Text {; *couleur* : Integer}}} )<br/>**GET LIST ITEM PROPERTIES** ( * ; *liste* ; * ; *saisissable* : Boolean {; *style* : Integer {; *icône* : Integer {; *couleur* : Integer}}} )<!-- END REF-->
