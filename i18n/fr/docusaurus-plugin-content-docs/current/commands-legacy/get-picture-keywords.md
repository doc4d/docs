...
<!--REF #_command_.GET PICTURE KEYWORDS.Syntax-->**GET PICTURE KEYWORDS** ( *image* : Picture ; *tabMotsclés* : Text array {; *} )<br/>**GET PICTURE KEYWORDS** ( *image* : Picture ; *tabMotsclés* : Text array {; *} )<!-- END REF-->
