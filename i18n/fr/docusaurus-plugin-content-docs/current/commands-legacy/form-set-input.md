...
<!--REF #_command_.FORM SET INPUT.Syntax-->**FORM SET INPUT** ( {*laTable* : Table ;} *formulaire* : Text {; *formUtilisateur* : Text {; *}} )<br/>**FORM SET INPUT** ( {*laTable* : Table ;} *formulaire* : Object {; *formUtilisateur* : Text {; *}} )<!-- END REF-->
