...
<!--REF #_command_.INSERT IN LIST.Syntax-->**INSERT IN LIST** ( {* ;} *liste* ; *avantElément* ; *libelléElément* ; *réfElément* {; sous_Liste ; *déployée*} )<br/>**INSERT IN LIST** ( * ; *liste* ; * ; *libelléElément* : Text ; *réfElément* : Integer {; sous_Liste ; *déployée* : Boolean} )<!-- END REF-->
