...
<!--REF #_command_.Find in field.Syntax-->**Find in field** ( *champCible* : Field ; *valeur* : Field ) : Integer<br/>**Find in field** ( *champCible* : Field ; *valeur* : Variable ) : Integer<!-- END REF-->
