...
<!--REF #_command_.Is field number valid.Syntax-->**Is field number valid** ( *ptrTable* ; *numChamp* : Integer ) : Boolean<br/>**Is field number valid** ( *numTable* ; *numChamp* : Integer ) : Boolean<!-- END REF-->
