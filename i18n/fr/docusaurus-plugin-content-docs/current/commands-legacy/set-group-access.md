...
* La portée de cette commande est la session courante. L'appel à la commande [CHANGE CURRENT USER](change-current-user) par la suite, redéfinit par exemple les adhésions.
