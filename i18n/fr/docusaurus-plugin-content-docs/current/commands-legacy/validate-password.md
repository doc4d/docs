...
<!--REF #_command_.Validate password.Syntax-->**Validate password** ( *utilisateur* : Integer ; *motDePasse* : Text {; *digest* : Boolean} ) : Boolean<br/>**Validate password** ( *utilisateur* : Text ; *motDePasse* : Text {; *digest* : Boolean} ) : Boolean<!-- END REF-->
