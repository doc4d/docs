...
<!--REF #_command_.SET FIELD RELATION.Syntax-->**SET FIELD RELATION** ( *tableN* ; *aller* : Integer ; *retour* : Integer )<br/>**SET FIELD RELATION** ( *champN* ; *aller* : Integer ; *retour* : Integer )<!-- END REF-->
