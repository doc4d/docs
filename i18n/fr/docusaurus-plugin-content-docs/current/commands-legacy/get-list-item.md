...
<!--REF #_command_.GET LIST ITEM.Syntax-->**GET LIST ITEM** ( {* ;} *liste* ; positionElém ; *réfElément* ; *libelléElément* {; sous_Liste ; *déployée*} )<br/>**GET LIST ITEM** ( {* ;} *liste* ; * ; *réfElément* : Integer ; *libelléElément* : Text {; sous_Liste ; *déployée* : Boolean} )<!-- END REF-->
