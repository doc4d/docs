...
* Sous Mac OS, le premier caractère de la chaîne devient la marque de la ligne de menu (généralement, le [Char](char)(18), qui est la coche standard de Mac OS, est utilisé).
* Sous Windows, la marque standard de Windows est associée au menu.

## Exemple 

Reportez-vous à l'exemple de la commande [Get menu item mark](get-menu-item-mark).
