...
Vous pouvez passer dans *menu* un identifiant unique de menu ([RefMenu](# "Référence unique de menu (16 caractères alphanumériques)")), un numéro de barre de menus ou une référence de barre de menus obtenue via la commande [Get menu bar reference](get-menu-bar-reference).
