...
<!--REF #_command_.GET MENU ITEMS.Syntax-->**GET MENU ITEMS** ( *menu* : Integer ; *tabTitresMenus* : Text array ; *tabRefsMenus* : Text array )<br/>**GET MENU ITEMS** ( *menu* : Text ; *tabTitresMenus* : Text array ; *tabRefsMenus* : Text array )<!-- END REF-->
