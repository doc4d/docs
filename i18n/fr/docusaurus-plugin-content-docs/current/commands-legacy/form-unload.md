...
L’appel de cette commande est nécessaire lors de l’utilisation de la commande [FORM LOAD](../commands/form-load) hors contexte d’impression (en cas d’impression, le formulaire courant est automatiquement refermé lorsque la commande [CLOSE PRINTING JOB](close-printing-job) est appelée). 
