...
Cette fonction compare *motDePasse* à un *hash* généré par la commande [Generate password hash](generate-password-hash).
...
Cet exemple compare un hash de mot de passe créé par la commande [Generate password hash](generate-password-hash) et stocké dans la table \[Users\] avec un mot de passe qui vient d'être saisi :
