...
<!--REF #_command_.ENABLE MENU ITEM.Syntax-->**ENABLE MENU ITEM** ( *menu* : Integer ; *ligneMenu* : Integer {; *process* : Integer} )<br/>**ENABLE MENU ITEM** ( *menu* : Text ; *ligneMenu* : Integer {; *process* : Integer} )<!-- END REF-->
