...
**Note :** Si vous voulez personnaliser l'icône de chaque élément d'une liste hiérarchique, utilisez la commande [SET LIST ITEM PROPERTIES](set-list-item-properties). 
...
\- par programmation, à l’aide des commandes [SELECT LIST ITEMS BY POSITION](select-list-items-by-position) et [SELECT LIST ITEMS BY REFERENCE](select-list-items-by-reference).  
