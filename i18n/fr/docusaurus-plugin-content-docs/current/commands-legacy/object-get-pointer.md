...
**Note :** Ce fonctionnement équivaut strictement à celui de la commande historique [Self](self). La commande [Self](self) est conservée pour des raisons de compatibilité uniquement.
...
**Note :** Ce fonctionnement équivaut strictement à celui de la commande [Focus object](focus-object). La commande [Focus object](focus-object) est obsolète à compter de 4D v12\.
