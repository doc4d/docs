...
<!--REF #_command_.OBJECT Get multiline.Syntax-->**OBJECT Get multiline** ( * ; *objet* : Text ) : Integer<br/>**OBJECT Get multiline** ( *objet* : Field, Variable ) : Integer<!-- END REF-->
...
L’option "Multilignes" d’un objet peut avoir été définie en mode Développement via la Liste des propriétés, ou à l’aide de la commande [OBJECT SET MULTILINE](object-set-multiline). 
...
[OBJECT SET MULTILINE](object-set-multiline)  
