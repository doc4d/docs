...
A noter que les commandes [SELECTION TO ARRAY](selection-to-array) et [SELECTION RANGE TO ARRAY](selection-range-to-array) appliquées à un champ de type Heure créent un tableau de type Heure uniquement si le tableau n’a pas déjà été défini dans un autre type, par exemple en entier long. 
