...
<!--REF #_command_.ACTIVITY SNAPSHOT.Syntax-->**ACTIVITY SNAPSHOT** (* tabActivités* {; *} )<br/>**ACTIVITY SNAPSHOT** ( *tabUUID* ; *tabDébut* : Text array ; *tabDurée* : Integer array ; *tabInfo* : Text array {; *tabDétails* : Object array} )<!-- END REF-->
