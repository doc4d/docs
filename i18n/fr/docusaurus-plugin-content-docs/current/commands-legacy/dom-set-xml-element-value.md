...
<!--REF #_command_.DOM SET XML ELEMENT VALUE.Syntax-->**DOM SET XML ELEMENT VALUE** ( *refElément* : Text {; *xPath* : Text}; *valeurElément* : Text {; *} )<br/>**DOM SET XML ELEMENT VALUE** ( *refElément* : Text {; *xPath* : Text}; *valeurElément* : Variable {; *} )<!-- END REF-->
