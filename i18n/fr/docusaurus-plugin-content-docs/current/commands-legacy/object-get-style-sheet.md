...
<!--REF #_command_.OBJECT Get style sheet.Syntax-->**OBJECT Get style sheet** ( * ; *objet* : Text ) : Text<br/>**OBJECT Get style sheet** ( *objet* : Field, Variable ) : Text<!-- END REF-->
...
La feuille de style peut avoir été affectée en mode Développement via la Liste des propriétés ou pour le process courant via la commande [OBJECT SET STYLE SHEET](object-set-style-sheet). 
