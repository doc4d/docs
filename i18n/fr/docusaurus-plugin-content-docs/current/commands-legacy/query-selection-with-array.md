...
**QUERY SELECTION WITH ARRAY** fonctionne de la même manière que [QUERY WITH ARRAY](query-with-array). La différence entre ces deux commandes se situe au niveau de la portée de la recherche :

* [QUERY WITH ARRAY](query-with-array) effectue sa recherche parmi la totalité des enregistrements de la table de *champCible*.
...
Pour plus d’informations, reportez-vous à la description de la commande [QUERY WITH ARRAY](query-with-array).
