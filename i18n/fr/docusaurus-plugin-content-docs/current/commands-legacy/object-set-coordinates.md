...
**Note :** Cette commande équivaut à utiliser la commande [OBJECT MOVE](object-move) en passant le 2e paramètre *\**. 
...
**Note :** Si vous souhaitez déplacer un objet relativement à sa position initiale, il est préférable d’utiliser la commande existante [OBJECT MOVE](object-move). 
...
* En-têtes et pieds de page des formulaires sortie affichés par la commande [MODIFY SELECTION](modify-selection) ou [DISPLAY SELECTION](display-selection),
