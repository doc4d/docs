...
Hormis la prise en charge de tableaux (cf. ci-dessous), cette commande est identique à [DOM Create XML element](dom-create-xml-element). Reportez-vous à la description de cette commande pour le détail de son fonctionnement. 
