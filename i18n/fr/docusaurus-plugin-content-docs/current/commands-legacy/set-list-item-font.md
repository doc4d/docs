...
<!--REF #_command_.SET LIST ITEM FONT.Syntax-->**SET LIST ITEM FONT** ( {* ;} *liste* ; *refElément * ; *police* )<br/>**SET LIST ITEM FONT** ( * ; *liste* ; * ; *police* : Text )<br/>**SET LIST ITEM FONT** ( * ; *liste* ; * ; *police* : Integer )<!-- END REF-->
