...
Le code ci-dessous illustre les différentes possibilités offertes par les commandes **GET FIELD RELATION**, [GET AUTOMATIC RELATIONS](get-automatic-relations) et [SET FIELD RELATION](set-field-relation), [SET AUTOMATIC RELATIONS](set-automatic-relations) ainsi que leurs effets :
