...
L’option "Orientation" d’un objet peut avoir été définie en mode Développement via la Liste des propriétés ou à l’aide de la commande [OBJECT SET TEXT ORIENTATION](object-set-text-orientation).
...
[OBJECT SET TEXT ORIENTATION](object-set-text-orientation)  
