...
<!--REF #_command_.SAX ADD XML ELEMENT VALUE.Syntax-->**SAX ADD XML ELEMENT VALUE** ( *document* : Time ; *données* : Text {; *} )<br/>**SAX ADD XML ELEMENT VALUE** ( *document* : Time ; *données* : Variable {; *} )<!-- END REF-->
