...
| --- | --- | --- | --- |
| utilisateurs | Blob | &#8596; | *in:* BLOB that must contain users<br/>*out:* User accounts (encrypted) |
</div>
<!-- END REF-->
...
Le BLOB généré est automatiquement encrypté et ne peut être lu que par la commande [BLOB TO USERS](blob-to-users). Vous pouvez stocker ce BLOB dans un fichier disque ou dans un champ.   
