...
<!--REF #_command_.CREATE SELECTION FROM ARRAY.Syntax-->**CREATE SELECTION FROM ARRAY** ( *laTable* : Table ; *tabEnrg* : Integer {; *nom* : Text} )<br/>**CREATE SELECTION FROM ARRAY** ( *laTable* : Table ; *tabEnrg* : Boolean array {; *nom* : Text} )<!-- END REF-->
