...
La commande **OBJECT SET ENTERABLE** permet également d’activer par programmation le mode “Saisie en liste” pour les sous-formulaires et les formulaires liste affichés par les commandes [MODIFY SELECTION](modify-selection) et [DISPLAY SELECTION](display-selection) :
