...
<!--REF #_command_.SET LIST ITEM PARAMETER.Syntax-->**SET LIST ITEM PARAMETER** ( {* ;} *liste* ; *refElément* ; *sélecteur* ; *valeur* )<br/>**SET LIST ITEM PARAMETER** ( * ; *liste* ; * ; *sélecteur* : Text ; *valeur* : Text )<br/>**SET LIST ITEM PARAMETER** ( * ; *liste* ; * ; *sélecteur* : Text ; *valeur* : Boolean )<br/>**SET LIST ITEM PARAMETER** ( * ; *liste* ; * ; *sélecteur* : Text ; *valeur* : Real )<!-- END REF-->
