...
* Si vous agrandissez sa taille, les éléments existants ne sont pas modifiés, les nouveaux éléments sont initialisés à un pointeur nul (ce qui signifie que la fonction [Is nil pointer](is-nil-pointer) appliquée à l'un de ces éléments retourne Vrai).
