...
L’option "Menu contextuel" d’un objet peut avoir été définie en mode Développement via la Liste des propriétés, ou à l’aide de la commande [OBJECT SET CONTEXT MENU](object-set-context-menu).
...
[OBJECT SET CONTEXT MENU](object-set-context-menu)  
