...
**Note :** L’empilement des ordres d’exécutions ne peut être modifié ou stoppé, sauf si le 4D Client est désinscrit à l’aide de la commande [UNREGISTER CLIENT](unregister-client).
