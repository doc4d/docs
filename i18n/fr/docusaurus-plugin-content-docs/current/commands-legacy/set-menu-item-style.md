...
<!--REF #_command_.SET MENU ITEM STYLE.Syntax-->**SET MENU ITEM STYLE** ( *menu* : Integer ; *ligneMenu* : Integer ; *styleLigne* : Integer {; *process* : Integer} )<br/>**SET MENU ITEM STYLE** ( *menu* : Text ; *ligneMenu* : Integer ; *styleLigne* : Integer {; *process* : Integer} )<!-- END REF-->
