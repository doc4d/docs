...
## Note 
 ...
 Pour que les commandes [GET MACRO PARAMETER](get-macro-parameter) et **SET MACRO PARAMETER** fonctionnent correctement, l'attribut “version” doit être déclaré dans la macro elle-même, de la façon suivante :
