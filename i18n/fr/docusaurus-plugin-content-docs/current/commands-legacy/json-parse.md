...
**Note :** Si vous utilisez des pointeurs, vous devez appeler la commande [JSON Stringify](json-stringify) avant **JSON Parse**. 
...
Cet exemple montre l’utilisation conjointe des commandes [JSON Stringify](json-stringify) et **JSON Parse** :
