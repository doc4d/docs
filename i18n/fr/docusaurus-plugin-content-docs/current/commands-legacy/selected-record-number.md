...
Si la sélection est non vide et si l'enregistrement courant en fait partie, **Selected record number** retourne une valeur comprise entre *1* et [Records in selection](records-in-selection). Si la sélection est vide ou s'il n'y a pas d'enregistrement courant, **Selected record number** retourne 0.

Le numéro de l'enregistrement dans la sélection est différent du numéro retourné par [Record number](record-number) ([Record number](record-number) retourne le numéro physique de l'enregistrement dans la table). Le numéro de l'enregistrement dans la sélection dépend de la sélection courante.
