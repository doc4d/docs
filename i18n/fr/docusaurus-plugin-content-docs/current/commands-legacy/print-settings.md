...
<!--REF #_command_.PRINT SETTINGS.Summary-->La commande **PRINT SETTINGS** provoque l'affichage d'une boîte de dialogue d'impression.<!-- END REF--> Cette commande doit être appelée avant une série de commandes [Print form](../commands/print-form) ou la commande [OPEN PRINTING JOB](open-printing-job).
...
**Note :** La boîte de dialogue d'impression comporte l'option **Imprimer à l'écran** permettant à l'utilisateur de visualiser son impression à l'écran. Vous pouvez présélectionner ou désélectionner cette option par un appel préalable à la commande [SET PRINT PREVIEW](set-print-preview).
...
[OPEN PRINTING JOB](open-printing-job)  
[PAGE BREAK](page-break)  
[Print form](../commands/print-form)  
[SET PRINT PREVIEW](set-print-preview)  
