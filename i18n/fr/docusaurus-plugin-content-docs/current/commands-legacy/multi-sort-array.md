...
<!--REF #_command_.MULTI SORT ARRAY.Syntax-->**MULTI SORT ARRAY** ( *tableau* : Array {; *sensDuTri* : Operator}{; *tableau2* ; *sensDuTri2* ; ... ; *tableauN* ; *sensDuTriN*} ) <br/>
**MULTI SORT ARRAY** ( *tabPointeurs* : Pointer array ; *tabTris* : Integer array )<!-- END REF-->
