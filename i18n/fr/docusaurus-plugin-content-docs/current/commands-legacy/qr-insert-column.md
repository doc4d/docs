...
<!--REF #_command_.QR INSERT COLUMN.Syntax-->**QR INSERT COLUMN** ( *zone* : Integer ; *numColonne* : Integer ; *objet* : Field )<br/>**QR INSERT COLUMN** ( *zone* : Integer ; *numColonne* : Integer ; *objet* : Variable )<br/>**QR INSERT COLUMN** ( *zone* : Integer ; *numColonne* : Integer ; *objet* : Pointer )<!-- END REF-->
