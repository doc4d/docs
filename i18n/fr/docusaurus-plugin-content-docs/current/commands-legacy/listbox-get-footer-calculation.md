...
<!--REF #_command_.LISTBOX Get footer calculation.Syntax-->**LISTBOX Get footer calculation** ( * ; *objet* : Text ) : Integer<br/>**LISTBOX Get footer calculation** ( *objet* : Field, Variable ) : Integer<!-- END REF-->
...
Vous pouvez comparer la valeur retournée aux constantes du thème *List box pied calcul* (cf. commande [LISTBOX SET FOOTER CALCULATION](listbox-set-footer-calculation)). 

## Voir aussi 

[LISTBOX SET FOOTER CALCULATION](listbox-set-footer-calculation)  
