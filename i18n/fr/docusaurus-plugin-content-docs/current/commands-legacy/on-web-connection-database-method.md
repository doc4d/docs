...
**Attention :** L’appel d’une commande 4D affichant un élément d’interface ([DIALOG](../commands/dialog), [ALERT](../commands/alert.md)...) entraîne l’arrêt du traitement de la méthode.
