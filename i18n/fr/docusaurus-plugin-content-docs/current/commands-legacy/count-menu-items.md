...
<!--REF #_command_.Count menu items.Syntax-->**Count menu items** ( *menu* : Integer {; *process* : Integer} ) : Integer<br/>**Count menu items** ( *menu* : Text {; *process* : Integer} ) : Integer<!-- END REF-->
