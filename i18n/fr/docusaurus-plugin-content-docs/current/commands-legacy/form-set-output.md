...
<!--REF #_command_.FORM SET OUTPUT.Syntax-->**FORM SET OUTPUT** ( {*laTable* : Table ;} *formulaire* : Text {; *formUtilisateur* : Text} )<br/>**FORM SET OUTPUT** ( {*laTable* : Table ;} *formulaire* : Object {; *formUtilisateur* : Text} )<!-- END REF-->
