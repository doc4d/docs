...
**Note :** Vous pouvez définir l’indentation du document à l'aide de la commande [XML SET OPTIONS](xml-set-options) avant de commencer votre saisie.
...
[SAX GET XML DOCUMENT VALUES](sax-get-xml-document-values)  
