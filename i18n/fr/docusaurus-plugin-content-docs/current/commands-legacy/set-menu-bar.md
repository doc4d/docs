...
<!--REF #_command_.SET MENU BAR.Syntax-->**SET MENU BAR** ( *barre* : Integer {; *process* : Integer}{; *} )<br/>**SET MENU BAR** ( *barre* : Text {; *process* : Integer}{; *} )<br/>**SET MENU BAR** ( *barre* : Text {; *process* : Integer}{; *} )<!-- END REF-->
