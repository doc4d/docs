...
<!--REF #_command_.RECEIVE PACKET.Syntax-->**RECEIVE PACKET** ( {*docRef* : Time ;} *réceptVar* : Text ; *stopChar* )<br/>**RECEIVE PACKET** ( {*docRef* : Time ;} *réceptVar* : Blob ; *stopChar* )<br/>**RECEIVE PACKET** ( {*docRef* : Time ;} *réceptVar* : Text ; *numBytes* )<br/>**RECEIVE PACKET** ( {*docRef* : Time ;} *réceptVar* : Blob ; *numBytes* )<!-- END REF-->
