...
**Note :** Les commandes [GET MENU ITEMS](get-menu-items) et [Get menu item](get-menu-item) retourneront ou non les métacaractères d’un libellé en fonction de son mode de création : s’il a été créé avec l’option *\**, les métacaractères seront retournés en tant que caractères standard.
