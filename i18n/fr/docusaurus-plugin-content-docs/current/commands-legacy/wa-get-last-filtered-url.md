...
* l’URL est interdit à cause d’un filtre (commande [WA SET URL FILTERS](wa-set-url-filters)),
* le lien est ouvert dans le navigateur par défaut (commande [WA SET EXTERNAL LINKS FILTERS](wa-set-external-links-filters)),
