...
<!--REF #_command_.Get menu item parameter.Syntax-->**Get menu item parameter** ( *menu* : Integer ; *ligneMenu* : Integer ) : Text<br/>**Get menu item parameter** ( *menu* : Text ; *ligneMenu* : Integer ) : Text<!-- END REF-->
