...
<!--REF #_command_.ARRAY TO LIST.Syntax-->**ARRAY TO LIST** ( *tableau* : Array ; *liste* : Text {; *réfEléments* : Array} )<br/>**ARRAY TO LIST** ( *tableau* : Array ; *liste* : Integer {; *réfEléments* : Array} )<!-- END REF-->
