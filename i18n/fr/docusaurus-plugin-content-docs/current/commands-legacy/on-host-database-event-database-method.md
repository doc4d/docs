...
| On before host database exit    | Entier long | 3      | La base hôte est en cours de fermeture. La [Semaphore](../commands/semaphore) de la base hôte n’a pas encore été appelée. <br/>La [Semaphore](../commands/semaphore) de la base hôte n’est pas appelée tant que la [On Host Database Event database method](on-host-database-event-database-method.md) du composant est en exécution |
