...
La commande retourne les options de glisser-déposer courantes, qu’elles aient été définies en mode Développement ou pour le process à l’aide de la commande [OBJECT SET DRAG AND DROP OPTIONS](object-set-drag-and-drop-options). 
