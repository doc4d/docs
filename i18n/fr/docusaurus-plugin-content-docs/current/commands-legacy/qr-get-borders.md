...
**Note :** A la différence de la commande [QR SET BORDERS](qr-set-borders), **QR GET BORDERS** n'accepte pas de valeurs cumulées. Vous devez tester séparément toutes les valeurs pour obtenir une description globale de l'encadrement de la cellule. 
