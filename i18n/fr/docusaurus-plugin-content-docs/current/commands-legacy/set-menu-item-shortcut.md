...
<!--REF #_command_.SET MENU ITEM SHORTCUT.Syntax-->**SET MENU ITEM SHORTCUT** ( *menu* : Integer ; *ligneMenu* : Integer ; *touche* : Text ; *modificateurs* : Integer {; *process* : Integer} )<br/>**SET MENU ITEM SHORTCUT** ( *menu* : Integer ; *ligneMenu* : Integer ; *touche* : Integer ; *modificateurs* : Integer {; *process* : Integer} )<br/>**SET MENU ITEM SHORTCUT** ( *menu* : Text ; *ligneMenu* : Integer ; *touche* : Text ; *modificateurs* : Integer {; *process* : Integer} )<br/>**SET MENU ITEM SHORTCUT** ( *menu* : Text ; *ligneMenu* : Integer ; *touche* : Integer ; *modificateurs* : Integer {; *process* : Integer} )<!-- END REF-->
