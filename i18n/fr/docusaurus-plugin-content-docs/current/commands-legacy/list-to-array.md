...
<!--REF #_command_.LIST TO ARRAY.Syntax-->**LIST TO ARRAY** ( *liste* : Text ; *tableau* : Array {; *réfEléments* : Array} )<br/>**LIST TO ARRAY** ( *liste* : Integer ; *tableau* : Array {; *réfEléments* : Array} )<!-- END REF-->
