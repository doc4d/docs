...
<!--REF #_command_.GET PICTURE FROM LIBRARY.Syntax-->**GET PICTURE FROM LIBRARY** ( *refImage * ; *image* : Picture )<br/>**GET PICTURE FROM LIBRARY** ( *nomImage* ; *image* : Picture )<!-- END REF-->
