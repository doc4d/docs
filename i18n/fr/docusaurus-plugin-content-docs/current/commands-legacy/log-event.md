...
| Into 4D diagnostic log  | Entier long | 5      | Indique à 4D d’inscrire le *message* dans le fichier de diagnostic de 4D, si ce fichier a été activé. <br/>Le fichier de diagnostic peut être activé à l’aide de la commande [SET DATABASE PARAMETER](set-database-parameter) (sélecteur 79).     |
