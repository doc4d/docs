...
* dans une méthode installée par [QR ON COMMAND](qr-on-command) afin de connaître le sous-élément sélectionné. Dans cette méthode, *$1* contient la référence de la *zone* et *$2* le numéro de la commande.
