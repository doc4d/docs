...
La variable système OK est définie sur 0 si le timeout a été atteint ou si la commande [CANCEL](cancel) a été appelée dans onEvent, sinon elle est définie sur 1.
