...
<!--REF #_command_.Convert to text.Syntax-->**Convert to text** ( *blob* : Blob ; *jeuCaractères* : Text ) : Text<br/>**Convert to text** ( *blob* : Blob ; *jeuCaractères* : Integer ) : Text<!-- END REF-->
