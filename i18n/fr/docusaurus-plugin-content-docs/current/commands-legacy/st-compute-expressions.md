...
Pour plus d’informations sur les expressions 4D utilisables dans les zone de texte multistyle ou une zone 4D Write Pro, reportez-vous à la description de la commande [ST INSERT EXPRESSION](st-insert-expression).
...
* lorsqu’elles sont "figées" à l’aide de la commande [ST FREEZE EXPRESSIONS](st-freeze-expressions), si le deuxième paramètre \* est passé.
