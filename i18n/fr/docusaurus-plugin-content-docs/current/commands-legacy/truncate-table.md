...
L’effet de cette commande est semblable à celui d’une séquence [ALL RECORDS](all-records) / [DELETE SELECTION](delete-selection), toutefois son fonctionnement diffère sur les points suivants :
