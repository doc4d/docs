...
<!--REF #_command_.DOM Create XML Ref.Syntax-->**DOM Create XML Ref** ( *racine* : Text {; *nameSpace* : Text} {; *nSNom* : Text ; *nSValeur* : Text} {; *nSNom2* ; *nSValeur2* ; ... ; *nSNomN* ; *nSValeurN*} ) : Text<!-- END REF-->
