...
Un process worker reste actif jusqu’à la fermeture de l'application ou jusqu'à ce que la commande [KILL WORKER](kill-worker) soit appelée explicitement pour ce process. Pensez à appeler cette commande une fois que le process worker n'est plus utile afin de libérer l'espace mémoire. 
