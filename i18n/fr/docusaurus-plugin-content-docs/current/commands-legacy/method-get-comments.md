...
La documentation lue par cette commande est affichée dans l’Explorateur de 4D (à ne pas confondre avec les lignes de commentaires dans le code, qui peuvent être lues à l’aide de [METHOD GET CODE](method-get-code)). 
...
[METHOD SET COMMENTS](method-set-comments)  
