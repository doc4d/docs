...
**Note :** La commande [HIGHLIGHT RECORDS](highlight-records) comporte un paramètre *\** facultatif permettant de déléguer la gestion du défilement dans les formulaires à la commande **OBJECT SET SCROLL POSITION**.
