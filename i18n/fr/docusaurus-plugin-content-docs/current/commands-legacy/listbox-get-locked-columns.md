...
Les colonnes peuvent avoir été verrouillées via la Liste des propriétés ou à l’aide de la commande [LISTBOX SET LOCKED COLUMNS](listbox-set-locked-columns). Pour plus d’informations, reportez-vous au manuel *Mode Développement*.
