...
* Empêcher l'ouverture de la base si une condition n'est pas remplie (comme par exemple, une ressource système manquante) par l'appel explicite de la commande [QUIT 4D](../commands/quit-4d).
