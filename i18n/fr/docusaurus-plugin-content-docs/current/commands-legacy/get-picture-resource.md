...
<!--REF #_command_.GET PICTURE RESOURCE.Syntax-->**GET PICTURE RESOURCE** ( *resNum* : Integer ; *resDonnées* : Field {; *resFichier* : Time} )<br/>**GET PICTURE RESOURCE** ( *resNum* : Integer ; *resDonnées* : Variable {; *resFichier* : Time} )<!-- END REF-->
