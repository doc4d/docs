...
**Note :** Pour plus d'informations sur les marques des lignes de menus sous Mac OS et Windows, reportez-vous à la description de la commande [SET MENU ITEM MARK](set-menu-item-mark).
