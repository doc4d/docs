...
<!--REF #_command_.QR GET DESTINATION.Syntax-->**QR GET DESTINATION** ( *zone* : Integer ; *type* : Integer {; *spécificités* : Text} )<br/>**QR GET DESTINATION** ( *zone* : Integer ; *type* : Integer {; *spécificités* : Variable} )<!-- END REF-->
