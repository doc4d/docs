...
<!--REF #_command_.METHOD SET COMMENTS.Syntax-->**METHOD SET COMMENTS** ( *chemin* : Text ; *commentaires* : Text {; *} )<br/>**METHOD SET COMMENTS** ( *chemin* : Text ; *commentaires* : Text array {; *} )<br/>**METHOD SET COMMENTS** ( *chemin* : Text array ; *commentaires* : Text {; *} )<br/>**METHOD SET COMMENTS** ( *chemin* : Text array ; *commentaires* : Text array {; *} )<!-- END REF-->
