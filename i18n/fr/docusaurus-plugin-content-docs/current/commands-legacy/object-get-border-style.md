...
Le style de bordure d’un objet peut avoir été défini en mode Développement via la Liste des propriétés, ou à l’aide de la commande [OBJECT SET BORDER STYLE](object-set-border-style). 
