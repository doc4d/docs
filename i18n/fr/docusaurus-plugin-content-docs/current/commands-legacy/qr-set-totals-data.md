...
<!--REF #_command_.QR SET TOTALS DATA.Syntax-->**QR SET TOTALS DATA** ( *zone* : Integer ; *numColonne* : Integer ; *numRupture* : Integer ; *opérateur* )<br/>**QR SET TOTALS DATA** ( *zone* : Integer ; *numColonne* : Integer ; *numRupture* : Integer ; *valeur* )<!-- END REF-->
