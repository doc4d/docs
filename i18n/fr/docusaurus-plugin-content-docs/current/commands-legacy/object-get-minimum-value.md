...
La propriété "Valeur minimum" peut être définie via la Liste des propriétés en mode Développement ou via la commande [OBJECT SET MINIMUM VALUE](object-set-minimum-value).
