...
Le texte peut être sélectionné par l'utilisateur ou par la commande [HIGHLIGHT TEXT](highlight-text).
...
Reportez-vous à l'exemple de la commande [FILTER KEYSTROKE](filter-keystroke).
