...
Soient deux valeurs réelles *a* et *b*. Si [Abs](abs)(a-b) est supérieur à l'epsilon, les valeurs sont considérées comme différentes ; sinon, elles sont déclarées égales.  
