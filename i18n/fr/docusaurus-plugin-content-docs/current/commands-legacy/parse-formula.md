...
**\** Les noms de la structure virtuelle sont définis à l'aide de commandes [SET TABLE TITLES](set-table-titles) et [SET FIELD TITLES](set-field-titles) (utilisées avec le paramètre \*).* 
