...
<!--REF #_command_.DELETE MENU ITEM.Syntax-->**DELETE MENU ITEM** ( *menu* : Integer ; *ligneMenu* : Integer {; *process* : Integer} )<br/>**DELETE MENU ITEM** ( *menu* : Text ; *ligneMenu* : Integer {; *process* : Integer} )<!-- END REF-->
