...
<!--REF #_command_.SET MENU ITEM METHOD.Syntax-->**SET MENU ITEM METHOD** ( *menu* : Integer ; *ligneMenu* : Integer ; *nomMéthode* : Text {; *process* : Integer} )<br/>**SET MENU ITEM METHOD** ( *menu* : Text ; *ligneMenu* : Integer ; *nomMéthode* : Text {; *process* : Integer} )<!-- END REF-->
