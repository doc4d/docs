...
Les colonnes statiques peuvent avoir été définies via la Liste des propriétés ou à l’aide de la commande [LISTBOX SET STATIC COLUMNS](listbox-set-static-columns). 
