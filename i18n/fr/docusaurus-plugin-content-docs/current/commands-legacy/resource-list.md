...
Après l'appel, vous pouvez tester le nombre de ressources qui ont été trouvées en appliquant la commande [Size of array](size-of-array) au tableau *resNums* ou *resNoms*.
