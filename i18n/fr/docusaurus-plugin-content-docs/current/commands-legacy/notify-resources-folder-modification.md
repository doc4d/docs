...
* localement, à l'aide de la commande [SET DATABASE PARAMETER](set-database-parameter) exécutée sur le poste distant (sélecteur Auto synchro resources folder). Dans ce cas, il "surcharge" celui de la base et s'applique uniquement au poste distant pour la session.
