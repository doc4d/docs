...
<!--REF #_command_.QUERY SELECTION BY ATTRIBUTE.Syntax-->**QUERY SELECTION BY ATTRIBUTE** ( {*laTable* : Table}{;}{*opConj* : Operator ;} *champObjet* : Field ; *cheminAttribut* : Text ; *opRecherche* : Text ; *valeur* : Text {; *} )<br/>**QUERY SELECTION BY ATTRIBUTE** ( {*laTable* : Table}{;}{*opConj* : Operator ;} *champObjet* : Field ; *cheminAttribut* : Text ; *opRecherche* : Text ; *valeur* : Real {; *} )<br/>**QUERY SELECTION BY ATTRIBUTE** ( {*laTable* : Table}{;}{*opConj* : Operator ;} *champObjet* : Field ; *cheminAttribut* : Text ; *opRecherche* : Text ; *valeur* : Date {; *} )<br/>**QUERY SELECTION BY ATTRIBUTE** ( {*laTable* : Table}{;}{*opConj* : Operator ;} *champObjet* : Field ; *cheminAttribut* : Text ; *opRecherche* : Text ; *valeur* : Time {; *} )<br/>**QUERY SELECTION BY ATTRIBUTE** ( {*laTable* : Table}{;}{*opConj* : Operator ;} *champObjet* : Field ; *cheminAttribut* : Text ; *opRecherche* : Operator ; *valeur* : Text {; *} )<br/>**QUERY SELECTION BY ATTRIBUTE** ( {*laTable* : Table}{;}{*opConj* : Operator ;} *champObjet* : Field ; *cheminAttribut* : Text ; *opRecherche* : Operator ; *valeur* : Real {; *} )<br/>**QUERY SELECTION BY ATTRIBUTE** ( {*laTable* : Table}{;}{*opConj* : Operator ;} *champObjet* : Field ; *cheminAttribut* : Text ; *opRecherche* : Operator ; *valeur* : Date {; *} )<br/>**QUERY SELECTION BY ATTRIBUTE** ( {*laTable* : Table}{;}{*opConj* : Operator ;} *champObjet* : Field ; *cheminAttribut* : Text ; *opRecherche* : Operator ; *valeur* : Time {; *} )<!-- END REF-->
