...
Si *nom* a été créée par la commande [CUT NAMED SELECTION](cut-named-selection) puis traitée à l'aide de la commande [USE NAMED SELECTION](use-named-selection), elle n'existe plus en mémoire. Dans ce cas, vous n'avez pas besoin d'utiliser **CLEAR NAMED SELECTION**.
