...
<!--REF #_command_.SET LIST ITEM.Syntax-->**SET LIST ITEM** ( {* ;} *liste* ; *refElément* ; *libelléElément* ; *nouvelRéf* {; sous_Liste ; *déployée*} )<br/>**SET LIST ITEM** ( * ; *liste* ; * ; *libelléElément* : Text ; *nouvelRéf* : Integer {; sous_Liste ; *déployée* : Boolean} )<!-- END REF-->
