...
Vous pouvez également passer *0* dans *réfElément* afin de désigner le dernier élément ajouté à la liste (à l'aide de [APPEND TO LIST](append-to-list)).   
...
Reportez-vous à l'exemple de la commande [GET LIST ITEM](get-list-item).   
