...
<!--REF #_command_.WEB SERVICE SET OPTION.Syntax-->**WEB SERVICE SET OPTION** ( *option* : Integer ; *valeur* : Integer )<br/>**WEB SERVICE SET OPTION** ( *option* : Integer ; *valeur* : Text )<!-- END REF-->
