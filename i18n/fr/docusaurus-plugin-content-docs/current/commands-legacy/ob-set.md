...
<!--REF #_command_.OB SET.Syntax-->**OB SET** ( *objet* : Object ; *propriété* : Text ; *valeur* : Expression {; *propriété2* ; *valeur2* ; ... ; *propriétéN* ; *valeurN*} )<br/>**OB SET** ( *objet* : Object ; *propriété* : Text ; *valeur* : Expression {; *propriété2* ; *valeur2* ; ... ; *propriétéN* ; *valeurN*} )<!-- END REF-->
