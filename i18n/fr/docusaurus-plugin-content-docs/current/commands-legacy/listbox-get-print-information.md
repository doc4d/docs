...
| lk printed rows            | Entier long | 1      | Retourne dans *info* le nombre de lignes effectivement imprimées lors du dernier appel à la commande [Print object](print-object). Ce nombre inclut les éventuelles lignes de ruptures ajoutées dans le cadre d’une list box hiérarchique. Par exemple, *info* vaut 10 si la list box contient 20 lignes et que les lignes impaires ont été masquées.                                                                               |
