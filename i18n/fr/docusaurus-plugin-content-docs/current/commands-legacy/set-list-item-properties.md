...
<!--REF #_command_.SET LIST ITEM PROPERTIES.Syntax-->**SET LIST ITEM PROPERTIES** ( {* ;} *liste* ; *refElément* ; *saisissable* ; *style* {; *icône* {; *couleur*}} )<br/>**SET LIST ITEM PROPERTIES** ( * ; *liste* ; * ; *saisissable* : Boolean ; *style* : Integer {; *icône* : Text {; *couleur* : Integer}} )<br/>**SET LIST ITEM PROPERTIES** ( * ; *liste* ; * ; *saisissable* : Boolean ; *style* : Integer {; *icône* : Integer {; *couleur* : Integer}} )<!-- END REF-->
