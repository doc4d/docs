...
<!--REF #_command_.OB Is defined.Syntax-->**OB Is defined** ( *objet* : Object, Object {; *propriété* : Text} ) : Boolean<!-- END REF-->
...
**Note :** Un objet peut être défini mais vide. Pour savoir si un objet est indéfini ou vide, utilisez la commande [OB Is empty](ob-is-empty). 
