...
<!--REF #_command_.SET MENU ITEM PARAMETER.Syntax-->**SET MENU ITEM PARAMETER** ( *menu* : Integer ; *ligneMenu* : Integer ; *param* : Text )<br/>**SET MENU ITEM PARAMETER** ( *menu* : Text ; *ligneMenu* : Integer ; *param* : Text )<!-- END REF-->
