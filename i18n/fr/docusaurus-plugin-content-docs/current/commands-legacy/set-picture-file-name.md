...
<!--REF #_command_.SET PICTURE FILE NAME.Syntax-->**SET PICTURE FILE NAME** ( *image* : Picture ; *nomFichier* : Text )<br/>**SET PICTURE FILE NAME** ( *image* : Picture ; *nomFichier* : Text )<!-- END REF-->
