...
**Note :** Ce mécanisme est identique à celui utilisé par la commande [Select folder](select-folder). Les numéros de chemins d’accès mémorisés sont partagés entre les deux commandes.
