...
<!--REF #_command_.QR Find column.Syntax-->**QR Find column** ( *zone* : Integer ; *expression* : Text ) : Integer<br/>**QR Find column** ( *zone* : Integer ; *expression* : Pointer ) : Integer<!-- END REF-->
