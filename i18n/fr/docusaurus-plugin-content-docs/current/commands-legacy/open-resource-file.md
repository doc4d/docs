...
Une fois que vous avez ouvert un fichier de ressources, vous pouvez analyser son contenu à l'aide des commandes [RESOURCE TYPE LIST](resource-type-list) et [RESOURCE LIST](resource-list).
