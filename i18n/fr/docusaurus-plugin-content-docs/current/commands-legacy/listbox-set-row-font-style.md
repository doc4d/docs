...
Si aucun tableau de styles de police n’a été associé à la list box ou à la colonne, il est créé dynamiquement lors de l’appel de la commande. Vous pourrez y accéder à l’aide de la commande [LISTBOX Get array](listbox-get-array).
...
[LISTBOX Get row font style](listbox-get-row-font-style)  
