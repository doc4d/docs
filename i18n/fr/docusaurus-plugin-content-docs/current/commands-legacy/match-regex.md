...
<!--REF #_command_.Match regex.Syntax-->**Match regex** ( *motif* : Text ; *laChaîne* : Text ; *début* : Integer {; pos_trouvée ; long_trouvée}{; *} ) -> Résultat <br/>
**Match regex** ( *motif* : Text ; *laChaîne* : Text ) -> Résultat<!-- END REF-->
