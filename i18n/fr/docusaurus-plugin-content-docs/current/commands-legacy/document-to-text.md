...
<!--REF #_command_.Document to text.Syntax-->**Document to text** ( *nomFichier* : Text {; *jeuCaractères* : Text {; *modeRetour* : Integer}} ) : Text<br/>**Document to text** ( *nomFichier* : Text {; *jeuCaractères* : Integer {; *modeRetour* : Integer}} ) : Text<!-- END REF-->
