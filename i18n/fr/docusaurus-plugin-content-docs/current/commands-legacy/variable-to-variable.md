...
<!--REF #_command_.VARIABLE TO VARIABLE.Syntax-->**VARIABLE TO VARIABLE** ( *process* : Integer ; *varDestination* : Variable ; *varSource* : Variable {; *varDestination2* ; *varSource2* ; ... ; *varDestinationN* ; *varSourceN*} )<!-- END REF-->
