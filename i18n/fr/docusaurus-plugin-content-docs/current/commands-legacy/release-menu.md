...
Les sous-menus éventuellement utilisés par *menu* ne sont pas effacés s'ils ont été créés directement via la commande [Create menu](create-menu). Vous devez dans ce cas les effacer individuellement (cf. règle énoncée ci-dessus). En revanche, s'ils sont issus de la duplication d'un menu existant, n'appelez pas [RELEASE MENU](release-menu) avec leurs instances car 4D les efface automatiquement.
