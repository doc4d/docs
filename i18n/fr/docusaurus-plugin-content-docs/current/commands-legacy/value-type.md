...
| **Type déclaré**       | **Résultat de** [Type](type) | **Résultat de Value type (interprété)** | **Résultat de Value type (compilé)** | **Commentaire**                                                                                                          |
| ---------------------- | ------------------------------- | --------------------------------------- | ------------------------------------ | ------------------------------------------------------------------------------------------------------------------------ |
