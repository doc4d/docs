...
Vous pouvez également extraire ces valeurs à l'aide des [SET AUTOMATIC RELATIONS](set-automatic-relations), comme dans l'exemple suivant :
...
La méthode formulaire suivante utilise la fonction **Menu selected** pour fournir les arguments "menu" et "ligne de menu" à [SET MENU ITEM MARK](set-menu-item-mark) :
