...
<!--REF #_command_.SPELL SET CURRENT DICTIONARY.Syntax-->**SPELL SET CURRENT DICTIONARY** ( *dictionnaire* : Integer )<br/>**SPELL SET CURRENT DICTIONARY** ( *dictionnaire* : Text )<!-- END REF-->
