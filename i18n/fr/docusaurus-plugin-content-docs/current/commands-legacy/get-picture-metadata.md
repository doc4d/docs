...
<!--REF #_command_.GET PICTURE METADATA.Syntax-->**GET PICTURE METADATA** ( *image* : Picture ; *nomMeta* : Text ; *contenuMeta* : Variable {; *nomMeta2* ; *contenuMeta2* ; ... ; *nomMetaN* ; *contenuMetaN*} )<!-- END REF-->
