...
<!--REF #_command_.SET DATABASE PARAMETER.Syntax-->**SET DATABASE PARAMETER** ( {*laTable* : Table ;} *sélecteur* : Integer ; *valeur* : Real )<br/>**SET DATABASE PARAMETER** ( {*laTable* : Table ;} *sélecteur* : Integer ; *valeur* : Text )<!-- END REF-->
