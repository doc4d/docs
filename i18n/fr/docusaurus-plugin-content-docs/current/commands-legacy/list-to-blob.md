...
**ATTENTION :** Si vous utilisez un BLOB pour stocker des listes, appelez ensuite la commande [BLOB to list](blob-to-list) pour relire le contenu du BLOB car les listes sont stockées dans les BLOBs avec un format interne 4D.
