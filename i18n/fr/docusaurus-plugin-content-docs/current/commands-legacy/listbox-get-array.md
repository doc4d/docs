...
* [Is nil pointer](is-nil-pointer) si aucun tableau de la propriété demandée n’est associé à la colonne ou à la list box
* un pointeur vers le tableau de la propriété demandée, défini par l’utilisateur
* un pointeur vers le tableau de la propriété demandée, défini dynamiquement lors de l’appel de la commande [LISTBOX SET ROW COLOR](listbox-set-row-color) ou [LISTBOX SET ROW FONT STYLE](listbox-set-row-font-style).
