...
| Résultat     | 4D.File |  <- | New file object                                                    | <!-- END REF --> |
...
| Paramètres | Type    |    | Description                                                |                  |
| ---------- | ------- | -- | ---------------------------------------------------------- | ---------------- |
| Résultat   | Boolean | <- | True if the file was created successfully, false otherwise | <!-- END REF --> |
...
| Résultat           | 4D.File   | <- | Alias or shortcut file reference                    | <!-- END REF --> |
