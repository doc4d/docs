...
| Résultat   | Text   | <- | Message encrypted and encoded using the `options.encodingEncrypted`           | <!-- END REF --> |
...
| Paramètres | Type |    | Description               |                  |
| ---------- | ---- | -- | ------------------------- | ---------------- |
| Résultat   | Text | <- | Private key in PEM format | <!-- END REF --> |
...
| Paramètres | Type |    | Description              |                  |
| ---------- | ---- | -- | ------------------------ | ---------------- |
| Résultat   | Text | <- | Public key in PEM format | <!-- END REF --> |
...
| options    | Object | -> | Options de signature                                                                              |                  |
| Résultat   | Object | <- | Status of the verification                                                                        | <!-- END REF --> |
