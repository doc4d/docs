...
| Résultat            | Collection |  <- | Differences between the entities       | <!-- END REF --> |
...
| Résultat        | Integer            |  <- | Position of the entity in an entity selection                  | <!-- END REF --> |
...
| Paramètres | Type    |     | Description                                                                                    |                  |
| ---------- | ------- | :-: | ---------------------------------------------------------------------------------------------- | ---------------- |
| Résultat   | Boolean |  <- | Vrai si l'entité vient juste d'être créée et n'a pas encore été enregistrée. Otherwise, False. | <!-- END REF --> |
...
| Paramètres | Type      |     | Description                                                                            |                  |
| ---------- | --------- | :-: | -------------------------------------------------------------------------------------- | ---------------- |
| Résultat   | 4D.Entity |  <- | Reference to last entity of an entity selection (Null if not found) | <!-- END REF --> |
...
| Résultat   | Object  |  <- | Result of lock operation                                             | <!-- END REF --> |
...
| Paramètres | Type      |     | Description                                                                             |                  |
| ---------- | --------- | :-: | --------------------------------------------------------------------------------------- | ---------------- |
| Résultat   | 4D.Entity |  <- | Reference to next entity in the entity selection (Null if not found) | <!-- END REF --> |
...
| Paramètres | Type      |     | Description                                                                                 |                  |
| ---------- | --------- | :-: | ------------------------------------------------------------------------------------------- | ---------------- |
| Résultat   | 4D.Entity |  <- | Reference to previous entity in the entity selection (Null if not found) | <!-- END REF --> |
...
| Résultat   | Object  |  <- | Result of save operation                          | <!-- END REF --> |
...
| Résultat     | Object     |  <- | Object built from the entity                                                                                                                                 | <!-- END REF --> |
...
| Paramètres | Type    |     | Description                                                                           |                  |
| ---------- | ------- | :-: | ------------------------------------------------------------------------------------- | ---------------- |
| Résultat   | Boolean |  <- | True if at least one entity attribute has been modified and not yet saved, else False | <!-- END REF --> |
...
| Paramètres | Type       |     | Description                                      |                  |
| ---------- | ---------- | :-: | ------------------------------------------------ | ---------------- |
| Résultat   | Collection |  <- | Names of touched attributes, or empty collection | <!-- END REF --> |
