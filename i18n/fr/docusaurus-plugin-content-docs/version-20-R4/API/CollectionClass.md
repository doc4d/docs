...
| Résultat     | Real, Undefined |  <- | Arithmetic mean (average) of collection values | <!-- END REF --> |
...
| Paramètres | Type       |     | Description                                   |                  |
| ---------- | ---------- | :-: | --------------------------------------------- | ---------------- |
| Résultat   | Collection |  <- | Original collection with all elements removed | <!-- END REF --> |
...
| Résultat   | Collection |  <- | Original collection containing combined element(s)               | <!-- END REF --> |
...
| Résultat   | Collection                                                     |  <- | New collection with value(s) added to the original collection                                                    | <!-- END REF --> |
...
| Résultat     | Collection |  <- | Deep copy of the original collection                                                                | <!-- END REF --> |
...
| ------------ | ---- | :-: | --------------------------------------------------------------- | ---------------- |
| propertyPath | Text |  -> | Chemin de propriété d'objet à utiliser pour évaluer les valeurs |                  |
| Résultat     | Real |  <- | Number of elements in the collection                            | <!-- END REF --> |
...
| propertyPath | Text                                            |  -> | Chemin de propriété d'objet à utiliser pour évaluer les valeurs |                  |
| Résultat     | Real                                            |  <- | Number of occurrences of the value                              | <!-- END REF --> |
...
| Résultat     | Collection |  <- | New collection with only distinct values                                | <!-- END REF --> |
...
| Résultat    | Boolean    |  <- | True if collections are identical, false otherwise                                  | <!-- END REF --> |
...
| Résultat   | Boolean     |  <- | True if all elements successfully passed the test                    | <!-- END REF --> |
...
| Résultat     | Collection |  <- | New collection containing extracted values                                                                                                            | <!-- END REF --> |
...
| Résultat   | collection                                      |  <- | Original collection with filled values                    | <!-- END REF --> |
...
| Résultat   | Collection  |  <- | New collection containing filtered elements (shallow copy) | <!-- END REF --> |
...
| methodName | Text        |  -> | Nom de méthode                                                       |                  |
| param      | any         |  -> | Parameter(s) to pass to _formula_ or _methodName_ |                  |
| Résultat   | any         |  <- | First value found, or Undefined if not found                         | <!-- END REF --> |
...
| methodName | Text        |  -> | Nom de méthode                                                       |                  |
| param      | any         |  -> | Parameter(s) to pass to _formula_ or _methodName_ |                  |
| Résultat   | Integer     |  <- | Index of first value found, or -1 if not found                       | <!-- END REF --> |
...
| Paramètres | Type |     | Description                 |                  |
| ---------- | ---- | :-: | --------------------------- | ---------------- |
| Résultat   | any  |  <- | First element of collection | <!-- END REF --> |
...
| startFrom  | Integer    |  -> | Elément à partir duquel débuter la recherche  |                  |
| Résultat   | Boolean    |  <- | True if _toSearch_ is found in the collection | <!-- END REF --> |
...
| toSearch   | expression |  -> | Expression à rechercher dans la collection                                   |                  |
| startFrom  | Integer    |  -> | Elément à partir duquel débuter la recherche                                 |                  |
| Résultat   | Integer    |  <- | Index of the first occurrence of toSearch in the collection, -1 if not found | <!-- END REF --> |
...
| Résultat    | Collection |  <- | Element index(es) matching queryString in the collection                                     | <!-- END REF --> |
...
| Paramètres | Type |     | Description                |                  |
| ---------- | ---- | :-: | -------------------------- | ---------------- |
| Résultat   | any  |  <- | Last element of collection | <!-- END REF --> |
...
| methodName | Text        |  -> | Nom de méthode                                                       |                  |
| param      | any         |  -> | Parameter(s) to pass to _formula_ or _methodName_ |                  |
| Résultat   | Collection  |  <- | Collection of transformed values                                     | <!-- END REF --> |
...
| ------------ | ----------------------------------------------- | :-: | --------------------------------------------------------------- | ---------------- |
| propertyPath | Text                                            |  -> | Chemin de propriété d'objet à utiliser pour évaluer les valeurs |                  |
| Résultat     | Boolean, Text, Number, Collection, Object, Date |  <- | Maximum value in the collection                                 | <!-- END REF --> |
...
| ------------ | ----------------------------------------------- | :-: | --------------------------------------------------------------- | ---------------- |
| propertyPath | Text                                            |  -> | Chemin de propriété d'objet à utiliser pour évaluer les valeurs |                  |
| Résultat     | Boolean, Text, Number, Collection, Object, Date |  <- | Minimum value in the collection                                 | <!-- END REF --> |
...
| Résultat   | Collection  |  <- | Original collection sorted                                                                                                    | <!-- END REF --> |
...
| Résultat    | Collection |  <- | Ordered copy of the collection (shallow copy)                                    | <!-- END REF --> |
...
Si vous ne passez aucun paramètre, la fonction trie les valeurs scalaires de la collection par ordre croissant (les autres types d'éléments tels que les objets ou les collections sont retournés sans être triés). You can modify this automatic order by passing the `ck ascending` or `ck descending` constants in the _ascOrDesc_ parameter (see below).
...
| Résultat   | Collection  |  <- | Sorted copy of the collection (shallow copy) | <!-- END REF --> |
...
| Résultat   | Collection |  <- | Original collection containing added elements           | <!-- END REF --> |
...
| Résultat      | Collection |  <- | Element(s) matching queryString in the collection                                            | <!-- END REF --> |
...
| Résultat   | Text, Number, Object, Collection, Date, Boolean |  <- | Result of the accumulator value                                                   | <!-- END REF --> |
...
| Résultat   | Collection |  <- | Original collection without removed element(s) | <!-- END REF --> |
...
| Résultat     | Collection                                      |  <- | Resized original collection                         | <!-- END REF --> |
...
| Paramètres | Type       |     | Description                     |                  |
| ---------- | ---------- | :-: | ------------------------------- | ---------------- |
| Résultat   | Collection |  <- | Inverted copy of the collection | <!-- END REF --> |
...
| startFrom  | Integer    |  -> | Numéro de l'élément de départ (inclus)                   |                  |
| end        | Integer    |  -> | Position de fin (non incluse)                            |                  |
| Résultat   | Collection |  <- | New collection containing sliced elements (shallow copy) | <!-- END REF --> |
...
| Résultat   | Boolean     |  <- | True if at least one element successfully passed the test | <!-- END REF --> |
...
| ------------ | ---- | :-: | --------------------------------------------------------------- | ---------------- |
| propertyPath | Text |  -> | Chemin de propriété d'objet à utiliser pour évaluer les valeurs |                  |
| Résultat     | Real |  <- | Sum of collection values                                        | <!-- END REF --> |
