...
| Résultat           | 4D.Folder |  <- | Copied file or folder                       | <!-- END REF --> |
...
| Résultat   | 4D.File | <- | `File` object (null if invalid path) | <!-- END REF --> |
...
| Résultat   | Collection | <- | Collection of children file objects | <!-- END REF --> |
...
| ---------- | --------- | -- | ----------------------------------------------------------------- | ---------------- |
| path       | Text      | -> | Chemin POSIX relatif                                              |                  |
| Résultat   | 4D.Folder | <- | Created folder object (null if invalid _path_) | <!-- END REF --> |
...
| Résultat   | Collection | <- | Collection of children folder objects | <!-- END REF --> |
