...
| Résultat       | 4D.Folder |  <- | New folder object                                                  | <!-- END REF --> |
...
| Paramètres | Type    |    | Description                                                  |                  |
| ---------- | ------- | -- | ------------------------------------------------------------ | ---------------- |
| Résultat   | Boolean | <- | True if the folder was created successfully, false otherwise | <!-- END REF --> |
...
| Résultat           | 4D.File   | <- | Alias or shortcut reference                         | <!-- END REF --> |
...
| Résultat           | 4D.Folder | <- | Moved folder                   | <!-- END REF --> |
...
| Résultat   | 4D.Folder | <- | Renamed folder                 | <!-- END REF --> |
