...
| Résultat   | cs.DataStore | <- | Reference to the datastore             | <!-- END REF --> |
...
| Résultat       | cs.DataStore | <- | Datastore object                                                                                     | <!-- END REF --> |
...
| Paramètres | Type   |     | Description                                                                 |                  |
| ---------- | ------ | :-: | --------------------------------------------------------------------------- | ---------------- |
| Résultat   | Object |  <- | Information about the encryption of the current datastore and of each table | <!-- END REF --> |
...
| Paramètres | Type       |    | Description                                |                  |
| ---------- | ---------- | -- | ------------------------------------------ | ---------------- |
| Résultat   | Collection | <- | Collection of optimization context objects | <!-- END REF --> |
...
| Paramètres | Type    |     | Description                                                                                       |                  |
| ---------- | ------- | :-: | ------------------------------------------------------------------------------------------------- | ---------------- |
| Résultat   | Boolean |  <- | True if the Data Explorer access is disabled, False if it is enabled (default) | <!-- END REF --> |
...
| Résultat      | Object | <- | Result of the encryption key matching   | <!-- END REF --> |
