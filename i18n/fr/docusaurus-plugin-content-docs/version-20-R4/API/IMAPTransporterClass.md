...
| Résultat   | Object     |  <- | Status of the addFlags operation                                                                                                                                                                        | <!-- END REF --> |
...
| Résultat       | Object |  <- | Status of the append operation              | <!-- END REF --> |
...
| Résultat       | Object     |  <- | Status of the copy operation                                    | <!-- END REF --> |
...
| Paramètres | Type |     | Description                   |                  |
| ---------- | ---- | :-: | ----------------------------- | ---------------- |
| Résultat   | Text |  <- | Hierarchy delimiter character | <!-- END REF --> |
...
| options    | Object     |  -> | Instructions sur la gestion du message                                                                                                                                             |                  |
| Résultat   | Object     |  <- | Object containing:<br/><ul><li>a collection of [Email objects](EmailObjectClass.md#email-object) and</li><li>a collection of IDs or numbers for missing messages, if any</li></ul> | <!-- END REF --> |
