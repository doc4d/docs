...
| **Cursor line background color**                  | Couleur de fond de la ligne contenant le curseur.                                                                                                                        |
| **Execution line background color**               | Couleur de fond de la ligne en cours d'exécution dans le débogueur.                                                                                                      |
| **Highlight of the found words**                  | Couleur de surlignage des mots trouvés à l'issue d'une recherche.                                                                                                        |
...
| **Selection back color**                          | Couleur de fond de la sélection.                                                                                                                                         |
