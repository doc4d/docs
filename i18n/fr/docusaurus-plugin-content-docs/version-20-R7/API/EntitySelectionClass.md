...
- Si *startFrom* < 0, il est recalculé comme *startFrom:=startFrom+length* (il est considéré comme partant de la fin de l'entity selection). If the calculated value < 0, *startFrom* is set to 0.
