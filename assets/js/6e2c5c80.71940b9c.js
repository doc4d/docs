...
const metadata = {
  ...
  "permalink": "/docs/code-editor/find-replace",
  "draft": false,
  "tags": [],
  "version": "19-R6",
  "frontMatter": {
  ...
  "previous": {
    "title": "Code Editor",
    "permalink": "/docs/code-editor/write-class-method"
  },
  "next": {
    "title": "Creating and using macros",
    "permalink": "/docs/code-editor/creating-using-macros"
  }
};
const assets = {};
const toc = [{
...
Be careful, unlike the `, /* @__PURE__ */ (0, import_react2.mdx)("strong", {
    ...
    parentName: "p",
    ...{
      "href": "/docs/code-editor/write-class-method#using-bookmarks"
    }
