...
const metadata = {
  ...
  "id": "version-19-R6/FormObjects/propertiesAction",
  "title": "Action",
  "description": "---",
  "source": "@site/versioned_docs/version-19-R6/FormObjects/properties_Action.md",
  ...
  "next": {
    "title": "Animation",
    "permalink": "/docs/FormObjects/propertiesAnimation"
  }
};
const assets = {};
const toc = [{
...
function MDXContent({
  ...
  return /* @__PURE__ */ (0, import_react2.mdx)(MDXLayout, {
    ...
    parentName: "li"
  }, `On Begin Drag`), ` form event in the context of the object. You then manage the drag action using a method.`, /* @__PURE__ */ (0, import_react2.mdx)("br", {
    parentName: "li"
    ...
    src: (__webpack_require__(56495)/* ["default"] */ .Z),
    width: "421",
    height: "63"
  }), /* @__PURE__ */ (0, import_react2.mdx)("br", {
    parentName: "li"
  }), /* @__PURE__ */ (0, import_react2.mdx)("img", {
    src: (__webpack_require__(5215)/* ["default"] */ .Z),
    width: "421",
    height: "27"
  }), `
In this mode, the `, /* @__PURE__ */ (0, import_react2.mdx)("inlineCode", {
    ...
    parentName: "li"
  }, `On Drop`), ` form events in the context of the object. You then manage the drop action using a method.`, /* @__PURE__ */ (0, import_react2.mdx)("br", {
    parentName: "li"
  }), `In custom mode, basically the whole drag-and-drop operation is handled by the programmer. This mode lets you implement any interface based upon drag-on-drop, including interfaces that do not necessarily transport data, but can perform any action like opening files or triggering a calculation. This mode is based upon a combination of specific properties, events, and commands from the `, /* @__PURE__ */ (0, import_react2.mdx)("inlineCode", {
    parentName: "li"
  }, `Pasteboard`), ` theme. `), /* @__PURE__ */ (0, import_react2.mdx)("li", {
