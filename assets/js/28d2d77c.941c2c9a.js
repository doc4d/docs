...
const metadata = {
  ...
  "permalink": "/docs/19/FormObjects/dropdownListOverview",
  "draft": false,
  "tags": [],
  "version": "19",
  "frontMatter": {
  ...
  "previous": {
    "title": "Combo Box",
    "permalink": "/docs/19/FormObjects/comboBoxOverview"
  },
  "next": {
    "title": "Group Box",
...
function MDXContent({
  ...
  return /* @__PURE__ */ (0, import_react2.mdx)(MDXLayout, {
    ...
    parentName: "p",
    ...{
      "href": "/docs/19/FormObjects/propertiesDataSource"
    }
...
`)), /* @__PURE__ */ (0, import_react2.mdx)("p", null, `You must select each event that you test for in your Case statement. Arrays always contain a finite number of items. The list of items is dynamic and can be changed by a method. Items in an array can be modified, sorted, and added to.`), /* @__PURE__ */ (0, import_react2.mdx)("h3", {
    ...
    parentName: "p",
    ...{
      "href": "/docs/19/FormEditor/forms#form-pages"
    }
