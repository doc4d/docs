...
const metadata = {
  ...
  "id": "version-19/WebServer/sessions",
  "title": "User sessions",
  ...
  "source": "@site/versioned_docs/version-19/WebServer/sessions.md",
  "sourceDirName": "WebServer",
  "slug": "/WebServer/sessions",
  "permalink": "/docs/19/WebServer/sessions",
  "draft": false,
  "tags": [],
  "version": "19",
  "frontMatter": {
  ...
  "next": {
    ...
    "permalink": "/docs/19/WebServer/preemptiveWeb"
  }
};
const assets = {};
const toc = [{
...
`, /* @__PURE__ */ (0, import_react2.mdx)("img", {
    alt: "alt-text",
    src: (__webpack_require__(32710)/* ["default"] */ .Z),
    width: "821",
    height: "361"
    ...
    parentName: "li",
    ...{
      "href": "/docs/19/API/WebServerClass#scalablesession"
    }
    ...
    parentName: "li",
    ...{
      "href": "/docs/19/API/WebServerClass#start"
    }
  }, /* @__PURE__ */ (0, import_react2.mdx)("inlineCode", {
    parentName: "a"
    ...
    parentName: "p",
    ...{
      "href": "/docs/19/Concepts/variables#process-variables"
    }
    ...
    parentName: "p"
  }, `even in interpreted mode`), `. You need to make sure that your web code is `, /* @__PURE__ */ (0, import_react2.mdx)("a", {
    parentName: "p",
    ...{
      "href": "/docs/19/WebServer/preemptiveWeb#writing-thread-safe-web-server-code"
    }
  }, `compliant with a preemptive execution`), `.`), /* @__PURE__ */ (0, import_react2.mdx)("blockquote", null, /* @__PURE__ */ (0, import_react2.mdx)("p", {
    parentName: "blockquote"
  }, `To debug web code on 4D Server (interpreted), you need to launch and connect `, /* @__PURE__ */ (0, import_react2.mdx)("a", {
    parentName: "p",
    ...{
      "href": "/docs/19/Desktop/clientServer#using-4d-and-4d-server-on-the-same-machine"
    }
  }, `4D on the same machine as 4D Server`), ` and open the development environment (e.g., the Explorer) on the 4D application. With this configuration, all processes switch to cooperative mode and the web server code can be debugged.`)), /* @__PURE__ */ (0, import_react2.mdx)("p", null, `With 4D single-user, interpreted code is always run in cooperative mode.`), /* @__PURE__ */ (0, import_react2.mdx)("h2", {
    ...{
      "id": "sharing-information"
    }
    ...
    parentName: "p",
    ...{
      "href": "/docs/19/API/SessionClass#storage"
    }
  }, /* @__PURE__ */ (0, import_react2.mdx)("inlineCode", {
    parentName: "a"
    ...
    parentName: "p",
    ...{
      "href": "/docs/19/API/SessionClass#idletimeout"
    }
  }, /* @__PURE__ */ (0, import_react2.mdx)("inlineCode", {
    parentName: "a"
    ...
    parentName: "p",
    ...{
      "href": "/docs/19/API/SessionClass#setprivileges"
    }
  }, /* @__PURE__ */ (0, import_react2.mdx)("inlineCode", {
    parentName: "a"
    ...
    parentName: "p",
    ...{
      "href": "/docs/19/API/SessionClass#hasprivilege"
    }
  }, /* @__PURE__ */ (0, import_react2.mdx)("inlineCode", {
    parentName: "a"
    ...
    parentName: "p",
    ...{
      "href": "/docs/19/API/SessionClass#isguest"
    }
  }, /* @__PURE__ */ (0, import_react2.mdx)("inlineCode", {
    parentName: "a"
...
`)), /* @__PURE__ */ (0, import_react2.mdx)("h2", {
    ...
    alt: "alt-text",
    src: (__webpack_require__(31685)/* ["default"] */ .Z),
    width: "450",
    height: "225"
...
`)), /* @__PURE__ */ (0, import_react2.mdx)("p", null, /* @__PURE__ */ (0, import_react2.mdx)("img", {
    alt: "alt-text",
    src: (__webpack_require__(33603)/* ["default"] */ .Z),
    width: "523",
    height: "158"
