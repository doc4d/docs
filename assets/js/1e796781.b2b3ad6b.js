...
const metadata = {
  ...
  "permalink": "/docs/Desktop/building",
  "draft": false,
  "tags": [],
  "version": "19-R6",
  "frontMatter": {
  ...
  "previous": {
    "title": "User Settings",
    "permalink": "/docs/Desktop/user-settings"
  }
};
const assets = {};
const toc = [{
...
`, /* @__PURE__ */ (0, import_react2.mdx)("strong", {
    ...
    parentName: "p",
    ...{
      "href": "/docs/Project/compiler#compilation-target"
    }
...
Only the client portion can connect to the corresponding server portion. If a user tries to connect to the server portion using a standard 4D application, an error message is returned and connection is impossible.`), /* @__PURE__ */ (0, import_react2.mdx)("li", {
    ...
    parentName: "td",
    ...{
      "href": "/docs/Users/editing#directoryjson-file"
    }
...
`)), /* @__PURE__ */ (0, import_react2.mdx)("h4", {
    ...
    parentName: "li",
    ...{
      "href": "/docs/settings/database#support-of-mecab-japanese-version"
    }
