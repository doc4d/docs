...
const metadata = {
  ...
  "id": "version-19/ORDA/dsmapping",
  "title": "Data Model Objects",
  "description": "The ORDA technology is based upon an automatic mapping of an underlying 4D structure. It also provides access to data through entity and entity selection objects. As a result, ORDA exposes the whole database as a set of data model objects.",
  "source": "@site/versioned_docs/version-19/ORDA/dsMapping.md",
  "sourceDirName": "ORDA",
  "slug": "/ORDA/dsmapping",
  ...
  "previous": {
    "title": "What is ORDA?",
    "permalink": "/docs/19/ORDA/overview"
  },
  "next": {
...
function MDXContent({
  ...
  return /* @__PURE__ */ (0, import_react2.mdx)(MDXLayout, {
  ...
  }, `Structure mapping`), /* @__PURE__ */ (0, import_react2.mdx)("p", null, `When you call a datastore using the `, /* @__PURE__ */ (0, import_react2.mdx)("inlineCode", {
    parentName: "p"
  }, `ds`), ` or the `, /* @__PURE__ */ (0, import_react2.mdx)("inlineCode", {
    parentName: "p"
    ...
    src: (__webpack_require__(87476)/* ["default"] */ .Z),
    width: "961",
    height: "480"
    ...
    parentName: "li",
    ...{
      "href": "/docs/19/Concepts/identifiers"
    }
    ...
    parentName: "li",
    ...{
      "href": "/docs/19/Concepts/blob"
    }
  }, `BLOB`), ` type attributes are not managed in the datastore. BLOB type attributes are returned as Null in entities and cannot be assigned.`)), /* @__PURE__ */ (0, import_react2.mdx)("blockquote", null, /* @__PURE__ */ (0, import_react2.mdx)("p", {
    ...
    parentName: "p",
    ...{
      "href": "/docs/19/REST/gettingStarted"
    }
    ...
    src: (__webpack_require__(40089)/* ["default"] */ .Z),
    width: "279",
    height: "362"
  })), /* @__PURE__ */ (0, import_react2.mdx)("h3", {
    ...{
...
`)), /* @__PURE__ */ (0, import_react2.mdx)("p", null, `The main (default) datastore is always available through the `, /* @__PURE__ */ (0, import_react2.mdx)("inlineCode", {
    ...
    src: (__webpack_require__(80554)/* ["default"] */ .Z),
    width: "137",
    height: "188"
...
`)), /* @__PURE__ */ (0, import_react2.mdx)("p", null, `This code assigns to `, /* @__PURE__ */ (0, import_react2.mdx)("inlineCode", {
  ...
  }, `Entities`), `.`), /* @__PURE__ */ (0, import_react2.mdx)("p", null, `All eligible fieds in a table are available as attributes of their parent `, /* @__PURE__ */ (0, import_react2.mdx)("a", {
    parentName: "p",
    ...{
      "href": "#dataclass"
    }
    ...
    parentName: "p"
  }, `i.e.`), `, provide only a single value) support the standard 4D data type (integer, text, object, etc.).`), /* @__PURE__ */ (0, import_react2.mdx)("ul", null, /* @__PURE__ */ (0, import_react2.mdx)("li", {
    parentName: "ul"
    ...
    src: (__webpack_require__(13533)/* ["default"] */ .Z),
    width: "690",
    height: "533"
    ...
    src: (__webpack_require__(77448)/* ["default"] */ .Z),
    width: "1049",
    height: "288"
    ...
    parentName: "p",
    ...{
      "href": "/docs/19/ORDA/entities#using-entity-attributes"
    }
  }, `entity objects`), `.`), /* @__PURE__ */ (0, import_react2.mdx)("h3", {
    ...{
      "id": "entity"
    }
...
`)), /* @__PURE__ */ (0, import_react2.mdx)("p", null, `Entity selections can be "sorted" or "unsorted" (`, /* @__PURE__ */ (0, import_react2.mdx)("a", {
    ...
    parentName: "p",
    ...{
      "href": "/docs/19/ORDA/entities#shareable-or-alterable-entity-selections"
    }
