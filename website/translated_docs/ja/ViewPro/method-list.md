...
| -------- | ------ | -- | -------------------- |
| rangeObj | Object | -> | レンジオブジェクト            |
| 戻り値      | オブジェクト | <- | 指定レンジ内にあるセル結合のオブジェクト |
<!-- END REF -->  
...
| 戻り値        | コレクション | <- | スタイルシートオブジェクトのコレクション         |
<!-- END REF -->  
...
| ------- | ---- | ---------------------------------------------------------------------------------------------------------------------------------------------------- | ----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- | -- |
| family  | テキスト | フォントを指定します。                                                                                                                                          | 標準の、あるいは一般的なフォントファミリー。 例:  例:  "Arial", "Helvetica", "serif", "arial,sans-serif"                                                                                                                                                                                                                                                    | ◯  |
...
| borderPosObj   | オブジェクト | -> | 境界線の位置を格納したオブジェクト  |
...
| プロパティ                    |            |            | タイプ                 | 説明                                                                                                                                                                                                                                                                                                                                                                                                                                                                    |
| ------------------------ | ---------- | ---------- | ------------------- | --------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| `<customFunction>` |            |            | オブジェクト              | カスタムファンクションの名前。 カスタムファンクションの名前。 `<functionName>` プロパティ名は、4D View Pro フォーミュラで表示するカスタムファンクションの名前を定義します (スペースは使用できません)                                                                                                                                                                                                                                                                                                                                             |
...
| vpAreaName | テキスト   | -> | 4D View Pro フォームオブジェクト名   |
| styleObj   | オブジェクト | -> | スタイルオブジェクト                |
| sheet      | 整数     | -> | シートインデックス (デフォルト=カレントシート) |
