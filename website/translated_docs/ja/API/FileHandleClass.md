...
| 引数  | タイプ |    | 説明                            |
| --- | --- | -- | ----------------------------- |
| 戻り値 | 実数  | <- | Size of the document in bytes |
<!-- END REF -->
...
| 引数   | タイプ |    | 説明                                |
| ---- | --- | -- | --------------------------------- |
| size | 実数  | -> | New size of the document in bytes |
<!-- END REF -->
...
| 引数            | タイプ  |    | 説明            |
| ------------- | ---- | -- | ------------- |
| *textToWrite* | テキスト | -> | Text to write |
<!-- END REF -->
