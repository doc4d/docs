...
> 属性の型に関する注記:
> 
> * **日付** は JavaScript 形式で表す必要があります: YYYY-MM-DDTHH:MM:SSZ (例: "2010-10-05T23:00:00Z")。 日付属性のために日付プロパティを指定した場合、タイムゾーンおよび時刻 (時間・分・秒) の情報は削除されます。 In this case, you can also send the date in the format that it is returned to you dd!mm!yyyy (e.g., 05!10!2013).
