...
| データを追加 (レコード番号3番)           |                                                   |                                                                                                                                                                                                                              |
| Key1を使用してデータファイルを暗号化        | 0003.4BK ファイル (Key1で暗号化)                          | Encryption saves original files (including journal) in folder "Replaced files (Encrypting) YYY-DD-MM HH-MM-SS". When opening the encrypted data file, a new journal is created and a backup is made to activate this journal |
| Add data (record #4)        |                                                   |                                                                                                                                                                                                                              |
| データベースをバックアップ               | 0003.4BL and 0004.4BK files (encrypted with key1) | We can restore 0003.4BK and integrate 0003.4BL                                                                                                                                                                               |
| Add data (record # 5)       |                                                   |                                                                                                                                                                                                                              |
