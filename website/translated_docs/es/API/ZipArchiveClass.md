...
| Propiedad  | Tipo     | Descripción                                                                                                                                                |
| ---------- | -------- | ---------------------------------------------------------------------------------------------------------------------------------------------------------- |
| statusText | Texto    | Mensaje de error (si lo hay):<li>No se puede abrir el archivo ZIP</li><li>No se puede crear un archivo ZIP</li><li>La contraseña es necesaria para la codificación |
