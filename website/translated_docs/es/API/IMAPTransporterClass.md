...
La función `.deleteBox()` <!-- REF #IMAPTransporterClass.deleteBox().Summary -->elimina definitivamente el buzón llamado `name` en el servidor IMAP<!-- END REF -->. Intentar eliminar un INBOX o un buzón que no existe generará un error.
