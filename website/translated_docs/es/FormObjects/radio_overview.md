...
This button style can be used to add a standard collapse/expand icon. Estos botones se utilizan de forma nativa en las listas jerárquicas. In Windows, the button looks like a [+] or a [-]; in macOS, it looks like a triangle pointing right or down.
