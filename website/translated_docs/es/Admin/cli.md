...
[archivo de registro de diagnóstico](debugLogFiles.md#4ddiagnosticlogtxt) (alerta de licencia, diálogo de conversión, selección de base de datos, selección de archivo de datos). In such case, an error message is thrown both in the stderr stream and the system event log, and then the application quits.
