...
If you want your component classes and functions to be exposed in the host projects, you need to declare a component namespace. Si quiere exponer las clases y funciones del componente en el proyecto local, necesita declarar un espacio de nombres del componente. Additionally, you can control how component classes and functions are suggested in the host Code Editor.
