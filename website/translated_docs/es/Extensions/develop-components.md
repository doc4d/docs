...
- Sólo los "formularios de proyecto" (formularios que no están asociados a ninguna tabla específica) pueden utilizarse en un componente. Un componente puede llamar a formularios tabla del proyecto local.
