...
| selectionBackColor   |                        | cadena       | El color de fondo de la selección para la hoja. (preferred RGBA format)                                                                                                                                                                                                                                      |
...
| S        | Strikethrough                     | printInfo.headerLeft:="&SEsto es texto."                              | ~~This is text.~~                                 |
...
| K        | Text Color prefix                 | printInfo.headerLeft:="&KFF0000This is text."                         | <span style="color:red">Esto es texto</span>.     |
...
| centering       | entero largo | How the contents are centered on the printed page. Valores disponibles: `vk print centering both`, `vk print centering horizontal`, `vk print centering none` (por defecto), `vk print centering vertical` |
...
| formatter       |            | texto        | Pattern for value/time property.                                                                                                                                                                                                                                                                                                                                     | Number/text/date/time formats, special characters. Ver [Formato de celda](#cell-format).                                                                                                                                                    |
...
|                 | alignement | entero largo | Especifica la posición de la etiqueta de la celda. Optional property.                                                                                                                                                                                                                                                                                                | `vk label alignment top left`, `vk label alignment bottom left`, `vk label alignment top center`, `vk label alignment bottom center`, `vk label alignment top right`, `vk label alignment bottom right`                                     |
|                 | visibility | entero largo | Especifica la visibilidad de la etiqueta de la celda. Optional property.                                                                                                                                                                                                                                                                                             | `vk label visibility auto`, `vk label visibility hidden`, `vk label visibility visible`                                                                                                                                                     |
...
| textOrientation |            | entero largo | Defines the rotation angle of the text in a cell. Número entre -90 y 90                                                                                                                                                                                                                                                                                              |                                                                                                                                                                                                                                             |
| marca de agua   |            | texto        | Define el contenido de la marca de agua (etiqueta de la celda)                                                                                                                                                                                                                                                                                                       |                                                                                                                                                                                                                                             |
| wordWrap        |            | booleano     | Specifies if text should be wrapped.                                                                                                                                                                                                                                                                                                                                 | True = texto ajustado, False = texto no ajustado                                                                                                                                                                                            |
