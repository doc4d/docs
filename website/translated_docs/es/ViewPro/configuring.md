...
|           | \[ ].page     | texto                | The page(s) where the watermark is printed.<p>For all pages: "all". For specific pages: page numbers or page ranges separated by commas. Ej.: "1,3,5-12" |
