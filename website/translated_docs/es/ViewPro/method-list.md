...
| sheet      | Integer | -> | Índice de la hoja (hoja actual si se omite)              |
| Resultado  | Objeto  | <- | Rango que contiene la tabla                              |
...
| vpAreaName | Texto      | -> | Nombre de objeto formulario área 4D View Pro |
| sheet      | Integer    | -> | Índice de la hoja (hoja actual si se omite)  |
| Resultado  | Collection | <- | Text collection with all table names         |
...
If the *tableName* table is bound to a collection, the command inserts new, empty element(s) in the collection. Si *tableName* no existe, no pasa nada.
...
Para insertar una línea en la tabla "dataContext" antes de la segunda línea:
...
| Parámetros | Tipo    |    | Descripción                                 |
| ---------- | ------- | -- | ------------------------------------------- |
| vpAreaName | Texto   | -> | Nombre del área View Pro                    |
| tableName  | Texto   | -> | Nombre de la tabla a eliminar               |
...
If the *tableName* table is bound to a collection, the command removes element(s) from the collection. Si *tableName* no existe, no pasa nada.
...
Para eliminar dos líneas de la tercera línea de la tabla "dataContext":
...
| Parámetros | Tipo   |    | Descripción               |
| ---------- | ------ | -- | ------------------------- |
| rangeObj   | Objeto | -> | Nuevo rango para la tabla |
| tableName  | Texto  | -> | Nombre de la tabla        |
