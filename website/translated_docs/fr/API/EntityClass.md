...
| Résultat   | Object  | <- | Result of drop operation                                                        |
<!-- END REF -->
...
| Résultat   | Text    | <- | Value of the text primary key of the entity                                             |
| Résultat   | Integer | <- | Value of the numeric primary key of the entity                                          |
