...
| Result         | Objet      | <- | Status of the copy operation                     |
<!-- END REF -->
...
| msgsIDs   | Collection | -> | Collection of message unique IDs (strings)       |
| allMsgs   | Integer    | -> | `IMAP all`: All messages in the selected mailbox |
| Result    | Objet      | <- | Status of the delete operation                   |
<!-- END REF -->
...
| Result    | Objet   | <- | [Email object](emailObjectClass.md#email-object) |
<!-- END REF -->
...
| options   | Objet      | -> | Message handling instructions                          |
| Result    | Objet      | <- | Object containing:<br><ul><li>a collection of [Email objects](emailObjectClass.md#email-object) and</li><li>a collection of IDs or numbers for missing messages, if any</li></ul> |
<!-- END REF -->
...
| Result         | Objet      | <- | Status of the move operation                     |
<!-- END REF -->
