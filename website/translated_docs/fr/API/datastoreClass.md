...
| Parameter | Type  |    | Description                                                                 |
| --------- | ----- |:--:| --------------------------------------------------------------------------- |
| Result    | Objet | <- | Information about the encryption of the current datastore and of each table |
<!-- END REF -->
...
| Parameter | Type  |    | Description          |
| --------- | ----- |:--:| -------------------- |
| Result    | Objet | <- | Datastore properties |
<!-- END REF -->
...
| Result        | Objet | <- | Result of the encryption key matching |
<!-- END REF -->
