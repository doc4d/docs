...
| debugLog                   | number             | Status of the HTTP request log file (HTTPDebugLog_nn.txt, stored in the "Logs" folder of the application -- nn is the file number). <li>0 = désactivé</li><li>1 = enabled without body parts (body size is provided in this case)</li><li>3 = enabled with body parts in response only</li><li>5 = enabled with body parts in request only</li><li>7 = enabled with body parts in response and request</li>                                                                                                                                                                                                                                                                                                                                                                                                                                                                                  |
