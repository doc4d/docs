...
| HTTPTrace                  | boolean            | Activation HTTP TRACE. Pour des raisons de sécurité, le serveur Web rejette par défaut les requêtes HTTP TRACE avec une erreur 405. When enabled, the web server replies to HTTP TRACE requests with the request line, header, and body.                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                               |
