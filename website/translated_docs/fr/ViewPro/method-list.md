...
| comment   | Texte  | Commentaire associé à une formule nommée                                                                                                                                                                                                                                                                                                                                                                                                                         |
...
| ---------- | ----------- | -- | -------------------------------------- |
| vpAreaName | Texte       | -> | 4D View Pro area form object name      |
| sheet      | Entier long | -> | Sheet index (current sheet if omitted) |
| Résultat   | Objet       | <- | Range object of all cells              |
<!-- END REF -->  
...
| ---------- | ----------- | -- | -------------------------------------- |
| vpAreaName | Texte       | -> | 4D View Pro area form object name      |
| column     | Entier long | -> | Sheet index (current sheet if omitted) |
| row        | Entier long | -> | Sheet index (current sheet if omitted) |
| sheet      | Entier long | -> | Sheet index (current sheet if omitted) |
| Résultat   | Objet       | <- | Range object of all cells              |
<!-- END REF -->  
...
| ----------- | ----------- | -- | -------------------------------------- |
| vpAreaName  | Texte       | -> | 4D View Pro area form object name      |
| column      | Entier long | -> | Column index                           |
| row         | Entier long | -> | Row index                              |
| columnCount | Entier long | -> | Number of columns                      |
| rowCount    | Entier long | -> | Number of rows                         |
| sheet       | Entier long | -> | Sheet index (current sheet if omitted) |
| Résultat    | Objet       | <- | Range object of cells                  |
<!-- END REF -->  
...
| Résultat       | Objet | <- | Objet 4D View Pro |	
...
| copyOptions | Entier long | Specifies what is copied or moved. Valeurs possibles : <p><table><tr><th>Valeur</th><th>Description</th></tr><tr><td>`vk clipboard options all` (default)</td><td>Copies all data objects, including values, formatting, and formulas.</td></tr><tr><td>`vk clipboard options formatting`</td><td>Copies only the formatting.</td></tr><tr><td>`vk clipboard options formulas`</td><td>Copies only the formulas.</td></tr><tr><td>`vk clipboard options formulas and formatting`</td><td>Copies the formulas and formatting.</td></tr><tr><td>`vk clipboard options values`</td><td>Copies only the values.</td></tr><tr><td>`vk clipboard options value and formatting`</td><td>Copies the values and formatting.</td></tr></table></p>                                         |
...
| ---------- | ----- | -- | --------------------------------- |
| vpAreaName | Texte | -> | 4D View Pro area form object name |
| filePath   | Texte | -> | Pathname of the document          |
| paramObj   | Objet | -> | Export options                    |
<!-- END REF -->  
...
| Propriété   | Type        | Description                                                                                                                                                                                                          |
| ----------- | ----------- | -------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| afterColumn | Entier long | The number of the column just before the starting column of the search. If the *rangeObj* is a combined range, the column number given must be from the first range. Default value: -1 (beginning of the *rangeObj*) |
| afterRow    | Entier long | The number of the row just before the starting row of the search. If the *rangeObj* is a combined range, the row number given must be from the first range. Default value: -1 (beginning of the *rangeObj*)          |
...
| flags       | Entier long | <table><tr><td>`vk find flag exact match`</td><td>The entire content of the cell must completely match the search value</td></tr><tr><td>`vk find flag ignore case`</td><td>Capital and lower-case letters are considered the same. Ex: "a" is the same as "A".</td></tr><tr><td>`vk find flag none`</td><td>no search flags are considered (default)</td></tr><tr><td>`vk find flag use wild cards`</td><td>Wildcard characters (\*,?) can be used in the search string. Wildcard characters can be used in any string comparison to match any number of characters:<li>\* for zero or multiple characters (for example, searching for "bl*"  can find "bl", "black", or "blob")</li><li>? for a single character (for example, searching for "h?t" can find "hot", or "hit"</li></td></tr></table><p>These flags can be combined. Par exemple :<p> <code>$search.flags:=vk find flag use wild cards+vk find flag ignore case</code></p>                                                                                            |
| order       | Entier long | <table><tr><td>`vk find order by columns`</td><td>The search is performed by columns. Each row of a column is searched before the search continues to the next column.</td></tr><tr><td>`vk find order by rows`</td><td>The search is performed by rows. Each column of a row is searched before the search continues to the next row (default)</td></tr></table>                                                                                                                                                                                           |
| target      | Entier long | <table><tr><td>`vk find target formula`</td><td>The search is performed in the cell formula</td></tr><tr><td>`vk find target tag`</td><td>The search is performed in the cell tag</td></tr><tr><td>`vk find target text`</td><td>The search is performed in the cell text (default)</td></tr></table><p>These flags can be combined. Par exemple :<p> <code>$search.target:=vk find target formula+vk find target text</code></p>                                                                                            |
...
| Paramètres | Type  |    | Description           |
| ---------- | ----- | -- | --------------------- |
| font       | Texte | -> | Font shorthand string |
<!-- END REF -->  
...
| vpAreaName | Texte       | -> | 4D View Pro area form object name      |
| sheet      | Entier long | -> | Sheet index (current sheet if omitted) |
| Résultat   | Objet       | <- | Range object of single cell            |
<!-- END REF -->  
...
| Paramètres | Type        |    | Description                            |
| ---------- | ----------- | -- | -------------------------------------- |
| vpAreaName | Texte       | -> | 4D View Pro area from object name      |
| sheet      | Entier long | -> | Sheet index (current sheet if omitted) |
| Résultat   | Entier long | <- | Total number of columns                |
<!-- END REF -->  
...
| --------------- | ----------- | -- | --------------------------------- |
| vpAreaName      | Texte       | -> | 4D View Pro area form object name |
| Function result | Entier long | <- | Index of the current sheet        |
<!-- END REF --> 
...
| ---------- | ------ | -- | --------------------------------------- |
| vpAreaName | Texte  | -> | 4D View Pro area form object name       |
| name       | Texte  | -> | Name of the named range                 |
| scope      | Nombre | -> | Target scope (default=current sheet)    |
| Résultat   | Texte  | <- | Named formula or named range definition |
<!-- END REF -->  
...
| Propriété | Type  | Description                                                                                                                                 |
| --------- | ----- | ------------------------------------------------------------------------------------------------------------------------------------------- |
| formula   | Texte | Text of the formula corresponding to the named formula or named range. For named ranges, the formula is a sequence of absolute coordinates. |
| comment   | Texte | Comment corresponding to the named formula or named range                                                                                   |
...
| vpAreaName | Texte       | -> | 4D View Pro area form object name                   |
| sheet      | Entier long | -> | Sheet index (current sheet if omitted)              |
| Résultat   | Objet       | <- | Object containing frozen column and row information |
<!-- END REF -->  
...
| Propriété           | Type        | Description                                            |
| ------------------- | ----------- | ------------------------------------------------------ |
| columnCount         | Entier long | The number of frozen columns on the left of the sheet  |
| trailingColumnCount | Entier long | The number of frozen columns on the right of the sheet |
| rowCount            | Entier long | The number of frozen rows on the top of the sheet      |
| trailingRowCount    | Entier long | The number of frozen rows on the bottom of the sheet   |
...
| Propriété           | Type  | Description                    |
| ------------------- | ----- | ------------------------------ |
| result\[ ].name    | Texte | cell or range name             |
| result\[ ].formula | Texte | formula                        |
| result\[ ].comment | Texte | Comment associated to the name |
...
| vpAreaName | Texte       | -> | 4D View Pro area form object name      |
| sheet      | Entier long | -> | Sheet index (current sheet if omitted) |
| Résultat   | Objet       | <- | Object of printing information         |
<!-- END REF -->  
...
| vpAreaName | Texte       | -> | 4D View Pro area from object name      |
| sheet      | Entier long | -> | Sheet index (current sheet if omitted) |
| Résultat   | Entier long | <- | Total number of rows                   |
<!-- END REF -->  
...
| --------------- | ----------- | -- | --------------------------------- |
| vpAreaName      | Texte       | -> | 4D View Pro area form object name |
| Function result | Entier long | <- | Number of sheets                  |
<!-- END REF --> 
...
| vpAreaName | Texte       | -> | 4D View Pro area from object name      |
| sheet      | Entier long | -> | Sheet index (current sheet if omitted) |
| Résultat   | Objet       | <- | Sheet options object                   |
<!-- END REF -->  
...
| vpAreaName      | Texte       | -> | 4D View Pro area form object name                |
| sheet           | Entier long | <- | Sheet index                                      |
| Function result | Booléen     | <- | True if print lines are visible, False otherwise |
<!-- END REF --> 
...
| ---------- | ----- | -- | -------------------------------------- |
| vpAreaName | Texte | -> | 4D View Pro area form object name      |
| Résultat   | Objet | <- | Object containing the workbook options |
<!-- END REF -->  
...
|            | rowDelimiter    | Texte  | Row delimiter. If not present, the delimiter is automatically determined by 4D.                                                                                                                                                                          |
|            | columnDelimiter | Texte  | Column delimiter. Default: ","                                                                                                                                                                                                                           |
...
| ---------- | ----- | -- | --------------------------------- |
| vpAreaName | Texte | -> | 4D View Pro area form object name |
| viewPro    | Objet | -> | Objet 4D View Pro                 |
...
| pasteOptions | Entier long | Specifies what is pasted. Valeurs possibles : <p><table><tr><th>Valeur</th><th>Description</th></tr><tr><td>`vk clipboard options all` (default)</td><td>Pastes all data objects, including values, formatting, and formulas.</td></tr><tr><td>`vk clipboard options formatting`</td><td>Pastes only the formatting.</td></tr><tr><td>`vk clipboard options formulas`</td><td>Pastes only the formulas.</td></tr><tr><td>`vk clipboard options formulas and formatting`</td><td>Pastes the formulas and formatting.</td></tr><tr><td>`vk clipboard options values`</td><td>Pastes only the values.</td></tr><tr><td>`vk clipboard options value and formatting`</td><td>Pastes the values and formatting.</td></tr></table></p>                                                                                                                                |
...
| ---------- | ----------- | -- | ----------------------------------------- |
| vpAreaName | Texte       | -> | 4D View Pro area form object name         |
| rangeName  | Texte       | -> | Existing range name                       |
| scope      | Entier long | -> | Range location (current sheet if omitted) |
| Résultat   | Objet       | <- | Range object of name                      |
...
| Paramètres | Type  |    | Description    |
| ---------- | ----- | -- | -------------- |
| fontObj    | Objet | -> | Font object    |
| Résultat   | Texte | <- | Font shorthand |
...
| --------- | ----- | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------ | ----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- | --------- |
| family    | Texte | Specifies the font.                                                                                                                                                      | any standard or generic font family. Ex : "Arial", "Helvetica", "serif", "arial,sans-serif"                                                                                                                                                                                                                                                                       | Oui       |
...
| ---------- | ----------- | -- | -------------------------------------------------- |
| vpAreaName | Texte       | -> | 4D View Pro area form object name                  |
| name       | Texte       | -> | Name of the named range or named formula to remove |
| scope      | Entier long | -> | Target scope (default=current sheet)               |
...
| ---------- | ----------- | -- | --------------------------------- |
| vpAreaName | Texte       | -> | 4D View Pro area form object name |
| index      | Entier long | -> | Index of the sheet to remove      |
<!-- END REF -->  
...
| rowCount   | Entier long | -> | Number of rows                         |
| sheet      | Entier long | -> | Sheet index (current sheet if omitted) |
| Résultat   | Objet       | <- | Range object of row(s)                 |
...
| Paramètres | Type  |    | Description                                                                     |
| ---------- | ----- | -- | ------------------------------------------------------------------------------- |
| parameters | Objet | -> | Object containing the offscreen area's attributes                               |
...
| Paramètres | Type  |    | Description                              |
| ---------- | ----- | -- | ---------------------------------------- |
| methodObj  | Objet | -> | Allowed methods in the 4D View Pro areas |
...
| Propriété              |            |            | Type                  | Description                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                        |
| ---------------------- | ---------- | ---------- | --------------------- | ---------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| `<functionName>` |            |            | Objet                 | Custom function definition. The `<functionName>` property name defines the name of the custom function to display in 4D View Pro formulas (no spaces allowed)                                                                                                                                                                                                                                                                                                                                                                |
|                        | method     |            | Texte                 | (mandatory) Name of the existing 4D project method to allow                                                                                                                                                                                                                                                                                                                                                                                                                                                                        |
|                        | parameters |            | Collection of objects | Collection of parameters (in the order they are defined in the method).                                                                                                                                                                                                                                                                                                                                                                                                                                                            |
|                        |            | \[ ].name | Texte                 | Name of a parameter to display for the `<functionName>`.<p><p>**Note**: Parameter names must not contain space characters.                                                                                                                                                                                                                                                                                                                                                   |
...
|                        | summary    |            | Texte                 | Function description to display in 4D View Pro                                                                                                                                                                                                                                                                                                                                                                                                                                                                                     |
...
| ---------- | ----------- | -- | --------------------------------- |
| vpAreaName | Texte       | -> | 4D View Pro area form object name |
| index      | Entier long | <- | Index of the new current sheet    |
<!-- END REF --> 
...
| Propriété                |            |            | Type                  | Description                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                   |
| ------------------------ | ---------- | ---------- | --------------------- | ----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| `<customFunction>` |            |            | Objet                 | Custom function definition. `<customFunction>` defines the name of the custom function to display in 4D View Pro formulas (no spaces allowed)                                                                                                                                                                                                                                                                                                                                                                                                                                                                           |
|                          | formula    |            | Objet                 | 4D formula object (mandatory). See the `Formula` command.                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                     |
|                          | parameters |            | Collection of objects | Collection of parameters (in the order they are defined in the formula)                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                       |
|                          |            | \[ ].name | Texte                 | Name of parameter to display in 4D View Pro                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                   |
...
|                          | summary    |            | Texte                 | Formula description to display in 4D View Pro                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                 |
|                          | minParams  |            | Nombre                | Minimum number of parameters                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                  |
|                          | maxParams  |            | Nombre                | Maximum number of parameters. Passing a number higher than the length of *parameters* allows declaring "optional" parameters with default type                                                                                                                                                                                                                                                                                                                                                                                                                                                                                |
> **WARNING**
> 
...
| vpAreaName | Texte       | -> | 4D View Pro area form object name     |
| styleObj   | Objet       | -> | Style object                          |
| sheet      | Entier long | -> | Sheet index (default = current sheet) |
...
| ---------- | ----------- | -- | --------------------------------------------------- |
| vpAreaName | Texte       | -> | 4D View Pro area form object name                   |
| paneObj    | Objet       | -> | Object containing frozen column and row information |
| sheet      | Entier long | -> | Sheet index (current sheet if omitted)              |
...
| Paramètres | Type        |    | Description                            |
| ---------- | ----------- | -- | -------------------------------------- |
| vpAreaName | Texte       | -> | Nom de la zone 4D View Pro             |
| printInfo  | Objet       | -> | Object containing printing attributes  |
| sheet      | Entier long | -> | Sheet index (current sheet if omitted) |
...
| Paramètres  | Type  |    | Description                      |
| ----------- | ----- | -- | -------------------------------- |
| rangeObj    | Objet | -> | Range of rows                    |
| propertyObj | Objet | -> | Object containing row properties |
...
| Paramètres | Type  |    | Description           |
| ---------- | ----- | -- | --------------------- |
| rangeObj   | Objet | -> | Range object of cells |
...
| ---------- | ----------- | -- | --------------------------------- |
| vpAreaName | Texte       | -> | 4D View Pro area form object name |
| number     | Entier long | -> | Number of sheets                  |
...
| ---------- | ----------- | -- | --------------------------------- |
| vpAreaName | Texte       | -> | 4D View Pro area form object name |
| name       | Texte       | -> | New name for the sheet            |
| index      | Entier long | -> | Index of the sheet to be renamed  |
...
| Paramètres   | Type  |    | Description                            |
| ------------ | ----- | -- | -------------------------------------- |
| vpAreaName   | Objet | -> | Nom de la zone 4D View Pro             |
| sheetOptions | Objet | -> | Sheet option(s) to set                 |
| sheet        | Objet | -> | Sheet index (current sheet if omitted) |
...
| format    | Texte                                    | Pattern for value/time property. For information on patterns and formatting characters, please refer to the [Cell Format](configuring.md#cell-format) paragraph. |
...
| ---------- | ----- | -- | ------------------------------------------------ |
| vpAreaName | Texte | -> | 4D View Pro area form object name                |
| optionObj  | Objet | -> | Object containing the workbook options to be set |
<!-- END REF -->  
...
| showResizeTip                         | number                  | How to display the resize tip. Valeurs disponibles : <table><tr><th>Valeur</th><th>Description</th></tr><tr><td> vk show resize tip both </td><td> Specifies that horizontal and vertical resize tips are displayed.</td></tr><tr><td> vk show resize tip column </td><td> Specifies that only the horizontal resize tip is displayed.</td></tr><tr><td> vk show resize tip none </td><td> Specifies that no resize tip is displayed.</td></tr><tr><td> vk show resize tip row </td><td> Specifies that only the vertical resize tip is displayed.</td></tr></table>                                                                                                                                                                                          |
| showDragDropTip                       | boolean                 | Whether to display the drag-drop tip.                                                                                                                                                                                                                                   |
| showDragFillTip                       | boolean                 | Whether to display the drag-fill tip.                                                                                                                                                                                                                                   |
| showScrollTip                         | number                  | How to display the scroll tip. Valeurs disponibles : <table><tr><th>Valeur</th><th>Description</th></tr><tr><td> vk show scroll tip both </td><td> Specifies that horizontal and vertical scroll tips are displayed.</td></tr><tr><td> vk show scroll tip horizontal </td><td> Specifies that only the horizontal scroll tip is displayed.</td></tr><tr><td> vk show scroll tip none </td><td> Specifies that no scroll tip is displayed.</td></tr><tr><td> vk show scroll tip vertical </td><td> Specifies that only the vertical scroll tip is displayed.</td></tr></table>                                                                                                                                                                                          |
...
| autoFitType                           | number                  | Whether content will be formatted to fit in cells or in cells and headers. Valeurs disponibles : <table><tr><th>Valeur</th><th>Description</th></tr><tr><td> vk auto fit type cell </td><td> The component autofits cells</td></tr><tr><td> vk auto fit type cell with header </td><td> The component autofits cells and headers</td></tr></table>                                                                                                                                              |
| referenceStyle                        | number                  | the style for cell and range references in cell formulas on this sheet. Valeurs disponibles : <table><tr><th>Valeur</th><th>Description</th></tr><tr><td> vk reference style a1 </td><td> Indicates a1 style.</td></tr><tr><td> vk reference style r1c1 </td><td> Indicates r1c1 style</td></tr></table>                                                                                                                                                 |
...
| copyPasteHeaderOptions                | number                  | Which headers are included when data is copied to or pasted. Valeurs disponibles : <table><tr><th>Valeur</th><th>Description</th></tr><tr><td> vk copy paste header options all headers</td><td> Includes selected headers when data is copied; overwrites selected headers when data is pasted.</td></tr><tr><td> vk copy paste header options column headers </td><td> Includes selected column headers when data is copied; overwrites selected column headers when data is pasted.</td></tr><tr><td> vk copy paste header options no headers</td><td> Includes neither column nor row headers when data is copied; does not overwrite selected column or row headers when data is pasted.</td></tr><tr><td> vk copy paste header options row headers</td><td>    Includes selected row headers when data is copied; overwrites selected row headers when data is pasted.</td></tr></table>                                                                                                                                                            |
...
| columnResizeMode                      | number                  | Specifies the way to resize column. Valeurs disponibles : <table><tr><th>Valeur</th><th>Description</th></tr><tr><td> vk resize mode normal </td><td> specifies use normal way to resize</td></tr><tr><td> vk resize mode split </td><td> specifies use split way to resize</td></tr></table>                                                                                                                                                                                     |
