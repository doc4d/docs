...
| Parameter | Typ    |    | Beschreibung                                          |
| --------- | ------ | -- | ----------------------------------------------------- |
| Ergebnis  | Objekt | <- | Contents of .exe/.dll version resource or .plist file |
<!-- END REF -->
...
| Ergebnis  | [4D.FileHandle](FileHandleClass) | <- | New File handle object                  |
<!-- END REF -->
...
| `.breakModeRead`  | Zahl | Processing mode for line breaks used when reading in the file (see below)                                                     | 1       |
| `.breakModeWrite` | Zahl | Processing mode for line breaks used when writing to the file (see below)                                                     | 1       |
...
| Break mode value | Constant                      | Beschreibung                                                                                                                                                   |
| ---------------- | ----------------------------- | -------------------------------------------------------------------------------------------------------------------------------------------------------------- |
...
| Parameter | Typ    |    | Beschreibung                                                     |
| --------- | ------ | -- | ---------------------------------------------------------------- |
| info      | Objekt | -> | Properties to write in .exe/.dll version resource or .plist file |
<!-- END REF -->
