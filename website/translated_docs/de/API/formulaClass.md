...
| Ergebnis   | 4D.Function | <- | Native function encapsulating the formula |
<!-- END REF -->
...
| Ergebnis      | 4D.Function | <- | Native object encapsulating the formula |
<!-- END REF -->
...
| Ergebnis      | any        | <- | Value from formula execution                                            |
<!-- END REF -->
