...
- Im interpretierten Modus werden Anweisungen im Moment der Ausführung gelesen und in Maschinensprache übersetzt. You can add or modify the code whenever you need to, the application is automatically updated.
