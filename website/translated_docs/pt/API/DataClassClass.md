...
| Parameter | Type   |    | Description                                                                |
| --------- | ------ | -- | -------------------------------------------------------------------------- |
| settings  | Objeto | -> | Object that sets the timeout and size of the ORDA cache for the dataclass. |
<!-- END REF -->
...
| Propriedade | Type          | Description         |
| ----------- | ------------- | ------------------- |
| timeout     | Inteiro longo | Timeout in seconds. |
| maxEntries  | Inteiro longo | Number of entities. |
...
| Propriedade | Type          | Description                                                               |
| ----------- | ------------- | ------------------------------------------------------------------------- |
| maxEntries  | Inteiro longo | Maximum number of entries collection.                                     |
| stamp       | Inteiro longo | Stamp of the cache.                                                       |
| timeout     | Inteiro longo | Time remaining before the new entries in the cache are marked as expired. |
