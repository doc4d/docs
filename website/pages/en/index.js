...
class Index extends React.Component {
  render() {
    ...
    var subContents = {
      installation: (
        <translate desc="in index page Getting started">Installation</translate>
      ),
      start: (
        <translate desc="in index page Getting started">Starting 4D</translate>
      ),
      languageConcepts: (
        <translate desc="in index page Getting started">
          Language Concepts
        </translate>
      ),
      projectDatabases: (
