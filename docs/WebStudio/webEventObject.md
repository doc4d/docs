...
The `WEB Event` command returns an object describing the event triggered in a web form component, such as a button or a datatable. 

This command must be called in the context of a web form handled by the web server (see the [WEB Form command](https://doc.4d.com/4dv19R/help/command/en/page1735.html)).
...
This generic method is callable on the server for several components:
