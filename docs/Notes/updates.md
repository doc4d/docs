...
- Support of S/MIME email signing in [`4D.SMTPTransporter`](../API/SMTPTransporterClass.md) class through new properties: [`.certificate`](../API/SMTPTransporterClass.md#certificate), [`.certificateName`](../API/SMTPTransporterClass.md#certificatename) and [`.certificatePassword`](../API/SMTPTransporterClass.md#certificatepassword).
