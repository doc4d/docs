...
- New [`WebServer.quotas`](../API/WebServerClass.md#quotas) property and enhanced [`4D.QuotaManager`](../API/QuotaManagerClass.md) class to configure server-global and session-default [Web server quotas](../WebServer/quotas.md).
- New [Web server quotas](../WebServer/quotas.md), configurable at the server-global or session-default level using the [`WebServer.quotas`](../API/WebServerClass.md#quotas) property and the [`4D.QuotaManager`](../API/QuotaManagerClass.md) class.
