...
- In 4D 21 R3, the improvements to the [Code Live Checker](../code-editor/write-class-method.md#warnings-and-errors) mainly apply to language commands (see [this blog post](https://blog.4d.com/enhancement-of-command-syntax-checking-in-the-editor)). Syntax errors that were previously undetected may now be flagged in your code.
