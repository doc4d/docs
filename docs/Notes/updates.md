...
- Enhanced support of client/server disconnections with QUIC network layer: new [`QUIC session timeout`] database parameter, new [`unreachableSince` session.info](../API/SessionClass.md#info) property
