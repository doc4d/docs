...
-[ Write Pro standard actions](../WritePro/user-legacy/standard-actions.md) that apply or remove [list styles](../WritePro/user-legacy/using-a-4d-write-pro-area.md#list-styles) now automatically adjust paragraph margins to keep markers correctly positioned inside it.
