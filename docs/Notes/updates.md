...
- You can now [create components directly from the host project](../Extensions/develop-components.md#creating-components), without having to leave it or use a separate matrix project.
- 4D Language:
