...
- IMAP transporter now supports mailbox event notifications using the IDLE protocol through a [listener object](../API/IMAPTransporterClass.md#listener), configurable via [IMAP New transporter](../commands/imap-new-transporter).
