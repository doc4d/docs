...
- Web Server: Ability to [customize HTTP response headers](../WebServer/http-responses.md); the Web server object contains a new [`rules`](../API/WebServerClass.md#rules) attribute.  
- 4D Language:
