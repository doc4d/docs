...
|[`borderColor`](./properties_BackgroundAndBorder.md#frame-color)|Defines the border color of a custom-style button, check box, or radio button. |Any CSS value, "transparent", "automatic"|
|[`borderFillColor`](properties_BackgroundAndBorder.md#fill-color)|Defines the background color of a custom-style button, check box, or radio button. |Any CSS value, "transparent", "automatic"|
...
|[`borderWidth`](./properties_BackgroundAndBorder.md#frame-width)|Defines the border width of a custom-style button, check box, or radio button.  |minimum: 0|
