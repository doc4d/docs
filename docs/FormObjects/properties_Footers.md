...
This property is used to display or hide [list box column footers](listbox-header-footer#footers.md). There is one footer per column; each footer is configured separately.
...
[Headers](properties_Headers.md) - [List box footers](listbox-header-footer#footers.md)
