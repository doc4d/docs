...
This property is used to display or hide [list box column headers](listbox-header-footer#headers.md). There is one header per column; each header is configured separately.
...
[Footers](properties_Footers.md) - [List box headers](listbox-header-footer#headers.md)
