...
The design of rectangles is controlled through many properties (color, line thickness, pattern, etc.). Specifically, the [roundness](properties_BackgroundAndBorder.md#corner-radius) of its corners can be defined. 
