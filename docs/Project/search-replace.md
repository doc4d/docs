...
The **Replace in contents** feature supports components: all elements listed in the Results window are replaced, including component elements that were found. 
