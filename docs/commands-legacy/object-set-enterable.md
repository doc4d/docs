...
The **OBJECT SET ENTERABLE** command can also be used to enable the “Enter in List” mode by programming for subforms and list forms displayed using the [MODIFY SELECTION](modify-selection) and [DISPLAY SELECTION](display-selection) commands:
