...
<!--REF #_command_.SET MENU ITEM.Syntax-->**SET MENU ITEM** ( *menu* : Integer ; *menuItem* : Integer ; *itemText* : Text {; *process* : Integer}{; *} )<br/>**SET MENU ITEM** ( *menu* : Text ; *menuItem* : Integer ; *itemText* : Text {; *process* : Integer}{; *} )<!-- END REF-->
