...
The documentation for this database method has been updated and moved to [developer.4d.com/go-mobile](../commands/https://developer.4d.com/go-mobile/docs/4d/on-mobile-app-action).
