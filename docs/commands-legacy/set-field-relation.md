...
<!--REF #_command_.SET FIELD RELATION.Syntax-->**SET FIELD RELATION** ( *manyTable* ; *one* : Integer ; *many* : Integer )<br/>**SET FIELD RELATION** ( *field* ; *one* : Integer ; *many* : Integer )<!-- END REF-->
