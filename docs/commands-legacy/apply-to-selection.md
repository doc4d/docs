...
The progress thermometer is displayed while **APPLY TO SELECTION** is executing. To hide it, use [MESSAGES OFF](messages-off) prior to the call to **APPLY TO SELECTION**. If the progress thermometer is displayed, the user can cancel the operation.
