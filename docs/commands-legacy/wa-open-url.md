...
Like the existing [OPEN URL](open-url) command, **WA OPEN URL** accepts several types of syntaxes in the *url* parameter to designate the files:
...
On Mac OS, when FileVault is activated, you must use the Posix syntax. You can transform paths of the system using the [Convert path system to POSIX](convert-path-system-to-posix) command.
