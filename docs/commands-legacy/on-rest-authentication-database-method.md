...
The [Force login authentication](../commands/../REST/authUsers.md) is now highly recommended. In converted projects, you can upgrade your configuration by clicking on the [**Activate REST authentication through ds.authentify() function**](../commands/../settings/web.md#access) settings button. See also [this blog post](../commands/https://blog.4d.com/force-login-becomes-default-for-all-rest-auth/) to know how to migrate your code if necessary.
