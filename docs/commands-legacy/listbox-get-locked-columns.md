...
Columns can be locked through the Property List or using the [LISTBOX SET LOCKED COLUMNS](listbox-set-locked-columns) command. For more information, refer to the *Design Reference* manual.
