...
Use the [SET CURRENT PRINTER](set-current-printer) and [Get current printer](get-current-printer) commands to modify or get the selected printer in 4D. You must pass them the names returned in the first array (*namesArray*)
