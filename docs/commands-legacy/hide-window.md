...
* Use the [SHOW WINDOW](show-window) command and pass the window reference ID.
...
To hide all the windows of a process, use the [HIDE PROCESS](hide-process) command.
