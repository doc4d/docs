...
Automatic action buttons perform the same tasks as the [FORM FIRST PAGE](form-first-page), [FORM LAST PAGE](form-last-page), [FORM NEXT PAGE](form-next-page), [FORM PREVIOUS PAGE](form-previous-page) and **FORM GOTO PAGE** commands that you can apply to objects such as tab controls, drop-down list boxes, and so on. Whenever appropriate, use automatic action buttons instead of commands. 
...
* Use the [FORM Get current page](form-get-current-page) command to find out which page is being displayed.
