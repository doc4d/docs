...
It is useless to pass a number to **CLOSE WINDOW** when closing a window previously opened by the [Open window](open-window.md) or [Open form window](../commands/open-form-window.md) function, since a call to **CLOSE WINDOW** will always close the last window created by one of these commands.
