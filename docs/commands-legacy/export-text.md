...
By default, the command uses by default the UTF-8 character set. You can use the [USE CHARACTER SET](use-character-set) command to change this character set. 
