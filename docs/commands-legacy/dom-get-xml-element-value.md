...
**Note:** If the element designated by *elementRef* is a BLOB processed by the [DOM SET XML ELEMENT VALUE](dom-set-xml-element-value) command, it has been automatically encoded in base64\. Therefore the command will automatically attempt to decode it in base64.
