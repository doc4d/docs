...
<!--REF #_command_.GRAPH.Syntax-->**GRAPH** ( *graphPicture* : Picture ; *graphNumber* ; *xLabels* : Array {; *yElements* : Array} {; *yElements2* ; ... ; *yElementsN*} )<br/>**GRAPH** ( *graphPicture* : Picture ; *graphSettings* ; *xLabels* : Array {; *yElements* : Array} {; *yElements2* ; ... ; *yElementsN*} )<!-- END REF-->
