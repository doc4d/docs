...
* For collection or entity selection type list boxes, pass a Nil (->\[\]) pointer in *colVariable*; you will need to call [LISTBOX SET COLUMN FORMULA](listbox-set-column-formula) afterwards to specify the data source expression.
