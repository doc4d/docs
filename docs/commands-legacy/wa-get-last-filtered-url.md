...
* The URL was denied because of a filter ([WA SET URL FILTERS](wa-set-url-filters) command),
* The link is open in the default browser ([WA SET EXTERNAL LINKS FILTERS](wa-set-external-links-filters) command),
