...
If the *menuItem* parameter designates a hierarchical submenu, all the items of this menu and any submenus are enabled. This command also works with a menu bar created using the [Create menu](create-menu) command and installed with the [SET MENU BAR](set-menu-bar) command.
