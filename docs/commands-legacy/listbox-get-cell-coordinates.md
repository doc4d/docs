...
* All cells are clipped to the coordinates of their parent list box (as returned by the [OBJECT GET COORDINATES](object-get-coordinates) command for the list box).
...
For more information, please refer to the [OBJECT GET COORDINATES](object-get-coordinates) command description.
