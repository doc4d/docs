...
<!--REF #_command_.EXECUTE METHOD.Syntax-->**EXECUTE METHOD** ( *methodName* : Text {; *result* : Variable {; *param* : Expression}}{; *param2* ; ... ; *paramN*} )<br/>**EXECUTE METHOD** ( *methodName* : Text {; *result* : Operator {; *param* : Expression}}{; *param2* ; ... ; *paramN*} )<!-- END REF-->
