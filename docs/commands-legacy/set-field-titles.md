...
* If the [SET TABLE TITLES](set-table-titles) command is called without any parameters, the "virtual" structure (including table and field custom names) is completely removed from the Application environment.

## Example 

See example for the [SET TABLE TITLES](set-table-titles) command.
