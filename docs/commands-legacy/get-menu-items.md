...
In the *menu* parameter, you can pass a menu reference ([MenuRef](# "Unique ID (16-character alphanumeric) of a menu")), a menu bar number or a menu bar reference obtained using the [Get menu bar reference](get-menu-bar-reference) command.
