...
<!--REF #_command_.WEB GET BODY PART.Syntax-->**WEB GET BODY PART** ( *part* : Integer ; *contents* : Blob ; *name* : Text ; *mimeType* : Text ; *fileName* : Text )<br/>**WEB GET BODY PART** ( *part* : Integer ; *contents* : Text ; *name* : Text ; *mimeType* : Text ; *fileName* : Text )<!-- END REF-->
