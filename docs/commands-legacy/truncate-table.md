...
The effect of this command is similar to that of an [ALL RECORDS](all-records) / [DELETE SELECTION](delete-selection) sequence; however, its functioning differs on the following points:
