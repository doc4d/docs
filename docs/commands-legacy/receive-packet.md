...
<!--REF #_command_.RECEIVE PACKET.Syntax-->**RECEIVE PACKET** ( {*docRef* : Time ;} *receiveVar* : Text ; *stopChar* )<br/>**RECEIVE PACKET** ( {*docRef* : Time ;} *receiveVar* : Blob ; *stopChar* )<br/>**RECEIVE PACKET** ( {*docRef* : Time ;} *receiveVar* : Text ; *numBytes* )<br/>**RECEIVE PACKET** ( {*docRef* : Time ;} *receiveVar* : Blob ; *numBytes* )<!-- END REF-->
