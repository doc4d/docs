...
<!--REF #_command_.GET MENU ITEM ICON.Syntax-->**GET MENU ITEM ICON** ( *menu* : Integer ; *menuItem* : Integer ; *iconRef* : Text {; *process* : Integer} )<br/>**GET MENU ITEM ICON** ( *menu* : Integer ; *menuItem* : Integer ; *iconRef* : Integer {; *process* : Integer} )<br/>**GET MENU ITEM ICON** ( *menu* : Text ; *menuItem* : Integer ; *iconRef* : Text {; *process* : Integer} )<br/>**GET MENU ITEM ICON** ( *menu* : Text ; *menuItem* : Integer ; *iconRef* : Integer {; *process* : Integer} )<!-- END REF-->
