...
<!--REF #_command_.Get menu item.Syntax-->**Get menu item** ( *menu* : Integer ; *menuItem* : Integer {; *process* : Integer} ) : Text<br/>**Get menu item** ( *menu* : Text ; *menuItem* : Integer {; *process* : Integer} ) : Text<!-- END REF-->
