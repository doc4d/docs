...
The new object can be moved and resized via the *moveH*, *moveV*, *resizeH* and *resizeV* parameters. As with the [OBJECT MOVE](object-move) command, the direction of the move or the resizing is specified by the sign of the values passed in the *moveH* and *moveV* parameters:
...
* On Unload event
* Event related to printing context (On Header, On Printing Detail, etc.). To print an object several times, you must use the [Print object](print-object) command.
