...
<!--REF #_command_.CLEAR SEMAPHORE.Summary-->**CLEAR SEMAPHORE** erases *semaphore* previously set by the [Semaphore](semaphore) function.<!-- END REF-->
...
See the example for [Semaphore](semaphore).
