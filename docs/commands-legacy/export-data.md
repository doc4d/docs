...
* Save the project to disk, then load it for example by using the [DOM Parse XML source](dom-parse-xml-source) command, and pass its reference in the *project* parameter
