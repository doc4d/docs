...
These properties can be set using the [SET LIST PROPERTIES](set-list-properties) command and/or in the Design environment List Editor, if the list was created there or saved using the [SAVE LIST](save-list) command.

For a complete description of the appearance, node icons, minimal line height and double-click management of a list, see the [SET LIST PROPERTIES](set-list-properties) command.
