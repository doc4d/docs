...
<!--REF #_command_.DOM Append XML child node.Syntax-->**DOM Append XML child node** ( *elementRef* : Text ; *childType* : Integer ; *childValue* : Text ) : Text<br/>**DOM Append XML child node** ( *elementRef* : Text ; *childType* : Integer ; *childValue* : Blob ) : Text<!-- END REF-->
