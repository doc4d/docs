...
<!--REF #_command_.Get menu item parameter.Syntax-->**Get menu item parameter** ( *menu* : Integer ; *menuItem* : Integer ) : Text<br/>**Get menu item parameter** ( *menu* : Text ; *menuItem* : Integer ) : Text<!-- END REF-->
