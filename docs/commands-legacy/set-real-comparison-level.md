...
Given two real numbers *a* and *b*, if [Abs](abs)(a-b) is greater than the epsilon, the numbers are considered not equal; otherwise, the numbers are considered equal.
