...
Style sheets may have been assigned in Design mode using the Property List, or for the current process using the [OBJECT SET STYLE SHEET](object-set-style-sheet) command.
