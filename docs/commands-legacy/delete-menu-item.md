...
<!--REF #_command_.DELETE MENU ITEM.Syntax-->**DELETE MENU ITEM** ( *menu* : Integer ; *menuItem* : Integer {; *process* : Integer} )<br/>**DELETE MENU ITEM** ( *menu* : Text ; *menuItem* : Integer {; *process* : Integer} )<!-- END REF-->
