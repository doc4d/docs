...
* Prevent the opening of the database if a condition is not met (i.e., missing system resources) by explicitly calling [QUIT 4D](quit-4d).
...
See the example in the [Semaphore](semaphore) section.  
