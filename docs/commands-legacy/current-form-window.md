...
The current form window can be generated automatically using a command such as [ADD RECORD](add-record), following a user action or by using the [Open window](../commands/open-window) or [Open form window](../commands/open-form-window) commands. 
