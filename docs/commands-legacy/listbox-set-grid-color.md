...
Pass the RGB color value in *color*. For more information on RGB colors, refer to the description of the [OBJECT SET RGB COLORS](object-set-rgb-colors) command. 
