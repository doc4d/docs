...
Once this is implemented in the database, we have all we need to write the project method CREATE DOCUMENTATION listed below. We use of **GET DOCUMENT PROPERTIES** and [SET DOCUMENT PROPERTIES](set-document-properties) for handling the date and time of creation and modification of the documents.
