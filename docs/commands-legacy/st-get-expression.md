...
**Note:** This command returns "real" names for fields and tables, even if a "virtual" structure has been defined using [SET TABLE TITLES](set-table-titles) and [SET FIELD TITLES](set-field-titles) commands. 
