...
Parameters associated with items store additional information about each item. They are set using the [SET LIST ITEM PARAMETER](set-list-item-parameter) command.
