...
<!--REF #_command_.CALL WORKER.Syntax-->**CALL WORKER** ( *process* : Text ; *formula* : Object {; *param* : Expression}{; *param2* ; ... ; *paramN*} )<br/>**CALL WORKER** ( *process* : Text ; *formula* : Text {; *param* : Expression}{; *param2* ; ... ; *paramN*} )<br/>**CALL WORKER** ( *process* : Integer ; *formula* : Object {; *param* : Expression}{; *param2* ; ... ; *paramN*} )<br/>**CALL WORKER** ( *process* : Integer ; *formula* : Text {; *param* : Expression}{; *param2* ; ... ; *paramN*} )<!-- END REF-->
...
You can also pass parameters to the *formula* using one or more optional *param* parameters. You can use sequential parameters ($1, $2...) (../Concepts/parameters.md#sequential-parameters) or, if the formula expression is a function or a project method, [named parameters](../Concepts/parameters.md). Upon starting execution in the context of the process, the process formula receives the parameter values either in the named parameters, or in *$1*, *$2*, and so on. Remember that arrays cannot be passed as parameters. Furthermore, in the context of the **CALL WORKER** command, the following additional considerations need to be taken into account:
