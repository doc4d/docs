...
**Note:** The [GET MENU ITEMS](get-menu-items) and [Get menu item](get-menu-item) commands will or will not return any metacharacters in the text of a menu item depending on how it was created: if it was created with the *\** option, metacharacters will be returned as standard characters.
