...
* This command is mainly used in the context of array type list boxes. For selection type list boxes, you can use the [LISTBOX SET COLUMN FORMULA](listbox-set-column-formula) command or [OBJECT SET DATA SOURCE FORMULA](../commands/object-set-data-source-formula) instead.
...
[OBJECT Get data source](object-get-data-source)  
