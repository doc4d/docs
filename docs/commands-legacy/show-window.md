...
In order to use the **SHOW WINDOW** command, the window must have been hidden by using the [HIDE WINDOW](hide-window) command. If the window is already displayed, the command does nothing.

## Example 

Refer to the example of the [HIDE WINDOW](hide-window) command.
