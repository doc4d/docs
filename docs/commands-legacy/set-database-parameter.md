...
<!--REF #_command_.SET DATABASE PARAMETER.Syntax-->**SET DATABASE PARAMETER** ( {*aTable* : Table ;} *selector* : Integer ; *value* : Real )<br/>**SET DATABASE PARAMETER** ( {*aTable* : Table ;} *selector* : Integer ; *value* : Text )<!-- END REF-->
