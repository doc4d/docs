...
**Note:** This mechanism is the same as the one used by the [Select folder](select-folder) command. The numbers of the memorized pathnames are shared by both commands.
