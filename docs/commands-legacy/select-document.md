...
<!--REF #_command_.Select document.Syntax-->**Select document** ( *directory* : Text ; *fileTypes* : Text ; *title* : Text ; *options* : Integer {; *selected* : Text array} ) : Text<br/>**Select document** ( *directory* : Integer ; *fileTypes* : Text ; *title* : Text ; *options* : Integer {; *selected* : Text array} ) : Text<!-- END REF-->
