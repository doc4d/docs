...
<!--REF #_command_.HTTP Get.Syntax-->**HTTP Get** ( *url* : Text ; *response* : Text {; *headerNames* : Text array ; *headerValues* : Text array}{; *} ) : Integer<br/>**HTTP Get** ( *url* : Text ; *response* : Blob {; *headerNames* : Text array ; *headerValues* : Text array}{; *} ) : Integer<br/>**HTTP Get** ( *url* : Text ; *response* : Picture {; *headerNames* : Text array ; *headerValues* : Text array}{; *} ) : Integer<br/>**HTTP Get** ( *url* : Text ; *response* : Object {; *headerNames* : Text array ; *headerValues* : Text array}{; *} ) : Integer<!-- END REF-->
