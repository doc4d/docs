...
<!--REF #_command_.Find in field.Syntax-->**Find in field** ( *targetField* : Field ; *value* : Field ) : Integer<br/>**Find in field** ( *targetField* : Field ; *value* : Variable ) : Integer<!-- END REF-->
