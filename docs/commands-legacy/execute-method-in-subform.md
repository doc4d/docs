...
<!--REF #_command_.EXECUTE METHOD IN SUBFORM.Syntax-->**EXECUTE METHOD IN SUBFORM** ( *subformObject* : Text ; *formula* : Object {; *return* : Variable {; *param* : Expression} {; *param2* ; ... ; *paramN*}} )<br/>**EXECUTE METHOD IN SUBFORM** ( *subformObject* : Text ; *formula* : Text {; *return* : Variable {; *param* : Expression} {; *param2* ; ... ; *paramN*}} )<br/>**EXECUTE METHOD IN SUBFORM** ( *subformObject* : Text ; *formula* : Object {; * {; *param*} {; *param2* ; ... ; *paramN*}} )<br/>**EXECUTE METHOD IN SUBFORM** ( *subformObject* : Text ; *formula* : Text {; * {; *param*} {; *param2* ; ... ; *paramN*}} )<!-- END REF-->
