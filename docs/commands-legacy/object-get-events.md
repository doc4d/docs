...
Form events can be enabled/disabled either using the Property List, or using the [OBJECT SET EVENTS](object-set-events) command if it is called in the current process.
