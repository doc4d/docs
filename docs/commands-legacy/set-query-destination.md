...
<!--REF #_command_.SET QUERY DESTINATION.Syntax-->**SET QUERY DESTINATION** ( *destinationType* : Integer {; *destinationObject* : Text {; *destinationPtr* : Pointer}} )<br/>**SET QUERY DESTINATION** ( *destinationType* : Integer {; *destinationObject* : Variable {; *destinationPtr* : Pointer}} )<!-- END REF-->
