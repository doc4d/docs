...
<!--REF #_command_.SET MENU ITEM STYLE.Syntax-->**SET MENU ITEM STYLE** ( *menu* : Integer ; *menuItem* : Integer ; *itemStyle* : Integer {; *process* : Integer} )<br/>**SET MENU ITEM STYLE** ( *menu* : Text ; *menuItem* : Integer ; *itemStyle* : Integer {; *process* : Integer} )<!-- END REF-->
