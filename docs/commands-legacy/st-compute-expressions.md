...
For more information about 4D expressions used in multi-style text or 4D Write Pro areas, refer to the description of the [ST INSERT EXPRESSION](st-insert-expression) command.
...
* when they are "frozen" using the [ST FREEZE EXPRESSIONS](st-freeze-expressions) command, if the second *\** parameter is passed.
