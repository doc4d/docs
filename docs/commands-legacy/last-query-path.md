...
The description of the last query path can be compared to the description of the query plan provided for the last query (obtained using the [Last query plan](last-query-plan) command) for optimization purposes.
