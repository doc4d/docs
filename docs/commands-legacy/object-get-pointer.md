...
**Note:** This is strictly equivalent to the previous functioning of the [Self](self) command. This command is only kept for compatibility reasons.
...
**Note:** This is strictly equivalent to the functioning of the [Focus object](focus-object) command. This command is now obsolete beginning with 4D v12\.
