...
<!--REF #_command_.GET PICTURE RESOURCE.Syntax-->**GET PICTURE RESOURCE** ( *resID* : Integer ; *resData* : Field {; *resFile* : Time} )<br/>**GET PICTURE RESOURCE** ( *resID* : Integer ; *resData* : Variable {; *resFile* : Time} )<!-- END REF-->
