...
**Note:** If you want to get the color as a 4-byte longint format, you need to use the [OBJECT SET RGB COLORS](object-set-rgb-colors) command. For more information on color formats, please refer to the [OBJECT SET RGB COLORS](object-set-rgb-colors) command description. 
