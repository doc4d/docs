...
<!--REF #_command_.QR SET TEXT PROPERTY.Syntax-->**QR SET TEXT PROPERTY** ( *area* : Integer ; *colNum* : Integer ; *rowNum* : Integer ; *property* : Integer ; *value* : Integer )<br/>**QR SET TEXT PROPERTY** ( *area* : Integer ; *colNum* : Integer ; *rowNum* : Integer ; *property* : Integer ; *value* : Text )<!-- END REF-->
