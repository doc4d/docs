...
**Note:** This command is the equivalent of using the [OBJECT MOVE](object-move) command and passing its 2nd *\** parameter. 
...
**Note:** If you want to move an object relative to its initial position, we recommend using the existing [OBJECT MOVE](object-move) command.
...
* Headers and footers of output forms displayed by the [MODIFY SELECTION](modify-selection) or [DISPLAY SELECTION](display-selection) command,
* Forms being printed.
