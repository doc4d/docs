...
After you have put a picture into the pasteboard, you can retrieve it using the [GET PICTURE FROM PASTEBOARD](get-picture-from-pasteboard) command or for example [GET PASTEBOARD DATA](get-pasteboard-data)("com.4d.private.picture.gif";...).
