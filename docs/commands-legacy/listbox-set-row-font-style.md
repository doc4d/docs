...
If there is no font style array associated with the list box or column, one will be created dynamically when this command is called. You can access them using the [LISTBOX Get array](listbox-get-array) command.
