...
By default, if you do not pass the *\** parameter, the command returns only the Codecs that can be used to encode (write) pictures. These IDs can be used in the *format* parameter of the picture export commands [WRITE PICTURE FILE](write-picture-file) and [PICTURE TO BLOB](picture-to-blob).  
...
[Is picture file](is-picture-file)  
*Pictures*  
