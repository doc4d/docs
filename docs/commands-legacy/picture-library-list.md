...
To obtain the number of pictures currently stored in the Picture Library, use the [Size of array](size-of-array) command to get the size of one of the two arrays.
