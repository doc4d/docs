...
The **WEB SERVICE SET OPTION** command sets different options to be used during the next SOAP request triggered using the [WEB SERVICE CALL](web-service-call) command.   
