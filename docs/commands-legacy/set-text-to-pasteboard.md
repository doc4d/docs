...
After you have put some text into the pasteboard, you can retrieve it using the [Get text from pasteboard](get-text-from-pasteboard) command or by calling for example [GET PASTEBOARD DATA](get-pasteboard-data) ("com.4d.private.text.native";...).
