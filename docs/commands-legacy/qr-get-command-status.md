...
* In the method installed by [QR ON COMMAND](qr-on-command), to allow you to know which sub-item was selected. In that method, *$1* is the reference of the area and *$2* is the number of the command.
