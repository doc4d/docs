...
You can compare the value returned with the constants of the *Listbox Footer Calculation* theme (see the [LISTBOX SET FOOTER CALCULATION](listbox-set-footer-calculation) command). 
