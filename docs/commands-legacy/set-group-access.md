...
* The scope of this command is the current session. Calling [CHANGE CURRENT USER](change-current-user) afterwards for example would reset defined memberships.
