...
In *languageCode*, you pass a string indicating the code of the language to use, based on RFC3066, ISO639 and ISO3166\. For more information, refer to the description of the [SET DATABASE LOCALIZATION](set-database-localization) command. 
