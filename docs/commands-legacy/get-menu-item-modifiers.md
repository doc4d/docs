...
The standard shortcut is composed of the Command (macOS) or Ctrl (Windows) key plus a custom key. The standard shortcut is managed using the [SET MENU ITEM SHORTCUT](set-menu-item-shortcut) and [Get menu item key](get-menu-item-key) commands.
...
Refer to the example of the [Get menu item key](get-menu-item-key) command. 
