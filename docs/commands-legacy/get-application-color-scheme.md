...
* a call to the [SET APPLICATION COLOR SCHEME](set-application-color-scheme) command;
* if [SET APPLICATION COLOR SCHEME](set-application-color-scheme) was not called or called with "inherited" parameter value, the [color scheme Settings](../settings/interface.md#color-scheme) (host database Settings in case of a component);
...
Please refer to the [SET APPLICATION COLOR SCHEME](set-application-color-scheme) command description for details about color scheme names. 
