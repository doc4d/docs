...
<!--REF #_command_.HTTP Request.Syntax-->**HTTP Request** ( *httpMethod* : Text ; *url* : Text ; *contents* : Text ; *response* : Text {; *headerNames* : Text array ; *headerValues* : Text array}{; *} ) : Integer<br/>**HTTP Request** ( *httpMethod* : Text ; *url* : Text ; *contents* : Text ; *response* : Blob {; *headerNames* : Text array ; *headerValues* : Text array}{; *} ) : Integer<br/>**HTTP Request** ( *httpMethod* : Text ; *url* : Text ; *contents* : Text ; *response* : Picture {; *headerNames* : Text array ; *headerValues* : Text array}{; *} ) : Integer<br/>**HTTP Request** ( *httpMethod* : Text ; *url* : Text ; *contents* : Text ; *response* : Object {; *headerNames* : Text array ; *headerValues* : Text array}{; *} ) : Integer<br/>**HTTP Request** ( *httpMethod* : Text ; *url* : Text ; *contents* : Blob ; *response* : Text {; *headerNames* : Text array ; *headerValues* : Text array}{; *} ) : Integer<br/>**HTTP Request** ( *httpMethod* : Text ; *url* : Text ; *contents* : Blob ; *response* : Blob {; *headerNames* : Text array ; *headerValues* : Text array}{; *} ) : Integer<br/>**HTTP Request** ( *httpMethod* : Text ; *url* : Text ; *contents* : Blob ; *response* : Picture {; *headerNames* : Text array ; *headerValues* : Text array}{; *} ) : Integer<br/>**HTTP Request** ( *httpMethod* : Text ; *url* : Text ; *contents* : Blob ; *response* : Object {; *headerNames* : Text array ; *headerValues* : Text array}{; *} ) : Integer<br/>**HTTP Request** ( *httpMethod* : Text ; *url* : Text ; *contents* : Picture ; *response* : Text {; *headerNames* : Text array ; *headerValues* : Text array}{; *} ) : Integer<br/>**HTTP Request** ( *httpMethod* : Text ; *url* : Text ; *contents* : Picture ; *response* : Blob {; *headerNames* : Text array ; *headerValues* : Text array}{; *} ) : Integer<br/>**HTTP Request** ( *httpMethod* : Text ; *url* : Text ; *contents* : Picture ; *response* : Picture {; *headerNames* : Text array ; *headerValues* : Text array}{; *} ) : Integer<br/>**HTTP Request** ( *httpMethod* : Text ; *url* : Text ; *contents* : Picture ; *response* : Object {; *headerNames* : Text array ; *headerValues* : Text array}{; *} ) : Integer<br/>**HTTP Request** ( *httpMethod* : Text ; *url* : Text ; *contents* : Object ; *response* : Text {; *headerNames* : Text array ; *headerValues* : Text array}{; *} ) : Integer<br/>**HTTP Request** ( *httpMethod* : Text ; *url* : Text ; *contents* : Object ; *response* : Blob {; *headerNames* : Text array ; *headerValues* : Text array}{; *} ) : Integer<br/>**HTTP Request** ( *httpMethod* : Text ; *url* : Text ; *contents* : Object ; *response* : Picture {; *headerNames* : Text array ; *headerValues* : Text array}{; *} ) : Integer<br/>**HTTP Request** ( *httpMethod* : Text ; *url* : Text ; *contents* : Object ; *response* : Object {; *headerNames* : Text array ; *headerValues* : Text array}{; *} ) : Integer<!-- END REF-->
