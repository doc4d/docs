...
A sequence of SQL statements must be enclosed with the [Begin SQL](begin-sql) and **End SQL** keywords. For more information, refer to the description of the [Begin SQL](begin-sql) keyword.
