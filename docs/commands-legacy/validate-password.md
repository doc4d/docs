...
<!--REF #_command_.Validate password.Syntax-->**Validate password** ( *userID* : Integer ; *password* : Text {; *digest* : Boolean} ) : Boolean<br/>**Validate password** ( *userID* : Text ; *password* : Text {; *digest* : Boolean} ) : Boolean<!-- END REF-->
