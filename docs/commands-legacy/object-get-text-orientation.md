...
You can set the "Orientation" option for an object in Design mode using the Property List, or using the [OBJECT SET TEXT ORIENTATION](object-set-text-orientation) command.
