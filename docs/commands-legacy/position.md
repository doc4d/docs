...
<!--REF #_command_.Position.Syntax-->**Position** ( *find* : Text ; *aString* {; *start* : Integer {; *lengthFound* : Integer}}{; *} ) -> Function result <br/>**Position** ( *find* : Text ; *aString* ; *start* : Integer ; *lengthFound* : Integer ; *options* : Integer ) -> Function result<!-- END REF-->
