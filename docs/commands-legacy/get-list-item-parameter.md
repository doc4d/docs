...
<!--REF #_command_.GET LIST ITEM PARAMETER.Syntax-->**GET LIST ITEM PARAMETER** ( {* ;} *list* ; *itemRef* ; *selector* ; *value* )<br/>**GET LIST ITEM PARAMETER** ( * ; *list* ; * ; *selector* : Text ; *value* : Text )<br/>**GET LIST ITEM PARAMETER** ( * ; *list* ; * ; *selector* : Text ; *value* : Boolean )<br/>**GET LIST ITEM PARAMETER** ( * ; *list* ; * ; *selector* : Text ; *value* : Real )<!-- END REF-->
