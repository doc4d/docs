...
<!--REF #_command_.CREATE SELECTION FROM ARRAY.Syntax-->**CREATE SELECTION FROM ARRAY** ( *aTable* : Table ; *recordArray* : Integer {; *selectionName* : Text} )<br/>**CREATE SELECTION FROM ARRAY** ( *aTable* : Table ; *recordArray* : Boolean array {; *selectionName* : Text} )<!-- END REF-->
