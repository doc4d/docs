...
<!--REF #_command_.LIST TO ARRAY.Syntax-->**LIST TO ARRAY** ( *list* : Text ; *array* : Array {; *itemRefs* : Array} )<br/>**LIST TO ARRAY** ( *list* : Integer ; *array* : Array {; *itemRefs* : Array} )<!-- END REF-->
