...
This command is useful in the context of the parsing of a form using the [FORM LOAD](../commands/form-load), [FORM GET OBJECTS](form-get-objects) and [OBJECT Get type](object-get-type) commands. You can use it, when needed, to obtain the names of list box sub-objects.
