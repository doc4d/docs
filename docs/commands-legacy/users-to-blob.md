...
The generated BLOB is encrypted automatically and can only be read using the [BLOB TO USERS](blob-to-users) command. You can store this BLOB in a file on your hard disk or in a field.
