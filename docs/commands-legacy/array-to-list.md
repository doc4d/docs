...
<!--REF #_command_.ARRAY TO LIST.Syntax-->**ARRAY TO LIST** ( *array* : Array ; *list* : Text {; *itemRefs* : Array} )<br/>**ARRAY TO LIST** ( *array* : Array ; *list* : Integer {; *itemRefs* : Array} )<!-- END REF-->
