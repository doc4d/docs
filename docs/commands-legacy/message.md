...
* To display the text at a particular place in the window, call [GOTO XY](goto-xy).
* To erase the contents of the window, call [ERASE WINDOW](erase-window).
...
Using [GOTO XY](goto-xy) and writing some additional lines:
