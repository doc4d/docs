...
**QUERY SELECTION WITH ARRAY** functions in the same way as [QUERY WITH ARRAY](query-with-array). The difference between these two commands is the scope of the search:

* [QUERY WITH ARRAY](query-with-array) searches all the records of the table containing *targetField*.
* **QUERY SELECTION WITH ARRAY** only searches the records of the current selection of the table containing *targetField*.

For more information, please refer to the description of the [QUERY WITH ARRAY](query-with-array) command.
