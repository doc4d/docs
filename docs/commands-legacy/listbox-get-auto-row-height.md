...
The current minimum or maximum row height value can be set either in the Property list (see *Automatic Row Height*) or in the current process using the [LISTBOX SET AUTO ROW HEIGHT](listbox-set-auto-row-height) command.
