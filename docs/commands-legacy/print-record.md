...
**Warning:** Do not use the [PAGE BREAK](page-break) command with **PRINT RECORD**. [PAGE BREAK](page-break) is exclusively reserved for use in combination with the [Print form](../commands/print-form) command.
