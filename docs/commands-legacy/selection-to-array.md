...
<!--REF #_command_.SELECTION TO ARRAY.Syntax-->**SELECTION TO ARRAY** {( *aField* : Field ; *array* : Array {; *aField2* ; *array2* ; ... ; *aFieldN* ; *arrayN*}{; *})<br/>**SELECTION TO ARRAY** {( *aTable* ; *array* : Array {; *aField* : Field ; *array* : Array {; *aField2* ; *array2* ; ... ; *aFieldN* ; *arrayN*}}{; *})}<!-- END REF-->
