...
If no development license is registered on the machine but there is one associated with the 4D account, you will be prompted to install it automatically. 
