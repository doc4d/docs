...
Pass the option to be modified in *selector* and the new value of the option in *value*. You can pass as many selector/value pairs as you want. You must use the constants described below. 
