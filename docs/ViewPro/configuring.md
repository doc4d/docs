...
|clipBoardOptions|	|	longint|	The clipboard option.<p><table><tr><th>Constant</th><th>Value</th><th>Comment</th></tr><tr><td>[`vk clipboard paste options all`](constantReference.md#vk-clipboard-paste-options-all)</td><td>0</td><td>Pastes all data objects, including values, formatting, and formulas.</td></tr><tr><td>[`vk clipboard paste options formatting`](constantReference.md#vk-clipboard-paste-options-formatting)</td><td>2</td><td>Pastes only formatting.</td></tr><tr><td>[`vk clipboard paste options formulas`](constantReference.md#vk-clipboard-paste-options-formulas)</td><td>3</td><td>Pastes only formulas.</td></tr><tr><td>[`vk clipboard paste options formulas and formatting`](constantReference.md#vk-clipboard-paste-options-formulas-and-formatting)</td><td>5</td><td>Pastes formulas and formatting.</td></tr><tr><td>[`vk clipboard paste options values`](constantReference.md#vk-clipboard-paste-options-values)</td><td>1</td><td>Pastes only values.</td></tr><tr><td>[`vk clipboard paste options values and formatting`](constantReference.md#vk-clipboard-paste-options-values-and-formatting)</td><td>4</td><td>Pastes values and formatting.</td></tr></table>|
...
|rowHeaderAutoText|		|longint|	Specifies whether the row header displays letters or numbers or is blank.<p><table><tr><th>Constant</th><th>Value</th><th>Comment</th></tr><tr><td>[`vk header auto text blank`](constantReference.md#vk-header-auto-text-blank)</td><td>0</td><td>Displays blanks in the headers.</td></tr><tr><td>[`vk header auto text letters`](constantReference.md#vk-header-auto-text-letters)</td><td>2</td><td>Displays letters in the headers.</td></tr><tr><td>[`vk header auto text numbers`](constantReference.md#vk-header-auto-text-numbers)</td><td>1</td><td>Displays numbers in the headers.</td></tr></table>|
...
|---|---|---|
|[`vk pattern full date time`](constantReference.md#vk-pattern-full-date-time)|	"_fullDateTimePattern_"	|ISO 8601 format for the full date and time in current localization.<p><p>USA default pattern: "dddd, dd MMMM yyyy HH:mm:ss"|
|[`vk pattern long date`](constantReference.md#vk-pattern-long-date)|	"_longDatePattern_"	|ISO 8601 format for the full date in current localization.<p><p>USA default pattern: "dddd, dd MMMM yyyy"|
|[`vk pattern long time`](constantReference.md#vk-pattern-long-time)|	"_longTimePattern_"	|ISO 8601 format for the time in current localization.<p><p>USA default pattern: "HH:mm:ss"|
|[`vk pattern month day`](constantReference.md#vk-pattern-month-day)|	"_monthDayPattern_"	|ISO 8601 format for the month and day in current localization.<p><p>USA default pattern: "MMMM dd"|
|[`vk pattern short date`](constantReference.md#vk-pattern-short-date)|	"_shortDatePattern_"	|Abbreviated ISO 8601 format for the date in current localization.<p><p>USA default pattern: "MM/dd/yyyy"|
|[`vk pattern short time`](constantReference.md#vk-pattern-short-time)|	"_shortTimePattern_"|	Abbreviated ISO 8601 format for the time in current localization.<p><p>USA default pattern: "HH:mm"|
|[`vk pattern sortable date time`](constantReference.md#vk-pattern-sortable-date-time)|	"_sortableDateTimePattern_"	|ISO 8601 format for the date and time in current localization which can be sorted.<p><p>USA default pattern: "yyyy\'-\'MM\'-\'dd\'T\'HH\':\'mm\':\'ss"|
|[`vk pattern universal sortable date time`](constantReference.md#vk-pattern-universal-sortable-date-time)|	"_universalSortableDateTimePattern_"	|ISO 8601 format for the date and time in current localization using UTC which can be sorted.<p><p>USA default pattern: "yyyy\'-\'MM\'-\'dd HH\':\'mm\':\'ss\'Z\'"|
|[`vk pattern year month`](constantReference.md#vk-pattern-year-month)	|"_yearMonthPattern_"|	ISO 8601 format for the month and year in current localization.<p><p>USA default pattern: "yyyy MMMM"|
...
*	[VP SET PRINT INFO](languageReference.md#vp-set-print-info) 
*	[VP Get print info](languageReference.md#vp-get-print-info) 
*	[VP PRINT](languageReference.md#vp-print)
...
|||<table><tr><th>Constant</th><th>Value</th><th>Comment</th></tr><tr><td>[`vk print page orientation landscape`](constantReference.md#vk-print-page-orientation-landscape)</td><td>2</td><td>Landscape orientation</td></tr><tr><td>[`vk print page orientation portrait`](constantReference.md#vk-print-page-orientation-portrait)</td><td>1</td><td>Portrait orientation. (default)</td></tr></table>|
...
| 	|	|<table><tr><th>Constant</th><th>Value</th><th>Comment</th></tr><tr><td>[`vk print centering both`](constantReference.md#vk-print-centering-both)</td><td>3</td><td>Printing is centered both horizontally and vertically on the page</td></tr><tr><td>[`vk print centering horizontal`](constantReference.md#vk-print-centering-horizontal)</td><td>1</td><td>Printing is centered horizontally on the page.</td></tr><tr><td>[`vk print centering none`](constantReference.md#vk-print-centering-none)</td><td>0</td><td>Printing is not centered. (default)</td></tr><tr><td>[`vk print centering vertical`](constantReference.md#vk-print-centering-vertical)</td><td>2</td><td>Printing is centered vertically on the page.</td></tr></table>|
...
| |		|<table><tr><th>Constant</th><th>Value</th><th>Comment</th></tr><tr><td>[`vk print page order auto`](constantReference.md#vk-print-page-order-auto)</td><td>0</td><td>Printing order is determined automatically. (default)</td></tr><tr><td>[`vk print page order down then over`](constantReference.md#vk-print-page-order-down-then-over)</td><td>1</td><td>Pages are printed in descending order, then across.</td></tr><tr><td>[`vk print page order over then down`](constantReference.md#vk-print-page-order-over-then-down)</td><td>2</td><td>Pages are printed across, then descending order.</td></tr></table>|
...
| |	|	<table><tr><th>Constant</th><th>Value</th><th>Comment</th></tr><tr><td><tr><td>[`vk print visibility hide`](constantReference.md#vk-print-visibility-hide)</td><td>1</td><td>The header is not visible.</td></tr><tr><td>[`vk print visibility inherit`](constantReference.md#vk-print-visibility-inherit)</td><td>0</td><td>Inherits the settings from the sheet (default)</td></tr><tr><td>[`vk print visibility show`](constantReference.md#vk-print-visibility-show)</td><td>2</td><td>The header is visible on every page.</td></tr><tr><td>[`vk print visibility show once`](constantReference.md#vk-print-visibility-show-once)</td><td>3</td><td>	The header is visible once.</td></tr></table>|
...
You can use style objects directly with the [VP SET CELL STYLE](languageReference.md#vp-set-cell-style)) and [VP SET DEFAULT STYLE](languageReference.md#vp-set-default-style) commands.
...
Style sheets are created with the [VP ADD STYLESHEET](languageReference.md#vp-add-stylesheet) command and applied with the the [VP SET DEFAULT STYLE](languageReference.md#vp-set-default-style) or [VP SET CELL STYLE](languageReference.md#vp-set-cell-style) commands. You can  remove a style sheet with the [VP REMOVE STYLESHEET](languageReference.md#vp-remove-stylesheet) command.

The [VP Get stylesheet](languageReference.md#vp-get-stylesheet) command can be used to return the style object of a single style sheet or you can use the [VP Get stylesheets](languageReference.md#vp-get-stylesheets) command to retrieve a collection of style objects for multiple style sheets.

### Style properties

 
You can find detailed descriptions of the possible values below on the [4D View Pro Constants](constantReference.md) page.
...
|Property|Subproperty|	Type|	Description|	Possible values|
|---|---|---|---|---|
|font|		|text|	Specifies the font characteristics in CSS font shorthand ("font-style font-variant font-weight font-size/line-height font-family"). Example: "14pt Century Gothic". The font-size and font-family values are mandatory. If one of the other values is missing, their default values are used. Note: If a font name contains a space, the name must be within quotes.|	A CSS font shorthand.<p>4D provides utility commands to handle font characteristics as objects: [`VP Font to object`](languageReference.md#vp-font-to-object) and [`VP Object to font`](languageReference.md#vp-object-to-font)|
