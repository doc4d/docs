...
|formatter|		|text|Pattern for value/time property.|Number/text/date/time formats, special characters. See [4D View Pro Cell Format](vpConfig.md#cell-format) section.|
