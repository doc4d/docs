...
*	The **4D View Pro object** ([C_OBJECT](Concepts/dt_object.md) type variable or expression): stores the whole spreadsheet contents (see below). You can get or set this object using the [VP IMPORT FROM OBJECT](method-reference.md#vp-import-from-object) or [VP Export to object](method-reference.md#vp-export-to-object) commands.
