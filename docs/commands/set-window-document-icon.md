...
<!--REF #_command_.SET WINDOW DOCUMENT ICON.Syntax-->**SET WINDOW DOCUMENT ICON** ( *winRef* : Integer )<br/>**SET WINDOW DOCUMENT ICON** ( *winRef* : Integer ; *image* : Picture )<br/>**SET WINDOW DOCUMENT ICON** ( *winRef* : Integer ; *file* : 4D.File )<br/>**SET WINDOW DOCUMENT ICON** ( *winRef* : Integer ; *file* : 4D.Folder )<br/>**SET WINDOW DOCUMENT ICON** (  *winRef* : Integer ; *image* : Picture ; *file* : 4D.File )<br/>**SET WINDOW DOCUMENT ICON** (  *winRef* : Integer ; *image* : Picture ; *file* : 4D.Folder )<!-- END REF-->
