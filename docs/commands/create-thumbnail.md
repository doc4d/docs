...
If you do not enter any parameter, the “Scaled to fit prop centered” mode (6) is applied by default. Below is an illustration of the various modes: Source picture <br/>![](img/27911/pict27911.en.png) Resulting thumbnails (48x48) 
* Scaled to fit = 2<br/>![](img/27912/pict27912.en.png)
* Scaled to fit proportional = 5<br/>![](img/27913/pict27913.en.png)
* Scaled to fit prop centered = 6 (default mode)<br/>![](img/27914/pict27914.en.png)
