...
#### Example 2
 ...
 This example creates a local array of 100 rows of 50 2-byte <span class="rte4d_typ">Integer</span> elements:
```4d
...
#### Example 3
 ...
 This example creates an interprocess array of 50 2-byte <span class="rte4d_typ">Integer</span> elements, and sets each element to its element number:
```4d
