...
<!--REF #_command_.String.Syntax-->**String** ( *expression* : Expression {; *format* : Integer {; *addTime* : Time}} ) : Text<br/>**String** ( *expression* : Expression {; *format* : Text {; *addTime* : Time}} ) : Text<br/>**String** ( *expression* : Expression ; *base* : Integer ) : Text<!-- END REF-->
