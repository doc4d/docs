...
<!--REF #_command_.WP Import document.Syntax-->**WP Import document** ( *filePath* : Text {; *option* : Integer} ) : Object<br/>**WP Import document** ( *filePath* : Text {; *option* : Object} ) : Object<br/>**WP Import document** ( *fileObj* : 4D.File {; *option* : Integer} ) : Object<br/>**WP Import document** ( *fileObj* : 4D.File {; *option* : Object} ) : Object<!-- END REF-->
