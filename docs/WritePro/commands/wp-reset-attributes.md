...
<!--REF #_command_.WP RESET ATTRIBUTES.Syntax-->**WP RESET ATTRIBUTES** ( *targetObj* : Object ; *...attribName* )<br/>**WP RESET ATTRIBUTES** ( *sectionOrSubsection* : Object {; *...attribName* })<br/>**WP RESET ATTRIBUTES** ( *targetObj* : Object ; *attribColl* : Collection )<br/> **WP RESET ATTRIBUTES** ( *sectionOrSubsection* : Object {; *attribColl* : Collection})<!-- END REF-->
