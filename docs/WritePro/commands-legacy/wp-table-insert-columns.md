...
<!--REF #_command_.WP Table insert columns.Syntax-->**WP Table insert columns** ( *targetObj* {; *numColumns* }) : Object<br/>**WP Table insert columns** ( *tableRef* ; *colNumber* {; *numColumns*} ) <!-- END REF-->
