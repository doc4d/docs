...
<!--REF #_command_.WP New.Syntax-->**WP New** {( *source* : Text {; *option* : Integer} )} : Object<br/>**WP New** {( *source* : Blob {; *option* : Integer} )} : Object<br/>**WP New** {( *source* : Object {; *option* : Integer} )} : Object<!-- END REF-->
