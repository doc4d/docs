...
<!--REF #_command_.WP Table get cells.Syntax-->**WP Table get cells** ( *targetObj* ) : Object<br/>**WP Table get cells** ( *tableRef* ; *startCol* ; *startRow* {; *numCols*{; *numRows*}} ) : Object<!-- END REF-->
