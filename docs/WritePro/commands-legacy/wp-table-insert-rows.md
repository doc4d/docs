...
<!--REF #_command_.WP Table insert rows.Syntax-->**WP Table insert rows** ( *targetObj* {; *numRows*}) : Object<br/>**WP Table insert rows** ( *tableRef* ; *rowNumber* {; *numRows*} ) : Object<!-- END REF-->
