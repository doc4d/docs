...
<!--REF #_command_.WP Table get rows.Syntax-->**WP Table get rows** ( *targetObj* ) : Object<br/>**WP Table get rows** ( *tableRef* ; startRow | wk header rows {; *numRows*} ) : Object<!-- END REF-->
