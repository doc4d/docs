...
<!--REF #_command_.WP Table get rows.Syntax-->**WP Table get rows** ( *targetObj* ) : Object<br/>**WP Table get rows** ( *tableRef* ; startRow {; *numRows*} ) : Object<br/>**WP Table get rows** ( *tableRef* ; *headers* ) : Object<!-- END REF-->
