...
| Border System Rounded | Integer | 8  | On macOS, the border line is drawn with "Liquid Glass" graphic appearance. On Windows, the rendering is similar to `Border System` |
