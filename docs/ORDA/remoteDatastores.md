...
* You can bypass the learning phase or customize an optimization context using the [.setRemoteContextInfo()](../API/DataStoreClass.md#setremotecontextinfo) function. Additionally, you can get information about running contexts using the following functions:
...
Entity and Entity selection class:
