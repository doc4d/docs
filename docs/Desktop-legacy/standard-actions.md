...
| Constant (if any) | Activation conditions | Available with |
|---|---|---|
| `ak open back url` | A previous URL was loaded | Buttons, Menu commands |
...
| Constant (if any) | Activation conditions | Available with |
|---|---|---|
| `ak open forward url` | `openBackURL` previously executed | Buttons, Menu commands |
...
| Constant (if any) | Activation conditions | Available with |
|---|---|---|
| `ak refresh current url` | `openBackURL` previously executed (can be handled by the [OBJECT SET ENABLED](../commands/object-set-enabled) command) | Buttons, Menu commands |
...
| Constant (if any) | Activation conditions | Available with |
|---|---|---|
| `ak stop loading url` | URL being loaded | Buttons, Menu commands |
...
| Constant (if any) | Activation conditions | Available with |
|---|---|---|
| `ak undo` | An editing action was done | Buttons, Menu commands |
...
| Constant (if any) | Activation conditions | Available with |
|---|---|---|
| `ak redo` | An undo action was done | Buttons, Menu commands |
...
| Constant (if any) | Activation conditions | Available with |
|---|---|---|
| `ak cut` | Contents selected | Buttons, Menu commands |
...
| Constant (if any) | Activation conditions | Available with |
|---|---|---|
| `ak copy` | Contents selected | Buttons, Menu commands |
...
| Constant (if any) | Activation conditions | Available with |
|---|---|---|
| `ak paste` | Clipboard not empty | Buttons, Menu commands |
...
| Constant (if any) | Activation conditions | Available with |
|---|---|---|
| `ak clear` | Focused object has an editable area | Buttons, Menu commands |
...
| Constant (if any) | Activation conditions | Available with |
|---|---|---|
| `ak select all` | Focused object has an editable area | Buttons, Menu commands |
