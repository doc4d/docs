...
const metadata = {
  ...
  "id": "version-18/Concepts/interpreted-compiled",
  "title": "Interpreted and Compiled modes",
  "description": "4D applications can work in interpreted or compiled mode:",
  "source": "@site/versioned_docs/version-18/Concepts/interpreted.md",
  "sourceDirName": "Concepts",
  "slug": "/Concepts/interpreted-compiled",
  "permalink": "/docs/es/18/Concepts/interpreted-compiled",
  "draft": false,
  "tags": [],
  "version": "18",
  "frontMatter": {
  ...
  "previous": {
    ...
    "permalink": "/docs/es/18/Concepts/error-handling"
  },
  "next": {
    "title": "Components",
    "permalink": "/docs/es/18/Concepts/components"
  }
};
const assets = {};
const toc = [{
...
function MDXContent({
  ...
  return /* @__PURE__ */ (0, import_react2.mdx)(MDXLayout, {
    ...
    parentName: "li"
  }, `Speed`), `: Your database can run from 3 to 1,000 times faster.`), /* @__PURE__ */ (0, import_react2.mdx)("li", {
    parentName: "ul"
  }, /* @__PURE__ */ (0, import_react2.mdx)("strong", {
    parentName: "li"
  }, `Code checking`), `: Your database application is scanned for the consistency of code. Both logical and syntactical conflicts are detected.`), /* @__PURE__ */ (0, import_react2.mdx)("li", {
    parentName: "ul"
  }, /* @__PURE__ */ (0, import_react2.mdx)("strong", {
    parentName: "li"
  }, `Protection`), `: Once your database is compiled, you can delete the interpreted code. Then, the compiled database is functionally identical to the original, except that the structure and methods cannot be viewed or modified, deliberately or inadvertently.`), /* @__PURE__ */ (0, import_react2.mdx)("li", {
    parentName: "ul"
  }, /* @__PURE__ */ (0, import_react2.mdx)("strong", {
    parentName: "li"
  }, `Stand-alone double-clickable applications`), `: compiled databases can also be transformed into stand-alone applications (.EXE files) with their own icon.`), /* @__PURE__ */ (0, import_react2.mdx)("li", {
    parentName: "ul"
  }, /* @__PURE__ */ (0, import_react2.mdx)("strong", {
    parentName: "li"
  ...
  }, `Using Compiler Directives with the Interpreter`), /* @__PURE__ */ (0, import_react2.mdx)("p", null, `Compiler directives are not required for uncompiled databases. The interpreter automatically types each variable according to how it is used in each statement, and a variable can be freely retyped throughout the database.`), /* @__PURE__ */ (0, import_react2.mdx)("p", null, `Because of this flexibility, it is possible that a database can perform differently in interpreted and compiled modes.`), /* @__PURE__ */ (0, import_react2.mdx)("p", null, `For example, if you write:`), /* @__PURE__ */ (0, import_react2.mdx)("pre", null, /* @__PURE__ */ (0, import_react2.mdx)("code", {
    parentName: "pre",
    ...{
      "className": "language-4d"
    }
  }, `C_LONGINT(MyInt)
`)), /* @__PURE__ */ (0, import_react2.mdx)("p", null, `and elsewhere in the database, you write:`), /* @__PURE__ */ (0, import_react2.mdx)("pre", null, /* @__PURE__ */ (0, import_react2.mdx)("code", {
    parentName: "pre",
    ...{
      "className": "language-4d"
    }
