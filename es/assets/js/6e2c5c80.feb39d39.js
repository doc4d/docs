...
var find_replace_exports = {};
__export(find_replace_exports, {
  assets: () => assets,
...
module.exports = __toCommonJS(find_replace_exports);
...
const metadata = {
  "unversionedId": "code-editor/find-replace",
  "id": "version-19-R6/code-editor/find-replace",
  "title": "Find and replace",
  "description": "The Code Editor has specific find and replace functions that apply to the current window.",
  "source": "@site/versioned_docs/version-19-R6/code-editor/find-replace.md",
  "sourceDirName": "code-editor",
  "slug": "/code-editor/find-replace",
  "permalink": "/docs/es/code-editor/find-replace",
  "draft": false,
  "tags": [],
  "version": "19-R6",
  "frontMatter": {
  ...
  "previous": {
    "title": "Code Editor",
    "permalink": "/docs/es/code-editor/write-class-method"
  },
  "next": {
    "title": "Creating and using macros",
    "permalink": "/docs/es/code-editor/creating-using-macros"
  }
};
const assets = {};
const toc = [{
  ...
  value: "Find Same Next/Previous",
  id: "find-same-nextprevious",
  level: 3
}, {
  value: "Bookmark All",
  id: "bookmark-all",
...
function MDXContent({
  ...
  return /* @__PURE__ */ (0, import_react2.mdx)(MDXLayout, {
    ...
    components,
    mdxType: "MDXLayout"
  }, /* @__PURE__ */ (0, import_react2.mdx)("p", null, `The Code Editor has specific find and replace functions that apply to the current window.`), /* @__PURE__ */ (0, import_react2.mdx)("p", null, `The find area located in the toolbar of each method window can be used to carry out simple searches.`), /* @__PURE__ */ (0, import_react2.mdx)("p", null, `The Find/Replace commands for methods, classes or functions are located in `, /* @__PURE__ */ (0, import_react2.mdx)("strong", {
    parentName: "p"
  }, `Edit`), ` menu of 4D:`), /* @__PURE__ */ (0, import_react2.mdx)("p", null, /* @__PURE__ */ (0, import_react2.mdx)("img", {
    alt: "find-replace",
    src: (__webpack_require__(22890)/* ["default"] */ .Z),
    width: "658",
    height: "462"
  })), /* @__PURE__ */ (0, import_react2.mdx)("blockquote", null, /* @__PURE__ */ (0, import_react2.mdx)("p", {
    parentName: "blockquote"
  }, `The find commands located above the `, /* @__PURE__ */ (0, import_react2.mdx)("strong", {
    parentName: "p"
  }, `Find`), ` submenu are not specific to the Code Editor but may be used to search for a value among all the methods, classes or functions, using the `, /* @__PURE__ */ (0, import_react2.mdx)("strong", {
    parentName: "p"
  }, `Find in design`), ` feature in the toolbar or in the `, /* @__PURE__ */ (0, import_react2.mdx)("strong", {
    parentName: "p"
  }, `Edit`), ` menu.`)), /* @__PURE__ */ (0, import_react2.mdx)("h2", {
    ...{
      "id": "find"
    }
  }, `Find`), /* @__PURE__ */ (0, import_react2.mdx)("p", null, `Selecting the `, /* @__PURE__ */ (0, import_react2.mdx)("strong", {
    parentName: "p"
  }, `Find...`), ` command displays the following dialog box:`), /* @__PURE__ */ (0, import_react2.mdx)("p", null, /* @__PURE__ */ (0, import_react2.mdx)("img", {
    alt: "find-dialog",
    src: (__webpack_require__(82093)/* ["default"] */ .Z),
    width: "495",
    height: "262"
  })), /* @__PURE__ */ (0, import_react2.mdx)("p", null, `The search defined in this dialog box will be performed in the method located in the foreground.`), /* @__PURE__ */ (0, import_react2.mdx)("ul", null, /* @__PURE__ */ (0, import_react2.mdx)("li", {
    parentName: "ul"
  }, `The `, /* @__PURE__ */ (0, import_react2.mdx)("strong", {
    parentName: "li"
  }, `Find What:`), ` area enables you to enter the string of characters to be searched for. This area is a combo box that stores the last 15 character strings that have been searched for or replaced during the session. If you highlight text before choosing the `, /* @__PURE__ */ (0, import_react2.mdx)("strong", {
    parentName: "li"
  }, `Find...`), ` command, it will appear in this area. You can then either use this text or replace it with another.`), /* @__PURE__ */ (0, import_react2.mdx)("li", {
    parentName: "ul"
  }, `The `, /* @__PURE__ */ (0, import_react2.mdx)("strong", {
    parentName: "li"
  }, `Whole Word`), ` option is used to limit the search to exact occurrences of the word being searched for. When this option is checked, for instance, a search for "client" will not find either "clients" or "myclient." By default, this option is not checked; therefore, a search for "var" will find "Myvar," "variation," etc.
Be careful, unlike the `, /* @__PURE__ */ (0, import_react2.mdx)("strong", {
    parentName: "li"
  }, `Whole Object Name`), ` option of the Find in Design dialog box, the `, /* @__PURE__ */ (0, import_react2.mdx)("strong", {
    parentName: "li"
  }, `Whole Word`), ` option does not take object names into account. For example, with this option, searching for the string "My" in a method will find the "My Variable" variable. This is not the case for an overall search using the `, /* @__PURE__ */ (0, import_react2.mdx)("strong", {
    parentName: "li"
  }, `Whole Object Name`), ` option, where the same result will not be found in the context of the above example since the whole object name (of the variable found previously) is "My Variable" and therefore does not correspond exactly to the string entered ("My").`), /* @__PURE__ */ (0, import_react2.mdx)("li", {
    parentName: "ul"
  }, `The `, /* @__PURE__ */ (0, import_react2.mdx)("strong", {
    parentName: "li"
  }, `Case Sensitive`), ` option is used to take the case of characters as they were entered in the "Find What:" area into account. For instance, a search for "MyVar" will not find "myVar."`), /* @__PURE__ */ (0, import_react2.mdx)("li", {
    parentName: "ul"
  }, `The `, /* @__PURE__ */ (0, import_react2.mdx)("strong", {
    parentName: "li"
  }, `Previous/Next`), ` radio buttons are used to set the direction of the search: towards the beginning or end of the current method, starting from the initial location of the cursor.`)), /* @__PURE__ */ (0, import_react2.mdx)("p", null, `When you click on `, /* @__PURE__ */ (0, import_react2.mdx)("strong", {
    parentName: "p"
  }, `OK`), `, 4D begins searching from the current text insertion point and continues to the end of the method. The first item corresponding to the set criteria is thus selected in the Code Editor window. It is then possible to continue the search using the `, /* @__PURE__ */ (0, import_react2.mdx)("strong", {
    parentName: "p"
  }, `Find Next`), ` and `, /* @__PURE__ */ (0, import_react2.mdx)("strong", {
    parentName: "p"
  }, `Find Previous`), ` commands of the `, /* @__PURE__ */ (0, import_react2.mdx)("strong", {
    parentName: "p"
  }, `Edit`), ` menu.`), /* @__PURE__ */ (0, import_react2.mdx)("h3", {
    ...{
      "id": "find-same"
    }
  }, `Find Same`), /* @__PURE__ */ (0, import_react2.mdx)("p", null, `The `, /* @__PURE__ */ (0, import_react2.mdx)("strong", {
    parentName: "p"
  }, `Find Same`), ` command is used to find character strings identical to the one selected. This command is only active if you have selected at least one character in the Code Editor.`), /* @__PURE__ */ (0, import_react2.mdx)("p", null, `The search carried out is of the "Find Next" type in the current code editor window.`), /* @__PURE__ */ (0, import_react2.mdx)("h3", {
    ...{
      "id": "find-same-nextprevious"
    }
  }, `Find Same Next/Previous`), /* @__PURE__ */ (0, import_react2.mdx)("p", null, `The `, /* @__PURE__ */ (0, import_react2.mdx)("strong", {
    parentName: "p"
  }, `Find Same Next`), ` and `, /* @__PURE__ */ (0, import_react2.mdx)("strong", {
    parentName: "p"
  }, `Find Same Previous`), ` commands are used to find character strings `, /* @__PURE__ */ (0, import_react2.mdx)("em", {
    parentName: "p"
  }, `strictly`), ` identical to the ones selected. For example, the case must match.`), /* @__PURE__ */ (0, import_react2.mdx)("h3", {
    ...{
      "id": "bookmark-all"
    }
  }, `Bookmark All`), /* @__PURE__ */ (0, import_react2.mdx)("p", null, `The `, /* @__PURE__ */ (0, import_react2.mdx)("strong", {
    parentName: "p"
  }, `Bookmark All`), ` command is enabled when a search has already been specified in the find or replace dialog box. When you select this command, 4D puts a bookmark at each line that contains an item corresponding to the "current" search criteria. This makes it easy to spot all the search results.`), /* @__PURE__ */ (0, import_react2.mdx)("p", null, `For more information about bookmarks, refer to `, /* @__PURE__ */ (0, import_react2.mdx)("a", {
    parentName: "p",
    ...{
      "href": "/docs/es/code-editor/write-class-method#using-bookmarks"
    }
  }, `Using bookmarks`), `.`), /* @__PURE__ */ (0, import_react2.mdx)("h2", {
    ...{
      "id": "replace"
    }
  }, `Replace`), /* @__PURE__ */ (0, import_react2.mdx)("p", null, `The `, /* @__PURE__ */ (0, import_react2.mdx)("strong", {
    parentName: "p"
  }, `Replace`), ` command displays the following dialog box:`), /* @__PURE__ */ (0, import_react2.mdx)("p", null, /* @__PURE__ */ (0, import_react2.mdx)("img", {
    alt: "find-dialog",
    src: (__webpack_require__(26882)/* ["default"] */ .Z),
    width: "495",
    height: "292"
    ...
    parentName: "li"
  }, `Find What:`), ` area is used to define the character string or the expression to be searched for. As in the Find dialog box, this area is a combo-box that stores the last 15 character strings searched for. If you highlight text before choosing the `, /* @__PURE__ */ (0, import_react2.mdx)("strong", {
    parentName: "li"
  }, `Replace`), ` command, it will appear in this area.`), /* @__PURE__ */ (0, import_react2.mdx)("li", {
    parentName: "ul"
  }, `The `, /* @__PURE__ */ (0, import_react2.mdx)("strong", {
    parentName: "li"
  }, `Replace with:`), ` area is used to define the character string that will replace the one defined above. This area is also a combo-box storing the last 15 character strings that have been searched for or replaced.`), /* @__PURE__ */ (0, import_react2.mdx)("li", {
    parentName: "ul"
  }, `The `, /* @__PURE__ */ (0, import_react2.mdx)("strong", {
    parentName: "li"
  }, `Whole Word`), ` option is used to find/replace only character strings that correspond exactly to the string entered. In this case, for instance, a search for "client" will not find the strings "clients" or "myclient," etc.`), /* @__PURE__ */ (0, import_react2.mdx)("li", {
    parentName: "ul"
  }, `The `, /* @__PURE__ */ (0, import_react2.mdx)("strong", {
    parentName: "li"
  }, `Case Sensitive`), ` option is used to find/replace only character strings having the same case as that of the entered string. For instance, a search for "MyVar" will not find "myVar."`), /* @__PURE__ */ (0, import_react2.mdx)("li", {
    parentName: "ul"
  }, `As in the Find dialog box, the `, /* @__PURE__ */ (0, import_react2.mdx)("strong", {
    parentName: "li"
  }, `Previous`), ` and `, /* @__PURE__ */ (0, import_react2.mdx)("strong", {
    parentName: "li"
  }, `Next`), ` buttons are used to set the direction of the search: towards the beginning or end of the current method, starting from the initial location of the cursor.`)), /* @__PURE__ */ (0, import_react2.mdx)("p", null, `The `, /* @__PURE__ */ (0, import_react2.mdx)("strong", {
    parentName: "p"
  }, `Replace`), ` button is used to launch the search and replace the first occurrence found. 4D begins searching from the current text insertion point and continues to the end of the method. It is then possible to continue finding/replacing using the `, /* @__PURE__ */ (0, import_react2.mdx)("strong", {
    parentName: "p"
  }, `Replace Next`), ` and `, /* @__PURE__ */ (0, import_react2.mdx)("strong", {
    parentName: "p"
  }, `Replace Previous`), ` commands of the `, /* @__PURE__ */ (0, import_react2.mdx)("strong", {
    parentName: "p"
  }, `Edit`), ` menu.`), /* @__PURE__ */ (0, import_react2.mdx)("p", null, `The `, /* @__PURE__ */ (0, import_react2.mdx)("strong", {
    parentName: "p"
  }, `Everywhere`), ` button is used to replace all the occurrences corresponding to the search criteria directly in the open method.`), /* @__PURE__ */ (0, import_react2.mdx)("h2", {
    ...{
      "id": "goto-definition"
    }
  }, `Goto Definition`), /* @__PURE__ */ (0, import_react2.mdx)("p", null, `The `, /* @__PURE__ */ (0, import_react2.mdx)("strong", {
    parentName: "p"
  }, `Goto Definition`), ` command opens the definition of an element referenced in the Code Editor. To do this, place the cursor inside the object name or select it, and choose `, /* @__PURE__ */ (0, import_react2.mdx)("strong", {
    parentName: "p"
  }, `Method`), ` > `, /* @__PURE__ */ (0, import_react2.mdx)("strong", {
    parentName: "p"
  }, `Goto Definition...`), ` or use the context menu of the editor.`), /* @__PURE__ */ (0, import_react2.mdx)("p", null, /* @__PURE__ */ (0, import_react2.mdx)("strong", {
    parentName: "p"
  }, `Note:`), ` This feature is also available through the keyboard shortcut `, /* @__PURE__ */ (0, import_react2.mdx)("strong", {
    parentName: "p"
  }, `Ctrl+K`), ` (Windows) or `, /* @__PURE__ */ (0, import_react2.mdx)("strong", {
    parentName: "p"
  }, `Command+K`), ` (macOS).`), /* @__PURE__ */ (0, import_react2.mdx)("p", null, `The effect varies depending on the target element. For example:`), /* @__PURE__ */ (0, import_react2.mdx)("ul", null, /* @__PURE__ */ (0, import_react2.mdx)("li", {
    parentName: "ul"
  }, `Selecting a project method and choosing `, /* @__PURE__ */ (0, import_react2.mdx)("strong", {
    parentName: "li"
  }, `Goto Definition...`), ` displays the contents of the method in a new window of the Code Editor`), /* @__PURE__ */ (0, import_react2.mdx)("li", {
    parentName: "ul"
  }, `Selecting a class name or class attribute and choosing `, /* @__PURE__ */ (0, import_react2.mdx)("strong", {
    parentName: "li"
  }, `Goto Definition...`), ` opens the class in the the Code Editor`)), /* @__PURE__ */ (0, import_react2.mdx)("h2", {
    ...{
      "id": "reveal-in-explorer"
    }
  }, `Reveal in Explorer`), /* @__PURE__ */ (0, import_react2.mdx)("p", null, `The `, /* @__PURE__ */ (0, import_react2.mdx)("strong", {
    parentName: "p"
  }, `Reveal in Explorer...`), ` command opens an Explorer window with the target element selected. To do this, place the cursor inside the element's name or select it, then choose `, /* @__PURE__ */ (0, import_react2.mdx)("strong", {
    parentName: "p"
  }, `Method`), ` > `, /* @__PURE__ */ (0, import_react2.mdx)("strong", {
    parentName: "p"
  }, `Reveal in Explorer...`), ` .`), /* @__PURE__ */ (0, import_react2.mdx)("h2", {
    ...{
      "id": "show-documentation"
    }
  }, `Show documentation`), /* @__PURE__ */ (0, import_react2.mdx)("p", null, `The `, /* @__PURE__ */ (0, import_react2.mdx)("strong", {
    parentName: "p"
  }, `Show documentation...`), ` command opens the documentation for the target element. To do this, place the cursor inside the element's name or select it, then choose `, /* @__PURE__ */ (0, import_react2.mdx)("strong", {
    parentName: "p"
  }, `Method`), ` > `, /* @__PURE__ */ (0, import_react2.mdx)("strong", {
    parentName: "p"
  }, `Show documentation...`), ` or use the contextual menu. The effect varies depending on the target element. For example:`), /* @__PURE__ */ (0, import_react2.mdx)("ul", null, /* @__PURE__ */ (0, import_react2.mdx)("li", {
    parentName: "ul"
  }, `Selecting a project method or a user class and choosing `, /* @__PURE__ */ (0, import_react2.mdx)("strong", {
    parentName: "li"
  }, `Show documentation...`), ` selects the method in the Explorer and switches to the documentation tab`), /* @__PURE__ */ (0, import_react2.mdx)("li", {
    parentName: "ul"
  }, `Selecting a 4D command or a 4D class name and choosing `, /* @__PURE__ */ (0, import_react2.mdx)("strong", {
    parentName: "li"
  }, `Show documentation...`), ` displays the online documentation`)), /* @__PURE__ */ (0, import_react2.mdx)("p", null, `If no element is selected, the command opens the documentation of the method currently opened in the Code Editor.`), /* @__PURE__ */ (0, import_react2.mdx)("h2", {
    ...{
      "id": "search-references"
    }
  }, `Search references`), /* @__PURE__ */ (0, import_react2.mdx)("p", null, `The `, /* @__PURE__ */ (0, import_react2.mdx)("strong", {
    parentName: "p"
  }, `Search references...`), ` command found in the `, /* @__PURE__ */ (0, import_react2.mdx)("strong", {
    parentName: "p"
  }, `Method`), ` menu or the context menu of the Code Editor finds all the objects (methods and forms) in the database where the current item of the method is referenced (used).`), /* @__PURE__ */ (0, import_react2.mdx)("p", null, `The current item is either the one selected or the one where the cursor is located. It can be a field name, variable name, command, string, and so on. For example, the following action looks for all the occurrences of the `, /* @__PURE__ */ (0, import_react2.mdx)("em", {
    parentName: "p"
  }, `vlNbCmd`), ` variable in the database:`), /* @__PURE__ */ (0, import_react2.mdx)("p", null, /* @__PURE__ */ (0, import_react2.mdx)("img", {
    alt: "find-dialog",
    src: (__webpack_require__(68703)/* ["default"] */ .Z),
    width: "344",
    height: "86"
  })), /* @__PURE__ */ (0, import_react2.mdx)("p", null, `This command displays its results in a new window.`), /* @__PURE__ */ (0, import_react2.mdx)("h2", {
    ...{
      "id": "search-callers"
    }
  }, `Search Callers`), /* @__PURE__ */ (0, import_react2.mdx)("p", null, `The `, /* @__PURE__ */ (0, import_react2.mdx)("strong", {
    parentName: "p"
  }, `Search Callers`), ` command in the `, /* @__PURE__ */ (0, import_react2.mdx)("strong", {
    parentName: "p"
  }, `Method`), ` menu is only enabled for project methods. It searches for all the objects (other methods or menus) that reference the project method.`), /* @__PURE__ */ (0, import_react2.mdx)("p", null, /* @__PURE__ */ (0, import_react2.mdx)("strong", {
    parentName: "p"
  }, `Note:`), ` The `, /* @__PURE__ */ (0, import_react2.mdx)("strong", {
    parentName: "p"
  }, `Search Callers...`), ` command is also available in `, /* @__PURE__ */ (0, import_react2.mdx)("strong", {
    parentName: "p"
  }, `Explorer`), ` > `, /* @__PURE__ */ (0, import_react2.mdx)("strong", {
    parentName: "p"
  }, `Methods`)), /* @__PURE__ */ (0, import_react2.mdx)("p", null, `This command displays its results in a new window.`), /* @__PURE__ */ (0, import_react2.mdx)("h2", {
    ...{
      "id": "goto-line"
    }
  }, `Goto Line`), /* @__PURE__ */ (0, import_react2.mdx)("p", null, `This specific search command is located in the `, /* @__PURE__ */ (0, import_react2.mdx)("strong", {
    parentName: "p"
  }, `Method`), ` menu. It opens a dialog box where you can indicate the line number you want to find. When you click `, /* @__PURE__ */ (0, import_react2.mdx)("strong", {
    parentName: "p"
  }, `OK`), `, the editor finds and highlights that line in the method. This type of search is useful when used in conjunction with the compiler, which flags runtime errors by the line number in which they occur.`), /* @__PURE__ */ (0, import_react2.mdx)("p", null, `You can choose whether or not to display lines numbers in the Code Editor window. This option is described in the `, /* @__PURE__ */ (0, import_react2.mdx)("a", {
    parentName: "p",
    ...{
      "href": "/docs/es/code-editor/write-class-method#using-bookmarks"
    }
...
/* harmony export */   "Z": () => (__WEBPACK_DEFAULT_EXPORT__)
/* harmony export */ });
/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = (__webpack_require__.p + "assets/images/find-replace-1-c76fdfb3428a4b3dccc55ce935a9fb67.png");
