...
const metadata = {
  ...
  "id": "version-19/API/DataStoreClass",
  "title": "DataStore",
  ...
  "source": "@site/versioned_docs/version-19/API/DataStoreClass.md",
  "sourceDirName": "API",
  "slug": "/API/DataStoreClass",
  "permalink": "/docs/es/19/API/DataStoreClass",
  "draft": false,
  "tags": [],
  "version": "19",
  "frontMatter": {
  ...
  "previous": {
    ...
    "permalink": "/docs/es/19/API/DataClassAttributeClass"
  },
  "next": {
    "title": "Email",
    "permalink": "/docs/es/19/API/EmailObjectClass"
  }
};
const assets = {};
const toc = [{
...
function MDXContent({
  ...
  return /* @__PURE__ */ (0, import_react2.mdx)(MDXLayout, {
    ...
    parentName: "p",
    ...{
      "href": "/docs/es/19/ORDA/dsmapping#datastore"
    }
    ...
    parentName: "p"
  }, `Null`), `.`), /* @__PURE__ */ (0, import_react2.mdx)("p", null, `Using `, /* @__PURE__ */ (0, import_react2.mdx)("inlineCode", {
    parentName: "p"
  }, `ds`), ` requires that the target database is compliant with ORDA, as specified in the `, /* @__PURE__ */ (0, import_react2.mdx)("strong", {
    parentName: "p"
  }, `ORDA prerequisites`), ` section. The following rules are applied:`), /* @__PURE__ */ (0, import_react2.mdx)("ul", null, /* @__PURE__ */ (0, import_react2.mdx)("li", {
    parentName: "ul"
  }, `A datastore only references tables with a single primary key. Tables without a primary key or with composite primary keys are not referenced.`), /* @__PURE__ */ (0, import_react2.mdx)("li", {
    parentName: "ul"
  }, `BLOB type attributes are not managed in the datastore.`)), /* @__PURE__ */ (0, import_react2.mdx)("h4", {
    ...{
      "id": "example-1"
    }
...
`)), /* @__PURE__ */ (0, import_react2.mdx)("h2", {
    ...
    parentName: "li",
    ...{
      "href": "/docs/es/19/REST/configuration#starting-the-rest-server"
    }
    ...
    parentName: "p"
  }, `localID`), ` session is created when the datastore object is used.`), /* @__PURE__ */ (0, import_react2.mdx)("p", null, `Once the session is opened, the following statements become equivalent and return a reference on the same datastore object:`), /* @__PURE__ */ (0, import_react2.mdx)("pre", null, /* @__PURE__ */ (0, import_react2.mdx)("code", {
    parentName: "pre",
    ...{
      "className": "language-4d"
    }
...
`)), /* @__PURE__ */ (0, import_react2.mdx)("h2", {
    ...
    parentName: "p",
    ...{
      "href": "/docs/es/19/Admin/dataExplorer"
    }
    ...
    parentName: "p",
    ...{
      "href": "/docs/es/19/ORDA/datastores"
    }
    ...
    parentName: "p",
    ...{
      "href": "/docs/es/19/ORDA/entities#shareable-or-non-shareable-entity-selections"
    }
...
`)), /* @__PURE__ */ (0, import_react2.mdx)("h2", {
    ...
    parentName: "p",
    ...{
      "href": "/docs/es/19/Admin/webAdmin#http-port"
    }
    ...
    parentName: "p",
    ...{
      "href": "/docs/es/19/Admin/webAdmin#access-key"
    }
