...
const metadata = {
  ...
  "id": "version-18/FormObjects/propertiesSubform",
  "title": "Subform",
  "description": "---",
  "source": "@site/versioned_docs/version-18/FormObjects/properties_Subform.md",
...
function MDXContent({
  ...
  return /* @__PURE__ */ (0, import_react2.mdx)(MDXLayout, {
    ...
    parentName: "p",
    ...{
      "href": "/docs/es/18/Concepts/components"
    }
    ...
    parentName: "ul"
  }, `Add Record: Creates a new record in the subform and changes to editing mode. The record will be created directly in the list if the `, `[Enterable in List]`, ` property is enabled. Otherwise, it will be created in page mode, in the `, /* @__PURE__ */ (0, import_react2.mdx)("a", {
    parentName: "li",
    ...{
      "href": "detail-form"
    }
    ...
    parentName: "li",
    ...{
      "href": "/docs/es/18/FormObjects/subformOverview#enterable-in-list"
    }
