...
function MDXContent({
  ...
  return /* @__PURE__ */ (0, import_react2.mdx)(MDXLayout, {
    ...
    src: (__webpack_require__(22574)/* ["default"] */ .Z),
    width: "523",
    height: "448"
  ...
  }, `Creating the log file`), /* @__PURE__ */ (0, import_react2.mdx)("p", null, `By default, any application project created with 4D uses a log file (option set in the `, /* @__PURE__ */ (0, import_react2.mdx)("strong", {
    parentName: "p"
  }, `General`), ` page of the Preferences). The log file is named `, /* @__PURE__ */ (0, import_react2.mdx)("em", {
    parentName: "p"
  }, `data.journal`), ` and is placed in the Data folder.`), /* @__PURE__ */ (0, import_react2.mdx)("p", null, `You can find out if your application uses a log file at any time: just check whether the `, /* @__PURE__ */ (0, import_react2.mdx)("strong", {
    parentName: "p"
  }, `Use Log`), ` option is selected on the `, /* @__PURE__ */ (0, import_react2.mdx)("strong", {
    parentName: "p"
  }, `Backup/Configuration`), ` page of the Settings. If you deselected this option, or if you use an application without a log file and wish to set up a backup strategy with a log file, you will have to create one.`), /* @__PURE__ */ (0, import_react2.mdx)("p", null, `To create a log file:`), /* @__PURE__ */ (0, import_react2.mdx)("ol", null, /* @__PURE__ */ (0, import_react2.mdx)("li", {
    parentName: "ol"
  }, /* @__PURE__ */ (0, import_react2.mdx)("p", {
    parentName: "li"
  }, `On the `, /* @__PURE__ */ (0, import_react2.mdx)("strong", {
    parentName: "p"
  }, `Backup/Configuration`), ` page of the Structure Settings, check the `, /* @__PURE__ */ (0, import_react2.mdx)("strong", {
    parentName: "p"
  }, `Use Log`), ` option.
...
If you have at least two hard drives, it is recommended that you place the log file on a disk other than the one containing the application project. If the application hard drive is lost, you can still recall your log file.`)), /* @__PURE__ */ (0, import_react2.mdx)("li", {
    parentName: "ol"
  }, /* @__PURE__ */ (0, import_react2.mdx)("p", {
    parentName: "li"
...
The disk and the name of the open log file are now displayed in the `, /* @__PURE__ */ (0, import_react2.mdx)("strong", {
    ...
    parentName: "li"
  }, `Validate the Settings dialog box.`))), /* @__PURE__ */ (0, import_react2.mdx)("p", null, `In order for you to be able to create a log file directly, the data must be in one of the following situations:`), /* @__PURE__ */ (0, import_react2.mdx)("ul", null, /* @__PURE__ */ (0, import_react2.mdx)("li", {
    parentName: "ul"
    ...
    parentName: "p"
  }, `Backup/Configuration`), ` page of the Settings.`), /* @__PURE__ */ (0, import_react2.mdx)("p", null, `4D then displays an alert message to remind you that this action prevents you from taking advantage of the security that the log file provides:`), /* @__PURE__ */ (0, import_react2.mdx)("p", null, /* @__PURE__ */ (0, import_react2.mdx)("img", {
    src: (__webpack_require__(5941)/* ["default"] */ .Z),
    width: "482",
    height: "188"
  })), /* @__PURE__ */ (0, import_react2.mdx)("p", null, `If you click `, /* @__PURE__ */ (0, import_react2.mdx)("strong", {
    parentName: "p"
  }, `Stop`), `, the current log file is immediately closed (the Settings dialog box does not need to be validated afterwards).`), /* @__PURE__ */ (0, import_react2.mdx)("p", null, `If you wish to close the current log file because it is too large, you might consider performing a data file backup, which will cause the log file to be backed up as well.`), /* @__PURE__ */ (0, import_react2.mdx)("blockquote", null, /* @__PURE__ */ (0, import_react2.mdx)("p", {
