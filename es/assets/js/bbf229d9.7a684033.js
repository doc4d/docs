...
const metadata = {
  ...
  "id": "version-18/FormObjects/propertiesDisplay",
  "title": "Display",
  "description": "---",
  "source": "@site/versioned_docs/version-18/FormObjects/properties_Display.md",
  ...
  "next": {
    "title": "Entry",
    "permalink": "/docs/es/18/FormObjects/propertiesEntry"
  }
};
const assets = {};
const toc = [{
...
function MDXContent({
  ...
  return /* @__PURE__ */ (0, import_react2.mdx)(MDXLayout, {
    ...
    src: (__webpack_require__(53027)/* ["default"] */ .Z),
    width: "155",
    height: "98"
...
Any custom formats or filters that you have created are automatically available, preceded by a vertical bar (|).`), /* @__PURE__ */ (0, import_react2.mdx)("p", null, `The number sign (#) is the placeholder for an alphanumeric display format. You can include the appropriate dashes, hyphens, spaces, and any other punctuation marks that you want to display. You use the actual punctuation marks you want and the number sign for each character you want to display.`), /* @__PURE__ */ (0, import_react2.mdx)("p", null, `For example, consider a part number with a format such as "RB-1762-1".`), /* @__PURE__ */ (0, import_react2.mdx)("p", null, `The alpha format would be:`), /* @__PURE__ */ (0, import_react2.mdx)("p", null, ` ##-####-#`), /* @__PURE__ */ (0, import_react2.mdx)("p", null, `When the user enters "RB17621," the field displays:`), /* @__PURE__ */ (0, import_react2.mdx)("p", null, ` RB-1762-1`), /* @__PURE__ */ (0, import_react2.mdx)("p", null, `The field actually contains "RB17621".`), /* @__PURE__ */ (0, import_react2.mdx)("p", null, `If the user enters more characters than the format allows, 4D displays the last characters. For example, if the format is:`), /* @__PURE__ */ (0, import_react2.mdx)("p", null, ` (#######)`), /* @__PURE__ */ (0, import_react2.mdx)("p", null, `and the user enters "proportion", the field displays:`), /* @__PURE__ */ (0, import_react2.mdx)("p", null, ` (portion)`), /* @__PURE__ */ (0, import_react2.mdx)("p", null, `The field actually contains "proportion". 4D accepts and stores the entire entry no matter what the display format. No information is lost.`), /* @__PURE__ */ (0, import_react2.mdx)("h4", {
    ...
    src: (__webpack_require__(7204)/* ["default"] */ .Z),
    width: "212",
    height: "198"
    ...
    src: (__webpack_require__(53872)/* ["default"] */ .Z),
    width: "429",
    height: "221"
  })), /* @__PURE__ */ (0, import_react2.mdx)("h3", {
    ...{
    ...
    src: (__webpack_require__(83049)/* ["default"] */ .Z),
    width: "447",
    height: "214"
  })), /* @__PURE__ */ (0, import_react2.mdx)("h3", {
    ...{
    ...
    src: (__webpack_require__(59218)/* ["default"] */ .Z),
    width: "663",
    height: "273"
    ...
    parentName: "td"
  }, `number columns`), `: "automatic" (default) or "checkbox"`, /* @__PURE__ */ (0, import_react2.mdx)("br", null), /* @__PURE__ */ (0, import_react2.mdx)("strong", {
    parentName: "td"
    ...
    src: (__webpack_require__(37549)/* ["default"] */ .Z),
    width: "137",
    height: "144"
    ...
    src: (__webpack_require__(78350)/* ["default"] */ .Z),
    width: "135",
    height: "143"
    ...
    parentName: "p",
    ...{
      "href": "https://doc.4d.com/4dv18/help/command/en/page603.html"
    }
  }, /* @__PURE__ */ (0, import_react2.mdx)("inlineCode", {
    parentName: "a"
  ...
  }, `Automatic visibility in list forms`), /* @__PURE__ */ (0, import_react2.mdx)("p", null, `In the context of list forms, the Visibility property supports two specific values:`), /* @__PURE__ */ (0, import_react2.mdx)("ul", null, /* @__PURE__ */ (0, import_react2.mdx)("li", {
    parentName: "ul"
  }, /* @__PURE__ */ (0, import_react2.mdx)("strong", {
    parentName: "li"
    ...
    src: (__webpack_require__(62743)/* ["default"] */ .Z),
    width: "446",
    height: "319"
    ...
    parentName: "p",
    ...{
      "href": "/docs/es/18/FormObjects/viewProAreaOverview"
    }
  }, `4D View Pro area`), ` - `, /* @__PURE__ */ (0, import_react2.mdx)("a", {
    parentName: "p",
    ...{
      "href": "/docs/es/18/FormObjects/writeProAreaOverview"
    }
    ...
    src: (__webpack_require__(71238)/* ["default"] */ .Z),
    width: "327",
    height: "165"
    ...
    src: (__webpack_require__(49339)/* ["default"] */ .Z),
    width: "327",
    height: "167"
    ...
    src: (__webpack_require__(22138)/* ["default"] */ .Z),
    width: "419",
    height: "206"
    ...
    src: (__webpack_require__(85679)/* ["default"] */ .Z),
    width: "419",
    height: "74"
  })), /* @__PURE__ */ (0, import_react2.mdx)("h4", {
    ...{
    ...
    src: (__webpack_require__(63946)/* ["default"] */ .Z),
    width: "327",
    height: "168"
  })), /* @__PURE__ */ (0, import_react2.mdx)("h4", {
    ...{
