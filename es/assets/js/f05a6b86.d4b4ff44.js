...
const metadata = {
  ...
  "id": "version-18/MSC/restore",
  "title": "Restore Page",
  "description": "Restoring a backup",
  "source": "@site/versioned_docs/version-18/MSC/restore.md",
  "sourceDirName": "MSC",
  "slug": "/MSC/restore",
  ...
  "previous": {
    "title": "Rollback Page",
    "permalink": "/docs/es/18/MSC/rollback"
  },
  "next": {
    "title": "Repair Page",
...
function MDXContent({
  ...
  return /* @__PURE__ */ (0, import_react2.mdx)(MDXLayout, {
  ...
  }, `Restoring a backup`), /* @__PURE__ */ (0, import_react2.mdx)("p", null, `You can manually restore an archive of the current database using the `, /* @__PURE__ */ (0, import_react2.mdx)("strong", {
    parentName: "p"
  }, `Restore`), ` page. This page provides several options that can be used to control the database restoration:`), /* @__PURE__ */ (0, import_react2.mdx)("p", null, /* @__PURE__ */ (0, import_react2.mdx)("img", {
    src: (__webpack_require__(23534)/* ["default"] */ .Z),
    width: "882",
    height: "666"
  })), /* @__PURE__ */ (0, import_react2.mdx)("blockquote", null, /* @__PURE__ */ (0, import_react2.mdx)("p", {
    parentName: "blockquote"
  }, `4D automatic recovery systems restore databases and include data log file when necessary.`)), /* @__PURE__ */ (0, import_react2.mdx)("p", null, `The list found in the left part of the window displays any existing backups of the database. You can also click on the Browse... button found just under the area in order to open any other archive file from a different location. It is then added to the list of archives.`), /* @__PURE__ */ (0, import_react2.mdx)("p", null, `When you select a backup in this list, the right part of the window displays the information concerning this particular backup:`), /* @__PURE__ */ (0, import_react2.mdx)("ul", null, /* @__PURE__ */ (0, import_react2.mdx)("li", {
    parentName: "ul"
    ...
    parentName: "li"
  }, `Destination folder of the restored files`), `: Folder where the restored files will be placed. By default, 4D restores the files in a folder named \u201CArchivename\u201D (no extension) that is placed next to the database structure file. To change this location, click on `, /* @__PURE__ */ (0, import_react2.mdx)("strong", {
    parentName: "li"
  ...
  }, `New database`), /* @__PURE__ */ (0, import_react2.mdx)("td", {
    parentName: "tr",
    ...{
      "align": null
    }
