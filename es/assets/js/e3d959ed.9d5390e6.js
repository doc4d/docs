...
const metadata = {
  ...
  "source": "@site/docs/settings/web.md",
  "sourceDirName": "settings",
  "slug": "/settings/web",
  "permalink": "/docs/es/next/settings/web",
  "draft": false,
  "tags": [],
  "version": "current",
  "frontMatter": {
  ...
  "previous": {
    ...
    "permalink": "/docs/es/next/settings/client-server"
  },
  "next": {
    "title": "SQL page",
    "permalink": "/docs/es/next/settings/sql"
  }
};
const assets = {};
const toc = [{
...
function MDXContent({
  ...
  return /* @__PURE__ */ (0, import_react2.mdx)(MDXLayout, {
    ...
    parentName: "p",
    ...{
      "href": "/docs/es/next/WebServer/overview"
    }
    ...
    parentName: "p",
    ...{
      "href": "/docs/es/next/WebServer/webServerAdmin#starting-the-4d-web-server"
    }
    ...
    parentName: "p",
    ...{
      "href": "/docs/es/next/WebServer/webServerConfig#enable-http"
    }
    ...
    parentName: "p",
    ...{
      "href": "/docs/es/next/WebServer/webServerConfig#http-port"
    }
    ...
    parentName: "p",
    ...{
      "href": "/docs/es/next/WebServer/webServerConfig#ip-address-to-listen"
    }
    ...
    parentName: "p",
    ...{
      "href": "/docs/es/next/WebServer/webServerConfig#https-port"
    }
    ...
    parentName: "p",
    ...{
      "href": "/docs/es/next/WebServer/webServerConfig#deprecated-settings"
    }
    ...
    parentName: "p",
    ...{
      "href": "/docs/es/next/WebServer/webServerConfig#root-folder"
    }
    ...
    parentName: "p",
    ...{
      "href": "/docs/es/next/WebServer/webServerConfig#default-home-page"
    }
    ...
    parentName: "p",
    ...{
      "href": "/docs/es/next/WebServer/webServerConfig#cache"
    }
  }, `Cache`), `.`), /* @__PURE__ */ (0, import_react2.mdx)("h4", {
    ...{
      "id": "pages-cache-size"
...
To do so, you just have to click on the `, /* @__PURE__ */ (0, import_react2.mdx)("strong", {
    ...
    parentName: "p",
    ...{
      "href": "/docs/es/next/WebServer/webServerAdmin#4dcacheclear"
    }
    ...
    parentName: "p",
    ...{
      "href": "/docs/es/next/WebServer/webServerConfig#keep-session"
    }
    ...
    parentName: "p",
    ...{
      "href": "/docs/es/next/WebServer/webServerConfig#maximum-concurrent-web-processes"
    }
    ...
    parentName: "p",
    ...{
      "href": "/docs/es/next/WebServer/webServerConfig#reuse-temporary-contexts-in-remote-mode"
    }
    ...
    parentName: "p",
    ...{
      "href": "/docs/es/next/WebServer/preemptiveWeb"
    }
    ...
    parentName: "p",
    ...{
      "href": "/docs/es/next/WebServer/preemptiveWeb#enabling-the-preemptive-mode-for-the-web-server"
    }
    ...
    parentName: "p",
    ...{
      "href": "/docs/es/next/WebServer/webServerConfig#inactive-process-timeout"
    }
...
Passwords with DIGEST protocol`), /* @__PURE__ */ (0, import_react2.mdx)("p", null, `Using `, /* @__PURE__ */ (0, import_react2.mdx)("strong", {
    ...
    parentName: "p",
    ...{
      "href": "/docs/es/next/WebServer/authentication"
    }
    ...
    parentName: "p",
    ...{
      "href": "/docs/es/next/WebServer/webServerConfig#character-set"
    }
    ...
    parentName: "p",
    ...{
      "href": "/docs/es/next/WebServer/webServerConfig#keep-alive-connections"
    }
    ...
    parentName: "p",
    ...{
      "href": "/docs/es/next/WebServer/webServerConfig#enable-cors-service"
    }
    ...
    parentName: "p",
    ...{
      "href": "/docs/es/next/WebServer/webServerConfig#cors-settings"
    }
    ...
    parentName: "p",
    ...{
      "href": "/docs/es/next/WebServer/webServerConfig#log-recording"
    }
...
When you choose the ELF (Extended Log Format) or WLF (WebStar Log Format) format, the "Weg Log Token Selection" area displays the fields available for the chosen format. You will need to select each field to be included in the log. To do so, use the arrow buttons or simply drag and drop the desired fields into the "Selected Tokens" area.`), /* @__PURE__ */ (0, import_react2.mdx)("p", null, /* @__PURE__ */ (0, import_react2.mdx)("strong", {
    ...
    parentName: "p",
    ...{
      "href": "/docs/es/next/REST/configuration"
    }
    ...
    parentName: "p",
    ...{
      "href": "/docs/es/next/REST/configuration#configuring-rest-access"
    }
