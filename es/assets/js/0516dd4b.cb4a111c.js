...
const metadata = {
  ...
  "id": "version-18/REST/{dataClass}",
  "title": "{dataClass}",
  "description": "Dataclass names can be used directly in the REST requests to work with entities, entity selections, or methods of the dataclass.",
  "source": "@site/versioned_docs/version-18/REST/{dataClass}.md",
  "sourceDirName": "REST",
  "slug": "/REST/{dataClass}",
  "permalink": "/docs/es/18/REST/{dataClass}",
  "draft": false,
  "tags": [],
  "version": "18",
  "frontMatter": {
  ...
  "previous": {
    "title": "$upload",
    "permalink": "/docs/es/18/REST/upload"
  },
  "next": {
    "title": "$asArray",
    "permalink": "/docs/es/18/REST/asArray"
  }
};
const assets = {};
const toc = [{
  ...
  value: "{dataClass}/{method} and {dataClass}({key})/{method}",
  id: "dataclassmethod-and-dataclasskeymethod",
  level: 2
}, {
  value: "Description",
  id: "description-3",
  ...
  value: "4D Configuration",
  id: "4d-configuration",
  level: 3
}, {
  value: "Passing Parameters to a Method",
  id: "passing-parameters-to-a-method",
  level: 3
}, {
  value: "Examples",
  id: "examples",
  ...
  value: "Current record scope",
  id: "current-record-scope",
  level: 4
}, {
  value: "Current selection scope",
  id: "current-selection-scope",
  level: 4
}];
const layoutProps = {
  toc
...
function MDXContent({
  ...
  return /* @__PURE__ */ (0, import_react2.mdx)(MDXLayout, {
    ...
    components,
    mdxType: "MDXLayout"
  }, /* @__PURE__ */ (0, import_react2.mdx)("p", null, `Dataclass names can be used directly in the REST requests to work with entities, entity selections, or methods of the dataclass.`), /* @__PURE__ */ (0, import_react2.mdx)("h2", {
    ...{
      "id": "available-syntaxes"
    }
    ...
    parentName: "td",
    ...{
      "href": "#dataclassmethod-and-dataclasskeymethod"
    }
  }, /* @__PURE__ */ (0, import_react2.mdx)("strong", {
    parentName: "a"
  }, `{dataClass}/{method}`))), /* @__PURE__ */ (0, import_react2.mdx)("td", {
    parentName: "tr",
    ...{
      "align": null
    }
    ...
    parentName: "td"
  }, `/Employee/getHighSalaries`)), /* @__PURE__ */ (0, import_react2.mdx)("td", {
    parentName: "tr",
    ...{
      "align": null
    }
  }, `Executes a project method and returns an object or a collection (the project method must be exposed)`)), /* @__PURE__ */ (0, import_react2.mdx)("tr", {
    parentName: "tbody"
  }, /* @__PURE__ */ (0, import_react2.mdx)("td", {
    parentName: "tr",
    ...{
    ...
    parentName: "a"
  }, `{dataClass}({key})/{method}`))), /* @__PURE__ */ (0, import_react2.mdx)("td", {
    parentName: "tr",
    ...{
      "align": null
    }
    ...
    parentName: "td"
  }, `/Employee(22)/getAge`)), /* @__PURE__ */ (0, import_react2.mdx)("td", {
    parentName: "tr",
    ...{
      "align": null
    }
  }, `Returns a value based on an entity method`)))), /* @__PURE__ */ (0, import_react2.mdx)("h2", {
    ...{
      "id": "dataclass"
    }
    ...
    parentName: "p",
    ...{
      "href": "/docs/es/18/REST/top_$limit"
    }
  }, /* @__PURE__ */ (0, import_react2.mdx)("inlineCode", {
    parentName: "a"
    ...
    parentName: "p",
    ...{
      "href": "/docs/es/18/REST/manData##selecting-attributes-to-get"
    }
...
`)), /* @__PURE__ */ (0, import_react2.mdx)("h2", {
    ...
    parentName: "p",
    ...{
      "href": "/docs/es/18/REST/attributes"
    }
    ...
    parentName: "p"
  }, `GET  /rest/Employee:lastname(Jones)`)), /* @__PURE__ */ (0, import_react2.mdx)("h2", {
    ...{
      "id": "dataclassmethod-and-dataclasskeymethod"
    }
  }, `{dataClass}/{method} and {dataClass}({key})/{method}`), /* @__PURE__ */ (0, import_react2.mdx)("p", null, `Returns an object or a collection based on a project method.`), /* @__PURE__ */ (0, import_react2.mdx)("h3", {
    ...{
      "id": "description-3"
    }
  }, `Description`), /* @__PURE__ */ (0, import_react2.mdx)("p", null, `Project methods are called through a dataclass (table) or an entity (record), and must return either an object or a collection.`), /* @__PURE__ */ (0, import_react2.mdx)("p", null, /* @__PURE__ */ (0, import_react2.mdx)("inlineCode", {
    parentName: "p"
  }, `POST  /rest/Employee/getHighSalaries`)), /* @__PURE__ */ (0, import_react2.mdx)("p", null, /* @__PURE__ */ (0, import_react2.mdx)("inlineCode", {
    parentName: "p"
  }, `POST  /rest/Employee(52)/getFullName`)), /* @__PURE__ */ (0, import_react2.mdx)("h3", {
    ...{
      "id": "4d-configuration"
    }
  }, `4D Configuration`), /* @__PURE__ */ (0, import_react2.mdx)("p", null, `To be called in a REST request, a method must:`), /* @__PURE__ */ (0, import_react2.mdx)("ul", null, /* @__PURE__ */ (0, import_react2.mdx)("li", {
    parentName: "ul"
  }, `have been declared as "Available through REST server" in 4D,`), /* @__PURE__ */ (0, import_react2.mdx)("li", {
    parentName: "ul"
  }, `have its master table and scope defined accordingly:`, /* @__PURE__ */ (0, import_react2.mdx)("ul", {
    parentName: "li"
  }, /* @__PURE__ */ (0, import_react2.mdx)("li", {
    parentName: "ul"
  }, /* @__PURE__ */ (0, import_react2.mdx)("strong", {
    parentName: "li"
  }, `Table`), `: 4D table (i.e. dataclass) on which the method is called. The table must be `, /* @__PURE__ */ (0, import_react2.mdx)("a", {
    parentName: "li",
    ...{
      "href": "/docs/es/18/REST/configuration#exposing-tables-and-fields"
    }
  }, `exposed to REST`), `.`), /* @__PURE__ */ (0, import_react2.mdx)("li", {
    parentName: "ul"
  }, /* @__PURE__ */ (0, import_react2.mdx)("strong", {
    parentName: "li"
  }, `Scope`), `: This setting is useful when the method uses the 4D classic language and thus, needs to have a database context on the server side.`, /* @__PURE__ */ (0, import_react2.mdx)("ul", {
    parentName: "li"
  }, /* @__PURE__ */ (0, import_react2.mdx)("li", {
    parentName: "ul"
  }, /* @__PURE__ */ (0, import_react2.mdx)("strong", {
    parentName: "li"
  }, `Table`), ` -for methods applied to the whole table (dataclass)`), /* @__PURE__ */ (0, import_react2.mdx)("li", {
    parentName: "ul"
  }, /* @__PURE__ */ (0, import_react2.mdx)("strong", {
    parentName: "li"
  }, `Current record`), ` -for methods applied to the current record (entity) using the `, /* @__PURE__ */ (0, import_react2.mdx)("inlineCode", {
    parentName: "li"
  }, `{dataClass}(key)/{method}`), ` syntax.`), /* @__PURE__ */ (0, import_react2.mdx)("li", {
    parentName: "ul"
  }, /* @__PURE__ */ (0, import_react2.mdx)("strong", {
    parentName: "li"
  }, `Current selection`), ` -for methods applied to the current selection`)))))), /* @__PURE__ */ (0, import_react2.mdx)("p", null, /* @__PURE__ */ (0, import_react2.mdx)("img", {
    alt: "alt-text",
    src: (__webpack_require__(70580)/* ["default"] */ .Z),
    width: "552",
    height: "557"
  ...
  }, `Passing Parameters to a Method`), /* @__PURE__ */ (0, import_react2.mdx)("p", null, `You can also pass parameters to a method in a POST.`), /* @__PURE__ */ (0, import_react2.mdx)("p", null, /* @__PURE__ */ (0, import_react2.mdx)("inlineCode", {
    parentName: "p"
  }, `POST  /rest/Employee/addEmployee`)), /* @__PURE__ */ (0, import_react2.mdx)("p", null, `You can POST data in the body part of the request, for example:`), /* @__PURE__ */ (0, import_react2.mdx)("p", null, `["John","Smith"]`), /* @__PURE__ */ (0, import_react2.mdx)("h3", {
    ...{
      "id": "examples"
    }
  ...
  }, `Table scope`), /* @__PURE__ */ (0, import_react2.mdx)("p", null, `Call of a `, /* @__PURE__ */ (0, import_react2.mdx)("inlineCode", {
    parentName: "p"
  }, `getAverage`), ` method:`), /* @__PURE__ */ (0, import_react2.mdx)("ul", null, /* @__PURE__ */ (0, import_react2.mdx)("li", {
    parentName: "ul"
  }, `on `, `[Employee]`, ` table`), /* @__PURE__ */ (0, import_react2.mdx)("li", {
    parentName: "ul"
  }, `with `, /* @__PURE__ */ (0, import_react2.mdx)("strong", {
    parentName: "li"
  }, `Table`), ` scope`)), /* @__PURE__ */ (0, import_react2.mdx)("pre", null, /* @__PURE__ */ (0, import_react2.mdx)("code", {
    parentName: "pre",
    ...{
...
`)), /* @__PURE__ */ (0, import_react2.mdx)("p", null, /* @__PURE__ */ (0, import_react2.mdx)("inlineCode", {
    parentName: "p"
  }, `POST  /rest/Employee/getAverage`)), /* @__PURE__ */ (0, import_react2.mdx)("p", null, `Result:`), /* @__PURE__ */ (0, import_react2.mdx)("pre", null, /* @__PURE__ */ (0, import_react2.mdx)("code", {
    parentName: "pre",
    ...{}
  }, `{
    "result": {
...
`)), /* @__PURE__ */ (0, import_react2.mdx)("h4", {
  ...
  }, `Current record scope`), /* @__PURE__ */ (0, import_react2.mdx)("p", null, `Call of a `, /* @__PURE__ */ (0, import_react2.mdx)("inlineCode", {
    parentName: "p"
  }, `getFullName`), ` method:`), /* @__PURE__ */ (0, import_react2.mdx)("ul", null, /* @__PURE__ */ (0, import_react2.mdx)("li", {
    parentName: "ul"
  }, `on `, `[Employee]`, ` table`), /* @__PURE__ */ (0, import_react2.mdx)("li", {
    parentName: "ul"
  }, `with `, /* @__PURE__ */ (0, import_react2.mdx)("strong", {
    parentName: "li"
  }, `Current record`), ` scope`)), /* @__PURE__ */ (0, import_react2.mdx)("pre", null, /* @__PURE__ */ (0, import_react2.mdx)("code", {
    parentName: "pre",
    ...{
      "className": "language-4d"
    }
...
`)), /* @__PURE__ */ (0, import_react2.mdx)("p", null, /* @__PURE__ */ (0, import_react2.mdx)("inlineCode", {
    parentName: "p"
  }, `POST  /rest/Employee(3)/getFullName`)), /* @__PURE__ */ (0, import_react2.mdx)("p", null, `Result:`), /* @__PURE__ */ (0, import_react2.mdx)("pre", null, /* @__PURE__ */ (0, import_react2.mdx)("code", {
    parentName: "pre",
    ...{}
  }, `{
    "result": {
...
`)), /* @__PURE__ */ (0, import_react2.mdx)("h4", {
  ...
  }, `Current selection scope`), /* @__PURE__ */ (0, import_react2.mdx)("p", null, `Call of a `, /* @__PURE__ */ (0, import_react2.mdx)("inlineCode", {
    parentName: "p"
  }, `updateSalary`), ` method:`), /* @__PURE__ */ (0, import_react2.mdx)("ul", null, /* @__PURE__ */ (0, import_react2.mdx)("li", {
    parentName: "ul"
  }, `on `, `[Employee]`, ` table`), /* @__PURE__ */ (0, import_react2.mdx)("li", {
    parentName: "ul"
  }, `with `, /* @__PURE__ */ (0, import_react2.mdx)("strong", {
    parentName: "li"
  }, `Current selection`), ` scope`)), /* @__PURE__ */ (0, import_react2.mdx)("pre", null, /* @__PURE__ */ (0, import_react2.mdx)("code", {
    parentName: "pre",
    ...{
      "className": "language-4d"
    }
...
`)), /* @__PURE__ */ (0, import_react2.mdx)("p", null, /* @__PURE__ */ (0, import_react2.mdx)("inlineCode", {
    parentName: "p"
  }, `POST  /rest/Employee/updateSalary/?$filter="salary<1500"`)), /* @__PURE__ */ (0, import_react2.mdx)("p", null, `POST data (in the request body):
`, `[1.5]`), /* @__PURE__ */ (0, import_react2.mdx)("p", null, `Result:`), /* @__PURE__ */ (0, import_react2.mdx)("pre", null, /* @__PURE__ */ (0, import_react2.mdx)("code", {
    parentName: "pre",
    ...{}
  }, `{
    "result": {
...
/* harmony export */ });
/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = (__webpack_require__.p + "assets/images/MethodProp-81c3e8a0e2bb72d44d9ac3e5d10d4a7f.png");
