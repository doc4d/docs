...
const metadata = {
  ...
  "id": "version-19-R6/FormEditor/stylesheets",
  "title": "Style sheets",
  "description": "A style sheet groups together a combination of attributes for form objects \u2014  from text attributes to nearly any available object attribute.",
  "source": "@site/versioned_docs/version-19-R6/FormEditor/createStylesheet.md",
  "sourceDirName": "FormEditor",
  "slug": "/FormEditor/stylesheets",
  "permalink": "/docs/es/FormEditor/stylesheets",
  "draft": false,
  "tags": [],
  "version": "19-R6",
  "frontMatter": {
  ...
  "previous": {
    ...
    "permalink": "/docs/es/FormEditor/forms"
  },
  "next": {
    "title": "Pictures",
...
function MDXContent({
  ...
  return /* @__PURE__ */ (0, import_react2.mdx)(MDXLayout, {
    ...
    parentName: "ul"
  }, `Controls multi-platform development: You can have a style sheets that apply to both macOS and Windows platforms, only macOS, or only Windows. When a style sheet is applied, 4D automatically uses the appropriate style sheet.`)), /* @__PURE__ */ (0, import_react2.mdx)("h2", {
    ...{
      "id": "creating-or-editing-style-sheets"
    }
    ...
    src: (__webpack_require__(95120)/* ["default"] */ .Z),
    width: "787",
    height: "582"
    ...
    src: (__webpack_require__(21859)/* ["default"] */ .Z),
    width: "116",
    height: "23"
  }))), /* @__PURE__ */ (0, import_react2.mdx)("li", {
    parentName: "ol"
    ...
    parentName: "li"
  }, `The style sheet will open in your default text editor.  `))), /* @__PURE__ */ (0, import_react2.mdx)("h2", {
    ...{
      "id": "style-sheet-files"
    }
  ...
  }, `For defining Windows only specific attribute styles`)))), /* @__PURE__ */ (0, import_react2.mdx)("p", null, `These files are stored in the project's "/SOURCES" folder. They can also be accessed directly via the `, /* @__PURE__ */ (0, import_react2.mdx)("a", {
    parentName: "p",
    ...{
      "href": "/docs/es/FormEditor/overview#css-preview"
    }
  }, `CSS Preview`), ` in the Form editor toobar.`), /* @__PURE__ */ (0, import_react2.mdx)("h2", {
    ...{
      "id": "style-sheet-architecture"
    }
  }, `Style Sheet Architecture`), /* @__PURE__ */ (0, import_react2.mdx)("p", null, `While adapted to meet the specific needs of 4D forms, style sheets for application projects generally follow CSS2 syntax and grammar.`), /* @__PURE__ */ (0, import_react2.mdx)("p", null, `Every style rule in a style sheet contains two parts:`), /* @__PURE__ */ (0, import_react2.mdx)("ul", null, /* @__PURE__ */ (0, import_react2.mdx)("li", {
    parentName: "ul"
  }, /* @__PURE__ */ (0, import_react2.mdx)("p", {
    parentName: "li"
...
`)), /* @__PURE__ */ (0, import_react2.mdx)("h2", {
  ...
  }, `Style Sheet Declarations`), /* @__PURE__ */ (0, import_react2.mdx)("h3", {
    ...{
      "id": "media-queries"
    }
  }, `Media Queries`), /* @__PURE__ */ (0, import_react2.mdx)("p", null, `Media queries are used to apply color schemes to an application.  `), /* @__PURE__ */ (0, import_react2.mdx)("p", null, `A media query is composed of a media feature and a value (e.g., `, /* @__PURE__ */ (0, import_react2.mdx)("inlineCode", {
    parentName: "p"
  }, `\\<media feature>:\\<value>`), ` ).`), /* @__PURE__ */ (0, import_react2.mdx)("p", null, `Available media features:`), /* @__PURE__ */ (0, import_react2.mdx)("ul", null, /* @__PURE__ */ (0, import_react2.mdx)("li", {
    parentName: "ul"
  }, /* @__PURE__ */ (0, import_react2.mdx)("inlineCode", {
    parentName: "li"
  }, `prefers-color-scheme`))), /* @__PURE__ */ (0, import_react2.mdx)("p", null, `Available media feature expressions:`), /* @__PURE__ */ (0, import_react2.mdx)("ul", null, /* @__PURE__ */ (0, import_react2.mdx)("li", {
    parentName: "ul"
  }, /* @__PURE__ */ (0, import_react2.mdx)("strong", {
    parentName: "li"
  }, `light`), /* @__PURE__ */ (0, import_react2.mdx)("br", null), `For using a light scheme`), /* @__PURE__ */ (0, import_react2.mdx)("li", {
    parentName: "ul"
  }, /* @__PURE__ */ (0, import_react2.mdx)("strong", {
    parentName: "li"
  }, `dark`), /* @__PURE__ */ (0, import_react2.mdx)("br", null), `For using a dark scheme`)), /* @__PURE__ */ (0, import_react2.mdx)("blockquote", null, /* @__PURE__ */ (0, import_react2.mdx)("p", {
    parentName: "blockquote"
  }, `Color schemes are only supported on macOS.`)), /* @__PURE__ */ (0, import_react2.mdx)("h5", {
    ...{
      "id": "example"
    }
  }, `Example`), /* @__PURE__ */ (0, import_react2.mdx)("p", null, `This CSS defines a color combination for text and text background in the light scheme (default) and another combination when the dark scheme is selected:`), /* @__PURE__ */ (0, import_react2.mdx)("pre", null, /* @__PURE__ */ (0, import_react2.mdx)("code", {
    parentName: "pre",
    ...{}
...
`)), /* @__PURE__ */ (0, import_react2.mdx)("h3", {
  ...
  }, `Object Attributes`), /* @__PURE__ */ (0, import_react2.mdx)("p", null, `The majority of form object attributes can be defined within a style sheet, except the following attributes:`), /* @__PURE__ */ (0, import_react2.mdx)("ul", null, /* @__PURE__ */ (0, import_react2.mdx)("li", {
    parentName: "ul"
  }, /* @__PURE__ */ (0, import_react2.mdx)("inlineCode", {
    parentName: "li"
    ...
    parentName: "li"
  }, `choiceList`), `, `, /* @__PURE__ */ (0, import_react2.mdx)("inlineCode", {
    parentName: "li"
  }, `excludedList`), `, `, /* @__PURE__ */ (0, import_react2.mdx)("inlineCode", {
    parentName: "li"
  }, `labels`), `, `, /* @__PURE__ */ (0, import_react2.mdx)("inlineCode", {
    parentName: "li"
  }, `list`), `, `, /* @__PURE__ */ (0, import_react2.mdx)("inlineCode", {
    parentName: "li"
  }, `requiredList`), ` (list type)`)), /* @__PURE__ */ (0, import_react2.mdx)("p", null, `Form object attributes can be declared with their `, /* @__PURE__ */ (0, import_react2.mdx)("a", {
    parentName: "p",
    ...{
      "href": "/docs/es/FormObjects/propertiesReference"
    }
  }, `JSON name`), ` as CSS attributes (not including object types, methods, events, and lists).`), /* @__PURE__ */ (0, import_react2.mdx)("h4", {
    ...{
      "id": "attribute-mapping"
    }
    ...
    parentName: "p"
  }, `sunken`), `) are not supported when using CSS attribute names.`)), /* @__PURE__ */ (0, import_react2.mdx)("h4", {
    ...{
      "id": "specific-attribute-values"
    }
...
`)))), /* @__PURE__ */ (0, import_react2.mdx)("blockquote", null, /* @__PURE__ */ (0, import_react2.mdx)("p", {
  ...
  }, `See also`), /* @__PURE__ */ (0, import_react2.mdx)("p", null, `See the `, /* @__PURE__ */ (0, import_react2.mdx)("a", {
    parentName: "p",
    ...{
      "href": "https://www.youtube.com/watch?v=3Hk4FUQENyQ"
    }
  }, /* @__PURE__ */ (0, import_react2.mdx)("strong", {
    parentName: "a"
  }, `CSS for 4D Forms`)), ` video presentation.`));
}
;
