...
const metadata = {
  ...
  "id": "version-18/FormObjects/propertiesPicture",
  "title": "Picture",
  "description": "Pathname",
  "source": "@site/versioned_docs/version-18/FormObjects/properties_Picture.md",
...
function MDXContent({
  ...
  }, `static picture`), `. You must use the POSIX syntax.`), /* @__PURE__ */ (0, import_react2.mdx)("p", null, `Two main locations can be used for static picture path:`), /* @__PURE__ */ (0, import_react2.mdx)("ul", null, /* @__PURE__ */ (0, import_react2.mdx)("li", {
    parentName: "ul"
  }, `in the `, /* @__PURE__ */ (0, import_react2.mdx)("strong", {
    parentName: "li"
  }, `Resources`), ` folder of the project database. Appropriate when you want to share static pictures between several forms in the database. In this case, the Pathname is "/RESOURCES/\\<picture path`, `>`, `".`), /* @__PURE__ */ (0, import_react2.mdx)("li", {
    parentName: "ul"
  }, `in an image folder (e.g. named `, /* @__PURE__ */ (0, import_react2.mdx)("strong", {
    parentName: "li"
  }, `Images`), `) within the form folder. Appropriate when the static pictures are used only in the form and/or you want to be able to move or duplicate the whole form within the project or different projects. In this case, the Pathname is "\\<picture path`, `>`, `" and is resolved from the root of the form folder.`)), /* @__PURE__ */ (0, import_react2.mdx)("h4", {
    ...{
      "id": "json-grammar"
    }
