...
const metadata = {
  ...
  "source": "@site/docs/API/FunctionClass.md",
  "sourceDirName": "API",
  ...
  "next": {
    "title": "HTTPRequest",
    "permalink": "/docs/es/next/API/HTTPRequestClass"
  }
};
const assets = {};
const toc = [{
...
`)), /* @__PURE__ */ (0, import_react2.mdx)("p", null, `Parameters are received within the method, in the order they are specified in the call.`), /* @__PURE__ */ (0, import_react2.mdx)("h3", {
    ...
    parentName: "li",
    ...{
      "href": "/docs/es/next/Concepts/classes#function"
    }
...
`)), /* @__PURE__ */ (0, import_react2.mdx)("p", null, /* @__PURE__ */ (0, import_react2.mdx)("img", {
    src: (__webpack_require__(88926)/* ["default"] */ .Z),
    width: "438",
    height: "217"
    ...
    src: (__webpack_require__(43489)/* ["default"] */ .Z),
    width: "532",
    height: "304"
  })), /* @__PURE__ */ (0, import_react2.mdx)("h2", {
    ...{
