...
const metadata = {
  ...
  "slug": "/Backup/backup",
  "permalink": "/docs/es/18/Backup/backup",
  "draft": false,
  "tags": [],
  "version": "18",
  "frontMatter": {
  ...
  "next": {
    ...
    "permalink": "/docs/es/18/Backup/settings"
  }
};
const assets = {};
const toc = [{
...
You can see the location of the backup folder using the pop-up menu next to the "Backup destination" area. This location is set on the `, /* @__PURE__ */ (0, import_react2.mdx)("strong", {
    ...
    parentName: "p",
    ...{
      "href": "/docs/es/18/Backup/settings#scheduler"
    }
    ...
    parentName: "p",
    ...{
      "href": "/docs/es/18/Backup/backup#handling-backup-issues"
    }
