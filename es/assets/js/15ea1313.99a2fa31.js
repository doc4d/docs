...
const metadata = {
  ...
  "id": "version-19/Preferences/methods",
  "title": "Methods Page",
  "description": "This page contains parameters defining the Method editor interface and it default display as well as options concerning its operation. It is divided into two sections accessed using the Theme and Options tabs.",
  "source": "@site/versioned_docs/version-19/Preferences/methods.md",
  "sourceDirName": "Preferences",
  "slug": "/Preferences/methods",
  "permalink": "/docs/es/19/Preferences/methods",
  "draft": false,
  "tags": [],
  "version": "19",
  "frontMatter": {
  ...
  "previous": {
    "title": "Forms Page",
    "permalink": "/docs/es/19/Preferences/forms"
  },
  "next": {
    "title": "Shortcuts Page",
    "permalink": "/docs/es/19/Preferences/shortcuts"
  }
};
const assets = {};
const toc = [{
...
function MDXContent({
  ...
  return /* @__PURE__ */ (0, import_react2.mdx)(MDXLayout, {
    ...
    components,
    mdxType: "MDXLayout"
  }, /* @__PURE__ */ (0, import_react2.mdx)("p", null, `This page contains parameters defining the Method editor interface and it default display as well as options concerning its operation. It is divided into two sections accessed using the Theme and Options tabs.`), /* @__PURE__ */ (0, import_react2.mdx)("h2", {
    ...{
      "id": "themes"
    }
  }, `Themes`), /* @__PURE__ */ (0, import_react2.mdx)("p", null, `This page allows selecting, creating, or configuring Method editor themes. A theme defines the font, font size, colors and styles of items displayed in the code editor.`), /* @__PURE__ */ (0, import_react2.mdx)("p", null, /* @__PURE__ */ (0, import_react2.mdx)("img", {
    src: (__webpack_require__(39933)/* ["default"] */ .Z),
    width: "1944",
    height: "1648"
    ...
    parentName: "p"
  }, `myTheme`), ` theme is automatically added if you already customized method editor styles in previous 4D releases.`), /* @__PURE__ */ (0, import_react2.mdx)("h3", {
    ...{
      "id": "creating-custom-themes"
    }
    ...
    parentName: "p",
    ...{
      "href": "/docs/es/19/Preferences/overview#storage"
    }
    ...
    parentName: "p"
  }, `font size`), ` menus allows you to select the font name and size used in the Method editor entry area for all categories.`), /* @__PURE__ */ (0, import_react2.mdx)("h3", {
    ...{
      "id": "4d-language-and-sql-language"
    }
  ...
  }, `Other Styles`), /* @__PURE__ */ (0, import_react2.mdx)("p", null, `These options configure the various colors used in the Method editor and debugger interfaces.`), /* @__PURE__ */ (0, import_react2.mdx)("p", null, /* @__PURE__ */ (0, import_react2.mdx)("img", {
    src: (__webpack_require__(40355)/* ["default"] */ .Z),
    width: "585",
    height: "385"
  ...
  }, `Background color of Method editor window.`)), /* @__PURE__ */ (0, import_react2.mdx)("tr", {
    parentName: "tbody"
  }, /* @__PURE__ */ (0, import_react2.mdx)("td", {
    parentName: "tr",
    ...{
  ...
  }, `Color of autocomplete text suggested by the Method editor.`)))), /* @__PURE__ */ (0, import_react2.mdx)("h2", {
    ...{
      "id": "options"
    }
  }, `Options`), /* @__PURE__ */ (0, import_react2.mdx)("p", null, `This page configures Method editor display options.`), /* @__PURE__ */ (0, import_react2.mdx)("p", null, /* @__PURE__ */ (0, import_react2.mdx)("img", {
    src: (__webpack_require__(61834)/* ["default"] */ .Z),
    width: "1944",
    height: "1648"
  })), /* @__PURE__ */ (0, import_react2.mdx)("h3", {
    ...{
  ...
  }, `Indentation`), /* @__PURE__ */ (0, import_react2.mdx)("p", null, `Changes the indentation value for the 4D code in the Method editor. The width must be specified in points (10 by default).`), /* @__PURE__ */ (0, import_react2.mdx)("p", null, `4D code is automatically indented in order to reveal its structure:`), /* @__PURE__ */ (0, import_react2.mdx)("p", null, /* @__PURE__ */ (0, import_react2.mdx)("img", {
    src: (__webpack_require__(98122)/* ["default"] */ .Z),
    width: "415",
    height: "332"
  ...
  }, `Show Line Numbers`), /* @__PURE__ */ (0, import_react2.mdx)("p", null, `Lets you display the line numbers by default in each window of the Method editor. You can also show/hide line numbers for the current window directly from the Method editor.`), /* @__PURE__ */ (0, import_react2.mdx)("h4", {
    ...{
      "id": "show-lists"
    }
  }, `Show Lists`), /* @__PURE__ */ (0, import_react2.mdx)("p", null, `Lets you choose whether or not to show the lists of objects (Commands, Tables and fields, etc.) by default when the Method editor window is opened. You can also show or hide each list directly from the Method editor.`), /* @__PURE__ */ (0, import_react2.mdx)("h4", {
    ...{
      "id": "highlight-the-logical-blocks"
    }
    ...
    src: (__webpack_require__(84826)/* ["default"] */ .Z),
    width: "550",
    height: "114"
    ...
    src: (__webpack_require__(69545)/* ["default"] */ .Z),
    width: "421",
    height: "210"
    ...
    src: (__webpack_require__(52087)/* ["default"] */ .Z),
    width: "199",
    height: "26"
...
`, /* @__PURE__ */ (0, import_react2.mdx)("img", {
    src: (__webpack_require__(87254)/* ["default"] */ .Z),
    width: "201",
    height: "27"
  })), /* @__PURE__ */ (0, import_react2.mdx)("h4", {
    ...{
...
The following options are available:`), /* @__PURE__ */ (0, import_react2.mdx)("ul", null, /* @__PURE__ */ (0, import_react2.mdx)("li", {
    ...
    src: (__webpack_require__(48957)/* ["default"] */ .Z),
    width: "645",
    height: "29"
    ...
    src: (__webpack_require__(66513)/* ["default"] */ .Z),
    width: "415",
    height: "249"
    ...
    src: (__webpack_require__(3867)/* ["default"] */ .Z),
    width: "282",
    height: "49"
  ...
  }, `Suggestions`), /* @__PURE__ */ (0, import_react2.mdx)("p", null, `This area lets you configure autocomplete mechanisms in the Method editor to adapt it to your own work habits.`), /* @__PURE__ */ (0, import_react2.mdx)("table", null, /* @__PURE__ */ (0, import_react2.mdx)("thead", {
    parentName: "table"
  }, /* @__PURE__ */ (0, import_react2.mdx)("tr", {
    parentName: "thead"
  }, /* @__PURE__ */ (0, import_react2.mdx)("th", {
    ...
    parentName: "td"
  }, `i.e.`), `, class functions)`)), `For example, when the "Variables (local or interprocess) and object attributes" option is checked, a list of suggestions appears when you type the $ character:`, /* @__PURE__ */ (0, import_react2.mdx)("img", {
    src: (__webpack_require__(96658)/* ["default"] */ .Z),
    width: "434",
    height: "171"
  ...
  }, `Sets the entry context that allows the Method editor to validate automatically the current suggestion displayed in the autocomplete window.`, /* @__PURE__ */ (0, import_react2.mdx)("ul", null, /* @__PURE__ */ (0, import_react2.mdx)("li", null, /* @__PURE__ */ (0, import_react2.mdx)("strong", {
    parentName: "td"
