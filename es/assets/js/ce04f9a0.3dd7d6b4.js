...
function MDXContent({
  ...
  return /* @__PURE__ */ (0, import_react2.mdx)(MDXLayout, {
    ...
    parentName: "p",
    ...{
      "href": "/docs/es/19/REST/configuration"
    }
...
`)), /* @__PURE__ */ (0, import_react2.mdx)("p", null, `See also `, /* @__PURE__ */ (0, import_react2.mdx)("a", {
    parentName: "p",
    ...{
      "href": "/docs/es/19/WebServer/gettingStarted#authenticating-users"
    }
    ...
    parentName: "p",
    ...{
      "href": "/docs/es/19/Users/overview"
    }
    ...
    parentName: "li",
    ...{
      "href": "/docs/es/19/REST/configuration#using-the-structure-settings"
    }
...
`)), /* @__PURE__ */ (0, import_react2.mdx)("p", null, `Alternatively, you can use the `, /* @__PURE__ */ (0, import_react2.mdx)("a", {
    parentName: "p",
    ...{
      "href": "/docs/es/19/Concepts/parameters#named-parameters"
    }
...
`)), /* @__PURE__ */ (0, import_react2.mdx)("blockquote", null, /* @__PURE__ */ (0, import_react2.mdx)("p", {
    ...
    parentName: "p",
    ...{
      "href": "/docs/es/19/WebServer/webServerConfig#about-ipv6-support"
    }
    ...
    parentName: "p",
    ...{
      "href": "/docs/es/19/WebServer/webServerConfig#ip-address-to-listen"
    }
