...
const metadata = {
  ...
  "source": "@site/docs/API/MailAttachmentClass.md",
  "sourceDirName": "API",
  "slug": "/API/MailAttachmentClass",
  "permalink": "/docs/es/next/API/MailAttachmentClass",
  "draft": false,
  "tags": [],
  "version": "current",
  "frontMatter": {
  ...
  "previous": {
    ...
    "permalink": "/docs/es/next/API/IMAPTransporterClass"
  },
  "next": {
...
function MDXContent({
  ...
  return /* @__PURE__ */ (0, import_react2.mdx)(MDXLayout, {
    ...
    parentName: "p",
    ...{
      "href": "/docs/es/next/API/EmailObjectClass"
    }
    ...
    parentName: "p",
    ...{
      "href": "/docs/es/next/API/EmailObjectClass#email-object"
    }
