...
const metadata = {
  ...
  "permalink": "/docs/es/next/settings/database",
  "draft": false,
  "tags": [],
  "version": "current",
  "frontMatter": {
  ...
  "previous": {
    "title": "Compiler page",
    "permalink": "/docs/es/next/settings/compiler"
  },
  "next": {
    "title": "Backup page",
    "permalink": "/docs/es/next/settings/backup"
  }
};
const assets = {};
const toc = [{
...
When this option is not checked (default value), the at sign is used as the wildcard character, in other words, it replaces any character (see `, /* @__PURE__ */ (0, import_react2.mdx)("a", {
    ...
    parentName: "p",
    ...{
      "href": "/docs/es/next/Preferences/general"
    }
