...
const metadata = {
  ...
  "id": "version-19-R6/ORDA/glossary",
  "title": "Glossary",
  "description": "Main concepts at a glance",
  "source": "@site/versioned_docs/version-19-R6/ORDA/glossary.md",
  "sourceDirName": "ORDA",
  "slug": "/ORDA/glossary",
...
function MDXContent({
  ...
  return /* @__PURE__ */ (0, import_react2.mdx)(MDXLayout, {
    ...
    src: (__webpack_require__(59762)/* ["default"] */ .Z),
    width: "478",
    height: "433"
  })), /* @__PURE__ */ (0, import_react2.mdx)("h2", {
    ...{
  ...
  }, `Computed attribute`), /* @__PURE__ */ (0, import_react2.mdx)("p", null, `A computed attribute doesn't actually store information. Instead, it determines its value based on other values from the same entity or from other entities, attributes or functions. When a computed attribute is referenced, the underlying "computation" is evaluated to determine the value. Computed attributes may even be assigned values where user-defined code determines what to do during the assignment.`), /* @__PURE__ */ (0, import_react2.mdx)("h2", {
    ...{
      "id": "data-model-class"
    }
