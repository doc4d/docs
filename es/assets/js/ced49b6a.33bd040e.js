...
const metadata = {
  ...
  "source": "@site/versioned_docs/version-19/ORDA/entities.md",
  "sourceDirName": "ORDA",
  "slug": "/ORDA/entities",
  "permalink": "/docs/es/19/ORDA/entities",
  "draft": false,
  "tags": [],
  "version": "19",
  "frontMatter": {
  ...
  "previous": {
    ...
    "permalink": "/docs/es/19/ORDA/ordaClasses"
  },
  "next": {
    "title": "Using a remote datastore",
    "permalink": "/docs/es/19/ORDA/datastores"
  }
};
const assets = {};
const toc = [{
  ...
  value: "Using the context property",
  id: "using-the-context-property",
  level: 3
}, {
...
function MDXContent({
  ...
  return /* @__PURE__ */ (0, import_react2.mdx)(MDXLayout, {
    ...
    parentName: "p",
    ...{
      "href": "/docs/es/19/ORDA/dsmapping#entity"
    }
  }, `entities`), ` and `, /* @__PURE__ */ (0, import_react2.mdx)("a", {
    parentName: "p",
    ...{
      "href": "/docs/es/19/ORDA/dsmapping#entity-selection"
    }
...
`)), /* @__PURE__ */ (0, import_react2.mdx)("p", null, `This is illustrated by the following graphic:`), /* @__PURE__ */ (0, import_react2.mdx)("p", null, /* @__PURE__ */ (0, import_react2.mdx)("img", {
    src: (__webpack_require__(54568)/* ["default"] */ .Z),
    width: "318",
    height: "129"
...
`)), /* @__PURE__ */ (0, import_react2.mdx)("p", null, `This is illustrated by the following graphic:`), /* @__PURE__ */ (0, import_react2.mdx)("p", null, /* @__PURE__ */ (0, import_react2.mdx)("img", {
    src: (__webpack_require__(98389)/* ["default"] */ .Z),
    width: "320",
    height: "129"
...
`)), /* @__PURE__ */ (0, import_react2.mdx)("p", null, `You can handle entities like any other object in 4D and pass their references directly as `, /* @__PURE__ */ (0, import_react2.mdx)("a", {
    parentName: "p",
    ...{
      "href": "/docs/es/19/Concepts/parameters"
    }
    ...
    parentName: "p",
    ...{
      "href": "/docs/es/19/ORDA/glossary#lazy-loading"
    }
    ...
    parentName: "p",
    ...{
      "href": "/docs/es/19/ORDA/dsmapping#storage-and-relation-attributes"
    }
...
`)), /* @__PURE__ */ (0, import_react2.mdx)("blockquote", null, /* @__PURE__ */ (0, import_react2.mdx)("p", {
    parentName: "blockquote"
  }, `Pictures attributes cannot be assigned directly with a given path in an entity.`)), /* @__PURE__ */ (0, import_react2.mdx)("p", null, `Accessing a related attribute depends on the attribute kind. For example, with the following structure:`), /* @__PURE__ */ (0, import_react2.mdx)("p", null, /* @__PURE__ */ (0, import_react2.mdx)("img", {
    src: (__webpack_require__(42960)/* ["default"] */ .Z),
    width: "690",
    height: "530"
...
`)), /* @__PURE__ */ (0, import_react2.mdx)("p", null, `Note that both `, /* @__PURE__ */ (0, import_react2.mdx)("em", {
    ...
    src: (__webpack_require__(22663)/* ["default"] */ .Z),
    width: "516",
    height: "612"
...
`)), /* @__PURE__ */ (0, import_react2.mdx)("h2", {
    ...
    src: (__webpack_require__(13400)/* ["default"] */ .Z),
    width: "764",
    height: "567"
...
`)), /* @__PURE__ */ (0, import_react2.mdx)("h2", {
    ...
    parentName: "li",
    ...{
      "href": "/docs/es/19/API/DataClassClass#query"
    }
  }, `in a dataclass`), ` or in an `, /* @__PURE__ */ (0, import_react2.mdx)("a", {
    parentName: "li",
    ...{
      "href": "/docs/es/19/API/EntitySelectionClass#query"
    }
    ...
    parentName: "li",
    ...{
      "href": "/docs/es/19/API/DataClassClass#all"
    }
    ...
    parentName: "li",
    ...{
      "href": "/docs/es/19/API/DataClassClass#newselection"
    }
  }, /* @__PURE__ */ (0, import_react2.mdx)("inlineCode", {
    parentName: "a"
    ...
    parentName: "li",
    ...{
      "href": "/docs/es/19/API/EntitySelectionClass#copy"
    }
  }, /* @__PURE__ */ (0, import_react2.mdx)("inlineCode", {
    parentName: "a"
    ...
    parentName: "p",
    ...{
      "href": "/docs/es/19/API/EntitySelectionClass#add"
    }
  }, /* @__PURE__ */ (0, import_react2.mdx)("inlineCode", {
    parentName: "a"
    ...
    parentName: "p",
    ...{
      "href": "/docs/es/19/API/EntitySelectionClass#slice"
    }
  }, /* @__PURE__ */ (0, import_react2.mdx)("inlineCode", {
    parentName: "a"
    ...
    parentName: "p",
    ...{
      "href": "/docs/es/19/API/EntitySelectionClass#and"
    }
  }, /* @__PURE__ */ (0, import_react2.mdx)("inlineCode", {
    parentName: "a"
    ...
    parentName: "p",
    ...{
      "href": "/docs/es/19/API/EntitySelectionClass#isalterable"
    }
    ...
    parentName: "li",
    ...{
      "href": "/docs/es/19/API/DataClassClass#fromcollection"
    }
    ...
    parentName: "li",
    ...{
      "href": "/docs/es/19/API/EntityClass#attributename"
    }
...
`)), /* @__PURE__ */ (0, import_react2.mdx)("p", null, `A new entity selection `, /* @__PURE__ */ (0, import_react2.mdx)("strong", {
    ...
    parentName: "li",
    ...{
      "href": "/docs/es/19/API/EntityClass#getselection"
    }
    ...
    parentName: "li",
    ...{
      "href": "/docs/es/19/API/EntitySelectionClass#attributename"
    }
    ...
    parentName: "li",
    ...{
      "href": "/docs/es/19/API/EntitySelectionClass#extract"
    }
...
`)), /* @__PURE__ */ (0, import_react2.mdx)("p", null, `This code returns in `, /* @__PURE__ */ (0, import_react2.mdx)("em", {
    ...
    src: (__webpack_require__(82121)/* ["default"] */ .Z),
    width: "1017",
    height: "794"
...
`)), /* @__PURE__ */ (0, import_react2.mdx)("p", null, `The last line will return in $myInvoices an entity selection of all invoices that have at least one invoice item related to a part in the entity selection myParts. When a relation attribute is used as a property of an entity selection, the result is always another entity selection, even if only one entity is returned. When a relation attribute is used as a property of an entity selection and no entities are returned, the result is an empty entity selection, not null.`), /* @__PURE__ */ (0, import_react2.mdx)("h2", {
    ...
    src: (__webpack_require__(72542)/* ["default"] */ .Z),
    width: "1091",
    height: "129"
  }))), /* @__PURE__ */ (0, import_react2.mdx)("li", {
    parentName: "ol"
    ...
    src: (__webpack_require__(59329)/* ["default"] */ .Z),
    width: "1121",
    height: "161"
  }))), /* @__PURE__ */ (0, import_react2.mdx)("li", {
    parentName: "ol"
    ...
    src: (__webpack_require__(16462)/* ["default"] */ .Z),
    width: "1084",
    height: "171"
...
`)), /* @__PURE__ */ (0, import_react2.mdx)("p", null, `In this example, we assign to $person1 a reference to the person entity with a key of 1. Then, we assign another reference of the same entity to variable $person2. Using $person1, we change the first name of the person and save the entity. When we attempt to do the same thing with $person2, 4D checks to make sure the entity on disk is the same as when the reference in $person1 was first assigned. Since it isn't the same, it returns false in the success property and doesn\u2019t save the second modification.`), /* @__PURE__ */ (0, import_react2.mdx)("p", null, `When this situation occurs, you can, for example, reload the entity from the disk using the `, /* @__PURE__ */ (0, import_react2.mdx)("inlineCode", {
    ...
    src: (__webpack_require__(12512)/* ["default"] */ .Z),
    width: "517",
    height: "571"
    ...
    src: (__webpack_require__(90493)/* ["default"] */ .Z),
    width: "774",
    height: "501"
  })), /* @__PURE__ */ (0, import_react2.mdx)("li", {
    parentName: "ul"
  }, `Example with a lock set by an ORDA method:`, /* @__PURE__ */ (0, import_react2.mdx)("br", null), /* @__PURE__ */ (0, import_react2.mdx)("br", null), /* @__PURE__ */ (0, import_react2.mdx)("img", {
    src: (__webpack_require__(15547)/* ["default"] */ .Z),
    width: "763",
    height: "427"
  }))), /* @__PURE__ */ (0, import_react2.mdx)("h2", {
    ...{
  ...
  }, `Client/server optimization`), /* @__PURE__ */ (0, import_react2.mdx)("p", null, `4D provides an automatic optimization for ORDA requests that use entity selections or load entities in client/server configurations. This optimization speeds up the execution of your 4D application by reducing drastically the volume of information transmitted over the network.`), /* @__PURE__ */ (0, import_react2.mdx)("p", null, `The following optimization mechanisms are implemented:`), /* @__PURE__ */ (0, import_react2.mdx)("ul", null, /* @__PURE__ */ (0, import_react2.mdx)("li", {
    parentName: "ul"
  }, /* @__PURE__ */ (0, import_react2.mdx)("p", {
    parentName: "li"
  }, `When a client requests an entity selection from the server, 4D automatically "learns" which attributes of the entity selection are actually used on the client side during the code execution, and builds a corresponding "optimization context". This context is attached to the entity selection and stores the used attributes. It will be dynamically updated if other attributes are used afterwards.`)), /* @__PURE__ */ (0, import_react2.mdx)("li", {
    parentName: "ul"
  }, /* @__PURE__ */ (0, import_react2.mdx)("p", {
    parentName: "li"
  }, `Subsequent requests sent to the server on the same entity selection automatically reuse the optimization context and only get necessary attributes from the server, which accelerates the processing. For example in an entity selection-based list box, the learning phase takes place during the display of the first rows, next rows display is very optimized.`)), /* @__PURE__ */ (0, import_react2.mdx)("li", {
    parentName: "ul"
  }, /* @__PURE__ */ (0, import_react2.mdx)("p", {
    parentName: "li"
    ...
    parentName: "p",
    ...{
      "href": "#using-the-context-property"
    }
  }, `Using the context property`), ` below).`))), /* @__PURE__ */ (0, import_react2.mdx)("p", null, `The following methods automatically associate the optimization context of the source entity selection to the returned entity selection:`), /* @__PURE__ */ (0, import_react2.mdx)("ul", null, /* @__PURE__ */ (0, import_react2.mdx)("li", {
    parentName: "ul"
  }, /* @__PURE__ */ (0, import_react2.mdx)("inlineCode", {
    parentName: "li"
    ...
    parentName: "li"
  }, `entitySelection.drop()`))), /* @__PURE__ */ (0, import_react2.mdx)("p", null, /* @__PURE__ */ (0, import_react2.mdx)("strong", {
    parentName: "p"
...
`)), /* @__PURE__ */ (0, import_react2.mdx)("p", null, `Thanks to the optimization, this request will only get data from used attributes (firstname, lastname, employer, employer.name) in `, /* @__PURE__ */ (0, import_react2.mdx)("em", {
    parentName: "p"
  }, `$sel`), ` after a learning phase.`), /* @__PURE__ */ (0, import_react2.mdx)("h3", {
    ...{
      "id": "using-the-context-property"
    }
  }, `Using the context property`), /* @__PURE__ */ (0, import_react2.mdx)("p", null, `You can increase the benefits of the optimization by using the `, /* @__PURE__ */ (0, import_react2.mdx)("strong", {
    parentName: "p"
  }, `context`), ` property. This property references an optimization context "learned" for an entity selection. It can be passed as parameter to ORDA methods that return new entity selections, so that entity selections directly request used attributes to the server and bypass the learning phase.`), /* @__PURE__ */ (0, import_react2.mdx)("p", null, `A same optimization context property can be passed to unlimited number of entity selections on the same dataclass. All ORDA methods that handle entity selections support the `, /* @__PURE__ */ (0, import_react2.mdx)("strong", {
    parentName: "p"
  }, `context`), ` property (for example `, /* @__PURE__ */ (0, import_react2.mdx)("inlineCode", {
    parentName: "p"
  }, `dataClass.query( )`), ` or `, /* @__PURE__ */ (0, import_react2.mdx)("inlineCode", {
    parentName: "p"
  }, `dataClass.all( )`), ` method). Keep in mind, however, that a context is automatically updated when new attributes are used in other parts of the code. Reusing the same context in different codes could result in overloading the context and then, reduce its efficiency.`), /* @__PURE__ */ (0, import_react2.mdx)("blockquote", null, /* @__PURE__ */ (0, import_react2.mdx)("p", {
    parentName: "blockquote"
  }, `A similar mechanism is implemented for entities that are loaded, so that only used attributes are requested (see the `, /* @__PURE__ */ (0, import_react2.mdx)("inlineCode", {
    parentName: "p"
  }, `dataClass.get( )`), ` method).`)), /* @__PURE__ */ (0, import_react2.mdx)("p", null, /* @__PURE__ */ (0, import_react2.mdx)("strong", {
    parentName: "p"
  }, `Example with `, /* @__PURE__ */ (0, import_react2.mdx)("inlineCode", {
    parentName: "strong"
  }, `dataClass.query( )`), ` method:`)), /* @__PURE__ */ (0, import_react2.mdx)("pre", null, /* @__PURE__ */ (0, import_react2.mdx)("code", {
    parentName: "pre",
    ...{
      "className": "language-4d"
    }
...
`)), /* @__PURE__ */ (0, import_react2.mdx)("h3", {
    ...
    parentName: "p",
    ...{
      "href": "/docs/es/19/FormObjects/listboxOverview#list-box-types"
    }
