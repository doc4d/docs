...
const metadata = {
  "unversionedId": "Admin/debugLogFiles",
  "id": "version-19/Admin/debugLogFiles",
  "title": "Description of log files",
  ...
  "source": "@site/versioned_docs/version-19/Admin/debugLogFiles.md",
  "sourceDirName": "Admin",
  "slug": "/Admin/debugLogFiles",
  ...
  "previous": {
    ...
    "permalink": "/docs/es/19/Admin/cli"
  },
  "next": {
    "title": "Overview",
...
`)), /* @__PURE__ */ (0, import_react2.mdx)("blockquote", null, /* @__PURE__ */ (0, import_react2.mdx)("p", {
    ...
    parentName: "p",
    ...{
      "href": "#4drequestslog_processinfotxt"
    }
    ...
    src: (__webpack_require__(22414)/* ["default"] */ .Z),
    width: "535",
    height: "378"
...
`)), /* @__PURE__ */ (0, import_react2.mdx)("p", null, `The following fields are logged for each event:  `), /* @__PURE__ */ (0, import_react2.mdx)("table", null, /* @__PURE__ */ (0, import_react2.mdx)("thead", {
  ...
  }, `Log operation type. This value may be an absolute value:`, /* @__PURE__ */ (0, import_react2.mdx)("ol", null, /* @__PURE__ */ (0, import_react2.mdx)("li", null, `Command`), /* @__PURE__ */ (0, import_react2.mdx)("li", null, `Method (project method, database method, etc.)`), /* @__PURE__ */ (0, import_react2.mdx)("li", null, `Message (sent by `, /* @__PURE__ */ (0, import_react2.mdx)("a", {
    parentName: "td",
    ...{
...
`)), /* @__PURE__ */ (0, import_react2.mdx)("p", null, `The following fields are logged for each event:`), /* @__PURE__ */ (0, import_react2.mdx)("table", null, /* @__PURE__ */ (0, import_react2.mdx)("thead", {
  ...
  }, `Info, Warning, Error`)), /* @__PURE__ */ (0, import_react2.mdx)("tr", {
    parentName: "tbody"
  }, /* @__PURE__ */ (0, import_react2.mdx)("td", {
    parentName: "tr",
    ...{
  ...
  }, `Description of the log entry`)))), /* @__PURE__ */ (0, import_react2.mdx)("p", null, `Depending on the event, various other fields can also be logged, such as task, socket, etc.`), /* @__PURE__ */ (0, import_react2.mdx)("h2", {
    ...{
      "id": "4dsmtplogtxt-4dpop3logtxt-and-4dimaplogtxt"
    }
    ...
    parentName: "li",
    ...{
      "href": "/docs/es/19/API/SMTPTransporterClass#smtp-new-transporter"
    }
    ...
    parentName: "li",
    ...{
      "href": "/docs/es/19/API/POP3TransporterClass#pop3-new-transporter"
    }
    ...
    parentName: "li",
    ...{
      "href": "/docs/es/19/API/IMAPTransporterClass#imap-new-transporter"
    }
...
`)), /* @__PURE__ */ (0, import_react2.mdx)("p", {
    ...
    parentName: "p",
    ...{
      "href": "https://doc.4d.com/4Dv18R5/4D/18-R5/Maintenance-Page.300-5149308.en.html"
    }
  }, `Maintenance Page`), ` of the 4D Server administration window.`), /* @__PURE__ */ (0, import_react2.mdx)("p", {
    parentName: "li"
  }, `  This log path is returned by the `, /* @__PURE__ */ (0, import_react2.mdx)("inlineCode", {
    parentName: "p"
  }, `Get 4D file`), ` command.`)), /* @__PURE__ */ (0, import_react2.mdx)("li", {
    parentName: "ul"
  }, /* @__PURE__ */ (0, import_react2.mdx)("p", {
    parentName: "li"
...
`)), /* @__PURE__ */ (0, import_react2.mdx)("p", null, `The following fields are logged for each request:`), /* @__PURE__ */ (0, import_react2.mdx)("table", null, /* @__PURE__ */ (0, import_react2.mdx)("thead", {
  ...
  }, `{"status":200,"body":{"__entityModel":"Persons",`, `[`, `...]`)))));
}
;
