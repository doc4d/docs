...
const metadata = {
  ...
  "id": "version-19/Concepts/about",
  "title": "About the 4D Language",
  "description": "The 4D built-in language, consisting of more than 1300 commands, makes 4D a powerful development tool for web, mobile, or desktop applications. You can use the 4D language for many different tasks\u2014from performing simple calculations to creating complex custom user interfaces. For example, you can:",
  "source": "@site/versioned_docs/version-19/Concepts/about.md",
  ...
  "next": {
    "title": "A Quick Tour",
    "permalink": "/docs/es/19/Concepts/quick-tour"
  }
};
const assets = {};
const toc = [{
...
function MDXContent({
  ...
  return /* @__PURE__ */ (0, import_react2.mdx)(MDXLayout, {
    ...
    components,
    mdxType: "MDXLayout"
  }, /* @__PURE__ */ (0, import_react2.mdx)("p", null, `The 4D built-in language, consisting of more than 1300 commands, makes 4D a powerful development tool for web, mobile, or desktop applications. You can use the 4D language for many different tasks\u2014from performing simple calculations to creating complex custom user interfaces. For example, you can:`), /* @__PURE__ */ (0, import_react2.mdx)("ul", null, /* @__PURE__ */ (0, import_react2.mdx)("li", {
    parentName: "ul"
    ...
    parentName: "ul"
  }, `Import and export data between 4D applications and other applications,`), /* @__PURE__ */ (0, import_react2.mdx)("li", {
    parentName: "ul"
    ...
    parentName: "ul"
  }, `Create applications: You can create easy-to-use, customized applications that run stand-alone.`), /* @__PURE__ */ (0, import_react2.mdx)("li", {
    parentName: "ul"
  }, `Add functionality to the built-in 4D Web server: build and update dynamic web pages filled with your data.`)), /* @__PURE__ */ (0, import_react2.mdx)("p", null, `The language lets you take complete control over the design and operation of your application. 4D provides powerful \u201Cgeneric\u201D editors, but the language lets you customize your application to whatever degree you require.`), /* @__PURE__ */ (0, import_react2.mdx)("h2", {
    ...{
      "id": "taking-control-of-your-data"
    }
  }, `Taking Control of Your Data`), /* @__PURE__ */ (0, import_react2.mdx)("p", null, `The 4D language lets you take complete control of your data in a powerful and elegant manner. The language is easy enough for a beginner, and sophisticated enough for an experienced application developer. It provides smooth transitions from built-in database functions to a completely customized application.`), /* @__PURE__ */ (0, import_react2.mdx)("p", null, `The commands in the 4D language provide access to the standard record management editors. For example, when you use the `, /* @__PURE__ */ (0, import_react2.mdx)("inlineCode", {
    parentName: "p"
  }, `QUERY`), ` command, you are presented with the Query Editor (which can be accessed in the Design mode using the Query command in the Records menu. You can tell the command to search for explicitly described data. For example, `, /* @__PURE__ */ (0, import_react2.mdx)("inlineCode", {
    parentName: "p"
  }, `QUERY([People];[People]Last Name="Smith")`), ` will find all the people named Smith in your database.`), /* @__PURE__ */ (0, import_react2.mdx)("p", null, `The 4D language is very powerful\u2014one command often replaces hundreds or even thousands of lines of code written in traditional computer languages. Surprisingly enough, with this power comes simplicity\u2014commands have plain English names. For example, to perform a query, you use the `, /* @__PURE__ */ (0, import_react2.mdx)("inlineCode", {
    parentName: "p"
