...
const metadata = {
  ...
  "permalink": "/docs/es/next/FormObjects/propertiesCoordinatesAndSizing",
  "draft": false,
  "tags": [],
  "version": "current",
  "frontMatter": {
  ...
  "previous": {
    ...
    "permalink": "/docs/es/next/FormObjects/propertiesBackgroundAndBorder"
  },
  "next": {
    "title": "Crop",
    "permalink": "/docs/es/next/FormObjects/propertiesCrop"
  }
};
const assets = {};
const toc = [{
...
`)), /* @__PURE__ */ (0, import_react2.mdx)("p", null, `Assuming that the unit of the rows is "lines," then the fifth row of the list box will have a height of three lines, while every other row will keep its default height.`), /* @__PURE__ */ (0, import_react2.mdx)("blockquote", null, /* @__PURE__ */ (0, import_react2.mdx)("ul", {
    ...
    parentName: "p",
    ...{
      "href": "/docs/es/next/FormObjects/propertiesFooters"
    }
