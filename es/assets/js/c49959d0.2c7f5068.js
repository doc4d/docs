...
const metadata = {
  ...
  "permalink": "/docs/es/19/FormObjects/progressIndicator",
  "draft": false,
  "tags": [],
  "version": "19",
  "frontMatter": {
  ...
  "previous": {
    "title": "Plug-in Area",
    "permalink": "/docs/es/19/FormObjects/pluginAreaOverview"
  },
  "next": {
    "title": "Radio Button",
    "permalink": "/docs/es/19/FormObjects/radiobuttonOverview"
  }
};
const assets = {};
const toc = [{
...
`)), /* @__PURE__ */ (0, import_react2.mdx)("p", null, `The method assigns the value of the indicator to the Salary field. As the user drags the indicator, the value in the Salary field changes.`), /* @__PURE__ */ (0, import_react2.mdx)("h2", {
    ...
    parentName: "p",
    ...{
      "href": "/docs/es/19/FormObjects/propertiesScale#barber-shop"
    }
    ...
    parentName: "p",
    ...{
      "href": "/docs/es/19/FormObjects/propertiesScale"
    }
