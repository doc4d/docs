...
const metadata = {
  ...
  "id": "version-18/FormObjects/propertiesDataSource",
  "title": "Data Source",
  "description": "Automatic Insertion",
  "source": "@site/versioned_docs/version-18/FormObjects/properties_DataSource.md",
  "sourceDirName": "FormObjects",
  "slug": "/FormObjects/propertiesDataSource",
  "permalink": "/docs/es/18/FormObjects/propertiesDataSource",
  "draft": false,
  "tags": [],
  "version": "18",
  "frontMatter": {
  ...
  "previous": {
    "title": "Crop",
    "permalink": "/docs/es/18/FormObjects/propertiesCrop"
  },
  "next": {
    "title": "Display",
    "permalink": "/docs/es/18/FormObjects/propertiesDisplay"
  }
};
const assets = {};
const toc = [{
...
function MDXContent({
  ...
  return /* @__PURE__ */ (0, import_react2.mdx)(MDXLayout, {
  ...
  }, `Automatic Insertion`), /* @__PURE__ */ (0, import_react2.mdx)("p", null, `When this option is selected, if a user enters a value that is not found in the choice list associated with the object, this value is automatically added to the list stored in memory. You can associate choice lists to objects using:`), /* @__PURE__ */ (0, import_react2.mdx)("ul", null, /* @__PURE__ */ (0, import_react2.mdx)("li", {
    parentName: "ul"
  ...
  }, `Choice List`), ` JSON property`), /* @__PURE__ */ (0, import_react2.mdx)("li", {
    parentName: "ul"
  }, `the `, /* @__PURE__ */ (0, import_react2.mdx)("a", {
    parentName: "li",
    ...{
      "href": "https://doc.4d.com/4Dv17R5/4D/17-R5/OBJECT-SET-LIST-BY-NAME.301-4128227.en.html"
    }
  }, `OBJECT SET LIST BY NAME`), ` or `, /* @__PURE__ */ (0, import_react2.mdx)("a", {
    parentName: "li",
    ...{
      "href": "https://doc.4d.com/4Dv17R5/4D/17-R5/OBJECT-SET-LIST-BY-REFERENCE.301-4128237.en.html"
    }
  }, `OBJECT SET LIST BY REFERENCE`), ` commands.`), /* @__PURE__ */ (0, import_react2.mdx)("li", {
    parentName: "ul"
  }, `the form editor's Property List.`)), /* @__PURE__ */ (0, import_react2.mdx)("p", null, `For example, given a choice list containing "France, Germany, Italy" that is associated with a "Countries" combo box: if the `, /* @__PURE__ */ (0, import_react2.mdx)("strong", {
    parentName: "p"
    ...
    src: (__webpack_require__(58594)/* ["default"] */ .Z),
    width: "485",
    height: "109"
  })), /* @__PURE__ */ (0, import_react2.mdx)("p", null, `Naturally, the value entered must not belong to the list of `, /* @__PURE__ */ (0, import_react2.mdx)("a", {
    parentName: "p",
    ...{
      "href": "/docs/es/18/FormObjects/propertiesRangeOfValues#excluded-list"
    }
  }, `excluded values`), ` associated with the object, if one has been set.`), /* @__PURE__ */ (0, import_react2.mdx)("blockquote", null, /* @__PURE__ */ (0, import_react2.mdx)("p", {
    parentName: "blockquote"
  }, `If the list was created from a list defined in Design mode, the original list is not modified.`)), /* @__PURE__ */ (0, import_react2.mdx)("p", null, `When the `, /* @__PURE__ */ (0, import_react2.mdx)("strong", {
    parentName: "p"
  }, `automatic insertion`), ` option is not selected (default), the value entered is stored in the object but not in the list in memory.`), /* @__PURE__ */ (0, import_react2.mdx)("h4", {
    ...{
      "id": "json-grammar"
    }
  ...
  }, `Choice List`), /* @__PURE__ */ (0, import_react2.mdx)("p", null, `Associates a choice list with an object. It can be a choice list name (a list reference) or a collection of default values.`), /* @__PURE__ */ (0, import_react2.mdx)("h4", {
    ...{
      "id": "json-grammar-1"
    }
  }, `JSON Grammar`), /* @__PURE__ */ (0, import_react2.mdx)("table", null, /* @__PURE__ */ (0, import_react2.mdx)("thead", {
...
`, /* @__PURE__ */ (0, import_react2.mdx)("a", {
  ...
  }, `Data Type`), /* @__PURE__ */ (0, import_react2.mdx)("p", null, `Please refer to `, /* @__PURE__ */ (0, import_react2.mdx)("a", {
    parentName: "p",
    ...{
    ...
    parentName: "p",
    ...{
      "href": "/docs/es/18/FormObjects/propertiesRangeOfValues#default-list-of-values"
    }
    ...
    src: (__webpack_require__(47413)/* ["default"] */ .Z),
    width: "396",
    height: "335"
    ...
    parentName: "p",
    ...{
      "href": "/docs/es/18/FormObjects/listboxOverview#selection-list-boxes"
    }
  }, `selection`), `
...
If you use a collection of scalar values, 4D will create an object for each collection element with a single property (named "value"), filled with the element value. In this case, you will use `, /* @__PURE__ */ (0, import_react2.mdx)("strong", {
    parentName: "p"
