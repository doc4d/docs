...
const metadata = {
  ...
  "id": "version-19/API/ZipArchiveClass",
  "title": "ZIPArchive",
  ...
  "source": "@site/versioned_docs/version-19/API/ZipArchiveClass.md",
  "sourceDirName": "API",
  ...
  "previous": {
    "title": "WebServer",
    "permalink": "/docs/es/19/API/WebServerClass"
  },
  "next": {
    "title": "ZIPFile",
...
function MDXContent({
  ...
  return /* @__PURE__ */ (0, import_react2.mdx)(MDXLayout, {
    ...
    parentName: "li",
    ...{
      "href": "/docs/es/19/API/ZipFileClass"
    }
    ...
    parentName: "li",
    ...{
      "href": "/docs/es/19/API/ZipFolderClass"
    }
  }, /* @__PURE__ */ (0, import_react2.mdx)("inlineCode", {
    parentName: "a"
...
`)), /* @__PURE__ */ (0, import_react2.mdx)("h2", {
    ...
    parentName: "p",
    ...{
      "href": "/docs/es/19/API/Document#copyto"
    }
  }, `file.copyTo()`), ` or `, /* @__PURE__ */ (0, import_react2.mdx)("a", {
    parentName: "p",
    ...{
      "href": "/docs/es/19/API/Directory#copyto"
    }
