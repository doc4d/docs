...
const metadata = {
  ...
  "id": "version-19-R6/REST/configuration",
  "title": "Server Configuration",
  ...
  "source": "@site/versioned_docs/version-19-R6/REST/configuration.md",
  "sourceDirName": "REST",
  "slug": "/REST/configuration",
  "permalink": "/docs/es/REST/configuration",
  "draft": false,
  "tags": [],
  "version": "19-R6",
  "frontMatter": {
  ...
  "next": {
    ...
    "permalink": "/docs/es/REST/authUsers"
  }
};
const assets = {};
const toc = [{
...
function MDXContent({
  ...
  return /* @__PURE__ */ (0, import_react2.mdx)(MDXLayout, {
    ...
    parentName: "p"
  }, `Expose as REST server`), ` option in the `, /* @__PURE__ */ (0, import_react2.mdx)("strong", {
    parentName: "p"
  }, `Web`), ` > `, /* @__PURE__ */ (0, import_react2.mdx)("strong", {
    parentName: "p"
  }, `Web Features`), ` page of the structure settings in order for REST requests to be processed.`), /* @__PURE__ */ (0, import_react2.mdx)("p", null, /* @__PURE__ */ (0, import_react2.mdx)("img", {
    alt: "alt-text",
    src: (__webpack_require__(43100)/* ["default"] */ .Z),
    width: "855",
    height: "381"
    ...
    parentName: "li"
  }, `Read/Write`), ` user group to REST services in the "`, /* @__PURE__ */ (0, import_react2.mdx)("strong", {
    parentName: "li"
  }, `Web`), ` > `, /* @__PURE__ */ (0, import_react2.mdx)("strong", {
    parentName: "li"
  }, `Web Features`), `" page of the Structure Settings;`), /* @__PURE__ */ (0, import_react2.mdx)("li", {
    parentName: "ul"
    ...
    parentName: "p"
  }, `On REST Authentication`), ` database method has been defined, 4D fully delegates control of REST requests to it: any setting made using the "Read/Write" menu on the `, /* @__PURE__ */ (0, import_react2.mdx)("strong", {
    parentName: "p"
  }, `Web`), ` > `, /* @__PURE__ */ (0, import_react2.mdx)("strong", {
    parentName: "p"
  }, `Web Features`), ` page of the Structure Settings is ignored.`)), /* @__PURE__ */ (0, import_react2.mdx)("h3", {
    ...{
      "id": "using-the-structure-settings"
    }
  }, `Using the Structure Settings`), /* @__PURE__ */ (0, import_react2.mdx)("p", null, `The `, /* @__PURE__ */ (0, import_react2.mdx)("strong", {
    parentName: "p"
  }, `Read/Write`), ` menu in the "`, /* @__PURE__ */ (0, import_react2.mdx)("strong", {
    parentName: "p"
  }, `Web`), ` > `, /* @__PURE__ */ (0, import_react2.mdx)("strong", {
    parentName: "p"
  }, `Web Features`), `" page of the structure settings specifies a group of 4D users that is authorized to establish the link to the 4D application using REST queries.`), /* @__PURE__ */ (0, import_react2.mdx)("p", null, `By default, the menu displays `, /* @__PURE__ */ (0, import_react2.mdx)("inlineCode", {
    parentName: "p"
...
`, /* @__PURE__ */ (0, import_react2.mdx)("img", {
    alt: "alt-text",
    src: (__webpack_require__(97920)/* ["default"] */ .Z),
    width: "279",
    height: "330"
  }), `
...
`, /* @__PURE__ */ (0, import_react2.mdx)("img", {
    alt: "alt-text",
    src: (__webpack_require__(26611)/* ["default"] */ .Z),
    width: "279",
    height: "271"
  }), `
...
/* harmony export */ });
/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = (__webpack_require__.p + "assets/images/Settings-934d69d2618fdc41073c2f25c38ea3a6.png");
