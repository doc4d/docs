...
const metadata = {
  ...
  "permalink": "/docs/es/18/REST/configuration",
  "draft": false,
  "tags": [],
  "version": "18",
  "frontMatter": {
  ...
  "previous": {
    ...
    "permalink": "/docs/es/18/REST/gettingStarted"
  },
  "next": {
    "title": "Users and sessions",
    "permalink": "/docs/es/18/REST/authUsers"
  }
};
const assets = {};
const toc = [{
...
You need to manage the `, /* @__PURE__ */ (0, import_react2.mdx)("a", {
    parentName: "li",
    ...{
      "href": "/docs/es/18/REST/authUsers#session-cookie"
    }
    ...
    parentName: "p",
    ...{
      "href": "/docs/es/18/REST/authUsers"
    }
