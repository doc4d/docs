...
const metadata = {
  ...
  "id": "version-18/Concepts/quick-tour",
  "title": "A Quick Tour",
  ...
  "source": "@site/versioned_docs/version-18/Concepts/quick-tour.md",
  "sourceDirName": "Concepts",
  "slug": "/Concepts/quick-tour",
  "permalink": "/docs/es/18/Concepts/quick-tour",
  "draft": false,
  "tags": [],
  "version": "18",
  "frontMatter": {
  ...
  "next": {
    ...
    "permalink": "/docs/es/18/Concepts/data-types"
  }
};
const assets = {};
const toc = [{
...
`)), /* @__PURE__ */ (0, import_react2.mdx)("p", null, `This code will display a platform-standard alert dialog box with the "Hello, World!" message, containing an OK button. To execute the code, you just need to click on the execution button in the Method editor:`), /* @__PURE__ */ (0, import_react2.mdx)("p", null, /* @__PURE__ */ (0, import_react2.mdx)("img", {
    alt: "alt-text",
    src: (__webpack_require__(47680)/* ["default"] */ .Z),
    width: "613",
    height: "322"
...
`)), /* @__PURE__ */ (0, import_react2.mdx)("p", null, `You MUST distinguish the assignment operator := from the other operators. Rather than combining expressions into a new one, the assignment operator copies the value of the expression to the right of the assignment operator into the variable or field to the left of the operator.`), /* @__PURE__ */ (0, import_react2.mdx)("p", null, /* @__PURE__ */ (0, import_react2.mdx)("strong", {
  ...
  }, `Variables`), /* @__PURE__ */ (0, import_react2.mdx)("p", null, `The 4D language is strongly typed, although some flexibility is allowed in many cases. You create a typed variable using a `, /* @__PURE__ */ (0, import_react2.mdx)("inlineCode", {
    parentName: "p"
  }, `C_XXX`), ` command. For example, to create a variable of the date type, you can write:`), /* @__PURE__ */ (0, import_react2.mdx)("pre", null, /* @__PURE__ */ (0, import_react2.mdx)("code", {
    parentName: "pre",
    ...{
      "className": "language-4d"
    }
  }, `C_DATE(MyDate) //Date type for MyDate variable
`)), /* @__PURE__ */ (0, import_react2.mdx)("p", null, `Even if it is usually not recommended, you can create variables simply by using them; you do not necessarily need to formally define them as you do with fields. For example, if you want a variable that will hold the current date plus 30 days, you can write:`), /* @__PURE__ */ (0, import_react2.mdx)("pre", null, /* @__PURE__ */ (0, import_react2.mdx)("code", {
    parentName: "pre",
    ...{
      "className": "language-4d"
    }
  }, `MyOtherDate:=Current date+30
`)), /* @__PURE__ */ (0, import_react2.mdx)("p", null, `The line of code reads \u201CMyOtherDate gets the current date plus 30 days.\u201D This line creates the variable, assigns it with both the (temporary) date type and a content. A variable created by assignment is interpreted as typeless, that is, it can be assigned with other types in other lines and then changes the type dynamically. A variable typed with `, /* @__PURE__ */ (0, import_react2.mdx)("inlineCode", {
    parentName: "p"
  }, `C_XXX`), ` cannot change the type. In compiled mode, the type can never be changed, regardless of how the variable was created.`), /* @__PURE__ */ (0, import_react2.mdx)("h2", {
    ...{
      "id": "commands"
    }
...
`)), /* @__PURE__ */ (0, import_react2.mdx)("p", null, `4D SVG is included in 4D.`), /* @__PURE__ */ (0, import_react2.mdx)("h2", {
  ...
  }, `Constants`), /* @__PURE__ */ (0, import_react2.mdx)("p", null, `4D proposes an extensed set of predefined constants, whose values are accessible by name. For example, `, /* @__PURE__ */ (0, import_react2.mdx)("inlineCode", {
    parentName: "p"
  }, `Read Mode`), ` is a constant (value 2). Predefined constants appear underlined by default in the 4D Method editor. They allow writing more readable code.`), /* @__PURE__ */ (0, import_react2.mdx)("pre", null, /* @__PURE__ */ (0, import_react2.mdx)("code", {
    parentName: "pre",
    ...{
      "className": "language-4d"
    }
...
`)), /* @__PURE__ */ (0, import_react2.mdx)("p", null, `If `, /* @__PURE__ */ (0, import_react2.mdx)("em", {
    ...
    parentName: "p",
    ...{
      "href": "/docs/es/18/Concepts/data-types"
    }
