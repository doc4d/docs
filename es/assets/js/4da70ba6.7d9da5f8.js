...
const metadata = {
  ...
  "permalink": "/docs/es/19/Backup/settings",
  "draft": false,
  "tags": [],
  "version": "19",
  "frontMatter": {
  ...
  "previous": {
    "title": "Backup",
    "permalink": "/docs/es/19/Backup/backup"
  },
  "next": {
...
function MDXContent({
  ...
  return /* @__PURE__ */ (0, import_react2.mdx)(MDXLayout, {
    ...
    parentName: "p",
    ...{
      "href": "/docs/es/19/Project/architecture#settings-folder"
    }
    ...
    parentName: "p",
    ...{
      "href": "/docs/es/19/Backup/backup#handling-backup-issues"
    }
    ...
    parentName: "li",
    ...{
      "href": "/docs/es/19/Project/architecture#settings-folder-1"
    }
...
4D generates archives using specific algorithms that are based on optimization (interlacing) and security (redundancy) mechanisms. You can set these mechanisms according to your needs. The menus for these options contain rates of `, /* @__PURE__ */ (0, import_react2.mdx)("strong", {
    ...
    parentName: "p",
    ...{
      "href": "/docs/es/19/Backup/restore#manually-restoring-a-backup-standard-dialog"
    }
  }, `manual restore`), `.`)));
}
;
