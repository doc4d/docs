...
const metadata = {
  ...
  "id": "version-19-R6/WebServer/webServerAdmin",
  "title": "Administration",
  "description": "4D provides several integrated tools to start, stop, or monitor the integrated web server.",
  "source": "@site/versioned_docs/version-19-R6/WebServer/webServerAdmin.md",
  ...
  "next": {
    ...
    "permalink": "/docs/es/WebServer/webServerObject"
  }
};
const assets = {};
const toc = [{
...
function MDXContent({
  ...
  return /* @__PURE__ */ (0, import_react2.mdx)(MDXLayout, {
    ...
    src: (__webpack_require__(69156)/* ["default"] */ .Z),
    width: "348",
    height: "278"
  })), /* @__PURE__ */ (0, import_react2.mdx)("li", {
    parentName: "ul"
    ...
    src: (__webpack_require__(67161)/* ["default"] */ .Z),
    width: "1030",
    height: "699"
  })))), /* @__PURE__ */ (0, import_react2.mdx)("li", {
    parentName: "ul"
    ...
    src: (__webpack_require__(50308)/* ["default"] */ .Z),
    width: "898",
    height: "746"
  })), /* @__PURE__ */ (0, import_react2.mdx)("li", {
    parentName: "ul"
    ...
    parentName: "li",
    ...{
      "href": "/docs/es/API/WebServerClass#start"
    }
    ...
    parentName: "li",
    ...{
      "href": "/docs/es/API/WebServerClass#stop"
    }
  }, /* @__PURE__ */ (0, import_react2.mdx)("inlineCode", {
    parentName: "a"
    ...
    src: (__webpack_require__(45601)/* ["default"] */ .Z),
    width: "355",
    height: "284"
  ...
  }, `Clearing the Cache`), /* @__PURE__ */ (0, import_react2.mdx)("p", null, `At any moment, you can clear the cache of the pages and images that it contains (if, for example, you have modified a static page and you want to reload it in the cache).`), /* @__PURE__ */ (0, import_react2.mdx)("p", null, `To do so, you can:`), /* @__PURE__ */ (0, import_react2.mdx)("ul", null, /* @__PURE__ */ (0, import_react2.mdx)("li", {
    parentName: "ul"
  }, `4D: click on the `, /* @__PURE__ */ (0, import_react2.mdx)("strong", {
    parentName: "li"
  }, `Clear Cache`), ` button in the Web/Options (I) page of the Settings dialog box. `), /* @__PURE__ */ (0, import_react2.mdx)("li", {
    parentName: "ul"
  }, `4D Server: click on the `, /* @__PURE__ */ (0, import_react2.mdx)("strong", {
    parentName: "li"
  }, `Clear Cache`), ` button in the HTTP page of the `, /* @__PURE__ */ (0, import_react2.mdx)("a", {
    parentName: "li",
    ...{
      "href": "Admin/server-admin.md#http-server-page"
    }
  }, `4D Server Administration window`), `.`)), /* @__PURE__ */ (0, import_react2.mdx)("p", null, `The cache is then immediately cleared.`), /* @__PURE__ */ (0, import_react2.mdx)("blockquote", null, /* @__PURE__ */ (0, import_react2.mdx)("p", {
    parentName: "blockquote"
    ...
    parentName: "p",
    ...{
      "href": "/docs/es/WebServer/webServerConfig#debug-log"
    }
...
Each field is separated by a space and each line ends by the CR/LF sequence (character 13, character 10). `), /* @__PURE__ */ (0, import_react2.mdx)("p", null, `DLF (Combined Log Format) format is similar to CLF (Common Log Format) format and uses exactly the same structure. It simply adds two additional HTTP fields at the end of each request: Referer and User-agent. Here is the description of CLF/DLF formats (not customizable):`), /* @__PURE__ */ (0, import_react2.mdx)("table", null, /* @__PURE__ */ (0, import_react2.mdx)("thead", {
    ...
    src: (__webpack_require__(94661)/* ["default"] */ .Z),
    width: "892",
    height: "744"
