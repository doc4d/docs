...
const metadata = {
  ...
  "previous": {
    "title": "Plug-in Area",
    "permalink": "/docs/es/next/FormObjects/pluginAreaOverview"
  },
  "next": {
    "title": "Radio Button",
...
`)), /* @__PURE__ */ (0, import_react2.mdx)("p", null, `The method assigns the value of the indicator to the Salary field. As the user drags the indicator, the value in the Salary field changes.`), /* @__PURE__ */ (0, import_react2.mdx)("h2", {
    ...
    parentName: "p",
    ...{
      "href": "/docs/es/next/FormObjects/propertiesScale#barber-shop"
    }
    ...
    parentName: "p",
    ...{
      "href": "/docs/es/next/FormObjects/propertiesScale"
    }
