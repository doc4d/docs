...
const metadata = {
  ...
  "id": "version-18/Concepts/methods",
  "title": "Methods",
  "description": "A method is basically a piece of code that executes one or several actions. In the 4D Language, there are two categories of methods:",
  "source": "@site/versioned_docs/version-18/Concepts/methods.md",
  ...
  "previous": {
    "title": "Arrays",
    "permalink": "/docs/es/18/Concepts/arrays"
  },
  "next": {
    "title": "Parameters",
...
const toc = [{
  ...
  value: "Subroutines and functions",
  id: "subroutines-and-functions",
  level: 3
}, {
  value: "Methods attached to objects",
  id: "methods-attached-to-objects",
  level: 3
}, {
  value: "Menu Methods",
  id: "menu-methods",
...
function MDXContent({
  ...
  return /* @__PURE__ */ (0, import_react2.mdx)(MDXLayout, {
    ...
    components,
    mdxType: "MDXLayout"
  }, /* @__PURE__ */ (0, import_react2.mdx)("p", null, `A method is basically a piece of code that executes one or several actions. In the 4D Language, there are two categories of methods:`), /* @__PURE__ */ (0, import_react2.mdx)("ul", null, /* @__PURE__ */ (0, import_react2.mdx)("li", {
    parentName: "ul"
  }, /* @__PURE__ */ (0, import_react2.mdx)("p", {
    parentName: "li"
  }, /* @__PURE__ */ (0, import_react2.mdx)("strong", {
    parentName: "p"
  }, `built-in methods`), `, which are provided by 4D or third-party developers and can be only called in your code. Built-in methods include:`), /* @__PURE__ */ (0, import_react2.mdx)("ul", {
    parentName: "li"
  }, /* @__PURE__ */ (0, import_react2.mdx)("li", {
    parentName: "ul"
  }, `Commands and functions of the 4D API, such as `, /* @__PURE__ */ (0, import_react2.mdx)("inlineCode", {
    parentName: "li"
  }, `ALERT`), ` or `, /* @__PURE__ */ (0, import_react2.mdx)("inlineCode", {
    parentName: "li"
  }, `Current date`), `.`), /* @__PURE__ */ (0, import_react2.mdx)("li", {
    parentName: "ul"
  }, `Methods attached to collections or native objects, such as `, /* @__PURE__ */ (0, import_react2.mdx)("inlineCode", {
    parentName: "li"
  }, `collection.orderBy()`), ` or `, /* @__PURE__ */ (0, import_react2.mdx)("inlineCode", {
    parentName: "li"
  }, `entity.save()`), `.`), /* @__PURE__ */ (0, import_react2.mdx)("li", {
    parentName: "ul"
  }, `Commands from plug-ins or components, provided by 4D or third-party developers, such as `, /* @__PURE__ */ (0, import_react2.mdx)("inlineCode", {
    parentName: "li"
  }, `SVG_New_arc`), `.`)), /* @__PURE__ */ (0, import_react2.mdx)("p", {
    parentName: "li"
  }, `Built-in methods are detailed in the `, /* @__PURE__ */ (0, import_react2.mdx)("em", {
    parentName: "p"
  }, `4D Language reference`), ` manual or dedicated manuals for plug-ins or components.  `)), /* @__PURE__ */ (0, import_react2.mdx)("li", {
    parentName: "ul"
  }, /* @__PURE__ */ (0, import_react2.mdx)("p", {
    parentName: "li"
  }, /* @__PURE__ */ (0, import_react2.mdx)("strong", {
...
The maximum size of a project method is limited to 2 GB of text or 32,000 lines of command.`))), /* @__PURE__ */ (0, import_react2.mdx)("p", null, /* @__PURE__ */ (0, import_react2.mdx)("strong", {
    parentName: "p"
  }, `Note:`), ` 4D also provides specific methods that are automatically executed depending on database or form events. See `, /* @__PURE__ */ (0, import_react2.mdx)("a", {
    parentName: "p",
    ...{
      "href": "#specialized-methods"
    }
  }, `Specialized methods`), `.`), /* @__PURE__ */ (0, import_react2.mdx)("h2", {
    ...{
      "id": "calling-project-methods"
    }
    ...
    parentName: "ul"
  }, `Subroutine and function`), /* @__PURE__ */ (0, import_react2.mdx)("li", {
    parentName: "ul"
  }, `Method attached to object`), /* @__PURE__ */ (0, import_react2.mdx)("li", {
    parentName: "ul"
  ...
  }, `Subroutines and functions`), /* @__PURE__ */ (0, import_react2.mdx)("p", null, `A subroutine is a project method that can be thought of as a servant. It performs those tasks that other methods request it to perform. A function is a subroutine that returns a value to the method that called it.`), /* @__PURE__ */ (0, import_react2.mdx)("p", null, `When you create a project method, it becomes part of the language of the database in which you create it. You can then call the project method from other project methods, or from `, /* @__PURE__ */ (0, import_react2.mdx)("a", {
    parentName: "p",
    ...{
      "href": "#predefined-methods"
    }
  }, `predefined methods`), ` in the same way that you call 4D\u2019s built-in commands. A project method used in this way is called a subroutine.`), /* @__PURE__ */ (0, import_react2.mdx)("p", null, `You use subroutines to:`), /* @__PURE__ */ (0, import_react2.mdx)("ul", null, /* @__PURE__ */ (0, import_react2.mdx)("li", {
    parentName: "ul"
...
`)), /* @__PURE__ */ (0, import_react2.mdx)("p", null, `If you do not use subroutines, you will have to write the code each time you want to modify a customer\u2019s record. If there are ten places in your custom database where you need to do this, you will have to write the code ten times. If you use subroutines, you will only have to write it once. This is the first advantage of subroutines\u2014to reduce the amount of code.`), /* @__PURE__ */ (0, import_react2.mdx)("p", null, `If the previously described code was a method called `, /* @__PURE__ */ (0, import_react2.mdx)("inlineCode", {
    parentName: "p"
  }, `MODIFY CUSTOMER`), `, you would execute it simply by using the name of the method in another method. For example, to modify a customer\u2019s record and then print the record, you would write this method:`), /* @__PURE__ */ (0, import_react2.mdx)("pre", null, /* @__PURE__ */ (0, import_react2.mdx)("code", {
    parentName: "pre",
    ...{
      "className": "language-4d"
    }
...
`)), /* @__PURE__ */ (0, import_react2.mdx)("p", null, `This capability simplifies your methods dramatically. In the example, you do not need to know how the `, /* @__PURE__ */ (0, import_react2.mdx)("inlineCode", {
    parentName: "p"
  }, `MODIFY CUSTOMER`), ` method works, just what it does. This is the second reason for using subroutines\u2014to clarify your methods. In this way, your methods become extensions to the 4D language.`), /* @__PURE__ */ (0, import_react2.mdx)("p", null, `If you need to change your method of finding customers in this example database, you will need to change only one method, not ten. This is the next reason to use subroutines\u2014to facilitate changes to your methods.`), /* @__PURE__ */ (0, import_react2.mdx)("p", null, `Using subroutines, you make your code modular. This simply means dividing your code into modules (subroutines), each of which performs a logical task. Consider the following code from a checking account database:`), /* @__PURE__ */ (0, import_react2.mdx)("pre", null, /* @__PURE__ */ (0, import_react2.mdx)("code", {
    parentName: "pre",
    ...{
      "className": "language-4d"
    }
...
`)), /* @__PURE__ */ (0, import_react2.mdx)("p", null, `Even for someone who doesn\u2019t know the database, it is clear what this code does. It is not necessary to examine each subroutine. Each subroutine might be many lines long and perform some complex operations, but here it is only important that it performs its task. We recommend that you divide your code into logical tasks, or modules, whenever possible.`), /* @__PURE__ */ (0, import_react2.mdx)("h3", {
  ...
  }, `Methods attached to objects`), /* @__PURE__ */ (0, import_react2.mdx)("p", null, `You can encapsulate your project methods in `, /* @__PURE__ */ (0, import_react2.mdx)("strong", {
    parentName: "p"
...
`)), /* @__PURE__ */ (0, import_react2.mdx)("p", null, `You can also `, /* @__PURE__ */ (0, import_react2.mdx)("a", {
    parentName: "p",
    ...{
      "href": "/docs/es/18/Concepts/parameters"
    }
...
`)), /* @__PURE__ */ (0, import_react2.mdx)("p", null, `Note the `, /* @__PURE__ */ (0, import_react2.mdx)("inlineCode", {
    ...
    parentName: "p"
  }, `Genealogy of`), ` stops calling itself when the query returns no records. Without this condition test, the method would call itself indefinitely; eventually, 4D would return a \u201CStack Full\u201D error becuase it would no longer have space to \u201Cpile up\u201D the calls (as well as parameters and local variables used in the method).`), /* @__PURE__ */ (0, import_react2.mdx)("h2", {
    ...{
      "id": "specialized-methods"
    }
  }, `Specialized Methods`), /* @__PURE__ */ (0, import_react2.mdx)("p", null, `In addition to generic `, /* @__PURE__ */ (0, import_react2.mdx)("strong", {
    parentName: "p"
  }, `project methods`), `, 4D supports several specific method types, that are automatically called depending on events:`), /* @__PURE__ */ (0, import_react2.mdx)("table", null, /* @__PURE__ */ (0, import_react2.mdx)("thead", {
    parentName: "table"
  ...
  }, `There are 16 database methods in 4D. See Database methods section`)))));
}
;
