...
const metadata = {
  ...
  "source": "@site/docs/API/EntityClass.md",
  "sourceDirName": "API",
  "slug": "/API/EntityClass",
  "permalink": "/docs/fr/next/API/EntityClass",
  "draft": false,
  "tags": [],
  "version": "current",
  "frontMatter": {
  ...
  "previous": {
    "title": "Email",
    "permalink": "/docs/fr/next/API/EmailObjectClass"
  },
  "next": {
...
function MDXContent({
  ...
  return /* @__PURE__ */ (0, import_react2.mdx)(MDXLayout, {
    ...
    parentName: "p",
    ...{
      "href": "/docs/fr/next/ORDA/dsmapping#entity"
    }
    ...
    parentName: "p",
    ...{
      "href": "/docs/fr/next/API/DataClassAttributeClass#kind"
    }
...
`)), /* @__PURE__ */ (0, import_react2.mdx)("h2", {
  ...
  }, `New entity referencing the record`)))), /* @__PURE__ */ (0, import_react2.mdx)("h4", {
    ...{
      "id": "description-1"
    }
...
`)), /* @__PURE__ */ (0, import_react2.mdx)("h2", {
    ...
    parentName: "li",
    ...{
      "href": "/docs/fr/next/Concepts/data-types#converting-data-types"
    }
  }, /* @__PURE__ */ (0, import_react2.mdx)("inlineCode", {
    parentName: "a"
...
`)), /* @__PURE__ */ (0, import_react2.mdx)("h2", {
  ...
  }, `Context attributes linked to the entity, separated by a comma`)))), /* @__PURE__ */ (0, import_react2.mdx)("blockquote", null, /* @__PURE__ */ (0, import_react2.mdx)("p", {
    parentName: "blockquote"
  }, /* @__PURE__ */ (0, import_react2.mdx)("strong", {
    parentName: "p"
    ...
    parentName: "p"
  }, `.getRemoteContextAttributes()`), ` function `, `returns information about the optimization context used by the entity `, `.`), /* @__PURE__ */ (0, import_react2.mdx)("p", null, `If there is no `, /* @__PURE__ */ (0, import_react2.mdx)("a", {
    parentName: "p",
    ...{
      "href": "/docs/fr/next/ORDA/datastores#clientserver-optimization"
    }
  }, `optimization context`), ` for the entity, the function returns an empty Text.`), /* @__PURE__ */ (0, import_react2.mdx)("h4", {
    ...{
      "id": "example-7"
    }
  }, `Example`), /* @__PURE__ */ (0, import_react2.mdx)("pre", null, /* @__PURE__ */ (0, import_react2.mdx)("code", {
...
`)), /* @__PURE__ */ (0, import_react2.mdx)("h4", {
    ...
    parentName: "p",
    ...{
      "href": "/docs/fr/next/API/EntitySelectionClass#getRemoteContextAttributes"
    }
  }, `EntitySelection.getRemoteContextAttributes()`), /* @__PURE__ */ (0, import_react2.mdx)("br", null), /* @__PURE__ */ (0, import_react2.mdx)("a", {
    parentName: "p",
    ...{
      "href": "/docs/fr/next/API/DataStoreClass#clearallremotecontexts"
    }
  }, `.clearAllRemoteContexts()`), /* @__PURE__ */ (0, import_react2.mdx)("br", null), /* @__PURE__ */ (0, import_react2.mdx)("a", {
    parentName: "p",
    ...{
      "href": "/docs/fr/next/API/DataStoreClass#getremotecontextinfo"
    }
  }, `.getRemoteContextInfo()`), /* @__PURE__ */ (0, import_react2.mdx)("br", null), /* @__PURE__ */ (0, import_react2.mdx)("a", {
    parentName: "p",
    ...{
      "href": "/docs/fr/next/API/DataStoreClass#getallremotecontexts"
    }
  }, `.getAllRemoteContexts()`), /* @__PURE__ */ (0, import_react2.mdx)("br", null), /* @__PURE__ */ (0, import_react2.mdx)("a", {
    parentName: "p",
    ...{
      "href": "/docs/fr/next/API/DataStoreClass#setremotecontextinfo"
    }
...
`)), /* @__PURE__ */ (0, import_react2.mdx)("h2", {
    ...
    parentName: "ul"
  }, `automatically, when it is no longer referenced by any entities in memory. For example, if the lock is put only on one local reference of an entity, the entity is unlocked when the function ends. As long as there are references to the entity in memory, the record remains locked.`)), /* @__PURE__ */ (0, import_react2.mdx)("blockquote", null, /* @__PURE__ */ (0, import_react2.mdx)("p", {
    parentName: "blockquote"
  }, `An entity can also be `, /* @__PURE__ */ (0, import_react2.mdx)("a", {
    parentName: "p",
    ...{
      "href": "/docs/fr/next/REST/lock"
    }
  }, `locked by a REST session`), `, in which case it can only be unlocked by the session.`)), /* @__PURE__ */ (0, import_react2.mdx)("p", null, `By default, if the `, /* @__PURE__ */ (0, import_react2.mdx)("em", {
    parentName: "p"
  }, `mode`), ` parameter is omitted, the function will return an error (see below) if the same entity was modified (i.e. the stamp has changed) by another process or user in the meantime.`), /* @__PURE__ */ (0, import_react2.mdx)("p", null, `Otherwise, you can pass the `, /* @__PURE__ */ (0, import_react2.mdx)("inlineCode", {
    parentName: "p"
  ...
  }, `"Locked by record" if locked by a 4D process, "Locked by session" if locked by a REST session`)), /* @__PURE__ */ (0, import_react2.mdx)("tr", {
    parentName: "tbody"
  }, /* @__PURE__ */ (0, import_react2.mdx)("td", {
    parentName: "tr",
    ...{
  ...
  }, `URL that locked the entity (e.g. "`, /* @__PURE__ */ (0, import_react2.mdx)("a", {
    parentName: "td",
    ...{
      "href": "http://www.myserver.com%22"
    }
  }, `www.myserver.com"`), `)`)), /* @__PURE__ */ (0, import_react2.mdx)("tr", {
    parentName: "tbody"
  }, /* @__PURE__ */ (0, import_react2.mdx)("td", {
    parentName: "tr",
    ...{
  ...
  }, `userAgent of the locker (e.g. Mozilla/5.0 (Macintosh; Intel Mac OS X 10_15_3) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/96.0.4664.110 Safari/537.36")`)), /* @__PURE__ */ (0, import_react2.mdx)("tr", {
    parentName: "tbody"
  }, /* @__PURE__ */ (0, import_react2.mdx)("td", {
    parentName: "tr",
    ...{
...
`)), /* @__PURE__ */ (0, import_react2.mdx)("h2", {
    ...
    parentName: "p",
    ...{
      "href": "/docs/fr/next/API/DataClassClass#new"
    }
  }, /* @__PURE__ */ (0, import_react2.mdx)("inlineCode", {
    parentName: "a"
