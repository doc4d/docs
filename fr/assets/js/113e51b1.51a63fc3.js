...
const metadata = {
  ...
  "next": {
    ...
    "permalink": "/docs/fr/Concepts/null-undefined"
  }
};
const assets = {};
const toc = [{
...
`)), /* @__PURE__ */ (0, import_react2.mdx)("p", null, `A null date is specified by `, /* @__PURE__ */ (0, import_react2.mdx)("em", {
    ...
    parentName: "p"
  }, `Tip:`), ` The Code Editor includes a shortcut for entering a null date. To type a null date, enter the exclamation (!) character and press Enter.`), /* @__PURE__ */ (0, import_react2.mdx)("p", null, /* @__PURE__ */ (0, import_react2.mdx)("strong", {
    parentName: "p"
