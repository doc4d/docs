...
const metadata = {
  ...
  "source": "@site/docs/API/WebServerClass.md",
  "sourceDirName": "API",
  "slug": "/API/WebServerClass",
  "permalink": "/docs/fr/next/API/WebServerClass",
  "draft": false,
  "tags": [],
  "version": "current",
  "frontMatter": {
  ...
  "previous": {
    "title": "SystemWorker",
    "permalink": "/docs/fr/next/API/SystemWorkerClass"
  },
  "next": {
    "title": "ZIPArchive",
...
`)), /* @__PURE__ */ (0, import_react2.mdx)("h2", {
    ...
    parentName: "p"
  }, `False`), ` otherwise`, `.`), /* @__PURE__ */ (0, import_react2.mdx)("h5", {
    ...{
      "id": "see-also"
    }
    ...
    parentName: "p"
  }, `.scalableSession`), ` : Boolean`), /* @__PURE__ */ (0, import_react2.mdx)("p", null, `t`, /* @__PURE__ */ (0, import_react2.mdx)("inlineCode", {
    parentName: "p"
  }, `True`), ` if scalable sessions are used in the web server, and `, /* @__PURE__ */ (0, import_react2.mdx)("inlineCode", {
    parentName: "p"
  }, `False`), ` otherwise`, `.`), /* @__PURE__ */ (0, import_react2.mdx)("h5", {
    ...{
      "id": "see-also-1"
  ...
  }, `.perfectForwardSecrecy`), `, and `, `[.sessionCookieName(#sessioncookiename)]`, `).`), /* @__PURE__ */ (0, import_react2.mdx)("p", null, `Customized session settings will be reset when the `, /* @__PURE__ */ (0, import_react2.mdx)("a", {
    parentName: "p",
    ...{
      "href": "#stop"
    }
