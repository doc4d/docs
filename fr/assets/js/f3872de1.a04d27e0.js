...
const metadata = {
  ...
  "id": "version-19-R6/Concepts/methods",
  "title": "Methods",
  ...
  "source": "@site/versioned_docs/version-19-R6/Concepts/methods.md",
  "sourceDirName": "Concepts",
  "slug": "/Concepts/methods",
  "permalink": "/docs/fr/Concepts/methods",
  "draft": false,
  "tags": [],
  "version": "19-R6",
  "frontMatter": {
  ...
  "previous": {
    "title": "Arrays",
    "permalink": "/docs/fr/Concepts/arrays"
  },
  "next": {
    "title": "Parameters",
    "permalink": "/docs/fr/Concepts/parameters"
  }
};
const assets = {};
const toc = [{
  ...
  value: "Manual Execution",
  id: "manual-execution",
  level: 3
}, {
  value: "From the Code Editor",
  id: "from-the-code-editor",
  level: 4
}, {
  value: "From the Execute Method dialog box",
  id: "from-the-execute-method-dialog-box",
  level: 4
}, {
...
function MDXContent({
  ...
  return /* @__PURE__ */ (0, import_react2.mdx)(MDXLayout, {
    ...
    parentName: "p",
    ...{
      "href": "/docs/fr/Concepts/classes#class-function"
    }
    ...
    parentName: "ul"
  }, `Event or Error catching method`)), /* @__PURE__ */ (0, import_react2.mdx)("p", null, `You can also execute your project methods manually, for testing purpose for example.`), /* @__PURE__ */ (0, import_react2.mdx)("h3", {
    ...{
      "id": "subroutines"
    }
...
`)), /* @__PURE__ */ (0, import_react2.mdx)("p", null, `You can also `, /* @__PURE__ */ (0, import_react2.mdx)("a", {
    parentName: "p",
    ...{
      "href": "/docs/fr/Concepts/parameters"
    }
...
`)), /* @__PURE__ */ (0, import_react2.mdx)("h3", {
    ...
    parentName: "p"
  }, `ON ERR CALL`), `.`), /* @__PURE__ */ (0, import_react2.mdx)("h3", {
    ...{
      "id": "manual-execution"
    }
  }, `Manual Execution`), /* @__PURE__ */ (0, import_react2.mdx)("p", null, `Project methods written in your application are usually called automatically during the use of the application via menu commands, buttons, other methods, and so on. As for database methods, they are executed in relation to specific events that occur in the application.`), /* @__PURE__ */ (0, import_react2.mdx)("p", null, `However, for testing and debugging purposes, 4D lets you manually execute project methods and certain database methods in Design mode. In this case, it is possible to run the method in a new process and/or directly in Debug mode, in order to check its execution step by step.`), /* @__PURE__ */ (0, import_react2.mdx)("p", null, `You can execute methods in two ways:`), /* @__PURE__ */ (0, import_react2.mdx)("ul", null, /* @__PURE__ */ (0, import_react2.mdx)("li", {
    parentName: "ul"
  }, `From the Code Editor window,`), /* @__PURE__ */ (0, import_react2.mdx)("li", {
    parentName: "ul"
  }, `From the Execute Method dialog box (project methods only).`)), /* @__PURE__ */ (0, import_react2.mdx)("h4", {
    ...{
      "id": "from-the-code-editor"
    }
  }, `From the Code Editor`), /* @__PURE__ */ (0, import_react2.mdx)("p", null, `Each `, /* @__PURE__ */ (0, import_react2.mdx)("a", {
    parentName: "p",
    ...{
      "href": "/docs/fr/code-editor/write-class-method"
    }
  }, /* @__PURE__ */ (0, import_react2.mdx)("strong", {
    parentName: "a"
  }, `Code Editor`)), ` window has a button that can be used to run the current method. Using the menu associated with this button, you can choose the type of execution desired`), /* @__PURE__ */ (0, import_react2.mdx)("p", null, `This button is only active for project methods and for the following database methods:`), /* @__PURE__ */ (0, import_react2.mdx)("ul", null, /* @__PURE__ */ (0, import_react2.mdx)("li", {
    parentName: "ul"
  }, `On Startup`), /* @__PURE__ */ (0, import_react2.mdx)("li", {
    parentName: "ul"
  }, `On Exit`), /* @__PURE__ */ (0, import_react2.mdx)("li", {
    parentName: "ul"
  }, `On Server Startup`), /* @__PURE__ */ (0, import_react2.mdx)("li", {
    parentName: "ul"
  }, `On Server Shutdown`)), /* @__PURE__ */ (0, import_react2.mdx)("p", null, `For more information, see `, /* @__PURE__ */ (0, import_react2.mdx)("a", {
    parentName: "p",
    ...{
      "href": "/docs/fr/code-editor/write-class-method#toolbar"
    }
  }, `Toolbar`), `.`), /* @__PURE__ */ (0, import_react2.mdx)("h4", {
    ...{
      "id": "from-the-execute-method-dialog-box"
    }
  }, `From the Execute Method dialog box`), /* @__PURE__ */ (0, import_react2.mdx)("p", null, `When you select the `, /* @__PURE__ */ (0, import_react2.mdx)("strong", {
    parentName: "p"
  }, `Method...`), ` command of the `, /* @__PURE__ */ (0, import_react2.mdx)("strong", {
    parentName: "p"
  }, `Run`), ` menu,  displays the `, /* @__PURE__ */ (0, import_react2.mdx)("strong", {
    parentName: "p"
  }, `Execute Method`), ` dialog.`), /* @__PURE__ */ (0, import_react2.mdx)("p", null, `This dialog box lists all the project methods of the database, including shared project methods of components. On the other hand, project methods that have been declared invisible will not appear.`), /* @__PURE__ */ (0, import_react2.mdx)("p", null, `To execute a project method, simply select its name in the list and click on `, /* @__PURE__ */ (0, import_react2.mdx)("strong", {
    parentName: "p"
  }, `Execute`), `. To run a method step by step in Debug mode, click on `, /* @__PURE__ */ (0, import_react2.mdx)("strong", {
    parentName: "p"
  }, `Debug`), `. For more information about the 4D debugger, refer to the `, /* @__PURE__ */ (0, import_react2.mdx)("a", {
    parentName: "p",
    ...{
      "href": "/docs/fr/Debugging/basics"
    }
  }, `Debugging`), ` section.`), /* @__PURE__ */ (0, import_react2.mdx)("p", null, `If you check the `, /* @__PURE__ */ (0, import_react2.mdx)("strong", {
    parentName: "p"
  }, `New Process`), ` check box, the method you selected executes in another process. If the method is performing a time-consuming task such as printing a large set of records, you can continue to work with your database, adding records to a table, creating a graph to display data, and so on. For more information about processes, refer to `, /* @__PURE__ */ (0, import_react2.mdx)("a", {
    parentName: "p",
    ...{
      "href": "https://doc.4d.com/4Dv19R5/4D/19-R5/Processes.300-5830912.en.html"
    }
  }, `Processes`), ` the 4D `, /* @__PURE__ */ (0, import_react2.mdx)("em", {
    parentName: "p"
  }, `Language Reference`), ` manual.`), /* @__PURE__ */ (0, import_react2.mdx)("p", null, /* @__PURE__ */ (0, import_react2.mdx)("strong", {
    parentName: "p"
  }, `4D Server Notes`), `:`), /* @__PURE__ */ (0, import_react2.mdx)("ul", null, /* @__PURE__ */ (0, import_react2.mdx)("li", {
    parentName: "ul"
  }, `If you want the method to be executed on the server machine rather than on the client machine, select the `, /* @__PURE__ */ (0, import_react2.mdx)("strong", {
    parentName: "li"
  }, `On 4D Server`), ` option in the To be executed menu. In this case, a new process, call a `, /* @__PURE__ */ (0, import_react2.mdx)("em", {
    parentName: "li"
  }, `stored procedure`), `, is created on the server machine in order to execute the method. This option can be used to reduce network traffic and optimize the functioning of 4D Server, in particular for methods that call data stored on the disk. All types of methods can be executed on the server machine or on another client machine, except for those that modify the user interface. In this case, stored procedures are ineffective.`), /* @__PURE__ */ (0, import_react2.mdx)("li", {
    parentName: "ul"
  }, `You can also choose to run the method on another client workstation. Other client workstations will not appear in the menu, unless they have been previously "registered" (for more information, refer to the description of the `, /* @__PURE__ */ (0, import_react2.mdx)("a", {
    parentName: "li",
    ...{
      "href": "https://doc.4d.com/4dv19/help/command/en/page648.html"
    }
  }, `REGISTER CLIENT`), `.`)), /* @__PURE__ */ (0, import_react2.mdx)("p", null, `By default, the `, /* @__PURE__ */ (0, import_react2.mdx)("strong", {
    parentName: "p"
  }, `locally`), ` option is selected. With the 4D single-user version, this is the only option available.`), /* @__PURE__ */ (0, import_react2.mdx)("h2", {
    ...{
      "id": "recursive-project-methods"
    }
