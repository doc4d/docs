...
const metadata = {
  "unversionedId": "settings/overview",
  "id": "version-19-R6/settings/overview",
  "title": "Overview",
  "description": "The Settings configure how the current project functions. These parameters may be different for each project. They include the listening ports, backup configurations, security options, Web parameters, etc.",
  "source": "@site/versioned_docs/version-19-R6/settings/overview.md",
  "sourceDirName": "settings",
  "slug": "/settings/overview",
  "permalink": "/docs/fr/settings/overview",
  "draft": false,
  "tags": [],
  "version": "19-R6",
  "frontMatter": {
  ...
  "previous": {
    ...
    "permalink": "/docs/fr/Debugging/debugLogFiles"
  },
  "next": {
    "title": "General page",
    "permalink": "/docs/fr/settings/general"
  }
};
const assets = {};
const toc = [{
  value: "Accessing the settings",
  id: "accessing-the-settings",
  level: 2
}, {
  ...
  value: "Customizing parameters",
  id: "customizing-parameters",
  level: 2
}, {
  value: "Resetting the settings",
  id: "resetting-the-settings",
  level: 2
}];
const layoutProps = {
  toc
...
function MDXContent({
  ...
  return /* @__PURE__ */ (0, import_react2.mdx)(MDXLayout, {
    ...
    components,
    mdxType: "MDXLayout"
  }, /* @__PURE__ */ (0, import_react2.mdx)("p", null, `The Settings configure how the current project functions. These parameters may be different for each project. They include the listening ports, backup configurations, security options, Web parameters, etc.`), /* @__PURE__ */ (0, import_react2.mdx)("p", null, /* @__PURE__ */ (0, import_react2.mdx)("img", {
    src: (__webpack_require__(95836)/* ["default"] */ .Z),
    width: "863",
    height: "723"
  }), `   `), /* @__PURE__ */ (0, import_react2.mdx)("blockquote", null, /* @__PURE__ */ (0, import_react2.mdx)("p", {
    parentName: "blockquote"
  }, `4D provides another set of parameters, called `, /* @__PURE__ */ (0, import_react2.mdx)("strong", {
    parentName: "p"
  }, `Preferences`), `, that apply to the 4D IDE application. For more information, refer to `, /* @__PURE__ */ (0, import_react2.mdx)("a", {
    parentName: "p",
    ...{
      "href": "/docs/fr/Preferences/general"
    }
  }, `Preferences`), `.`)), /* @__PURE__ */ (0, import_react2.mdx)("h2", {
    ...{
      "id": "accessing-the-settings"
    }
  }, `Accessing the settings`), /* @__PURE__ */ (0, import_react2.mdx)("p", null, `You can access the Settings dialog box:`), /* @__PURE__ */ (0, import_react2.mdx)("ul", null, /* @__PURE__ */ (0, import_react2.mdx)("li", {
    parentName: "ul"
  }, `using the `, /* @__PURE__ */ (0, import_react2.mdx)("strong", {
    parentName: "li"
  }, `Design > Settings...`), ` menu option`), /* @__PURE__ */ (0, import_react2.mdx)("li", {
    parentName: "ul"
  }, `by clicking `, /* @__PURE__ */ (0, import_react2.mdx)("strong", {
    parentName: "li"
  }, `Settings`), ` on the 4D toolbar`), /* @__PURE__ */ (0, import_react2.mdx)("li", {
    parentName: "ul"
  }, `on 4D Server, using the `, /* @__PURE__ */ (0, import_react2.mdx)("strong", {
    parentName: "li"
  }, `Edit > Settings...`), ` menu option`)), /* @__PURE__ */ (0, import_react2.mdx)("p", null, `When `, /* @__PURE__ */ (0, import_react2.mdx)("a", {
    parentName: "p",
    ...{
      "href": "/docs/fr/Desktop/user-settings"
    }
  }, /* @__PURE__ */ (0, import_react2.mdx)("strong", {
    parentName: "a"
  }, `User settings`), ` mode is enabled`), `, `, /* @__PURE__ */ (0, import_react2.mdx)("strong", {
    parentName: "p"
  }, `Settings...`), ` is renamed `, /* @__PURE__ */ (0, import_react2.mdx)("strong", {
    parentName: "p"
  }, `Structure Settings...`), ` and two additional menu commands are available at each location:`), /* @__PURE__ */ (0, import_react2.mdx)("ul", null, /* @__PURE__ */ (0, import_react2.mdx)("li", {
    parentName: "ul"
  }, /* @__PURE__ */ (0, import_react2.mdx)("strong", {
    parentName: "li"
  }, `User Settings...`), ` gives you access to settings that can be stored externally in a user file. If these are modified, they are used instead of structure settings.`), /* @__PURE__ */ (0, import_react2.mdx)("li", {
    parentName: "ul"
  }, /* @__PURE__ */ (0, import_react2.mdx)("strong", {
    parentName: "li"
  }, `User Settings for Data File...`), ` gives you access to settings that can be stored externally in a user file attached to the current data file. If they are modified, they are used instead of user or structure settings.`)), /* @__PURE__ */ (0, import_react2.mdx)("h3", {
    ...{
      "id": "locking-information"
    }
  }, `Locking information`), /* @__PURE__ */ (0, import_react2.mdx)("p", null, `Locking can occur in both Project and Client/server modes when:`), /* @__PURE__ */ (0, import_react2.mdx)("ul", null, /* @__PURE__ */ (0, import_react2.mdx)("li", {
    parentName: "ul"
  }, `The `, /* @__PURE__ */ (0, import_react2.mdx)("em", {
    parentName: "li"
  }, `settings.4DSettings`), ` file is 'Read-only' (Projects only). Modifying a setting will display an alert to unlock it, if possible.`), /* @__PURE__ */ (0, import_react2.mdx)("li", {
    parentName: "ul"
  }, `Two or more users attempt to modify the same settings at the same time. The settings cannot be used until the first user frees it by closing the window. (Client/server only)`)), /* @__PURE__ */ (0, import_react2.mdx)("p", null, `In both cases, the settings can be opened in 'Read-only', but cannot be used until the lock is removed.`), /* @__PURE__ */ (0, import_react2.mdx)("h2", {
    ...{
      "id": "customizing-parameters"
    }
  }, `Customizing parameters`), /* @__PURE__ */ (0, import_react2.mdx)("p", null, `In the Settings dialog boxes, parameters whose values have been modified appear `, /* @__PURE__ */ (0, import_react2.mdx)("strong", {
    parentName: "p"
  }, `in bold`), `:`), /* @__PURE__ */ (0, import_react2.mdx)("p", null, /* @__PURE__ */ (0, import_react2.mdx)("img", {
    src: (__webpack_require__(84482)/* ["default"] */ .Z),
    width: "703",
    height: "192"
  }), `   `), /* @__PURE__ */ (0, import_react2.mdx)("p", null, `Parameters indicated as customized may have been modified directly in the dialog box, or may have been modified previously in the case of a converted project. `), /* @__PURE__ */ (0, import_react2.mdx)("p", null, `A parameter still appears in bold even when its value is replaced manually with its default values. This way it is always possible to visually identify any parameters that have been customized.`), /* @__PURE__ */ (0, import_react2.mdx)("p", null, `Most of the settings are applied immediately. However, a few of them (such as the Startup environment setting) only take effect when the database is restarted. In this case, a dialog box appears to inform you that the change will take effect at the next startup.`), /* @__PURE__ */ (0, import_react2.mdx)("h2", {
    ...{
      "id": "resetting-the-settings"
    }
  }, `Resetting the settings`), /* @__PURE__ */ (0, import_react2.mdx)("p", null, `To reset the parameters to their default values and remove the bold style indicating that they have been customized, click `, /* @__PURE__ */ (0, import_react2.mdx)("strong", {
    parentName: "p"
  }, `Reset to factory settings`), `. `), /* @__PURE__ */ (0, import_react2.mdx)("p", null, `This button resets all the parameters of the current page. It becomes active when at least one parameter has been modified on the current page.`));
}
;
...
/* harmony export */   "Z": () => (__WEBPACK_DEFAULT_EXPORT__)
/* harmony export */ });
/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = (__webpack_require__.p + "assets/images/main-eb76fd922646d74ff2d364ba82524934.png");
