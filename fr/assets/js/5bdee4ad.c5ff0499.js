...
const metadata = {
  ...
  "id": "version-19-R6/Concepts/object",
  "title": "Object",
  ...
  "source": "@site/versioned_docs/version-19-R6/Concepts/dt_object.md",
  "sourceDirName": "Concepts",
  "slug": "/Concepts/object",
  "permalink": "/docs/fr/Concepts/object",
  "draft": false,
  "tags": [],
  "version": "19-R6",
  "frontMatter": {
  ...
  "previous": {
    ...
    "permalink": "/docs/fr/Concepts/number"
  },
  "next": {
    "title": "Picture",
    "permalink": "/docs/fr/Concepts/picture"
  }
};
const assets = {};
const toc = [{
...
function MDXContent({
  ...
  return /* @__PURE__ */ (0, import_react2.mdx)(MDXLayout, {
    ...
    parentName: "li"
  }, `A property name is always a text, for example "Name". It must follow `, /* @__PURE__ */ (0, import_react2.mdx)("a", {
    parentName: "p",
    ...{
      "href": "/docs/fr/Concepts/identifiers#object-properties"
    }
  }, `specific rules`), `.`)), /* @__PURE__ */ (0, import_react2.mdx)("li", {
    parentName: "ul"
  }, /* @__PURE__ */ (0, import_react2.mdx)("p", {
    parentName: "li"
    ...
    parentName: "ul"
  }, `object(1) (objects can be nested on several levels)`), /* @__PURE__ */ (0, import_react2.mdx)("li", {
    parentName: "ul"
  }, `picture(2)`), /* @__PURE__ */ (0, import_react2.mdx)("li", {
    parentName: "ul"
  }, `collection`)))), /* @__PURE__ */ (0, import_react2.mdx)("p", null, `(1)ORDA objects such as `, /* @__PURE__ */ (0, import_react2.mdx)("a", {
    parentName: "p",
    ...{
      "href": "/docs/fr/ORDA/dsmapping#entity"
    }
  }, `entities`), ` or `, /* @__PURE__ */ (0, import_react2.mdx)("a", {
    parentName: "p",
    ...{
      "href": "/docs/fr/ORDA/dsmapping#entity-selection"
    }
  }, `entity selections`), ` cannot be stored in `, /* @__PURE__ */ (0, import_react2.mdx)("strong", {
    parentName: "p"
  }, `object fields`), `; however, they are fully supported in `, /* @__PURE__ */ (0, import_react2.mdx)("strong", {
    parentName: "p"
  }, `object variables`), ` in memory. `), /* @__PURE__ */ (0, import_react2.mdx)("p", null, `(2)When exposed as text in the debugger or exported to JSON, picture object properties print "`, `[object Picture]`, `". `), /* @__PURE__ */ (0, import_react2.mdx)("p", null, /* @__PURE__ */ (0, import_react2.mdx)("strong", {
    parentName: "p"
  }, `Warning:`), ` Keep in mind that attribute names differentiate between upper and lower case.`), /* @__PURE__ */ (0, import_react2.mdx)("p", null, `You manage Object type variables, fields or expressions using the `, /* @__PURE__ */ (0, import_react2.mdx)("a", {
    parentName: "p",
    ...{
      "href": "/docs/fr/Concepts/object#syntax-basics"
    }
  }, `object notation`), ` or the classic commands available in the `, /* @__PURE__ */ (0, import_react2.mdx)("strong", {
    parentName: "p"
  }, `Objects (Language)`), ` theme. Note that specific commands of the `, /* @__PURE__ */ (0, import_react2.mdx)("strong", {
    parentName: "p"
  }, `Queries`), ` theme such as `, /* @__PURE__ */ (0, import_react2.mdx)("inlineCode", {
    parentName: "p"
    ...
    parentName: "p"
  }, `ORDER BY ATTRIBUTE`), ` can be used to carry out processing on object fields. `), /* @__PURE__ */ (0, import_react2.mdx)("p", null, `Each property value accessed through the object notation is considered an expression. You can use such values wherever 4D expressions are expected:`), /* @__PURE__ */ (0, import_react2.mdx)("ul", null, /* @__PURE__ */ (0, import_react2.mdx)("li", {
    parentName: "ul"
  }, `in 4D code, either written in the methods (Code Editor) or externalized (formulas, 4D tags files processed by `, /* @__PURE__ */ (0, import_react2.mdx)("inlineCode", {
    parentName: "li"
  }, `PROCESS 4D TAGS`), ` or the Web Server, export files, 4D Write Pro documents...),`), /* @__PURE__ */ (0, import_react2.mdx)("li", {
    parentName: "ul"
...
`)), /* @__PURE__ */ (0, import_react2.mdx)("p", null, `For more information, please refer to the `, /* @__PURE__ */ (0, import_react2.mdx)("inlineCode", {
    ...
    parentName: "ul"
  }, `Reading a property of an undefined object or value returns undefined; assigning an undefined value to variables (except arrays) has the same effect as calling `, /* @__PURE__ */ (0, import_react2.mdx)("inlineCode", {
    parentName: "li"
  }, `CLEAR VARIABLE`), ` with them:`)), /* @__PURE__ */ (0, import_react2.mdx)("pre", null, /* @__PURE__ */ (0, import_react2.mdx)("code", {
    parentName: "pre",
    ...{
      "className": "language-4d"
    }
