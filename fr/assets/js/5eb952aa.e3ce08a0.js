...
const metadata = {
  ...
  "id": "version-18/Concepts/number",
  "title": "Number (Real, Longint, Integer)",
  "description": "Number is a generic term that stands for:",
  "source": "@site/versioned_docs/version-18/Concepts/dt_number.md",
  "sourceDirName": "Concepts",
  "slug": "/Concepts/number",
  "permalink": "/docs/fr/18/Concepts/number",
  "draft": false,
  "tags": [],
  "version": "18",
  "frontMatter": {
  ...
  "previous": {
    ...
    "permalink": "/docs/fr/18/Concepts/null-undefined"
  },
  "next": {
    "title": "Objects",
    "permalink": "/docs/fr/18/Concepts/object"
  }
};
const assets = {};
const toc = [{
...
`)), /* @__PURE__ */ (0, import_react2.mdx)("p", null, `returns 23 because the expression (4 * 5) is evaluated first, because of the parentheses. The result is 20, which is then added to 3 for the final result of 23.`), /* @__PURE__ */ (0, import_react2.mdx)("p", null, `Parentheses can be nested inside other sets of parentheses. Be sure that each left parenthesis has a matching right parenthesis to ensure proper evaluation of expressions. Lack of, or incorrect use of parentheses can cause unexpected results or invalid expressions. Furthermore, if you intend to compile your applications, you must have matching parentheses\u2014the compiler detects a missing parenthesis as a syntax error.`), /* @__PURE__ */ (0, import_react2.mdx)("h2", {
  ...
  }, `Each resulting bit is the logical AND of the bits in the two operands. Here is the logical AND table:`, /* @__PURE__ */ (0, import_react2.mdx)("ul", null, /* @__PURE__ */ (0, import_react2.mdx)("li", null, `1 & 1 --> 1`), /* @__PURE__ */ (0, import_react2.mdx)("li", null, `0 & 1 --> 0`), `1 & 0 --> 0`, /* @__PURE__ */ (0, import_react2.mdx)("li", null, `0 & 0 --> 0`)), `In other words, the resulting bit is 1 if the two operand bits are 1; otherwise the resulting bit is 0.`)), /* @__PURE__ */ (0, import_react2.mdx)("tr", {
    parentName: "tbody"
  }, /* @__PURE__ */ (0, import_react2.mdx)("td", {
    parentName: "tr",
    ...{
  ...
  }, `Each resulting bit is the logical OR of the bits in the two operands. Here is the logical OR table:`, /* @__PURE__ */ (0, import_react2.mdx)("ul", null, /* @__PURE__ */ (0, import_react2.mdx)("li", null, `1 `, `|`, ` 1 --> 1`), /* @__PURE__ */ (0, import_react2.mdx)("li", null, `0 `, `|`, ` 1 --> 1`), /* @__PURE__ */ (0, import_react2.mdx)("li", null, `1 `, `|`, ` 0 --> 1`), /* @__PURE__ */ (0, import_react2.mdx)("li", null, `0 `, `|`, ` 0 --> 0`)), ` In other words, the resulting bit is 1 if at least one of the two operand bits is 1; otherwise the resulting bit is 0.`)), /* @__PURE__ */ (0, import_react2.mdx)("tr", {
    parentName: "tbody"
  }, /* @__PURE__ */ (0, import_react2.mdx)("td", {
    parentName: "tr",
    ...{
  ...
  }, `Each resulting bit is the logical XOR of the bits in the two operands. Here is the logical XOR table: `, /* @__PURE__ */ (0, import_react2.mdx)("ul", null, /* @__PURE__ */ (0, import_react2.mdx)("li", null, `1 \\^`, `|`, ` 1 --> 0`), /* @__PURE__ */ (0, import_react2.mdx)("li", null, `0 \\^`, `|`, ` 1 --> 1`), /* @__PURE__ */ (0, import_react2.mdx)("li", null, `1 \\^`, `|`, ` 0 --> 1`), /* @__PURE__ */ (0, import_react2.mdx)("li", null, `0 \\^`, `|`, ` 0 --> 0`)), ` In other words, the resulting bit is 1 if only one of the two operand bits is 1; otherwise the resulting bit is 0.`)), /* @__PURE__ */ (0, import_react2.mdx)("tr", {
    parentName: "tbody"
  }, /* @__PURE__ */ (0, import_react2.mdx)("td", {
    parentName: "tr",
    ...{
