...
const metadata = {
  ...
  "source": "@site/docs/settings/database.md",
  "sourceDirName": "settings",
  "slug": "/settings/database",
  "permalink": "/docs/fr/next/settings/database",
  "draft": false,
  "tags": [],
  "version": "current",
  "frontMatter": {
  ...
  "previous": {
    "title": "Compiler page",
    "permalink": "/docs/fr/next/settings/compiler"
  },
  "next": {
    "title": "Backup page",
    "permalink": "/docs/fr/next/settings/backup"
  }
};
const assets = {};
const toc = [{
...
function MDXContent({
  ...
  return /* @__PURE__ */ (0, import_react2.mdx)(MDXLayout, {
    ...
    src: (__webpack_require__(12396)/* ["default"] */ .Z),
    width: "493",
    height: "184"
    ...
    src: (__webpack_require__(23884)/* ["default"] */ .Z),
    width: "774",
    height: "101"
...
When this option is not checked (default value), the at sign is used as the wildcard character, in other words, it replaces any character (see `, /* @__PURE__ */ (0, import_react2.mdx)("a", {
    ...
    parentName: "p",
    ...{
      "href": "/docs/fr/next/Preferences/general"
    }
    ...
    src: (__webpack_require__(5470)/* ["default"] */ .Z),
    width: "474",
    height: "78"
  })), /* @__PURE__ */ (0, import_react2.mdx)("h2", {
    ...{
...
Maximum size = 1 GB Minimum size = 128 MB`)), /* @__PURE__ */ (0, import_react2.mdx)("p", {
    ...
    src: (__webpack_require__(88276)/* ["default"] */ .Z),
    width: "1168",
    height: "348"
  }))), /* @__PURE__ */ (0, import_react2.mdx)("li", {
    parentName: "ul"
...
4D saves the data placed in the cache at regular intervals. You can specify any time interval between 1 second and 500 minutes. By default, 4D saves your data every 20 seconds. The application also saves your data to disk each time you change to another environment or exit the application. You can also call the `, /* @__PURE__ */ (0, import_react2.mdx)("a", {
    ...
    parentName: "p",
    ...{
      "href": "/docs/fr/next/settings/interface"
    }
  }, `Interface page`), `.`))));
}
;
