...
const metadata = {
  ...
  "id": "version-18/FormObjects/staticPicture",
  "title": "Static picture",
  "description": "Overview",
  "source": "@site/versioned_docs/version-18/FormObjects/staticPicture.md",
...
function MDXContent({
  ...
  return /* @__PURE__ */ (0, import_react2.mdx)(MDXLayout, {
  ...
  }, `Overview`), /* @__PURE__ */ (0, import_react2.mdx)("p", null, `Static pictures are `, /* @__PURE__ */ (0, import_react2.mdx)("a", {
    parentName: "p",
    ...{
      "href": "/docs/fr/18/FormObjects/formObjectsOverview#active-and-static-objects"
    }
    ...
    src: (__webpack_require__(42059)/* ["default"] */ .Z),
    width: "312",
    height: "332"
  ...
  }, `If you place a static picture on page 0 of a multi-page form, it will appear automatically as a background element on all pages. You can also include it in an inherited form, applied in the background of other different forms. Either way, your database will run faster than if the picture was pasted into each page.`)), /* @__PURE__ */ (0, import_react2.mdx)("h2", {
    ...{
      "id": "format-and-location"
    }
    ...
    parentName: "li"
  }, `Resources`), ` folder of the project database. Appropriate when you want to share static pictures between several forms in the database. In this case, the Pathname is in the "/RESOURCES/\\<picture path`, `>`, `".`), /* @__PURE__ */ (0, import_react2.mdx)("li", {
    parentName: "ul"
