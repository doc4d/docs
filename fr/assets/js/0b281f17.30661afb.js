...
const metadata = {
  ...
  "id": "Users/editing",
  "title": "Managing 4D users and groups",
  "description": "In multi-user applications, 4D provides users with certain standard access privileges and certain powers. Once a users and groups system has been initiated, these standard privileges take effect.",
  "source": "@site/docs/Users/handling_users_groups.md",
  "sourceDirName": "Users",
  "slug": "/Users/editing",
  "permalink": "/docs/fr/next/Users/editing",
  "draft": false,
  "tags": [],
  "version": "current",
  "frontMatter": {
  ...
  "previous": {
    ...
    "permalink": "/docs/fr/next/Users/overview"
  },
  "next": {
    "title": "Overview",
    "permalink": "/docs/fr/next/MSC/overview"
  }
};
const assets = {};
const toc = [{
  value: "Users and groups in projects",
  id: "users-and-groups-in-projects",
  level: 2
}, {
...
function MDXContent({
  ...
  return /* @__PURE__ */ (0, import_react2.mdx)(MDXLayout, {
    ...
    components,
    mdxType: "MDXLayout"
  }, /* @__PURE__ */ (0, import_react2.mdx)("p", null, `In multi-user applications, 4D provides users with certain standard access privileges and certain powers. Once a users and groups system has been initiated, these standard privileges take effect. `), /* @__PURE__ */ (0, import_react2.mdx)("h2", {
    ...{
      "id": "users-and-groups-in-projects"
    }
  }, `Users and groups in projects`), /* @__PURE__ */ (0, import_react2.mdx)("p", null, `In project applications (.4DProject or .4dz files), 4D users and groups can be configured in both single-user and multi-user environments. However, `, /* @__PURE__ */ (0, import_react2.mdx)("strong", {
    parentName: "p"
  }, `access control`), ` is only effective with 4D Server. The following table lists the main users and groups features and their availability:`), /* @__PURE__ */ (0, import_react2.mdx)("table", null, /* @__PURE__ */ (0, import_react2.mdx)("thead", {
    parentName: "table"
  ...
  }, `4D (single-user)`), /* @__PURE__ */ (0, import_react2.mdx)("th", {
    parentName: "tr",
    ...{
      "align": null
    }
  ...
  }, `yes`)))), /* @__PURE__ */ (0, import_react2.mdx)("blockquote", null, /* @__PURE__ */ (0, import_react2.mdx)("p", {
    parentName: "blockquote"
  }, `For information about user identification and access control in single-user deployments, see `, /* @__PURE__ */ (0, import_react2.mdx)("a", {
    parentName: "p",
    ...{
      "href": "/docs/fr/next/Users/overview#access-control-in-single-user-applications"
    }
  }, `this paragraph`), `. `)), /* @__PURE__ */ (0, import_react2.mdx)("h2", {
    ...{
      "id": "designer-and-administrator"
    }
  }, `Designer and Administrator`), /* @__PURE__ */ (0, import_react2.mdx)("p", null, `The most powerful user is named `, /* @__PURE__ */ (0, import_react2.mdx)("strong", {
    parentName: "p"
  }, `Designer`), `. No aspect of the application is closed to the Designer.
The Designer can:`), /* @__PURE__ */ (0, import_react2.mdx)("ul", null, /* @__PURE__ */ (0, import_react2.mdx)("li", {
    parentName: "ul"
  }, `access all application servers without restriction,`), /* @__PURE__ */ (0, import_react2.mdx)("li", {
    parentName: "ul"
...
In client/server environment, assigning a password to the Designer activates the display of the 4D user login dialog.  Access to Design environment is read-only.`)), /* @__PURE__ */ (0, import_react2.mdx)("p", null, `After the Designer, the next most powerful user is the `, /* @__PURE__ */ (0, import_react2.mdx)("strong", {
    ...
    parentName: "ul"
  }, `by default, access to protected parts of the application. In particular, the Administrator cannot access to the Design mode if it is restricted. The Administrator must be part of one or more groups to have access privileges in the application. The Administrator is placed in every new group, but you can remove the Administrator\u2019s name from any group.`)), /* @__PURE__ */ (0, import_react2.mdx)("p", null, `Both the Designer and Administrator are available by default in all applications. In the `, /* @__PURE__ */ (0, import_react2.mdx)("a", {
    parentName: "p",
    ...{
    ...
    src: (__webpack_require__(42340)/* ["default"] */ .Z),
    width: "15",
    height: "15"
  })), /* @__PURE__ */ (0, import_react2.mdx)("li", {
    parentName: "ul"
  }, `Administrator icon: `, /* @__PURE__ */ (0, import_react2.mdx)("img", {
    src: (__webpack_require__(51759)/* ["default"] */ .Z),
    width: "15",
    height: "15"
    ...
    src: (__webpack_require__(65509)/* ["default"] */ .Z),
    width: "778",
    height: "276"
    ...
    parentName: "p",
    ...{
      "href": "https://doc.4d.com/4dv19R/help/command/en/page281.html"
    }
  }, `EDIT ACCESS`), ` command.
The whole users and groups configuration can also be edited during application execution using 4D language commands of the `, /* @__PURE__ */ (0, import_react2.mdx)("inlineCode", {
    parentName: "p"
  }, `Users and Groups`), ` theme.  `)), /* @__PURE__ */ (0, import_react2.mdx)("h3", {
    ...{
      "id": "adding-and-modifying-users"
    }
...
4D displays the users editor. `)), /* @__PURE__ */ (0, import_react2.mdx)("p", null, `The list of users displays all the users, including the `, /* @__PURE__ */ (0, import_react2.mdx)("a", {
    ...
    src: (__webpack_require__(56254)/* ["default"] */ .Z),
    width: "20",
    height: "16"
...
This name will be used by the user to open the application. You can rename a user at any time using the `, /* @__PURE__ */ (0, import_react2.mdx)("strong", {
    parentName: "p"
...
You can use up to 15 alphanumeric characters for a password. The password editor is case sensitive.`))), /* @__PURE__ */ (0, import_react2.mdx)("blockquote", null, /* @__PURE__ */ (0, import_react2.mdx)("p", {
    parentName: "blockquote"
  }, `Users can change their password at any time according to the options in the "Security" page of the structure settings, or using the `, /* @__PURE__ */ (0, import_react2.mdx)("inlineCode", {
    parentName: "p"
...
`, /* @__PURE__ */ (0, import_react2.mdx)("img", {
    src: (__webpack_require__(70793)/* ["default"] */ .Z),
    width: "19",
    height: "18"
    ...
    parentName: "p"
  }, `Startup Method`), `: Name of an associated method that will be automatically executed when the user opens the application (optional). This method can be used for example to load the user preferences. `))), /* @__PURE__ */ (0, import_react2.mdx)("h2", {
    ...{
      "id": "groups-editor"
    }
...
4D displays the groups editor window. The list of groups displays all the groups of the application project.`)), /* @__PURE__ */ (0, import_react2.mdx)("li", {
    parentName: "ol"
  }, /* @__PURE__ */ (0, import_react2.mdx)("p", {
    parentName: "li"
  }, `Click on the `, /* @__PURE__ */ (0, import_react2.mdx)("img", {
...
You can rename a group at any time using the `, /* @__PURE__ */ (0, import_react2.mdx)("strong", {
    ...
    src: (__webpack_require__(2324)/* ["default"] */ .Z),
    width: "450",
    height: "263"
...
`, /* @__PURE__ */ (0, import_react2.mdx)("img", {
    src: (__webpack_require__(54867)/* ["default"] */ .Z),
    width: "778",
    height: "575"
  }))), /* @__PURE__ */ (0, import_react2.mdx)("li", {
    parentName: "ul"
...
`, /* @__PURE__ */ (0, import_react2.mdx)("img", {
    src: (__webpack_require__(58727)/* ["default"] */ .Z),
    width: "778",
    height: "575"
  }))), /* @__PURE__ */ (0, import_react2.mdx)("li", {
    parentName: "ul"
...
`, /* @__PURE__ */ (0, import_react2.mdx)("img", {
    src: (__webpack_require__(67732)/* ["default"] */ .Z),
    width: "778",
    height: "575"
  })))), /* @__PURE__ */ (0, import_react2.mdx)("p", null, `You can decide which access privileges to assign to each group based on the level of responsibility of the users it includes.`), /* @__PURE__ */ (0, import_react2.mdx)("p", null, `Such a hierarchical system makes it easy to remember to which group a new user should be assigned. You only have to assign each user to one group and use the hierarchy of groups to determine access.`), /* @__PURE__ */ (0, import_react2.mdx)("h2", {
    ...{
      "id": "assigning-group-access"
    }
  }, `Assigning group access`), /* @__PURE__ */ (0, import_react2.mdx)("p", null, `Groups are assigned access privileges to specific parts or features of the application: `), /* @__PURE__ */ (0, import_react2.mdx)("ul", null, /* @__PURE__ */ (0, import_react2.mdx)("li", {
    parentName: "ul"
  }, `Design and Runtime Explorer access, `), /* @__PURE__ */ (0, import_react2.mdx)("li", {
    parentName: "ul"
  }, `HTTP server, `), /* @__PURE__ */ (0, import_react2.mdx)("li", {
    parentName: "ul"
  }, `REST server, `), /* @__PURE__ */ (0, import_react2.mdx)("li", {
    parentName: "ul"
  }, `SQL server. `)), /* @__PURE__ */ (0, import_react2.mdx)("p", null, `These accesses are defined in the Settings dialog. The following example shows Design and Runtime explorer access rights being assigned to the "Devs" group: `), /* @__PURE__ */ (0, import_react2.mdx)("p", null, /* @__PURE__ */ (0, import_react2.mdx)("img", {
    src: (__webpack_require__(96003)/* ["default"] */ .Z),
    width: "552",
    height: "121"
  })), /* @__PURE__ */ (0, import_react2.mdx)("p", null, `You also use groups to `, /* @__PURE__ */ (0, import_react2.mdx)("a", {
    parentName: "p",
    ...{
      "href": "#assigning-a-group-to-a-plug-in-or-to-a-server"
    }
  }, `distribute available licenses`), `. This distribution is defined in the Groups editor.`), /* @__PURE__ */ (0, import_react2.mdx)("h2", {
    ...{
      "id": "directoryjson-file"
    }
  }, `Directory.json file`), /* @__PURE__ */ (0, import_react2.mdx)("p", null, `Users, groups, as well as their access rights are stored in a specific project file named `, /* @__PURE__ */ (0, import_react2.mdx)("strong", {
    parentName: "p"
  }, `directory.json`), `.`), /* @__PURE__ */ (0, import_react2.mdx)("p", null, `This file can be stored at the following locations, depending on your needs:`), /* @__PURE__ */ (0, import_react2.mdx)("ul", null, /* @__PURE__ */ (0, import_react2.mdx)("li", {
    parentName: "ul"
  }, `If you want to use the same directory for all data files (or if you use a single data file), store the `, /* @__PURE__ */ (0, import_react2.mdx)("strong", {
    parentName: "li"
  }, `directory.json`), ` file in the user settings folder, i.e. in the "Settings" folder at the `, /* @__PURE__ */ (0, import_react2.mdx)("a", {
    parentName: "li",
    ...{
      "href": "/docs/fr/next/Project/architecture#project-folder"
    }
  }, `same level as the "Project" folder`), ` (default location). `), /* @__PURE__ */ (0, import_react2.mdx)("li", {
    parentName: "ul"
  }, `If you want to use a specific directory file per data file, store the `, /* @__PURE__ */ (0, import_react2.mdx)("strong", {
    parentName: "li"
  }, `directory.json`), ` file in the data settings folder, i.e. in the `, /* @__PURE__ */ (0, import_react2.mdx)("a", {
    parentName: "li",
    ...{
      "href": "/docs/fr/next/Project/architecture#settings"
    }
  }, `"Settings" folder of the "Data" folder`), `. If a `, /* @__PURE__ */ (0, import_react2.mdx)("strong", {
    parentName: "li"
  }, `directory.json`), ` file is present at this location, it takes priority over the file in the user settings folder. This custom/local Users and Groups configuration will left untouched by an application upgrade.  `)), /* @__PURE__ */ (0, import_react2.mdx)("blockquote", null, /* @__PURE__ */ (0, import_react2.mdx)("p", {
    parentName: "blockquote"
  }, `To allow for safe changes of passwords and group memberships in a deployed environment, you can include your `, /* @__PURE__ */ (0, import_react2.mdx)("strong", {
    parentName: "p"
  }, `directory.json`), ` file in the server application during the build, using the `, /* @__PURE__ */ (0, import_react2.mdx)("a", {
    parentName: "p",
    ...{
      "href": "/docs/fr/next/Desktop/building#embed-the-project-users-and-groups-in-built-server-application"
    }
  }, `corresponding build application option`), `.`)));
}
;
