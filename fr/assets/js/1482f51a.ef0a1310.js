...
const metadata = {
  ...
  "source": "@site/docs/API/CollectionClass.md",
  "sourceDirName": "API",
  ...
  "previous": {
    "title": "Class",
    "permalink": "/docs/fr/next/API/ClassClass"
  },
  "next": {
    "title": "CryptoKey",
...
function MDXContent({
  ...
  return /* @__PURE__ */ (0, import_react2.mdx)(MDXLayout, {
    ...
    parentName: "p",
    ...{
      "href": "/docs/fr/next/Concepts/collection"
    }
...
`)), /* @__PURE__ */ (0, import_react2.mdx)("h2", {
    ...
    parentName: "p",
    ...{
      "href": "/docs/fr/next/Concepts/shared#useend-use"
    }
  }, /* @__PURE__ */ (0, import_react2.mdx)("inlineCode", {
    parentName: "a"
    ...
    parentName: "p",
    ...{
      "href": "/docs/fr/next/Concepts/shared"
    }
...
`)), /* @__PURE__ */ (0, import_react2.mdx)("h2", {
  ...
  }, `Support of formula`)), /* @__PURE__ */ (0, import_react2.mdx)("tr", {
    parentName: "tbody"
  }, /* @__PURE__ */ (0, import_react2.mdx)("td", {
    parentName: "tr",
    ...{
    ...
    parentName: "p"
  }, `formula`), ` : 4D.Function { ;`, /* @__PURE__ */ (0, import_react2.mdx)("em", {
    parentName: "p"
  ...
  }, `Name of a method`)), /* @__PURE__ */ (0, import_react2.mdx)("tr", {
    parentName: "tbody"
  }, /* @__PURE__ */ (0, import_react2.mdx)("td", {
    parentName: "tr",
    ...{
    ...
    parentName: "td"
  }, `formula`), ` or `, /* @__PURE__ */ (0, import_react2.mdx)("em", {
    parentName: "td"
    ...
    parentName: "p"
  }, `formula`), ` object or `, /* @__PURE__ */ (0, import_react2.mdx)("em", {
    parentName: "p"
  }, `methodName`), ` name`, `.`), /* @__PURE__ */ (0, import_react2.mdx)("p", null, `You designate the callback to be executed to evaluate collection elements using either:`), /* @__PURE__ */ (0, import_react2.mdx)("ul", null, /* @__PURE__ */ (0, import_react2.mdx)("li", {
    parentName: "ul"
  }, /* @__PURE__ */ (0, import_react2.mdx)("em", {
    parentName: "li"
  }, `formula`), ` (recommended syntax), a `, /* @__PURE__ */ (0, import_react2.mdx)("a", {
    parentName: "li",
    ...{
      "href": "/docs/fr/next/API/FunctionClass"
    }
  }, `Formula object`), ` that can encapsulate any executable expressions, including functions and project methods;`), /* @__PURE__ */ (0, import_react2.mdx)("li", {
    parentName: "ul"
  }, `or `, /* @__PURE__ */ (0, import_react2.mdx)("em", {
    parentName: "li"
  }, `methodName`), `, the name of a project method (text).`)), /* @__PURE__ */ (0, import_react2.mdx)("p", null, `The callback is called with the parameter(s) passed in `, /* @__PURE__ */ (0, import_react2.mdx)("em", {
    parentName: "p"
  }, `param`), ` (optional). The callback can perform any test, with or without the parameter(s) and must return `, /* @__PURE__ */ (0, import_react2.mdx)("strong", {
    parentName: "p"
  }, `true`), ` for every element fulfilling the test. It receives an `, /* @__PURE__ */ (0, import_react2.mdx)("inlineCode", {
    parentName: "p"
  }, `Object`), ` in first parameter ($1).`), /* @__PURE__ */ (0, import_react2.mdx)("p", null, `The callback receives the following parameters:`), /* @__PURE__ */ (0, import_react2.mdx)("ul", null, /* @__PURE__ */ (0, import_react2.mdx)("li", {
    parentName: "ul"
    ...
    parentName: "li"
  }, `$N...`), `: paramN...`)), /* @__PURE__ */ (0, import_react2.mdx)("p", null, `It can set the following parameter(s):`), /* @__PURE__ */ (0, import_react2.mdx)("ul", null, /* @__PURE__ */ (0, import_react2.mdx)("li", {
    parentName: "ul"
  }, `(mandatory if you used a method) `, /* @__PURE__ */ (0, import_react2.mdx)("em", {
    parentName: "li"
    ...
    parentName: "p"
  }, `.every()`), ` function encounters the first collection element evaluated to `, /* @__PURE__ */ (0, import_react2.mdx)("strong", {
    parentName: "p"
  }, `false`), `, it stops calling the callback and returns `, /* @__PURE__ */ (0, import_react2.mdx)("strong", {
    parentName: "p"
...
`)), /* @__PURE__ */ (0, import_react2.mdx)("h2", {
  ...
  }, `.extract()`), /* @__PURE__ */ (0, import_react2.mdx)("details", null, /* @__PURE__ */ (0, import_react2.mdx)("summary", null, "History"), /* @__PURE__ */ (0, import_react2.mdx)("p", null, `|Version|Changes|`), /* @__PURE__ */ (0, import_react2.mdx)("p", null, `|---|---|
|v16 R6|Added|`)), /* @__PURE__ */ (0, import_react2.mdx)("p", null, /* @__PURE__ */ (0, import_react2.mdx)("strong", {
    parentName: "p"
    ...
    parentName: "p"
  }, `option`), ` parameter to include these values as null elements in the returned collection.`))), /* @__PURE__ */ (0, import_react2.mdx)("ul", null, /* @__PURE__ */ (0, import_react2.mdx)("li", {
    parentName: "ul"
...
`)), /* @__PURE__ */ (0, import_react2.mdx)("h2", {
    ...
    parentName: "p"
  }, `...param`), ` : any } ) : Collection`, /* @__PURE__ */ (0, import_react2.mdx)("br", null), /* @__PURE__ */ (0, import_react2.mdx)("strong", {
    parentName: "p"
  }, `.filter`), `( `, /* @__PURE__ */ (0, import_react2.mdx)("em", {
    parentName: "p"
  }, `methodName`), ` : Text { ; `, /* @__PURE__ */ (0, import_react2.mdx)("em", {
    ...
    parentName: "p"
  }, `.filter()`), ` function `, `returns a new collection containing all elements of the original collection for which the `, /* @__PURE__ */ (0, import_react2.mdx)("em", {
    parentName: "p"
  }, `formula`), ` or `, /* @__PURE__ */ (0, import_react2.mdx)("em", {
    parentName: "p"
  }, `methodName`), ` result is `, /* @__PURE__ */ (0, import_react2.mdx)("strong", {
    parentName: "p"
    ...
    parentName: "blockquote"
  }, `This function does not modify the original collection.`)), /* @__PURE__ */ (0, import_react2.mdx)("p", null, `You designate the callback to be executed to filter collection elements using either:`), /* @__PURE__ */ (0, import_react2.mdx)("ul", null, /* @__PURE__ */ (0, import_react2.mdx)("li", {
    parentName: "ul"
  }, /* @__PURE__ */ (0, import_react2.mdx)("em", {
    parentName: "li"
  }, `formula`), ` (recommended syntax), a `, /* @__PURE__ */ (0, import_react2.mdx)("a", {
    ...
    parentName: "p"
  }, `true`), ` for each element fulfilling the condition and thus, to push to the new collection. It receives an `, /* @__PURE__ */ (0, import_react2.mdx)("inlineCode", {
    parentName: "p"
  }, `Object`), ` in first parameter ($1).`), /* @__PURE__ */ (0, import_react2.mdx)("p", null, `The callback receives the following parameters:`), /* @__PURE__ */ (0, import_react2.mdx)("ul", null, /* @__PURE__ */ (0, import_react2.mdx)("li", {
    parentName: "ul"
  }, `in `, /* @__PURE__ */ (0, import_react2.mdx)("em", {
    ...
    parentName: "li"
  }, `true`), ` if the element value matches the filter condition and must be kept, `, /* @__PURE__ */ (0, import_react2.mdx)("strong", {
    parentName: "li"
  }, `false`), ` otherwise.`), /* @__PURE__ */ (0, import_react2.mdx)("li", {
    parentName: "ul"
  }, /* @__PURE__ */ (0, import_react2.mdx)("em", {
...
`)), /* @__PURE__ */ (0, import_react2.mdx)("h2", {
    ...
    parentName: "p"
  }, `methodName`), ` result, applied on each element, returns `, /* @__PURE__ */ (0, import_react2.mdx)("strong", {
    parentName: "p"
  }, `true`), `.`), /* @__PURE__ */ (0, import_react2.mdx)("blockquote", null, /* @__PURE__ */ (0, import_react2.mdx)("p", {
    parentName: "blockquote"
  }, `This function does not modify the original collection.`)), /* @__PURE__ */ (0, import_react2.mdx)("p", null, `You designate the callback to be executed to evaluate collection elements using either:`), /* @__PURE__ */ (0, import_react2.mdx)("ul", null, /* @__PURE__ */ (0, import_react2.mdx)("li", {
    parentName: "ul"
  }, /* @__PURE__ */ (0, import_react2.mdx)("em", {
    parentName: "li"
  }, `formula`), ` (recommended syntax), a `, /* @__PURE__ */ (0, import_react2.mdx)("a", {
    ...
    parentName: "p"
  }, `true`), ` for the first element fulfilling the condition. It receives an `, /* @__PURE__ */ (0, import_react2.mdx)("inlineCode", {
    parentName: "p"
  }, `Object`), ` in first parameter ($1).`), /* @__PURE__ */ (0, import_react2.mdx)("p", null, `The callback receives the following parameters:`), /* @__PURE__ */ (0, import_react2.mdx)("ul", null, /* @__PURE__ */ (0, import_react2.mdx)("li", {
    parentName: "ul"
  }, `in `, /* @__PURE__ */ (0, import_react2.mdx)("em", {
    ...
    parentName: "li"
  }, `true`), ` if the element value matches the search condition, `, /* @__PURE__ */ (0, import_react2.mdx)("strong", {
    parentName: "li"
  }, `false`), ` otherwise.`), /* @__PURE__ */ (0, import_react2.mdx)("li", {
    parentName: "ul"
  }, /* @__PURE__ */ (0, import_react2.mdx)("em", {
...
`, /* @__PURE__ */ (0, import_react2.mdx)("strong", {
  ...
  }, `Example 1`), /* @__PURE__ */ (0, import_react2.mdx)("p", null, `You want to get the first text element with a length smaller than 5:`), /* @__PURE__ */ (0, import_react2.mdx)("pre", null, /* @__PURE__ */ (0, import_react2.mdx)("code", {
    parentName: "pre",
    ...{
      "className": "language-4d"
    }
...
`)), /* @__PURE__ */ (0, import_react2.mdx)("h2", {
    ...
    parentName: "p"
  }, `formula`), ` 4D function or `, /* @__PURE__ */ (0, import_react2.mdx)("em", {
    parentName: "p"
    ...
    parentName: "p"
  }, `param`), ` (optional). The callback can perform any operation, with or without the parameter(s) and must return new transformed value to add to the resulting collection. It receives an `, /* @__PURE__ */ (0, import_react2.mdx)("inlineCode", {
    parentName: "p"
  }, `Object`), ` in first parameter ($1).`), /* @__PURE__ */ (0, import_react2.mdx)("p", null, `The callback receives the following parameters:`), /* @__PURE__ */ (0, import_react2.mdx)("ul", null, /* @__PURE__ */ (0, import_react2.mdx)("li", {
    parentName: "ul"
  }, `in `, /* @__PURE__ */ (0, import_react2.mdx)("em", {
...
`)), /* @__PURE__ */ (0, import_react2.mdx)("h2", {
    ...
    parentName: "p"
  }, `extraParam`), ` : expression } ) : Collection`, /* @__PURE__ */ (0, import_react2.mdx)("br", null), /* @__PURE__ */ (0, import_react2.mdx)("strong", {
    parentName: "p"
  }, `.orderByMethod`), `( `, /* @__PURE__ */ (0, import_react2.mdx)("em", {
    parentName: "p"
  }, `methodName`), ` : Text { ; ...`, /* @__PURE__ */ (0, import_react2.mdx)("em", {
  ...
  }, `Parameter(s) to pass`)), /* @__PURE__ */ (0, import_react2.mdx)("tr", {
    parentName: "tbody"
  }, /* @__PURE__ */ (0, import_react2.mdx)("td", {
    parentName: "tr",
    ...{
    ...
    parentName: "li"
  }, `methodName`), `, the name of a project method (text).`)), /* @__PURE__ */ (0, import_react2.mdx)("p", null, `In the callback, pass some code that compares two values and returns `, /* @__PURE__ */ (0, import_react2.mdx)("strong", {
    parentName: "p"
  }, `true`), ` if the first value is lower than the second value. You can provide `, /* @__PURE__ */ (0, import_react2.mdx)("em", {
    parentName: "p"
  }, `extraParam`), ` parameters to the callback if necessary.`), /* @__PURE__ */ (0, import_react2.mdx)("p", null, `The callback receives the following parameters:`), /* @__PURE__ */ (0, import_react2.mdx)("ul", null, /* @__PURE__ */ (0, import_react2.mdx)("li", {
    parentName: "ul"
    ...
    parentName: "ul"
  }, `$2...$N (any type): extra parameters`)))), /* @__PURE__ */ (0, import_react2.mdx)("p", null, `If you used a method, it must set the following parameter:`), /* @__PURE__ */ (0, import_react2.mdx)("ul", null, /* @__PURE__ */ (0, import_react2.mdx)("li", {
    parentName: "ul"
  }, /* @__PURE__ */ (0, import_react2.mdx)("em", {
    parentName: "li"
  }, `$1.result`), ` (boolean): `, /* @__PURE__ */ (0, import_react2.mdx)("strong", {
...
`)), /* @__PURE__ */ (0, import_react2.mdx)("p", null, `For detailed information on how to build a query using `, /* @__PURE__ */ (0, import_react2.mdx)("em", {
    ...
    parentName: "p",
    ...{
      "href": "/docs/fr/next/API/DataClassClass#query"
    }
  }, /* @__PURE__ */ (0, import_react2.mdx)("inlineCode", {
    parentName: "a"
...
`)), /* @__PURE__ */ (0, import_react2.mdx)("h4", {
    ...
    parentName: "p"
  }, `...param`), ` : expression }} ) : any`, /* @__PURE__ */ (0, import_react2.mdx)("br", null), /* @__PURE__ */ (0, import_react2.mdx)("strong", {
    parentName: "p"
  }, `.reduce`), `( `, /* @__PURE__ */ (0, import_react2.mdx)("em", {
    parentName: "p"
  }, `methodName`), ` : Text { ; `, /* @__PURE__ */ (0, import_react2.mdx)("em", {
    ...
    parentName: "p"
  }, `methodName`), ` callback against an accumulator and each element in the collection (from left to right) to reduce it to a single value`, `.`), /* @__PURE__ */ (0, import_react2.mdx)("blockquote", null, /* @__PURE__ */ (0, import_react2.mdx)("p", {
    parentName: "blockquote"
  }, `This function does not modify the original collection.`)), /* @__PURE__ */ (0, import_react2.mdx)("p", null, `You designate the callback to be executed to evaluate collection elements using either:`), /* @__PURE__ */ (0, import_react2.mdx)("ul", null, /* @__PURE__ */ (0, import_react2.mdx)("li", {
    parentName: "ul"
  }, /* @__PURE__ */ (0, import_react2.mdx)("em", {
    ...
    parentName: "li"
  }, `methodName`), `, the name of a project method (text).`)), /* @__PURE__ */ (0, import_react2.mdx)("p", null, `The callback takes each collection element and performs any desired operation to accumulate the result into `, /* @__PURE__ */ (0, import_react2.mdx)("em", {
    parentName: "p"
    ...
    parentName: "p"
  }, `Undefined`), `.`), /* @__PURE__ */ (0, import_react2.mdx)("p", null, `The callback receives the following parameters:`), /* @__PURE__ */ (0, import_react2.mdx)("ul", null, /* @__PURE__ */ (0, import_react2.mdx)("li", {
    parentName: "ul"
  }, `in `, /* @__PURE__ */ (0, import_react2.mdx)("em", {
    parentName: "li"
    ...
    parentName: "li"
  }, `paramN...`))), /* @__PURE__ */ (0, import_react2.mdx)("p", null, `The callback sets the following parameter(s):`), /* @__PURE__ */ (0, import_react2.mdx)("ul", null, /* @__PURE__ */ (0, import_react2.mdx)("li", {
    parentName: "ul"
  }, /* @__PURE__ */ (0, import_react2.mdx)("em", {
    parentName: "li"
...
`)), /* @__PURE__ */ (0, import_react2.mdx)("h2", {
    ...
    parentName: "p"
  }, `methodName`), ` code`, `.`), /* @__PURE__ */ (0, import_react2.mdx)("p", null, `You designate the 4D code (callback) to be executed to evaluate collection elements using either:`), /* @__PURE__ */ (0, import_react2.mdx)("ul", null, /* @__PURE__ */ (0, import_react2.mdx)("li", {
    parentName: "ul"
  }, /* @__PURE__ */ (0, import_react2.mdx)("em", {
    parentName: "li"
  }, `formula`), ` (recommended syntax), a `, /* @__PURE__ */ (0, import_react2.mdx)("a", {
    ...
    parentName: "li"
  }, `paramN...`))), /* @__PURE__ */ (0, import_react2.mdx)("p", null, `It can set the following parameter(s):`), /* @__PURE__ */ (0, import_react2.mdx)("ul", null, /* @__PURE__ */ (0, import_react2.mdx)("li", {
    parentName: "ul"
  }, `(mandatory if you used a method) `, /* @__PURE__ */ (0, import_react2.mdx)("em", {
    parentName: "li"
  }, `$1.result`), ` (boolean): `, /* @__PURE__ */ (0, import_react2.mdx)("strong", {
    ...
    parentName: "p"
  }, `.some()`), ` function encounters the first collection element returning true, it stops calling the callback and returns `, /* @__PURE__ */ (0, import_react2.mdx)("strong", {
    parentName: "p"
  ...
  }, `Example`), /* @__PURE__ */ (0, import_react2.mdx)("p", null, `You want to know if at least one collection value is >0.`), /* @__PURE__ */ (0, import_react2.mdx)("pre", null, /* @__PURE__ */ (0, import_react2.mdx)("code", {
    parentName: "pre",
    ...{
      "className": "language-4d"
    }
...
`)), /* @__PURE__ */ (0, import_react2.mdx)("h2", {
    ...
    parentName: "p"
  }, `...extraParam`), ` : any } ) : Collection`, /* @__PURE__ */ (0, import_react2.mdx)("br", null), /* @__PURE__ */ (0, import_react2.mdx)("strong", {
    parentName: "p"
  }, `.sort`), `( `, /* @__PURE__ */ (0, import_react2.mdx)("em", {
    parentName: "p"
  }, `methodName`), ` : Text { ; `, /* @__PURE__ */ (0, import_react2.mdx)("em", {
    ...
    parentName: "p"
  }, `formula`), ` (`, /* @__PURE__ */ (0, import_react2.mdx)("a", {
    parentName: "p",
    ...{
      "href": "/docs/fr/next/API/FunctionClass"
    }
    ...
    parentName: "p"
  }, `methodName`), ` (Text) a comparison callback that compares two values and returns `, /* @__PURE__ */ (0, import_react2.mdx)("strong", {
    parentName: "p"
  }, `true`), ` if the first value is lower than the second value. You can provide additional parameters to the callback if necessary.`), /* @__PURE__ */ (0, import_react2.mdx)("p", null, `The callback receives the following parameters:`), /* @__PURE__ */ (0, import_react2.mdx)("ul", null, /* @__PURE__ */ (0, import_react2.mdx)("li", {
    parentName: "ul"
  }, `$1 (object), where:`, /* @__PURE__ */ (0, import_react2.mdx)("ul", {
    parentName: "li"
  }, /* @__PURE__ */ (0, import_react2.mdx)("li", {
    ...
    parentName: "ul"
  }, `$2...$N (any type): extra parameters`)), /* @__PURE__ */ (0, import_react2.mdx)("p", null, `If you used a method, you must set the folllowing parameter:`), /* @__PURE__ */ (0, import_react2.mdx)("ul", null, /* @__PURE__ */ (0, import_react2.mdx)("li", {
    parentName: "ul"
  }, /* @__PURE__ */ (0, import_react2.mdx)("em", {
    parentName: "li"
  }, `$1.result`), ` (boolean): `, /* @__PURE__ */ (0, import_react2.mdx)("strong", {
