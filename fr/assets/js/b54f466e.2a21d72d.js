...
const metadata = {
  ...
  "id": "version-19/Concepts/classes",
  "title": "Classes",
  "description": "Overview",
  "source": "@site/versioned_docs/version-19/Concepts/classes.md",
  "sourceDirName": "Concepts",
  "slug": "/Concepts/classes",
  "permalink": "/docs/fr/19/Concepts/classes",
  "draft": false,
  "tags": [],
  "version": "19",
  "frontMatter": {
  ...
  "previous": {
    ...
    "permalink": "/docs/fr/19/Concepts/shared"
  },
  "next": {
    "title": "Control flow overview",
    "permalink": "/docs/fr/19/Concepts/control-flow"
  }
};
const assets = {};
const toc = [{
  ...
  value: "Using 4D interface",
  id: "using-4d-interface",
  level: 3
}, {
  ...
  value: "Class extends <code>&lt;ClassName&gt;</code>",
  ...
  value: "OB Class ( object ) -&gt; Object | Null",
  id: "ob-class--object----object--null",
  level: 4
}, {
  value: "OB Instance of",
  id: "ob-instance-of",
  level: 3
}, {
  value: "OB Instance of ( object ; class ) -&gt; Boolean",
...
function MDXContent({
  ...
  }, `functions`), `.`), /* @__PURE__ */ (0, import_react2.mdx)("blockquote", null, /* @__PURE__ */ (0, import_react2.mdx)("p", {
...
`)), /* @__PURE__ */ (0, import_react2.mdx)("h2", {
    ...
    parentName: "li",
    ...{
      "href": "/docs/fr/19/Concepts/identifiers#classes"
    }
  ...
  }, `Using 4D interface`), /* @__PURE__ */ (0, import_react2.mdx)("p", null, `Class files are automatically stored at the appropriate location when created through the 4D interface, either via the `, /* @__PURE__ */ (0, import_react2.mdx)("strong", {
    parentName: "p"
...
`, /* @__PURE__ */ (0, import_react2.mdx)("img", {
    src: (__webpack_require__(43556)/* ["default"] */ .Z),
    width: "266",
    height: "181"
  })), /* @__PURE__ */ (0, import_react2.mdx)("li", {
    parentName: "ul"
...
`)), /* @__PURE__ */ (0, import_react2.mdx)("h3", {
    ...
    parentName: "p",
    ...{
      "href": "/docs/fr/19/API/CryptoKeyClass"
    }
...
`)), /* @__PURE__ */ (0, import_react2.mdx)("h2", {
    ...
    parentName: "p",
    ...{
      "href": "/docs/fr/19/API/ClassClass"
    }
    ...
    parentName: "li",
    ...{
      "href": "/docs/fr/19/API/ClassClass#name"
    }
  }, /* @__PURE__ */ (0, import_react2.mdx)("inlineCode", {
    parentName: "a"
    ...
    parentName: "li",
    ...{
      "href": "/docs/fr/19/API/ClassClass#superclass"
    }
  }, /* @__PURE__ */ (0, import_react2.mdx)("inlineCode", {
    parentName: "a"
    ...
    parentName: "li",
    ...{
      "href": "/docs/fr/19/API/ClassClass#new"
    }
  }, /* @__PURE__ */ (0, import_react2.mdx)("inlineCode", {
    parentName: "a"
    ...
    parentName: "p",
    ...{
      "href": "/docs/fr/19/Concepts/classes#class-extends-classname"
    }
    ...
    parentName: "li"
  }, `Class constructor`), ` to define the properties of the objects.`), /* @__PURE__ */ (0, import_react2.mdx)("li", {
    parentName: "ul"
  }, /* @__PURE__ */ (0, import_react2.mdx)("inlineCode", {
    parentName: "li"
...
`)), /* @__PURE__ */ (0, import_react2.mdx)("p", null, `Class functions are specific properties of the class. They are objects of the `, /* @__PURE__ */ (0, import_react2.mdx)("a", {
    parentName: "p",
    ...{
      "href": "/docs/fr/19/API/FunctionClass#about-4dfunction-objects"
    }
...
`)), /* @__PURE__ */ (0, import_react2.mdx)("p", null, `For a class function, the `, /* @__PURE__ */ (0, import_react2.mdx)("inlineCode", {
    ...
    parentName: "p"
  }, `<ClassName>.<FunctionName>`), `, for example "MyClass.myMethod".`), /* @__PURE__ */ (0, import_react2.mdx)("p", null, `In the application code, class functions are called as member methods of the object instance and can receive `, /* @__PURE__ */ (0, import_react2.mdx)("a", {
    parentName: "p",
    ...{
    ...
    parentName: "li",
    ...{
      "href": "/docs/fr/19/API/FunctionClass#apply"
    }
  }, /* @__PURE__ */ (0, import_react2.mdx)("inlineCode", {
    parentName: "a"
    ...
    parentName: "li",
    ...{
      "href": "/docs/fr/19/API/FunctionClass#call"
    }
  }, /* @__PURE__ */ (0, import_react2.mdx)("inlineCode", {
    parentName: "a"
...
`)), /* @__PURE__ */ (0, import_react2.mdx)("blockquote", null, /* @__PURE__ */ (0, import_react2.mdx)("p", {
    ...
    parentName: "p"
  }, `Variant`), `.`)), /* @__PURE__ */ (0, import_react2.mdx)("p", null, `You declare the return parameter (optional) by adding an arrow (`, /* @__PURE__ */ (0, import_react2.mdx)("inlineCode", {
    parentName: "p"
  }, `->`), `) and the return parameter definition after the input parameter(s) list. For example:`), /* @__PURE__ */ (0, import_react2.mdx)("pre", null, /* @__PURE__ */ (0, import_react2.mdx)("code", {
    parentName: "pre",
    ...{
      "className": "language-4d"
    }
...
`)), /* @__PURE__ */ (0, import_react2.mdx)("p", null, `You can also declare the return parameter only by adding `, /* @__PURE__ */ (0, import_react2.mdx)("inlineCode", {
    parentName: "p"
  }, `: type`), `, in which case it will automatically be available through $0. For example:`), /* @__PURE__ */ (0, import_react2.mdx)("pre", null, /* @__PURE__ */ (0, import_react2.mdx)("code", {
    parentName: "pre",
    ...{
      "className": "language-4d"
    }
...
`)), /* @__PURE__ */ (0, import_react2.mdx)("p", null, `The `, /* @__PURE__ */ (0, import_react2.mdx)("a", {
    parentName: "p",
    ...{
      "href": "/docs/fr/19/Concepts/parameters#sequential-parameters"
    }
...
`)), /* @__PURE__ */ (0, import_react2.mdx)("h3", {
  ...
  }, `Class extends `, /* @__PURE__ */ (0, import_react2.mdx)("inlineCode", {
    parentName: "h3"
  }, `\\<ClassName>`)), /* @__PURE__ */ (0, import_react2.mdx)("h4", {
    ...{
      "id": "syntax-2"
    }
  }, `Syntax`), /* @__PURE__ */ (0, import_react2.mdx)("pre", null, /* @__PURE__ */ (0, import_react2.mdx)("code", {
