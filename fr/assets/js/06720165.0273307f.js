...
const metadata = {
  ...
  "permalink": "/docs/fr/19/Concepts/collection",
  "draft": false,
  "tags": [],
  "version": "19",
  "frontMatter": {
  ...
  "next": {
    "title": "Date",
    "permalink": "/docs/fr/19/Concepts/date"
  }
};
const assets = {};
const toc = [{
...
`)), /* @__PURE__ */ (0, import_react2.mdx)("h3", {
    ...
    parentName: "li",
    ...{
      "href": "/docs/fr/19/API/CollectionClass#new-collection"
    }
    ...
    parentName: "li",
    ...{
      "href": "/docs/fr/19/API/CollectionClass#new-shared-collection"
    }
  }, /* @__PURE__ */ (0, import_react2.mdx)("inlineCode", {
    parentName: "a"
