...
const metadata = {
  "unversionedId": "Backup/restore",
  "id": "version-19/Backup/restore",
  "title": "Restore",
  "description": "4D allows you to restore entire sets of application data in case of any incidents, regardless of the cause of the incident. Two primary categories of incidents can occur:",
  "source": "@site/versioned_docs/version-19/Backup/restore.md",
  "sourceDirName": "Backup",
  "slug": "/Backup/restore",
  "permalink": "/docs/fr/19/Backup/restore",
  "draft": false,
  "tags": [],
  "version": "19",
  "frontMatter": {
  ...
  "previous": {
    ...
    "permalink": "/docs/fr/19/Backup/log"
  },
  "next": {
    "title": "Overview",
    "permalink": "/docs/fr/19/WebServer/overview"
  }
};
const assets = {};
const toc = [{
  value: "Manually restoring a backup (standard dialog)",
  id: "manually-restoring-a-backup-standard-dialog",
  level: 2
}, {
  value: "Manually restoring a backup (MSC)",
  id: "manually-restoring-a-backup-msc",
  level: 2
}, {
  value: "Manually integrating the log",
  id: "manually-integrating-the-log",
  level: 2
}];
const layoutProps = {
  toc
...
function MDXContent({
  ...
  return /* @__PURE__ */ (0, import_react2.mdx)(MDXLayout, {
    ...
    components,
    mdxType: "MDXLayout"
  }, /* @__PURE__ */ (0, import_react2.mdx)("p", null, `4D allows you to restore entire sets of application data in case of any incidents, regardless of the cause of the incident. Two primary categories of incidents can occur:`), /* @__PURE__ */ (0, import_react2.mdx)("ul", null, /* @__PURE__ */ (0, import_react2.mdx)("li", {
    parentName: "ul"
  }, /* @__PURE__ */ (0, import_react2.mdx)("p", {
    parentName: "li"
  }, `The unexpected stoppage of an application while in use. This incident can occur because of a power outage, system element failure, etc. In this case, depending on the current state of the data cache at the moment of the incident, the restore of the application can require different operations:`), /* @__PURE__ */ (0, import_react2.mdx)("ul", {
    parentName: "li"
  }, /* @__PURE__ */ (0, import_react2.mdx)("li", {
    parentName: "ul"
  }, `If the cache was empty, the application opens normally. Any changes made in the application were recorded. This case does not require any particular operation.`), /* @__PURE__ */ (0, import_react2.mdx)("li", {
    parentName: "ul"
  }, `If the cache contains operations, the data file is intact but it requires integrating the current log file.`), /* @__PURE__ */ (0, import_react2.mdx)("li", {
    parentName: "ul"
  }, `If the cache was in the process of being written, the data file is probably damaged. The last backup must be restored and the current log file must be integrated.`))), /* @__PURE__ */ (0, import_react2.mdx)("li", {
    parentName: "ul"
  }, /* @__PURE__ */ (0, import_react2.mdx)("p", {
    parentName: "li"
  }, `The loss of application file(s). This incident can occur because of defective sectors on the disk containing the application, a virus, manipulation error, etc. The last backup must be restored and then the current log file must be integrated. To find out if an application was damaged following an incident, simply relaunch the application using 4D. The program performs a self-check and details the necessary restore operations to perform. In automatic mode, these operations are performed directly without any intervention on the part of the user. If a regular backup strategy was put into place, the 4D restore tools will allow you to recover (in most cases) the application in the exact state it was in before the incident.`))), /* @__PURE__ */ (0, import_react2.mdx)("blockquote", null, /* @__PURE__ */ (0, import_react2.mdx)("p", {
    parentName: "blockquote"
  }, `4D can launch procedures automatically to recover applications following incidents. These mechanisms are managed using two options available on the `, /* @__PURE__ */ (0, import_react2.mdx)("strong", {
    parentName: "p"
  }, `Backup/Backup & Restore`), ` page of the Settings. For more information, refer to the `, /* @__PURE__ */ (0, import_react2.mdx)("a", {
    parentName: "p",
    ...{
      "href": "/docs/fr/19/Backup/settings#automatic-restore"
    }
  }, `Automatic Restore`), ` paragraph.`, /* @__PURE__ */ (0, import_react2.mdx)("br", {
    parentName: "p"
  }), `
`, `If the incident is the result of an inappropriate operation performed on the data (deletion of a record, for example), you can attempt to repair the data file using the "rollback" function in the log file. This function is available on the `, /* @__PURE__ */ (0, import_react2.mdx)("a", {
    parentName: "p",
    ...{
      "href": "/docs/fr/19/MSC/rollback"
    }
  }, `Rollback`), ` page of the MSC.`)), /* @__PURE__ */ (0, import_react2.mdx)("h2", {
    ...{
      "id": "manually-restoring-a-backup-standard-dialog"
    }
  }, `Manually restoring a backup (standard dialog)`), /* @__PURE__ */ (0, import_react2.mdx)("p", null, `You can restore the contents of an archive generated by the backup module manually. A manual restore may be necessary, for instance, in order to restore the full contents of an archive (project files and enclosed attached files), or for the purpose of carrying out searches among the archives. The manual restore can also be performed along with the integration of the current log file.`), /* @__PURE__ */ (0, import_react2.mdx)("p", null, `The manual restore of backups can be carried out either via the standard Open document dialog box, or via the `, /* @__PURE__ */ (0, import_react2.mdx)("a", {
    parentName: "p",
    ...{
      "href": "MSC/restore"
    }
  }, `Restore`), ` page of the MSC. Restoring via the MSC provides more options and allows the archive contents to be previewed. On the other hand, only archives associated with the open application can be restored.`), /* @__PURE__ */ (0, import_react2.mdx)("p", null, `To restore an application manually via a standard dialog box:`), /* @__PURE__ */ (0, import_react2.mdx)("ol", null, /* @__PURE__ */ (0, import_react2.mdx)("li", {
    parentName: "ol"
  }, `Choose `, /* @__PURE__ */ (0, import_react2.mdx)("strong", {
    parentName: "li"
  }, `Restore...`), ` in the 4D application `, /* @__PURE__ */ (0, import_react2.mdx)("strong", {
    parentName: "li"
  }, `File`), ` menu.
It is not mandatory that an application project be open.
OR
Execute the `, /* @__PURE__ */ (0, import_react2.mdx)("inlineCode", {
    parentName: "li"
  }, `RESTORE`), ` command from a 4D method.
A standard Open file dialog box appears.`), /* @__PURE__ */ (0, import_react2.mdx)("li", {
    parentName: "ol"
  }, `Select a backup file (.4bk) or a log backup file (.4bl) to be restored and click `, /* @__PURE__ */ (0, import_react2.mdx)("strong", {
    parentName: "li"
  }, `Open`), `.
A dialog box appears, which allows you to specify the location where files will be restored. By default, 4D restores the files in a folder named `, /* @__PURE__ */ (0, import_react2.mdx)("em", {
    parentName: "li"
  }, `Archivename`), ` (no extension) located next to the archive. You can display the path:`)), /* @__PURE__ */ (0, import_react2.mdx)("p", null, /* @__PURE__ */ (0, import_react2.mdx)("img", {
    src: (__webpack_require__(98700)/* ["default"] */ .Z),
    width: "547",
    height: "242"
  })), /* @__PURE__ */ (0, import_react2.mdx)("p", null, `You can also click on the `, /* @__PURE__ */ (0, import_react2.mdx)("strong", {
    parentName: "p"
  }, `[...]`), ` button to specify a different location.
3. Click on the `, /* @__PURE__ */ (0, import_react2.mdx)("strong", {
    parentName: "p"
  }, `Restore`), ` button.
4D extracts all backup files from the specified location.
If the current log file or a log backup file with the same number as the backup file is stored in the same folder, 4D examines its contents. If it contains operations not present in the data file, the program asks you if you want to integrate these operations. Integration is done automatically if the `, /* @__PURE__ */ (0, import_react2.mdx)("strong", {
    parentName: "p"
  }, `Integrate last log file...`), ` option is checked (see `, /* @__PURE__ */ (0, import_react2.mdx)("a", {
    parentName: "p",
    ...{
      "href": "/docs/fr/19/Backup/settings#automatic-restore"
    }
  }, `Automatic Restore`), `).`), /* @__PURE__ */ (0, import_react2.mdx)("p", null, `4.(Optional) Click `, /* @__PURE__ */ (0, import_react2.mdx)("strong", {
    parentName: "p"
  }, `OK`), ` to integrate the log file into the restored application.
...
5. Click `, /* @__PURE__ */ (0, import_react2.mdx)("strong", {
    parentName: "p"
  }, `OK`), `.`), /* @__PURE__ */ (0, import_react2.mdx)("p", null, `The destination folder is displayed. During the restore, 4D places all backup files in this folder, regardless of the position of the original files on the disk when the backup starts. This way your files will be easier to find.`), /* @__PURE__ */ (0, import_react2.mdx)("blockquote", null, /* @__PURE__ */ (0, import_react2.mdx)("p", {
    parentName: "blockquote"
  }, `Any content related to the data file (files and `, /* @__PURE__ */ (0, import_react2.mdx)("inlineCode", {
    parentName: "p"
  }, `Settings`), ` folder) are automatically restored in a `, /* @__PURE__ */ (0, import_react2.mdx)("inlineCode", {
    parentName: "p"
  }, `Data`), ` subfolder within the destination folder.`)), /* @__PURE__ */ (0, import_react2.mdx)("h2", {
    ...{
      "id": "manually-restoring-a-backup-msc"
    }
  }, `Manually restoring a backup (MSC)`), /* @__PURE__ */ (0, import_react2.mdx)("p", null, `You can manually restore an archive of the current application using the `, /* @__PURE__ */ (0, import_react2.mdx)("a", {
    parentName: "p",
    ...{
      "href": "/docs/fr/19/MSC/restore"
    }
  }, `Restore page`), ` of the Maintenance and Security Center (MSC).`), /* @__PURE__ */ (0, import_react2.mdx)("h2", {
    ...{
      "id": "manually-integrating-the-log"
    }
  }, `Manually integrating the log`), /* @__PURE__ */ (0, import_react2.mdx)("p", null, `If you have not checked the option for the automatic integration of the log file on the Restore page of the MSC (see `, /* @__PURE__ */ (0, import_react2.mdx)("a", {
    parentName: "p",
    ...{
      "href": "/docs/fr/19/MSC/restore#successive-intergration-of-several-data-log-files"
    }
  }, `Successive integration of several log files`), `), a warning dialog box appears during the opening of the application when 4D notices that the log file contains more operations than have been carried out in the data file.`), /* @__PURE__ */ (0, import_react2.mdx)("p", null, /* @__PURE__ */ (0, import_react2.mdx)("img", {
    src: (__webpack_require__(43183)/* ["default"] */ .Z),
    width: "512",
    height: "242"
  })), /* @__PURE__ */ (0, import_react2.mdx)("blockquote", null, /* @__PURE__ */ (0, import_react2.mdx)("p", {
    parentName: "blockquote"
  }, `In order for this mechanism to work, 4D must be able to access the log file in its current location.`)), /* @__PURE__ */ (0, import_react2.mdx)("p", null, `You can choose whether or not to integrate the current log file. Not integrating the current log file allows you to avoid reproducing errors made in the data.`));
}
;
