...
const metadata = {
  ...
  "source": "@site/versioned_docs/version-19/MSC/analysis.md",
  "sourceDirName": "MSC",
  "slug": "/MSC/analysis",
  "permalink": "/docs/fr/19/MSC/analysis",
  "draft": false,
  "tags": [],
  "version": "19",
  "frontMatter": {
...
function MDXContent({
  ...
  return /* @__PURE__ */ (0, import_react2.mdx)(MDXLayout, {
    ...
    src: (__webpack_require__(45665)/* ["default"] */ .Z),
    width: "882",
    height: "666"
    ...
    parentName: "ul"
  }, `Update context: Change in extra data (e.g. a call to `, /* @__PURE__ */ (0, import_react2.mdx)("inlineCode", {
    parentName: "li"
  }, `CHANGE CURRENT USER`), ` or `, /* @__PURE__ */ (0, import_react2.mdx)("inlineCode", {
    parentName: "li"
  }, `SET USER ALIAS`), `).`))), /* @__PURE__ */ (0, import_react2.mdx)("li", {
    parentName: "ul"
  }, /* @__PURE__ */ (0, import_react2.mdx)("p", {
    parentName: "li"
  }, /* @__PURE__ */ (0, import_react2.mdx)("strong", {
    ...
    parentName: "p"
  }, `System User`), `: System name of the user that performed the operation. In client-server mode, the name of the client-side machine is displayed; in single-user mode, the session name of the user is displayed.`)), /* @__PURE__ */ (0, import_react2.mdx)("li", {
    parentName: "ul"
  }, /* @__PURE__ */ (0, import_react2.mdx)("p", {
    parentName: "li"
  }, /* @__PURE__ */ (0, import_react2.mdx)("strong", {
    parentName: "p"
  }, `4D User`), `: 4D user name of the user that performed the operation. If an alias is defined for the user, the alias is displayed instead of the 4D user name.`)), /* @__PURE__ */ (0, import_react2.mdx)("li", {
    parentName: "ul"
  }, /* @__PURE__ */ (0, import_react2.mdx)("p", {
    parentName: "li"
  }, /* @__PURE__ */ (0, import_react2.mdx)("strong", {
...
`, /* @__PURE__ */ (0, import_react2.mdx)("strong", {
    ...
    parentName: "p"
  }, `Analyze`), ` to update the contents of the current log file of the selected application (named by default dataname.journal). The Browse button can be used to select and open another log file for the application. The `, /* @__PURE__ */ (0, import_react2.mdx)("strong", {
    parentName: "p"
