...
const metadata = {
  ...
  "id": "FormObjects/webAreaOverview",
  "title": "Web Area",
  "description": "Web areas can display various types of web content within your forms: HTML pages with static or dynamic contents, files, pictures, JavaScript, etc. The rendering engine of the web area depends on the execution platform of the application and the selected rendering engine option.",
  "source": "@site/docs/FormObjects/webArea_overview.md",
  "sourceDirName": "FormObjects",
  "slug": "/FormObjects/webAreaOverview",
  "permalink": "/docs/fr/next/FormObjects/webAreaOverview",
  "draft": false,
  "tags": [],
  "version": "current",
  "frontMatter": {
  ...
  "previous": {
    "title": "Text",
    "permalink": "/docs/fr/next/FormObjects/text"
  },
  "next": {
    "title": "4D View Pro area",
    "permalink": "/docs/fr/next/FormObjects/viewProAreaOverview"
  }
};
const assets = {};
const toc = [{
...
function MDXContent({
  ...
  return /* @__PURE__ */ (0, import_react2.mdx)(MDXLayout, {
  ...
  }, `form events`), ` allow the developer to control the functioning of web areas. Specific variables can be used to exchange information between the area and the 4D environment.`), /* @__PURE__ */ (0, import_react2.mdx)("h2", {
    ...{
      "id": "specific-properties"
    }
    ...
    parentName: "a"
  }, `Progression`)), ` -- to control the loading percentage of the page displayed in the web area. `)), /* @__PURE__ */ (0, import_react2.mdx)("blockquote", null, /* @__PURE__ */ (0, import_react2.mdx)("p", {
    parentName: "blockquote"
  }, `As of 4D v19 R5, the Progression variable is no longer updated in Web Areas using the `, /* @__PURE__ */ (0, import_react2.mdx)("a", {
    parentName: "p",
    ...{
      "href": "/docs/fr/next/FormObjects/webAreaOverview#web-rendering-engine"
    }
  }, `Windows system rendering engine`), `.`)), /* @__PURE__ */ (0, import_react2.mdx)("h3", {
    ...{
      "id": "web-rendering-engine"
    }
...
`)), /* @__PURE__ */ (0, import_react2.mdx)("h2", {
    ...
    parentName: "p"
  }, `Open Forward URL`), `, `, /* @__PURE__ */ (0, import_react2.mdx)("inlineCode", {
    parentName: "p"
    ...
    parentName: "li",
    ...{
      "href": "/docs/fr/next/Events/onBeginUrlLoading"
    }
  }, /* @__PURE__ */ (0, import_react2.mdx)("inlineCode", {
    parentName: "a"
    ...
    parentName: "li",
    ...{
      "href": "/docs/fr/next/Events/onUrlResourceLoading"
    }
  }, /* @__PURE__ */ (0, import_react2.mdx)("inlineCode", {
    parentName: "a"
    ...
    parentName: "li",
    ...{
      "href": "/docs/fr/next/Events/onEndUrlLoading"
    }
  }, /* @__PURE__ */ (0, import_react2.mdx)("inlineCode", {
    parentName: "a"
    ...
    parentName: "li",
    ...{
      "href": "/docs/fr/next/Events/onUrlLoadingError"
    }
  }, /* @__PURE__ */ (0, import_react2.mdx)("inlineCode", {
    parentName: "a"
    ...
    parentName: "li",
    ...{
      "href": "/docs/fr/next/Events/onUrlFiltering"
    }
  }, /* @__PURE__ */ (0, import_react2.mdx)("inlineCode", {
    parentName: "a"
    ...
    parentName: "li",
    ...{
      "href": "/docs/fr/next/Events/onOpenExternalLink"
    }
  }, /* @__PURE__ */ (0, import_react2.mdx)("inlineCode", {
    parentName: "a"
    ...
    parentName: "li",
    ...{
      "href": "/docs/fr/next/Events/onWindowOpeningDenied"
    }
  }, /* @__PURE__ */ (0, import_react2.mdx)("inlineCode", {
    parentName: "a"
    ...
    parentName: "li",
    ...{
      "href": "/docs/fr/next/Events/onLoad"
    }
  }, /* @__PURE__ */ (0, import_react2.mdx)("inlineCode", {
    parentName: "a"
    ...
    parentName: "li",
    ...{
      "href": "/docs/fr/next/Events/onUnload"
    }
  }, /* @__PURE__ */ (0, import_react2.mdx)("inlineCode", {
    parentName: "a"
    ...
    parentName: "li",
    ...{
      "href": "/docs/fr/next/Events/onGettingFocus"
    }
  }, /* @__PURE__ */ (0, import_react2.mdx)("inlineCode", {
    parentName: "a"
    ...
    parentName: "li",
    ...{
      "href": "/docs/fr/next/Events/onLosingFocus"
    }
  }, /* @__PURE__ */ (0, import_react2.mdx)("inlineCode", {
    parentName: "a"
...
For security reasons, changing the contents of a web area by means of dragging and dropping a file or URL is not allowed by default. In this case, the cursor displays a "forbidden" icon `, /* @__PURE__ */ (0, import_react2.mdx)("img", {
    src: (__webpack_require__(98110)/* ["default"] */ .Z),
    width: "26",
    height: "28"
  }), `. You have to use the `, /* @__PURE__ */ (0, import_react2.mdx)("inlineCode", {
    parentName: "li"
  }, `WA SET PREFERENCE(*;"warea";WA enable URL drop;True)`), ` statement to display a "drop" icon and generate the `, /* @__PURE__ */ (0, import_react2.mdx)("a", {
    parentName: "li",
    ...{
      "href": "/docs/fr/next/Events/onWindowOpeningDenied"
    }
    ...
    parentName: "a"
  }, `On Window Opening Denied`)), ` event. In this event, you can call the `, /* @__PURE__ */ (0, import_react2.mdx)("a", {
    parentName: "li",
    ...{
      "href": "https://doc.4d.com/4dv19/help/command/en/page1020.html"
    }
  }, /* @__PURE__ */ (0, import_react2.mdx)("inlineCode", {
    parentName: "a"
  }, `WA OPEN URL`)), ` command or set the `, /* @__PURE__ */ (0, import_react2.mdx)("a", {
    parentName: "li",
    ...{
      "href": "/docs/fr/next/FormObjects/propertiesWebArea#url"
    }
  }, `URL variable`), ` in response to a user drop.`)), /* @__PURE__ */ (0, import_react2.mdx)("blockquote", null, /* @__PURE__ */ (0, import_react2.mdx)("p", {
    parentName: "blockquote"
  }, `Drag and drop features described above are not supported in web areas using the `, /* @__PURE__ */ (0, import_react2.mdx)("a", {
    parentName: "p",
    ...{
      "href": "/docs/fr/next/FormObjects/propertiesWebArea#use-embedded-web-rendering-engine"
    }
  }, `macOS system rendering engine`), `.`)), /* @__PURE__ */ (0, import_react2.mdx)("h3", {
    ...{
      "id": "subforms"
    }
  ...
  }, `Insertion of protocol (macOS)`), /* @__PURE__ */ (0, import_react2.mdx)("p", null, `The URLs handled by programming in web areas in macOS must begin with the protocol. For example, you need to pass the string "`, /* @__PURE__ */ (0, import_react2.mdx)("a", {
    parentName: "p",
    ...{
  ...
  }, `Web inspector`), /* @__PURE__ */ (0, import_react2.mdx)("p", null, `You can view and use a web inspector within web areas in your forms or in offscreen web areas. The web inspector is a debugger which allows parsing the code and the flow of information of the web pages.`), /* @__PURE__ */ (0, import_react2.mdx)("p", null, `To display the Web inspector, you can either execute the `, /* @__PURE__ */ (0, import_react2.mdx)("inlineCode", {
    parentName: "p"
  }, `WA OPEN WEB INSPECTOR`), ` command, or use the context menu of the web area. `), /* @__PURE__ */ (0, import_react2.mdx)("ul", null, /* @__PURE__ */ (0, import_react2.mdx)("li", {
    parentName: "ul"
  }, /* @__PURE__ */ (0, import_react2.mdx)("p", {
    parentName: "li"
  }, /* @__PURE__ */ (0, import_react2.mdx)("strong", {
    ...
    parentName: "strong"
  }, `WA OPEN WEB INSPECTOR`), ` command`), /* @__PURE__ */ (0, import_react2.mdx)("br", null), `
This command can be used directly with onscreen (form object) and offscreen web areas. `)), /* @__PURE__ */ (0, import_react2.mdx)("li", {
    parentName: "ul"
  }, /* @__PURE__ */ (0, import_react2.mdx)("p", {
    parentName: "li"
  }, /* @__PURE__ */ (0, import_react2.mdx)("strong", {
    parentName: "p"
  }, `Use the web area context menu`), /* @__PURE__ */ (0, import_react2.mdx)("br", null), `
This feature can only be used with onscreen web areas and requires that the following conditions are met:`), /* @__PURE__ */ (0, import_react2.mdx)("ul", {
    parentName: "li"
  ...
  }, `context menu`), ` for the web area is enabled`), /* @__PURE__ */ (0, import_react2.mdx)("li", {
    parentName: "ul"
  }, `the use of the inspector is expressly enabled in the area by means of the following statement:`)), /* @__PURE__ */ (0, import_react2.mdx)("pre", {
    parentName: "li"
...
`)))), /* @__PURE__ */ (0, import_react2.mdx)("blockquote", null, /* @__PURE__ */ (0, import_react2.mdx)("p", {
    parentName: "blockquote"
  }, `With `, /* @__PURE__ */ (0, import_react2.mdx)("a", {
    parentName: "p",
    ...{
      "href": "/docs/fr/next/FormObjects/propertiesWebArea#use-embedded-web-rendering-engine"
    }
  }, `Windows system rendering engine`), `, a change in this preference requires a navigation action in the area (for example, a page refresh) to be taken into account. `)), /* @__PURE__ */ (0, import_react2.mdx)("p", null, `For more information, refer to the description of the `, /* @__PURE__ */ (0, import_react2.mdx)("inlineCode", {
    parentName: "p"
  }, `WA SET PREFERENCE`), ` command.`), /* @__PURE__ */ (0, import_react2.mdx)("p", null, `When you have done the settings as described above, you then have new options such as `, /* @__PURE__ */ (0, import_react2.mdx)("strong", {
    parentName: "p"
    ...
    parentName: "blockquote"
  }, `For a detailed description of the features of this debugger, refer to the documentation provided by the web rendering engine.`)), /* @__PURE__ */ (0, import_react2.mdx)("h2", {
    ...{
      "id": "supported-properties"
    }
  ...
  }, `URL`), ` - `, /* @__PURE__ */ (0, import_react2.mdx)("a", {
    parentName: "p",
    ...{
      "href": "/docs/fr/next/FormObjects/propertiesWebArea#use-embedded-web-rendering-engine"
    }
