...
const metadata = {
  ...
  "next": {
    ...
    "permalink": "/docs/fr/next/WebServer/webServerObject"
  }
};
const assets = {};
const toc = [{
...
function MDXContent({
  ...
  return /* @__PURE__ */ (0, import_react2.mdx)(MDXLayout, {
    ...
    src: (__webpack_require__(51950)/* ["default"] */ .Z),
    width: "348",
    height: "278"
  })), /* @__PURE__ */ (0, import_react2.mdx)("li", {
    parentName: "ul"
    ...
    src: (__webpack_require__(2163)/* ["default"] */ .Z),
    width: "1030",
    height: "699"
  })))), /* @__PURE__ */ (0, import_react2.mdx)("li", {
    parentName: "ul"
    ...
    src: (__webpack_require__(46487)/* ["default"] */ .Z),
    width: "898",
    height: "746"
  })), /* @__PURE__ */ (0, import_react2.mdx)("li", {
    parentName: "ul"
    ...
    parentName: "li",
    ...{
      "href": "/docs/fr/next/API/WebServerClass#start"
    }
    ...
    parentName: "li",
    ...{
      "href": "/docs/fr/next/API/WebServerClass#stop"
    }
  }, /* @__PURE__ */ (0, import_react2.mdx)("inlineCode", {
    parentName: "a"
    ...
    src: (__webpack_require__(55393)/* ["default"] */ .Z),
    width: "355",
    height: "284"
    ...
    parentName: "li"
  }, `Clear Cache`), ` button in the `, /* @__PURE__ */ (0, import_react2.mdx)("a", {
    parentName: "li",
    ...{
      "href": "/docs/fr/next/settings/web"
    }
  }, `Web/Options (I) page`), ` of the Settings dialog box. `), /* @__PURE__ */ (0, import_react2.mdx)("li", {
    parentName: "ul"
  }, `4D Server: click on the `, /* @__PURE__ */ (0, import_react2.mdx)("strong", {
    parentName: "li"
  }, `Clear Cache`), ` button in the HTTP page of the 4D Server Administration window.`)), /* @__PURE__ */ (0, import_react2.mdx)("p", null, `The cache is then immediately cleared.`), /* @__PURE__ */ (0, import_react2.mdx)("blockquote", null, /* @__PURE__ */ (0, import_react2.mdx)("p", {
    parentName: "blockquote"
    ...
    parentName: "p",
    ...{
      "href": "/docs/fr/next/WebServer/webServerConfig#debug-log"
    }
...
Each field is separated by a space and each line ends by the CR/LF sequence (character 13, character 10). `), /* @__PURE__ */ (0, import_react2.mdx)("p", null, `DLF (Combined Log Format) format is similar to CLF (Common Log Format) format and uses exactly the same structure. It simply adds two additional HTTP fields at the end of each request: Referer and User-agent. Here is the description of CLF/DLF formats (not customizable):`), /* @__PURE__ */ (0, import_react2.mdx)("table", null, /* @__PURE__ */ (0, import_react2.mdx)("thead", {
    ...
    src: (__webpack_require__(82982)/* ["default"] */ .Z),
    width: "892",
    height: "744"
