...
const metadata = {
  ...
  "id": "Project/overview",
  "title": "Overview",
  "description": "A 4D project contains all of the source code of a 4D application, whatever its deployment type (web, mobile, or desktop), from the database structure to the user interface, including code, forms, menus, user settings, or any required resources. A 4D project is primarily made of text-based files.",
  "source": "@site/docs/Project/overview.md",
  "sourceDirName": "Project",
  "slug": "/Project/overview",
  "permalink": "/docs/fr/next/Project/overview",
  "draft": false,
  "tags": [],
  "version": "current",
  "frontMatter": {
  ...
  "previous": {
    ...
    "permalink": "/docs/fr/next/GettingStarted/creating"
  },
  "next": {
    "title": "Architecture of a project",
    "permalink": "/docs/fr/next/Project/architecture"
  }
};
const assets = {};
const toc = [{
...
function MDXContent({
  ...
  return /* @__PURE__ */ (0, import_react2.mdx)(MDXLayout, {
    ...
    parentName: "p"
  }, `4D`), ` application. It provides an Integrated Development Environment (IDE) for 4D projects as well as a web server, a mobile project generator, and an application runtime, allowing you to develop, test, and debug any kind of project. `), /* @__PURE__ */ (0, import_react2.mdx)("p", null, `Multi-user development is managed via standard `, /* @__PURE__ */ (0, import_react2.mdx)("strong", {
    parentName: "p"
    ...
    parentName: "li",
    ...{
      "href": "/docs/fr/next/Desktop/building"
    }
