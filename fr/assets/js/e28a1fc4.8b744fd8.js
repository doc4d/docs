...
const metadata = {
  ...
  "source": "@site/docs/FormObjects/tabControl.md",
  "sourceDirName": "FormObjects",
  "slug": "/FormObjects/tabControl",
  "permalink": "/docs/fr/next/FormObjects/tabControl",
  "draft": false,
  "tags": [],
  "version": "current",
  "frontMatter": {
  ...
  "previous": {
    "title": "Subform",
    "permalink": "/docs/fr/next/FormObjects/subformOverview"
  },
  "next": {
    "title": "Text",
...
const toc = [{
  ...
  value: "Using a Text array",
  id: "using-a-text-array",
  level: 3
}, {
  value: "Goto page features",
  id: "goto-page-features",
  level: 2
}, {
...
function MDXContent({
  ...
  return /* @__PURE__ */ (0, import_react2.mdx)(MDXLayout, {
    ...
    src: (__webpack_require__(52979)/* ["default"] */ .Z),
    width: "600",
    height: "534"
    ...
    parentName: "p",
    ...{
      "href": "https://doc.4d.com/4dv19/help/command/en/page247.html"
    }
    ...
    src: (__webpack_require__(59902)/* ["default"] */ .Z),
    width: "599",
    height: "510"
...
`)), /* @__PURE__ */ (0, import_react2.mdx)("h2", {
  ...
  }, `Adding labels to a tab control`), /* @__PURE__ */ (0, import_react2.mdx)("p", null, `To supply the labels for a tab control, you can use:`), /* @__PURE__ */ (0, import_react2.mdx)("ul", null, /* @__PURE__ */ (0, import_react2.mdx)("li", {
    parentName: "ul"
  }, `an object`), /* @__PURE__ */ (0, import_react2.mdx)("li", {
    parentName: "ul"
  }, `a choice list`), /* @__PURE__ */ (0, import_react2.mdx)("li", {
    parentName: "ul"
  }, `an array`)), /* @__PURE__ */ (0, import_react2.mdx)("h3", {
    ...{
      "id": "using-an-object"
    }
  }, `Using an object`), /* @__PURE__ */ (0, import_react2.mdx)("p", null, `You can assign an `, /* @__PURE__ */ (0, import_react2.mdx)("a", {
    parentName: "p",
    ...{
      "href": "/docs/fr/next/Concepts/object"
    }
  ...
  }, `collection`), ` as the `, /* @__PURE__ */ (0, import_react2.mdx)("a", {
    parentName: "p",
    ...{
      "href": "/docs/fr/next/FormObjects/propertiesObject#variable-or-expression"
    }
  }, `data source`), ` of the tab control. The object must contain the following properties:`), /* @__PURE__ */ (0, import_react2.mdx)("table", null, /* @__PURE__ */ (0, import_react2.mdx)("thead", {
    parentName: "table"
  ...
  }, `Mandatory - Collection of scalar values. Only string values are supported. If invalid, empty or not defined, the tab control is empty`)), /* @__PURE__ */ (0, import_react2.mdx)("tr", {
    parentName: "tbody"
  }, /* @__PURE__ */ (0, import_react2.mdx)("td", {
    parentName: "tr",
    ...{
  ...
  }, `Index of the currently tab control page (value between 0 and `, /* @__PURE__ */ (0, import_react2.mdx)("inlineCode", {
    parentName: "td"
  }, `collection.length-1`), `)`)), /* @__PURE__ */ (0, import_react2.mdx)("tr", {
    parentName: "tbody"
  }, /* @__PURE__ */ (0, import_react2.mdx)("td", {
    parentName: "tr",
    ...{
  ...
  }, `Currently selected value`)))), /* @__PURE__ */ (0, import_react2.mdx)("p", null, `The initialization code must be executed before the form is presented to the user. `), /* @__PURE__ */ (0, import_react2.mdx)("p", null, `In the following example, `, /* @__PURE__ */ (0, import_react2.mdx)("inlineCode", {
    parentName: "p"
  }, `Form.tabControl`), ` has been defined as tab control `, /* @__PURE__ */ (0, import_react2.mdx)("a", {
    parentName: "p",
    ...{
      "href": "/docs/fr/next/FormObjects/propertiesObject#variable-or-expression"
    }
  }, `expression`), `. You can associate the `, /* @__PURE__ */ (0, import_react2.mdx)("a", {
    parentName: "p",
    ...{
      "href": "#goto-page-action"
    }
  }, /* @__PURE__ */ (0, import_react2.mdx)("inlineCode", {
    parentName: "a"
  }, `gotoPage`), ` standard action`), ` to the form object:`), /* @__PURE__ */ (0, import_react2.mdx)("pre", null, /* @__PURE__ */ (0, import_react2.mdx)("code", {
    parentName: "pre",
    ...{
      "className": "language-4d"
    }
...
`)), /* @__PURE__ */ (0, import_react2.mdx)("h3", {
  ...
  }, `Using a choice list`), /* @__PURE__ */ (0, import_react2.mdx)("p", null, `You can assign a `, /* @__PURE__ */ (0, import_react2.mdx)("a", {
    parentName: "p",
    ...{
      "href": "/docs/fr/next/FormObjects/propertiesDataSource#choice-list-static-list"
    }
  }, `choice list`), ` to the tab control, either through a collection (static list) or a JSON pointer to a json list ("$ref"). Icons associated with list items in the Lists editor will be displayed in the tab control.`), /* @__PURE__ */ (0, import_react2.mdx)("h3", {
    ...{
      "id": "using-a-text-array"
    }
  }, `Using a Text array`), /* @__PURE__ */ (0, import_react2.mdx)("p", null, `You can create a Text array that contains the names of each page of the form. This code must be executed before the form is presented to the user. For example, you could place the code in the object method of the tab control and execute it when the `, /* @__PURE__ */ (0, import_react2.mdx)("inlineCode", {
    parentName: "p"
...
`)), /* @__PURE__ */ (0, import_react2.mdx)("blockquote", null, /* @__PURE__ */ (0, import_react2.mdx)("p", {
  ...
  }, `You can also store the names of the pages in a hierarchical list and use the `, /* @__PURE__ */ (0, import_react2.mdx)("a", {
    parentName: "p",
    ...{
      "href": "https://doc.4d.com/4dv19/help/command/en/page288.html"
    }
  }, `LIST TO ARRAY`), ` command to load the values into the array.`)), /* @__PURE__ */ (0, import_react2.mdx)("h2", {
    ...{
      "id": "goto-page-features"
    }
  }, `Goto page features`), /* @__PURE__ */ (0, import_react2.mdx)("h3", {
    ...{
      "id": "form-goto-page-command"
    }
...
`)), /* @__PURE__ */ (0, import_react2.mdx)("p", null, `The command is executed when the `, /* @__PURE__ */ (0, import_react2.mdx)("a", {
    parentName: "p",
    ...{
      "href": "/docs/fr/next/Events/onClicked"
    }
  }, /* @__PURE__ */ (0, import_react2.mdx)("inlineCode", {
    parentName: "a"
  }, `On Clicked`)), ` event occurs. You should then clear the array when the `, /* @__PURE__ */ (0, import_react2.mdx)("a", {
    parentName: "p",
    ...{
...
`)), /* @__PURE__ */ (0, import_react2.mdx)("h3", {
    ...
    parentName: "p",
    ...{
      "href": "/docs/fr/next/FormObjects/propertiesObject#save-value"
    }
