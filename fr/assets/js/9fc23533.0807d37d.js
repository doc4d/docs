...
const metadata = {
  ...
  "permalink": "/docs/fr/next/code-editor/find-replace",
  "draft": false,
  "tags": [],
  "version": "current",
  "frontMatter": {
  ...
  "previous": {
    "title": "Code Editor",
    "permalink": "/docs/fr/next/code-editor/write-class-method"
  },
  "next": {
    "title": "Creating and using macros",
    "permalink": "/docs/fr/next/code-editor/creating-using-macros"
  }
};
const assets = {};
const toc = [{
...
Be careful, unlike the `, /* @__PURE__ */ (0, import_react2.mdx)("strong", {
    ...
    parentName: "p",
    ...{
      "href": "/docs/fr/next/code-editor/write-class-method#using-bookmarks"
    }
