...
var onRowResize_exports = {};
__export(onRowResize_exports, {
  assets: () => assets,
...
module.exports = __toCommonJS(onRowResize_exports);
...
const metadata = {
  "unversionedId": "Events/onRowResize",
  "id": "version-19/Events/onRowResize",
  "title": "On Row Resize",
  "description": "|Code|Can be called by|Definition|",
  "source": "@site/versioned_docs/version-19/Events/onRowResize.md",
  "sourceDirName": "Events",
  "slug": "/Events/onRowResize",
...
function MDXContent({
  ...
  }, `60`), /* @__PURE__ */ (0, import_react2.mdx)("td", {
    parentName: "tr",
    ...{
      "align": null
    }
  ...
  }, `The height of a row is modified by a user with the mouse`)))), /* @__PURE__ */ (0, import_react2.mdx)("h2", {
    ...{
      "id": "description"
    }
  }, `Description`), /* @__PURE__ */ (0, import_react2.mdx)("p", null, `This event is generated when the height of a row is modified by a user in a 4D View Pro document. In this context, the `, /* @__PURE__ */ (0, import_react2.mdx)("a", {
    parentName: "p",
    ...{
  ...
  }, `60`)), /* @__PURE__ */ (0, import_react2.mdx)("tr", {
    parentName: "tbody"
  }, /* @__PURE__ */ (0, import_react2.mdx)("td", {
    parentName: "tr",
    ...{
  ...
  }, `Cell range of the rows whose heights have changed`)), /* @__PURE__ */ (0, import_react2.mdx)("tr", {
    parentName: "tbody"
  }, /* @__PURE__ */ (0, import_react2.mdx)("td", {
    parentName: "tr",
    ...{
  ...
  }, `True if the column header row (first row) is resized, else false`)))), /* @__PURE__ */ (0, import_react2.mdx)("h4", {
    ...{
      "id": "example"
    }
