...
const metadata = {
  "unversionedId": "settings/database",
  "id": "version-19-R6/settings/database",
  "title": "Database page",
  "description": "Data storage page",
  "source": "@site/versioned_docs/version-19-R6/settings/database.md",
  "sourceDirName": "settings",
  "slug": "/settings/database",
  "permalink": "/docs/fr/settings/database",
  "draft": false,
  "tags": [],
  "version": "19-R6",
  "frontMatter": {
  ...
  "previous": {
    "title": "Compiler page",
    "permalink": "/docs/fr/settings/compiler"
  },
  "next": {
    "title": "Backup page",
    "permalink": "/docs/fr/settings/backup"
  }
};
const assets = {};
const toc = [{
  value: "Data storage page",
  id: "data-storage-page",
  level: 2
}, {
  ...
  value: "Allow Read Only Data file Use",
  id: "allow-read-only-data-file-use",
  level: 4
}, {
  value: "About locked files",
  id: "about-locked-files",
  level: 4
}, {
  value: "Temporary Folder Location",
  id: "temporary-folder-location",
  level: 3
}, {
  ...
  value: "Support of MeCab (Japanese version)",
  id: "support-of-mecab-japanese-version",
  level: 4
}, {
  value: "Memory page",
  id: "memory-page",
  ...
  value: "Database Cache Settings",
  id: "database-cache-settings",
  level: 3
}];
const layoutProps = {
  toc
...
function MDXContent({
  ...
  }, `Data storage page`), /* @__PURE__ */ (0, import_react2.mdx)("p", null, `You use this page to configure data storage on disk for the 4D database.`), /* @__PURE__ */ (0, import_react2.mdx)("h3", {
    ...{
      "id": "general-settings"
    }
  }, `General Settings`), /* @__PURE__ */ (0, import_react2.mdx)("h4", {
    ...{
      "id": "allow-read-only-data-file-use"
    }
  }, `Allow Read Only Data file Use`), /* @__PURE__ */ (0, import_react2.mdx)("p", null, `This option allows configuration of the application operation when opening a locked data file at the operating system level. 4D includes a mechanism that automatically prevents the opening of a database when its data file, or one of its segments, is locked. In this case, when this detection option is activated, 4D displays a warning message and does not open the database:`), /* @__PURE__ */ (0, import_react2.mdx)("p", null, /* @__PURE__ */ (0, import_react2.mdx)("img", {
    src: (__webpack_require__(37460)/* ["default"] */ .Z),
    width: "493",
    height: "184"
  })), /* @__PURE__ */ (0, import_react2.mdx)("p", null, `Unless this option is checked, it is not possible to open a database when its data file is locked (default operation for 4D databases).`), /* @__PURE__ */ (0, import_react2.mdx)("h4", {
    ...{
      "id": "about-locked-files"
    }
  }, `About locked files`), /* @__PURE__ */ (0, import_react2.mdx)("p", null, `Locked files can be read but their contents cannot be modified. For example, files are locked when they are stored on a non-rewritable support (DVD type) or when they are copied from this type of support. 4D can work in a transparent manner with locked data files, which allows, more particularly, the use of projects stored on DVD. However, this operation runs the risk of inadvertent use of a locked data file in which modifications will not be saved. This is why by default 4D does not allow databases with a locked data file to be opened.`), /* @__PURE__ */ (0, import_react2.mdx)("h3", {
    ...{
      "id": "temporary-folder-location"
    }
  }, `Temporary Folder Location`), /* @__PURE__ */ (0, import_react2.mdx)("p", null, `This area lets you change the location of temporary files created while 4D is running. The temporary files folder is used by the application, when necessary, to temporarily save the data in memory to disk. `), /* @__PURE__ */ (0, import_react2.mdx)("p", null, `The current location of this folder is displayed in the "Current:" area. You can click in this area to show the pathname as a scrolldown list:`), /* @__PURE__ */ (0, import_react2.mdx)("p", null, /* @__PURE__ */ (0, import_react2.mdx)("img", {
    src: (__webpack_require__(65254)/* ["default"] */ .Z),
    width: "774",
    height: "101"
  })), /* @__PURE__ */ (0, import_react2.mdx)("p", null, `Three location options are provided:`), /* @__PURE__ */ (0, import_react2.mdx)("ul", null, /* @__PURE__ */ (0, import_react2.mdx)("li", {
    parentName: "ul"
  }, /* @__PURE__ */ (0, import_react2.mdx)("strong", {
    parentName: "li"
  }, `System`), `: When this option is selected, the 4D temporary files are created in a folder placed at the location specified by Windows and/or macOS. You can find out the current location defined by your system using the `, /* @__PURE__ */ (0, import_react2.mdx)("a", {
    parentName: "li",
    ...{
      "href": "https://doc.4d.com/4dv19R/help/command/en/page486.html"
    }
  }, /* @__PURE__ */ (0, import_react2.mdx)("inlineCode", {
    parentName: "a"
  }, `Temporary folder`)), ` 4D command. The files are put into a subfolder whose name consists of the database name and a unique identifier.`), /* @__PURE__ */ (0, import_react2.mdx)("li", {
    parentName: "ul"
  }, /* @__PURE__ */ (0, import_react2.mdx)("strong", {
    parentName: "li"
  }, `Data File Folder`), ` (default option): When this option is selected, the 4D temporary files are created in a folder named "temporary files" located at the same level as the data file of the database.`), /* @__PURE__ */ (0, import_react2.mdx)("li", {
    parentName: "ul"
  }, /* @__PURE__ */ (0, import_react2.mdx)("strong", {
    parentName: "li"
  }, `User Defined`), `: This option is used to set a custom location. If the location option is modified, it will be necessary to restart the database in order for the new option to be taken into account. 4D checks whether the folder selected can be write-accessed. If this is not the case, the application tries other options until a valid folder is found.`)), /* @__PURE__ */ (0, import_react2.mdx)("blockquote", null, /* @__PURE__ */ (0, import_react2.mdx)("p", {
    parentName: "blockquote"
  }, `This option is stored in the "extra properties" of the structure that is available when the structure definition is exported in XML (see `, /* @__PURE__ */ (0, import_react2.mdx)("a", {
    parentName: "p",
    ...{
      "href": "https://doc.4d.com/4Dv19/4D/19/Exporting-and-importing-structure-definitions.300-5416829.en.html"
    }
  }, `Exporting and importing structure definitions`), `).`)), /* @__PURE__ */ (0, import_react2.mdx)("h3", {
    ...{
      "id": "text-comparison"
    }
  }, `Text comparison`), /* @__PURE__ */ (0, import_react2.mdx)("blockquote", null, /* @__PURE__ */ (0, import_react2.mdx)("p", {
    parentName: "blockquote"
  }, `If you change one of these options, you have to quit and reopen the database to make the change effective. Once the database is reopened, all of the database's indexes are automatically re-indexed.`)), /* @__PURE__ */ (0, import_react2.mdx)("ul", null, /* @__PURE__ */ (0, import_react2.mdx)("li", {
    parentName: "ul"
...
When this option is not checked (default value), the at sign is used as the wildcard character, in other words, it replaces any character (see `, /* @__PURE__ */ (0, import_react2.mdx)("a", {
    ...
    parentName: "ul"
  }, `For searches, if the search criteria begins or ends with @, the "@" character will be treated as a wildcard. Only if the "@" character is placed in the middle of a word (for example: `, /* @__PURE__ */ (0, import_react2.mdx)("a", {
    parentName: "li",
    ...{
      "href": "mailto:bill@cgi.com"
    }
  }, `bill@cgi.com`), `) does 4D treat it differently.`), /* @__PURE__ */ (0, import_react2.mdx)("li", {
    parentName: "ul"
  }, `This option can also have an influence on the behavior of the commands in the `, /* @__PURE__ */ (0, import_react2.mdx)("a", {
    parentName: "li",
    ...{
      "href": "https://doc.4d.com/4Dv19/4D/19/Objects-Forms.201-5391558.en.html"
    }
  }, `Objects (Forms)`), ` theme that accept the wildcard character ("@") in the object parameter.`), /* @__PURE__ */ (0, import_react2.mdx)("li", {
    parentName: "ul"
  }, `For security reasons, only the Administrator or Designer of the database can modify this parameter. `))), /* @__PURE__ */ (0, import_react2.mdx)("li", {
    parentName: "ul"
  }, /* @__PURE__ */ (0, import_react2.mdx)("p", {
    parentName: "li"
  }, /* @__PURE__ */ (0, import_react2.mdx)("strong", {
    parentName: "p"
  }, `Current data language:`), ` Used to configure the language used for character string processing and comparison. The language choice has a direct influence on the sorting and searching of text, as well as the character case, but it has no effect on the translation of texts or on the date, time or currency formats, which remain in the system language. By default, 4D uses the system language.`), /* @__PURE__ */ (0, import_react2.mdx)("p", {
    parentName: "li"
  }, `A 4D project can thus operate in a language different from that of the system. When a project is opened, the 4D engine detects the language used by the data file and provides it to the language (interpreter or compiled mode). Text comparisons, regardless of whether they are carried out by the project engine or the language, are done in the same language.`), /* @__PURE__ */ (0, import_react2.mdx)("blockquote", {
    parentName: "li"
  }, /* @__PURE__ */ (0, import_react2.mdx)("p", {
    parentName: "blockquote"
  }, `You can modify this setting in the application Preferences (see `, /* @__PURE__ */ (0, import_react2.mdx)("a", {
    parentName: "p",
    ...{
      "href": "/docs/fr/Preferences/general"
    }
  }, `General Page`), `). In this case, the setting applies to all the new databases created by 4D.`))), /* @__PURE__ */ (0, import_react2.mdx)("li", {
    parentName: "ul"
  }, /* @__PURE__ */ (0, import_react2.mdx)("p", {
    parentName: "li"
  }, /* @__PURE__ */ (0, import_react2.mdx)("strong", {
    parentName: "p"
  }, `Consider only non-alphanumeric chars for keywords`), `: Modifies the algorithm used by 4D to identify keyword separators and hence build their indexes. By default, when this option is not checked, 4D uses a sophisticated algorithm that takes linguistic characteristics into account. `), /* @__PURE__ */ (0, import_react2.mdx)("p", {
    parentName: "li"
  }, `This algorithm is similar to the one used by word-processing software to determine the boundaries when selecting a word that is double-clicked. For more information about this algorithm, refer to the following address: `, /* @__PURE__ */ (0, import_react2.mdx)("inlineCode", {
    parentName: "p"
  }, `http://userguide.icu-project.org/boundaryanalysis`), `.`), /* @__PURE__ */ (0, import_react2.mdx)("p", {
    parentName: "li"
  }, `When this option is checked, 4D uses a simplified algorithm. In this configuration, any non-alphanumeric character (i.e., not a letter or a number) is considered as a keyword separator. This setting meets specific requirements associated with certain languages such as Japanese.`)), /* @__PURE__ */ (0, import_react2.mdx)("li", {
    parentName: "ul"
  }, /* @__PURE__ */ (0, import_react2.mdx)("p", {
    parentName: "li"
  }, /* @__PURE__ */ (0, import_react2.mdx)("strong", {
    parentName: "p"
  }, `Sorting order appropriate for searching`), `: This option is only displayed when the Japanese language is selected. Modifies the interpretation of characters such as the "Katakana-Hiragana Prolonged Sound Mark" or "\u9577\u97F3\u8A18\u53F7" or the "Japanese Iteration Marks" such as "\u309D" or "\u309E". Typical Japanese speaker is likely to prefer the results when the setting is enabled.  `))), /* @__PURE__ */ (0, import_react2.mdx)("h4", {
    ...{
      "id": "support-of-mecab-japanese-version"
    }
  }, `Support of MeCab (Japanese version)`), /* @__PURE__ */ (0, import_react2.mdx)("p", null, `On Japanese systems, 4D supports the `, /* @__PURE__ */ (0, import_react2.mdx)("em", {
    parentName: "p"
  }, `MeCab`), ` library, with a indexing algorithm for keywords that is particularly suited for the Japanese language.`), /* @__PURE__ */ (0, import_react2.mdx)("p", null, `This algorithm is used by default in Japanese versions of 4D. If needed, you can disable the use of the `, /* @__PURE__ */ (0, import_react2.mdx)("em", {
    parentName: "p"
  }, `MeCab`), ` algorithm and use the conventional `, /* @__PURE__ */ (0, import_react2.mdx)("em", {
    parentName: "p"
  }, `ICU`), ` library.`), /* @__PURE__ */ (0, import_react2.mdx)("p", null, `To disable `, /* @__PURE__ */ (0, import_react2.mdx)("em", {
    parentName: "p"
  }, `MeCab`), `, just check the `, /* @__PURE__ */ (0, import_react2.mdx)("strong", {
    parentName: "p"
  }, `Consider only non-alphanumeric chars for keywords`), ` option:`), /* @__PURE__ */ (0, import_react2.mdx)("p", null, /* @__PURE__ */ (0, import_react2.mdx)("img", {
    src: (__webpack_require__(80570)/* ["default"] */ .Z),
    width: "474",
    height: "78"
  })), /* @__PURE__ */ (0, import_react2.mdx)("h2", {
    ...{
...
Maximum size = 1 GB Minimum size = 128 MB`)), /* @__PURE__ */ (0, import_react2.mdx)("p", {
    parentName: "li"
  }, /* @__PURE__ */ (0, import_react2.mdx)("img", {
    src: (__webpack_require__(31306)/* ["default"] */ .Z),
    width: "1168",
    height: "348"
  }))), /* @__PURE__ */ (0, import_react2.mdx)("li", {
    parentName: "ul"
...
4D saves the data placed in the cache at regular intervals. You can specify any time interval between 1 second and 500 minutes. By default, 4D saves your data every 20 seconds. The application also saves your data to disk each time you change to another environment or exit the application. You can also call the `, /* @__PURE__ */ (0, import_react2.mdx)("a", {
    parentName: "p",
    ...{
      "href": "https://doc.4d.com/4dv19R/help/command/en/page297.html"
    }
  }, `FLUSH CACHE`), ` command to trigger the flush at any moment.`), /* @__PURE__ */ (0, import_react2.mdx)("p", {
    parentName: "li"
  }, `When you anticipate heavy data entry, consider setting a short time interval between saves. In case of a power failure, you will only lose the data entered since the previous save (if the database is running without a log file).`), /* @__PURE__ */ (0, import_react2.mdx)("p", {
    parentName: "li"
  }, `If there is a noticeable slowing down of the database each time the cache is flushed, you need to adjust the frequency. This slowness means that a huge amount of records is being saved. A shorter period between saves would therefore be more efficient since each save would involve fewer records and hence be faster.`), /* @__PURE__ */ (0, import_react2.mdx)("p", {
    parentName: "li"
  }, `By default, 4D displays a small window when the cache is flushed. If you do not want this visual reminder, you can uncheck the `, /* @__PURE__ */ (0, import_react2.mdx)("strong", {
    parentName: "p"
  }, `Flushing progress`), ` option on the `, /* @__PURE__ */ (0, import_react2.mdx)("a", {
    parentName: "p",
    ...{
      "href": "/docs/fr/settings/interface"
    }
  }, `Interface page`), `.`))));
}
;
...
/* harmony export */   "Z": () => (__WEBPACK_DEFAULT_EXPORT__)
/* harmony export */ });
/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = (__webpack_require__.p + "assets/images/memory-maximum-size-2040a7588972184f9c94c68a29013ad9.png");
