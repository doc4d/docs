...
const metadata = {
  ...
  "id": "version-18/Backup/backup",
  "title": "Backup",
  "description": "Starting a backup",
  "source": "@site/versioned_docs/version-18/Backup/backup.md",
  "sourceDirName": "Backup",
  "slug": "/Backup/backup",
  "permalink": "/docs/fr/18/Backup/backup",
  "draft": false,
  "tags": [],
  "version": "18",
  "frontMatter": {
  ...
  "next": {
    ...
    "permalink": "/docs/fr/18/Backup/settings"
  }
};
const assets = {};
const toc = [{
  value: "Starting a backup",
  id: "starting-a-backup",
  level: 2
}, {
  value: "Manual backup",
  id: "manual-backup",
  ...
  value: "Accessing the database during backup",
  id: "accessing-the-database-during-backup",
  level: 3
}, {
...
function MDXContent({
  ...
  return /* @__PURE__ */ (0, import_react2.mdx)(MDXLayout, {
  ...
  }, `Starting a backup`), /* @__PURE__ */ (0, import_react2.mdx)("p", null, `A backup can be started in three ways:`), /* @__PURE__ */ (0, import_react2.mdx)("ul", null, /* @__PURE__ */ (0, import_react2.mdx)("li", {
    parentName: "ul"
    ...
    parentName: "li",
    ...{
      "href": "/docs/fr/18/MSC/backup"
    }
  }, `Maintenance and Security Center`), `.`), /* @__PURE__ */ (0, import_react2.mdx)("li", {
    parentName: "ul"
  }, `Automatically, using the scheduler that can be set in the Database Settings,`), /* @__PURE__ */ (0, import_react2.mdx)("li", {
    parentName: "ul"
    ...
    parentName: "p"
  }, `BACKUP`), ` command. The command will be executed, in all cases, on the server.`)), /* @__PURE__ */ (0, import_react2.mdx)("h3", {
    ...{
      "id": "manual-backup"
    }
...
`, /* @__PURE__ */ (0, import_react2.mdx)("img", {
    src: (__webpack_require__(30731)/* ["default"] */ .Z),
    width: "564",
    height: "192"
  }), `
You can see the location of the backup folder using the pop-up menu next to the "Backup destination" area. This location is set on the `, /* @__PURE__ */ (0, import_react2.mdx)("strong", {
    ...
    parentName: "p"
  }, `Database properties...`), ` button causes the Backup/Configuration page of the Database Settings to be displayed.`), /* @__PURE__ */ (0, import_react2.mdx)("ol", {
    ...{
      "start": 2
    }
    ...
    parentName: "li"
  }, `Backup`), ` to start the backup using current parameters.`)), /* @__PURE__ */ (0, import_react2.mdx)("h3", {
    ...{
      "id": "scheduled-automatic-backup"
    }
    ...
    parentName: "p"
  }, `Database Settings`), `.`), /* @__PURE__ */ (0, import_react2.mdx)("p", null, `Backups are automatically performed at the times defined on this page without any type of user intervention. For more information on using this dialog box, refer to `, /* @__PURE__ */ (0, import_react2.mdx)("a", {
    parentName: "p",
    ...{
      "href": "/docs/fr/18/Backup/settings#scheduler"
    }
  }, `Scheduler in backup settings`), `.`), /* @__PURE__ */ (0, import_react2.mdx)("h3", {
    ...{
      "id": "backup-command"
    }
  }, `BACKUP command`), /* @__PURE__ */ (0, import_react2.mdx)("p", null, `When the `, /* @__PURE__ */ (0, import_react2.mdx)("inlineCode", {
    parentName: "p"
  }, `BACKUP`), ` 4D language command is executed from any method, the backup starts using the current parameters as defined in the Database settings. You can use the `, /* @__PURE__ */ (0, import_react2.mdx)("inlineCode", {
    parentName: "p"
    ...
    src: (__webpack_require__(24324)/* ["default"] */ .Z),
    width: "408",
    height: "168"
    ...
    parentName: "p",
    ...{
      "href": "/docs/fr/18/Backup/backup#handling-backup-issues"
    }
  ...
  }, `Accessing the database during backup`), /* @__PURE__ */ (0, import_react2.mdx)("p", null, `During a backup, access to the database is restricted by 4D according to the context. 4D locks any processes related to the types of files included in the backup: if only the project files are being backed up, access to the structure is not possible but access to the data will be allowed.`), /* @__PURE__ */ (0, import_react2.mdx)("p", null, `Conversely, if only the data file is being backed up, access to the structure is still allowed. In this case, the database access possibilities are as follows:`), /* @__PURE__ */ (0, import_react2.mdx)("ul", null, /* @__PURE__ */ (0, import_react2.mdx)("li", {
    parentName: "ul"
  }, `With the 4D single-user version, the database is locked for both read and write; all processes are frozen. No actions can be performed.`), /* @__PURE__ */ (0, import_react2.mdx)("li", {
    parentName: "ul"
    ...
    parentName: "li"
  }, `Cancel operation`), ` button. However, if the action waiting to be executed comes from a method launched prior to the backup, you should not cancel it because only operations remaining to be performed are cancelled. Also, a partially executed method can cause logical inconsistencies in the database.`)), /* @__PURE__ */ (0, import_react2.mdx)("blockquote", null, /* @__PURE__ */ (0, import_react2.mdx)("p", {
    parentName: "blockquote"
    ...
    parentName: "p"
  }, `Maintenance page`), ` of 4D Server, as well as in the database `, /* @__PURE__ */ (0, import_react2.mdx)("strong", {
    parentName: "p"
    ...
    parentName: "li"
  }, `Attached file not found`), `: When an attached file cannot be found, 4D performs a partial backup (backup of database files and accessible attached files) and returns an error.`), /* @__PURE__ */ (0, import_react2.mdx)("li", {
    parentName: "ul"
  }, /* @__PURE__ */ (0, import_react2.mdx)("strong", {
    parentName: "li"
...
If this is a first-time error, 4D will then make a second attempt to perform the backup. The wait between the two attempts is defined on the `, /* @__PURE__ */ (0, import_react2.mdx)("strong", {
    parentName: "li"
  }, `Backup/Backup & Restore`), ` page of the Database Settings.
If the second attempt fails, a system alert dialog box is displayed and an error is generated. You can intercept this error in the `, /* @__PURE__ */ (0, import_react2.mdx)("inlineCode", {
  ...
  }, `backupHistory.json`), /* @__PURE__ */ (0, import_react2.mdx)("p", null, `All information regarding the latest backup and restore operations are stored in the database's `, /* @__PURE__ */ (0, import_react2.mdx)("strong", {
    parentName: "p"
