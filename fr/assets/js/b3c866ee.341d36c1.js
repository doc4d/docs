...
const metadata = {
  ...
  "id": "version-18/FormObjects/listOverview",
  "title": "Hierarchical List",
  "description": "Overview",
  "source": "@site/versioned_docs/version-18/FormObjects/list_overview.md",
...
function MDXContent({
  ...
  }, `Overview`), /* @__PURE__ */ (0, import_react2.mdx)("p", null, `Hierarchical lists are form objects that can be used to display data as lists with one or more levels that can be expanded or collapsed.`), /* @__PURE__ */ (0, import_react2.mdx)("p", null, /* @__PURE__ */ (0, import_react2.mdx)("img", {
    src: (__webpack_require__(55134)/* ["default"] */ .Z),
    width: "168",
    height: "162"
...
`, `You program an elaborate management of hierarchical lists in which you absolutely must be able to identify each item individually at every level of the list. A simple way of implementing this is to maintain a personal counter. Suppose that you create a `, /* @__PURE__ */ (0, import_react2.mdx)("em", {
    ...
    parentName: "p",
    ...{
      "href": "/docs/fr/18/FormObjects/propertiesAction#draggable-and-droppable"
    }
