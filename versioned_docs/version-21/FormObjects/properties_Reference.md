...
|**h**|||
|[`header`](./listbox-header-footer#headers.md)|Defines the header of a list box column|Object with properties "text", "name", "icon", "dataSource", "fontWeight", "fontStyle", "tooltip" |
