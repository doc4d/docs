...
const metadata = {
  ...
  "permalink": "/docs/ja/FormObjects/propertiesCoordinatesAndSizing",
  "draft": false,
  "tags": [],
  "version": "19-R6",
  "frontMatter": {
  ...
  "previous": {
    ...
    "permalink": "/docs/ja/FormObjects/propertiesBackgroundAndBorder"
  },
  "next": {
    "title": "Crop",
    "permalink": "/docs/ja/FormObjects/propertiesCrop"
  }
};
const assets = {};
const toc = [{
...
`)), /* @__PURE__ */ (0, import_react2.mdx)("p", null, `Assuming that the unit of the rows is "lines," then the fifth row of the list box will have a height of three lines, while every other row will keep its default height.`), /* @__PURE__ */ (0, import_react2.mdx)("blockquote", null, /* @__PURE__ */ (0, import_react2.mdx)("ul", {
    ...
    parentName: "p",
    ...{
      "href": "/docs/ja/FormObjects/propertiesFooters"
    }
  }, `Footers`), ` - `, /* @__PURE__ */ (0, import_react2.mdx)("a", {
    parentName: "p",
    ...{
      "href": "/docs/ja/FormObjects/propertiesHeaders"
    }
