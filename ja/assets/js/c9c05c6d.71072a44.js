...
const metadata = {
  ...
  "source": "@site/docs/code-editor/overview.md",
  "sourceDirName": "code-editor",
  "slug": "/code-editor/overview",
  "permalink": "/docs/ja/next/code-editor/overview",
  "draft": false,
  "tags": [],
  "version": "current",
  "frontMatter": {
  ...
  "previous": {
    "title": "ZIPFolder",
    "permalink": "/docs/ja/next/API/ZipFolderClass"
  },
  "next": {
    "title": "Code Editor",
...
function MDXContent({
  ...
  return /* @__PURE__ */ (0, import_react2.mdx)(MDXLayout, {
    ...
    parentName: "p",
    ...{
      "href": "/docs/ja/next/Concepts/methods"
    }
  }, `methods`), ` and `, /* @__PURE__ */ (0, import_react2.mdx)("a", {
    parentName: "p",
    ...{
      "href": "/docs/ja/next/Concepts/classes"
    }
    ...
    parentName: "p",
    ...{
      "href": "/docs/ja/next/Project/architecture#sources"
    }
    ...
    parentName: "li",
    ...{
      "href": "/docs/ja/next/code-editor/write-class-method#shortcuts"
    }
    ...
    parentName: "p",
    ...{
      "href": "/docs/ja/next/Concepts/identifiers"
    }
    ...
    parentName: "p"
  }, `Run`), ` menu, you can make it Invisible by checking this option. An invisible method does not appear in the method execution dialog box. `), /* @__PURE__ */ (0, import_react2.mdx)("p", null, `When you make a project method invisible, it is still available to database programmers. It remains listed on the method list of the Explorer and of the Code Editor.`), /* @__PURE__ */ (0, import_react2.mdx)("h5", {
    ...{
      "id": "shared-by-components-and-host-database"
    }
    ...
    parentName: "p",
    ...{
      "href": "/docs/ja/next/Extensions/develop-components"
    }
    ...
    parentName: "p",
    ...{
      "href": "https://doc.4d.com/4Dv19R6/4D/19-R6/Execute-on-Server-attribute.300-5941841.en.html"
    }
    ...
    parentName: "p",
    ...{
      "href": "https://doc.4d.com/4Dv19R6/4D/19-R6/Preemptive-4D-processes.300-5911166.en.html"
    }
    ...
    parentName: "strong"
  }, `Particular case`), `:`), ` If the method has also the `, /* @__PURE__ */ (0, import_react2.mdx)("a", {
    parentName: "p",
    ...{
      "href": "shared-by-components-and-host-database"
    }
  }, /* @__PURE__ */ (0, import_react2.mdx)("strong", {
    parentName: "a"
  }, `Shared by components and host database`)), ` property, setting the `, /* @__PURE__ */ (0, import_react2.mdx)("strong", {
    parentName: "p"
  ...
  }, `4D tags and URLs (4DACTION...)`), /* @__PURE__ */ (0, import_react2.mdx)("p", null, `This option is used to reinforce 4D Web server security: when it is not checked, the project method cannot be executed via an HTTP request containing the special `, /* @__PURE__ */ (0, import_react2.mdx)("a", {
    parentName: "p",
    ...{
      "href": "/docs/ja/next/WebServer/httpRequests#4daction"
    }
  }, `4DACTION URL`), ` used for calling 4D methods, nor the special `, /* @__PURE__ */ (0, import_react2.mdx)("a", {
    parentName: "p",
    ...{
      "href": "/docs/ja/next/Tags/tags"
    }
  }, `4DSCRIPT, 4DTEXT and 4DHTML tags`), `.`), /* @__PURE__ */ (0, import_react2.mdx)("p", null, `In the Explorer, project methods with this attribute are given a specific icon `, /* @__PURE__ */ (0, import_react2.mdx)("img", {
    parentName: "p",
    ...{
...
The character string is used as a search criterion for the method names.`))), /* @__PURE__ */ (0, import_react2.mdx)("p", null, `Use the wildcard character @ to help define groups of methods:`), /* @__PURE__ */ (0, import_react2.mdx)("ul", null, /* @__PURE__ */ (0, import_react2.mdx)("li", {
    parentName: "ul"
  }, `To designate methods whose names begin with..., type @ at the end of the string. For example: `, /* @__PURE__ */ (0, import_react2.mdx)("inlineCode", {
    parentName: "li"
  }, `web@`)), /* @__PURE__ */ (0, import_react2.mdx)("li", {
    parentName: "ul"
  }, `To designate methods whose names contain..., type @ in the middle of the string. For example: `, /* @__PURE__ */ (0, import_react2.mdx)("inlineCode", {
    parentName: "li"
  }, `web@write`)), /* @__PURE__ */ (0, import_react2.mdx)("li", {
    parentName: "ul"
  }, `To designate methods whose names end with..., type @ at the beginning of the string. For example: `, /* @__PURE__ */ (0, import_react2.mdx)("inlineCode", {
    parentName: "li"
  }, `@write`)), /* @__PURE__ */ (0, import_react2.mdx)("li", {
    parentName: "ul"
  }, `To designate all of the methods, just type @ in the area.`)), /* @__PURE__ */ (0, import_react2.mdx)("p", null, /* @__PURE__ */ (0, import_react2.mdx)("strong", {
    parentName: "p"
  }, `Notes:`)), /* @__PURE__ */ (0, import_react2.mdx)("ul", null, /* @__PURE__ */ (0, import_react2.mdx)("li", {
    parentName: "ul"
  }, `The search does not take upper/lower case into account.`), /* @__PURE__ */ (0, import_react2.mdx)("li", {
    parentName: "ul"
  }, `You can enter several @ characters in the string, for example `, /* @__PURE__ */ (0, import_react2.mdx)("inlineCode", {
    parentName: "li"
  }, `dtro_@web@pro.@`))), /* @__PURE__ */ (0, import_react2.mdx)("ol", {
    ...{
      "start": 3
    }
    ...
    parentName: "li"
  }, `False`), ` radio button corresponding to the value to be applied.`)), /* @__PURE__ */ (0, import_react2.mdx)("p", null, /* @__PURE__ */ (0, import_react2.mdx)("strong", {
    parentName: "p"
  }, `Note:`), ` If the "Published in WSDL" attribute is set to True, it will only be applied to project methods already containing the "Offered as a Web Service" attribute.`), /* @__PURE__ */ (0, import_react2.mdx)("ol", {
    ...{
      "start": 4
    }
  }, /* @__PURE__ */ (0, import_react2.mdx)("li", {
