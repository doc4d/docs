...
const metadata = {
  ...
  "title": "Control flow overview",
  "description": "Regardless of the simplicity or complexity of a method or function, you will always use one or more of three types of programming structures. Programming structures control the flow of execution, whether and in what order statements are executed within a method. There are three types of structures:",
  "source": "@site/docs/Concepts/flow-control.md",
  "sourceDirName": "Concepts",
  "slug": "/Concepts/control-flow",
  "permalink": "/docs/ja/next/Concepts/control-flow",
  "draft": false,
  "tags": [],
  "version": "current",
  "frontMatter": {
  ...
  "previous": {
    "title": "Classes",
    "permalink": "/docs/ja/next/Concepts/classes"
  },
  "next": {
    "title": "Branching structures",
    "permalink": "/docs/ja/next/Concepts/branching"
  }
};
const assets = {};
const toc = [{
...
function MDXContent({
  ...
  return /* @__PURE__ */ (0, import_react2.mdx)(MDXLayout, {
    ...
    components,
    mdxType: "MDXLayout"
  }, /* @__PURE__ */ (0, import_react2.mdx)("p", null, `Regardless of the simplicity or complexity of a method or function, you will always use one or more of three types of programming structures. Programming structures control the flow of execution, whether and in what order statements are executed within a method. There are three types of structures:`), /* @__PURE__ */ (0, import_react2.mdx)("ul", null, /* @__PURE__ */ (0, import_react2.mdx)("li", {
    parentName: "ul"
    ...
    parentName: "strong",
    ...{
      "href": "/docs/ja/next/Concepts/branching"
    }
    ...
    parentName: "strong",
    ...{
      "href": "/docs/ja/next/Concepts/looping"
    }
  }, `Looping`)), `: When writing methods, it is very common to find that you need a sequence of statements to repeat a number of times. To deal with this need, the 4D language provides the following looping structures:`, /* @__PURE__ */ (0, import_react2.mdx)("pre", {
    parentName: "li"
...
`)), `The loops are controlled in two ways: either they loop until a condition is met, or they loop a specified number of times. Each looping structure can be used in either way, but `, /* @__PURE__ */ (0, import_react2.mdx)("inlineCode", {
    ...
    parentName: "p"
  }, `Note:`), ` 4D allows you to embed programming structures up to a "depth" of 512 levels. `), /* @__PURE__ */ (0, import_react2.mdx)("h2", {
    ...{
      "id": "return-expression"
    }
    ...
    parentName: "p"
  }, `return`), ` statement can be called from anywhere. When a `, /* @__PURE__ */ (0, import_react2.mdx)("inlineCode", {
    parentName: "p"
  }, `return`), ` statement is used in a function or method, the execution of the function or method is stopped. The remaining code is not executed and the control is returned to the caller. `), /* @__PURE__ */ (0, import_react2.mdx)("p", null, `The `, /* @__PURE__ */ (0, import_react2.mdx)("inlineCode", {
    parentName: "p"
  }, `return`), ` statement can be used to `, /* @__PURE__ */ (0, import_react2.mdx)("a", {
    parentName: "p",
    ...{
      "href": "/docs/ja/next/Concepts/parameters#return-expression"
    }
  }, `return a value`), ` to the caller. `), /* @__PURE__ */ (0, import_react2.mdx)("h3", {
    ...{
      "id": "example"
    }
