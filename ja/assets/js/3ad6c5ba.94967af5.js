...
const metadata = {
  ...
  "id": "version-19-R6/Menus/properties",
  "title": "Menu item properties",
  ...
  "source": "@site/versioned_docs/version-19-R6/Menus/properties.md",
  "sourceDirName": "Menus",
  "slug": "/Menus/properties",
  "permalink": "/docs/ja/Menus/properties",
  "draft": false,
  "tags": [],
  "version": "19-R6",
  "frontMatter": {
  ...
  "previous": {
    ...
    "permalink": "/docs/ja/Menus/creating"
  },
  "next": {
    "title": "Menu bar features",
    "permalink": "/docs/ja/Menus/bars"
  }
};
const assets = {};
const toc = [{
...
function MDXContent({
  ...
  return /* @__PURE__ */ (0, import_react2.mdx)(MDXLayout, {
    ...
    parentName: "li"
  }, `Method Name`), `: Select an existing project method name in the combo box. If the project method does not exist, enter its name in the "Method Name" combo box then click on the `, `[...]`, ` button. 4D displays a project method creation dialog that is used to access the Code Editor.`), /* @__PURE__ */ (0, import_react2.mdx)("li", {
    parentName: "ul"
  }, /* @__PURE__ */ (0, import_react2.mdx)("strong", {
    parentName: "li"
...
This option is mainly intended for `, /* @__PURE__ */ (0, import_react2.mdx)("strong", {
    ...
    src: (__webpack_require__(48261)/* ["default"] */ .Z),
    width: "180",
    height: "121"
...
Click on the `, `[...]`, ` button to the right of the "Shortcut" entry area. The following window appears:`), /* @__PURE__ */ (0, import_react2.mdx)("p", null, /* @__PURE__ */ (0, import_react2.mdx)("img", {
    src: (__webpack_require__(78328)/* ["default"] */ .Z),
    width: "365",
    height: "277"
...
To start over, click on `, /* @__PURE__ */ (0, import_react2.mdx)("strong", {
    ...
    parentName: "p",
    ...{
      "href": "/docs/ja/Menus/properties#using-control-characters"
    }
    ...
    src: (__webpack_require__(40673)/* ["default"] */ .Z),
    width: "123",
    height: "105"
    ...
    parentName: "p"
  }, `Open`), ` to open a picture from the disk. If you select a picture file that is not already stored in the project resources folder, it is automatically copied in that folder. Once set, the item icon appears in the preview area:`), /* @__PURE__ */ (0, import_react2.mdx)("p", null, /* @__PURE__ */ (0, import_react2.mdx)("img", {
    src: (__webpack_require__(57279)/* ["default"] */ .Z),
    width: "107",
    height: "36"
