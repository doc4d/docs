...
const toc = [{
  ...
  value: "Installing <code>key.pem</code> and <code>cert.pem</code> files",
  id: "installing-keypem-and-certpem-files",
  level: 3
}, {
  value: "With the web server",
  id: "with-the-web-server",
  level: 4
}, {
  value: "With the application server (client-server desktop applications)",
  id: "with-the-application-server-client-server-desktop-applications",
  level: 4
}, {
  value: "With the SQL server",
  id: "with-the-sql-server",
  level: 4
}, {
  value: "Enabling TLS",
  id: "enabling-tls",
...
function MDXContent({
  ...
  return /* @__PURE__ */ (0, import_react2.mdx)(MDXLayout, {
    ...
    src: (__webpack_require__(35723)/* ["default"] */ .Z),
    width: "318",
    height: "174"
    ...
    parentName: "p",
    ...{
      "href": "/docs/ja/WebServer/webServerConfig#minimum-tls-version"
    }
    ...
    src: (__webpack_require__(6946)/* ["default"] */ .Z),
    width: "394",
    height: "227"
    ...
    parentName: "li"
  }, `Send the certificate request to the chosen certificate authority.`), /* @__PURE__ */ (0, import_react2.mdx)("p", {
    parentName: "li"
    ...
    parentName: "li"
  }, `Once you get your certificate, create a text file named \u201Ccert.pem\u201D and paste the contents of the certificate into it.`), /* @__PURE__ */ (0, import_react2.mdx)("p", {
    parentName: "li"
  ...
  }, `Installing `, /* @__PURE__ */ (0, import_react2.mdx)("inlineCode", {
    parentName: "h3"
    ...
    parentName: "p"
  }, `cert.pem`), ` (document containing the certificate) at the appropriate location(s). Different locations are required depending on the server on which you want to use TLS.`), /* @__PURE__ */ (0, import_react2.mdx)("blockquote", null, /* @__PURE__ */ (0, import_react2.mdx)("p", {
    parentName: "blockquote"
  }, `Default `, /* @__PURE__ */ (0, import_react2.mdx)("em", {
    parentName: "p"
  }, `key.pem`), ` and `, /* @__PURE__ */ (0, import_react2.mdx)("em", {
    parentName: "p"
  }, `cert.pem`), ` files are provided with 4D. For a higher level of security, we strongly recommend that you replace these files with your own certificates.`)), /* @__PURE__ */ (0, import_react2.mdx)("h4", {
    ...{
      "id": "with-the-web-server"
    }
  }, `With the web server`), /* @__PURE__ */ (0, import_react2.mdx)("p", null, `To be used by the 4D web server, the `, /* @__PURE__ */ (0, import_react2.mdx)("strong", {
    parentName: "p"
  }, `key.pem`), ` and `, /* @__PURE__ */ (0, import_react2.mdx)("strong", {
    parentName: "p"
  }, `cert.pem`), ` files must be placed:`), /* @__PURE__ */ (0, import_react2.mdx)("ul", null, /* @__PURE__ */ (0, import_react2.mdx)("li", {
    parentName: "ul"
  }, `with 4D in local mode or 4D Server, next to the `, /* @__PURE__ */ (0, import_react2.mdx)("a", {
    parentName: "li",
    ...{
    ...
    parentName: "ul"
  }, `with 4D in remote mode, in the client database folder on the remote machine (for more information about the location of this folder, see the `, /* @__PURE__ */ (0, import_react2.mdx)("a", {
    parentName: "li",
    ...{
    ...
    parentName: "a"
  }, `Get 4D folder`)), ` command).`)), /* @__PURE__ */ (0, import_react2.mdx)("p", null, `You must copy these files manually on the remote machine.`), /* @__PURE__ */ (0, import_react2.mdx)("h4", {
    ...{
      "id": "with-the-application-server-client-server-desktop-applications"
    }
  }, `With the application server (client-server desktop applications)`), /* @__PURE__ */ (0, import_react2.mdx)("p", null, `To be used by the 4D application server, the `, /* @__PURE__ */ (0, import_react2.mdx)("strong", {
    parentName: "p"
  }, `key.pem`), ` and `, /* @__PURE__ */ (0, import_react2.mdx)("strong", {
    parentName: "p"
  }, `cert.pem`), ` files must be placed:`), /* @__PURE__ */ (0, import_react2.mdx)("ul", null, /* @__PURE__ */ (0, import_react2.mdx)("li", {
    ...
    parentName: "li",
    ...{
      "href": "/docs/ja/Project/architecture#resources"
    }
  }, /* @__PURE__ */ (0, import_react2.mdx)("strong", {
    parentName: "a"
  }, `Resources`), ` folder`), ` of the 4D Server application`), /* @__PURE__ */ (0, import_react2.mdx)("li", {
    parentName: "ul"
  }, `and in the `, /* @__PURE__ */ (0, import_react2.mdx)("strong", {
    parentName: "li"
  }, `Resources`), ` folder on each remote 4D application (for more information about the location of this folder, see the `, /* @__PURE__ */ (0, import_react2.mdx)("a", {
    parentName: "li",
    ...{
      "href": "https://doc.4d.com/4dv19/help/command/en/page485.html"
    }
    ...
    parentName: "a"
  }, `Get 4D folder`)), ` command).`)), /* @__PURE__ */ (0, import_react2.mdx)("h4", {
    ...{
      "id": "with-the-sql-server"
    }
  }, `With the SQL server`), /* @__PURE__ */ (0, import_react2.mdx)("p", null, `To be used by the 4D SQL server, the `, /* @__PURE__ */ (0, import_react2.mdx)("strong", {
    parentName: "p"
  }, `key.pem`), ` and `, /* @__PURE__ */ (0, import_react2.mdx)("strong", {
    parentName: "p"
  }, `cert.pem`), ` files must be placed next to the `, /* @__PURE__ */ (0, import_react2.mdx)("a", {
    parentName: "p",
    ...{
      "href": "/docs/ja/Project/architecture#project-folder"
    }
  }, `project folder`), `.`), /* @__PURE__ */ (0, import_react2.mdx)("h3", {
    ...{
      "id": "enabling-tls"
    }
    ...
    parentName: "li",
    ...{
      "href": "/docs/ja/WebServer/webServerConfig#enable-https"
    }
  }, `enable HTTPS`), `. You can set the `, /* @__PURE__ */ (0, import_react2.mdx)("a", {
    parentName: "li",
    ...{
      "href": "/docs/ja/WebServer/webServerConfig#enable-hsts"
    }
    ...
    parentName: "blockquote"
  }, `The 4D web server also supports `, /* @__PURE__ */ (0, import_react2.mdx)("a", {
    parentName: "p",
    ...{
      "href": "/docs/ja/WebServer/webServerConfig#enable-hsts"
    }
  }, `HSTS option`), ` to declare that browsers should only interact with it via secure HTTPS connections.`)), /* @__PURE__ */ (0, import_react2.mdx)("h2", {
    ...{
      "id": "perfect-forward-secrecy-pfs"
    }
    ...
    parentName: "p",
    ...{
      "href": "/docs/ja/WebServer/webServerConfig##cipher-list"
    }
