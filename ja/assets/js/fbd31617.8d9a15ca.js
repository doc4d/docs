...
const metadata = {
  ...
  "id": "version-18/Concepts/branching",
  "title": "Branching structures",
  "description": "If...Else...End if",
  "source": "@site/versioned_docs/version-18/Concepts/cf_branching.md",
  ...
  "previous": {
    ...
    "permalink": "/docs/ja/18/Concepts/control-flow"
  },
  "next": {
...
`)), /* @__PURE__ */ (0, import_react2.mdx)("p", null, `The `, /* @__PURE__ */ (0, import_react2.mdx)("inlineCode", {
    ...
    ...
 End if
`)), /* @__PURE__ */ (0, import_react2.mdx)("p", null, `he expression is TRUE only if both methods are TRUE. However, even if `, /* @__PURE__ */ (0, import_react2.mdx)("em", {
    parentName: "p"
