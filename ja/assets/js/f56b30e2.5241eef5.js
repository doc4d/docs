...
const metadata = {
  ...
  "id": "version-18/Menus/sdi",
  "title": "SDI mode on Windows",
  "description": "Overview",
  "source": "@site/versioned_docs/version-18/Menus/sdi.md",
  "sourceDirName": "Menus",
  "slug": "/Menus/sdi",
  ...
  "previous": {
    ...
    "permalink": "/docs/ja/18/Menus/bars"
  },
  "next": {
    "title": "Overview",
...
const toc = [{
  ...
  value: "SDI mode availabilty",
  id: "sdi-mode-availabilty",
  level: 3
}, {
...
function MDXContent({
  ...
  return /* @__PURE__ */ (0, import_react2.mdx)(MDXLayout, {
  ...
  }, `The concept of SDI/MDI does not exist on macOS. This feature concerns Windows applications only and related options are ignored on macOS.`)), /* @__PURE__ */ (0, import_react2.mdx)("h3", {
    ...{
      "id": "sdi-mode-availabilty"
    }
  }, `SDI mode availabilty`), /* @__PURE__ */ (0, import_react2.mdx)("p", null, `The SDI mode is available in the following execution environment only:`), /* @__PURE__ */ (0, import_react2.mdx)("ul", null, /* @__PURE__ */ (0, import_react2.mdx)("li", {
    parentName: "ul"
    ...
    parentName: "li"
  }, `Use SDI mode on Windows`), ` option in the "Interface" page of the Database Settings dialog box.`), /* @__PURE__ */ (0, import_react2.mdx)("li", {
    parentName: "ol"
    ...
    src: (__webpack_require__(77454)/* ["default"] */ .Z),
    width: "600",
    height: "238"
    ...
    parentName: "li"
  }, `Splash screen`), ` interface option was selected in the Database Settings, the splash window will contain any menus that would have been displayed in the MDI window. Note also that closing the splash screen window will result in exiting the application, just like in MDI mode.`), /* @__PURE__ */ (0, import_react2.mdx)("li", {
    parentName: "ul"
