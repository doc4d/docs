...
const metadata = {
  ...
  "id": "version-18/Menus/overview",
  "title": "Overview",
  "description": "You can create menu bars and menus for your 4D databases and custom applications. Because pull-down menus are a standard feature of any desktop application, their addition will make your databases easier to use and will make them feel familiar to users.",
  "source": "@site/versioned_docs/version-18/Menus/overview.md",
  "sourceDirName": "Menus",
  "slug": "/Menus/overview",
  "permalink": "/docs/ja/18/Menus/overview",
  "draft": false,
  "tags": [],
  "version": "18",
  "frontMatter": {
  ...
  "next": {
    ...
    "permalink": "/docs/ja/18/Menus/creating"
  }
};
const assets = {};
const toc = [{
...
function MDXContent({
  ...
  return /* @__PURE__ */ (0, import_react2.mdx)(MDXLayout, {
    ...
    components,
    mdxType: "MDXLayout"
  }, /* @__PURE__ */ (0, import_react2.mdx)("p", null, `You can create menu bars and menus for your 4D databases and custom applications. Because pull-down menus are a standard feature of any desktop application, their addition will make your databases easier to use and will make them feel familiar to users.`), /* @__PURE__ */ (0, import_react2.mdx)("p", null, /* @__PURE__ */ (0, import_react2.mdx)("img", {
    src: (__webpack_require__(97525)/* ["default"] */ .Z),
    width: "448",
    height: "138"
    ...
    src: (__webpack_require__(85723)/* ["default"] */ .Z),
    width: "778",
    height: "575"
