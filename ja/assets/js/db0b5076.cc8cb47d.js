...
const metadata = {
  "unversionedId": "Preferences/overview",
  "id": "version-19/Preferences/overview",
  "title": "Overview",
  "description": "User preferences specify various settings affecting your working environment, e.g. default options, display themes, method editor features, shortcuts, etc. They are applied to all projects opened with your 4D or 4D Server application.",
  "source": "@site/versioned_docs/version-19/Preferences/overview.md",
  "sourceDirName": "Preferences",
  "slug": "/Preferences/overview",
  "permalink": "/docs/ja/19/Preferences/overview",
  "draft": false,
  "tags": [],
  "version": "19",
  "frontMatter": {
  ...
  "previous": {
    "title": "ZIPFolder",
    "permalink": "/docs/ja/19/API/ZipFolderClass"
  },
  "next": {
    "title": "General Page",
    "permalink": "/docs/ja/19/Preferences/general"
  }
};
const assets = {};
const toc = [{
  ...
  value: "Customizing parameters and reset settings",
  id: "customizing-parameters-and-reset-settings",
  level: 2
}];
const layoutProps = {
  toc
...
function MDXContent({
  ...
  return /* @__PURE__ */ (0, import_react2.mdx)(MDXLayout, {
    ...
    components,
    mdxType: "MDXLayout"
  }, /* @__PURE__ */ (0, import_react2.mdx)("p", null, `User preferences specify various settings affecting your working environment, e.g. default options, display themes, method editor features, shortcuts, etc. They are applied to all projects opened with your 4D or 4D Server application.`), /* @__PURE__ */ (0, import_react2.mdx)("p", null, /* @__PURE__ */ (0, import_react2.mdx)("strong", {
    parentName: "p"
  }, `4D Server`), `: Object locking occurs when two or more users try to modify the settings in the Preferences dialog box at the same time. Only one user can use the Preferences dialog box at a time.`), /* @__PURE__ */ (0, import_react2.mdx)("blockquote", null, /* @__PURE__ */ (0, import_react2.mdx)("p", {
    parentName: "blockquote"
  }, `4D offers a different set of parameters specific to the open projet: `, /* @__PURE__ */ (0, import_react2.mdx)("strong", {
    parentName: "p"
  }, `Settings`), ` (available from the `, /* @__PURE__ */ (0, import_react2.mdx)("strong", {
    parentName: "p"
  }, `Design`), ` menu). For more information, refer to the Settings chapter.`)), /* @__PURE__ */ (0, import_react2.mdx)("h2", {
    ...{
      "id": "access"
    }
  }, `Access`), /* @__PURE__ */ (0, import_react2.mdx)("p", null, `You can access the Preferences dialog box from the `, /* @__PURE__ */ (0, import_react2.mdx)("strong", {
    parentName: "p"
  }, `Edit > Preferences...`), ` menu (Windows) or the `, /* @__PURE__ */ (0, import_react2.mdx)("strong", {
    parentName: "p"
  }, `4D`), ` Application menu (macOS):`), /* @__PURE__ */ (0, import_react2.mdx)("p", null, /* @__PURE__ */ (0, import_react2.mdx)("img", {
    src: (__webpack_require__(72250)/* ["default"] */ .Z),
    width: "314",
    height: "300"
  })), /* @__PURE__ */ (0, import_react2.mdx)("p", null, `This menu option is available even when there is no open project.`), /* @__PURE__ */ (0, import_react2.mdx)("p", null, `You can also display the Preferences dialog box in Application mode using the "Preferences" standard action (associated with a menu item or a button) or using the `, /* @__PURE__ */ (0, import_react2.mdx)("inlineCode", {
    parentName: "p"
  }, `OPEN SETTINGS WINDOW`), ` command.`), /* @__PURE__ */ (0, import_react2.mdx)("h2", {
    ...{
      "id": "storage"
    }
  }, `Storage`), /* @__PURE__ */ (0, import_react2.mdx)("p", null, `Settings made in the Preferences dialog box are saved in an XML format preferences file named `, /* @__PURE__ */ (0, import_react2.mdx)("strong", {
    parentName: "p"
  }, `4D Preferences vXX.4DPreferences`), ` that is stored in the active 4D folder of the current user, as returned by the `, /* @__PURE__ */ (0, import_react2.mdx)("a", {
    parentName: "p",
    ...{
      "href": "https://doc.4d.com/4Dv18R6/4D/18-R6/Get-4D-folder.301-5198423.en.html"
    }
  }, /* @__PURE__ */ (0, import_react2.mdx)("inlineCode", {
    parentName: "a"
  }, `Get 4D folder`)), ` command:`), /* @__PURE__ */ (0, import_react2.mdx)("ul", null, /* @__PURE__ */ (0, import_react2.mdx)("li", {
    parentName: "ul"
  }, `Windows: `, /* @__PURE__ */ (0, import_react2.mdx)("inlineCode", {
    parentName: "li"
  }, `{disk}\\Users\\{UserName}\\AppData\\Roaming\\4D`)), /* @__PURE__ */ (0, import_react2.mdx)("li", {
    parentName: "ul"
  }, `macOS: `, /* @__PURE__ */ (0, import_react2.mdx)("inlineCode", {
    parentName: "li"
  }, `{disk}:Users:{UserName}:Library:Application Support:4D`))), /* @__PURE__ */ (0, import_react2.mdx)("h2", {
    ...{
      "id": "customizing-parameters-and-reset-settings"
    }
  }, `Customizing parameters and reset settings`), /* @__PURE__ */ (0, import_react2.mdx)("p", null, `In settings dialog boxes, parameters whose values have been modified appear in bold:`), /* @__PURE__ */ (0, import_react2.mdx)("p", null, /* @__PURE__ */ (0, import_react2.mdx)("img", {
    src: (__webpack_require__(82754)/* ["default"] */ .Z),
    width: "833",
    height: "145"
  })), /* @__PURE__ */ (0, import_react2.mdx)("p", null, `Preferences indicated as customized may have been modified directly in the dialog box, or may have been modified previously in the case of a converted database.`), /* @__PURE__ */ (0, import_react2.mdx)("p", null, `A parameter still appears in bold even when its value is replaced manually with its default values. This way it is always possible to visually identify any parameters that have been customized.`), /* @__PURE__ */ (0, import_react2.mdx)("p", null, `To reset the parameters to their default values and remove the bold style indicating that they have been customized, click on the `, /* @__PURE__ */ (0, import_react2.mdx)("strong", {
    parentName: "p"
  }, `Reset to factory settings`), ` button:`), /* @__PURE__ */ (0, import_react2.mdx)("p", null, /* @__PURE__ */ (0, import_react2.mdx)("img", {
    src: (__webpack_require__(19306)/* ["default"] */ .Z),
    width: "866",
    height: "126"
  })), /* @__PURE__ */ (0, import_react2.mdx)("p", null, `This button resets all the parameters of the current page. It becomes active when at least one parameter has been modified on the current page.`));
}
;
