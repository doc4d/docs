...
const metadata = {
  ...
  "id": "version-18/REST/upload",
  "title": "$upload",
  "description": "Returns an ID of the file uploaded to the server",
  "source": "@site/versioned_docs/version-18/REST/$upload.md",
  "sourceDirName": "REST",
  "slug": "/REST/upload",
...
function MDXContent({
  ...
  return /* @__PURE__ */ (0, import_react2.mdx)(MDXLayout, {
  ...
  }, `Image upload example`), /* @__PURE__ */ (0, import_react2.mdx)("p", null, `To upload an image, you must first select the file object on the client using the HTML 5 built-in API for using file from a web application. 4D uses the MIME type attribute of the file object so it can handle it appropriately.`), /* @__PURE__ */ (0, import_react2.mdx)("p", null, `Then, we upload the selected image to 4D Server:`), /* @__PURE__ */ (0, import_react2.mdx)("p", null, ` `, /* @__PURE__ */ (0, import_react2.mdx)("inlineCode", {
    parentName: "p"
  }, `POST  /rest/$upload?$rawPict=true`), ` `), /* @__PURE__ */ (0, import_react2.mdx)("p", null, /* @__PURE__ */ (0, import_react2.mdx)("strong", {
    parentName: "p"
    ...
    parentName: "a"
  }, `$method=update`)), ` to add the image to an entity:`), /* @__PURE__ */ (0, import_react2.mdx)("p", null, ` `, /* @__PURE__ */ (0, import_react2.mdx)("inlineCode", {
    parentName: "p"
