...
const metadata = {
  ...
  "id": "version-19/Project/architecture",
  "title": "Architecture of a project",
  ...
  "source": "@site/versioned_docs/version-19/Project/architecture.md",
  "sourceDirName": "Project",
  "slug": "/Project/architecture",
  "permalink": "/docs/ja/19/Project/architecture",
  "draft": false,
  "tags": [],
  "version": "19",
  "frontMatter": {
  ...
  "previous": {
    ...
    "permalink": "/docs/ja/19/Project/creating"
  },
  "next": {
    "title": "Documenting a project",
    "permalink": "/docs/ja/19/Project/documentation"
  }
};
const assets = {};
const toc = [{
  ...
  value: "<em>applicationName</em>.4DProject file",
...
function MDXContent({
  ...
  return /* @__PURE__ */ (0, import_react2.mdx)(MDXLayout, {
    ...
    parentName: "li",
    ...{
      "href": "/docs/ja/19/Desktop/clientServer#opening-a-remote-project"
    }
  }, `Opening a remote project`), `)`)), /* @__PURE__ */ (0, import_react2.mdx)("blockquote", null, /* @__PURE__ */ (0, import_react2.mdx)("p", {
    parentName: "blockquote"
  }, `In 4D projects, development is done with 4D and multi-user development is managed through source control tools. 4D Server can open .4DProject files for testing purposes.`)), /* @__PURE__ */ (0, import_react2.mdx)("h3", {
    ...{
      "id": "sources-folder"
    }
...
The .4dm file extension is a text-based file format, containing the code of a 4D method. It is compliant with source control tools.`), /* @__PURE__ */ (0, import_react2.mdx)("h3", {
  ...
  }, `Libraries folder`), /* @__PURE__ */ (0, import_react2.mdx)("blockquote", null, /* @__PURE__ */ (0, import_react2.mdx)("p", {
    parentName: "blockquote"
    ...
    parentName: "p",
    ...{
      "href": "/docs/ja/19/Project/compiler#silicon-compiler"
    }
    ...
    parentName: "td",
    ...{
      "href": "/docs/ja/19/Backup/settings"
    }
    ...
    parentName: "li",
    ...{
      "href": "/docs/ja/19/Backup/backup#backup-journal"
    }
  ...
  }, `Components folder`), /* @__PURE__ */ (0, import_react2.mdx)("p", null, `This folder contains the components to be available in the application project. It must be stored at the same level as the Project folder.`), /* @__PURE__ */ (0, import_react2.mdx)("blockquote", null, /* @__PURE__ */ (0, import_react2.mdx)("p", {
    parentName: "blockquote"
    ...
    parentName: "li",
    ...{
      "href": "/docs/ja/19/Desktop/building#build-component"
    }
  ...
  }, `Plugins folder`), /* @__PURE__ */ (0, import_react2.mdx)("p", null, `This folder contains the plug-ins to be available in the application project. It must be stored at the same level as the Project folder.`), /* @__PURE__ */ (0, import_react2.mdx)("h2", {
    ...{
      "id": "documentation-folder"
    }
  }, `Documentation folder`), /* @__PURE__ */ (0, import_react2.mdx)("p", null, `This folder contains all documentation files (.md) created for the project elements such as classes, methods, or forms. Documentation files are managed and displayed in the 4D Explorer.`), /* @__PURE__ */ (0, import_react2.mdx)("p", null, `For more information, refer to `, /* @__PURE__ */ (0, import_react2.mdx)("a", {
    parentName: "p",
    ...{
      "href": "/docs/ja/19/Project/documentation"
    }
  }, `Documenting a project`), `.`), /* @__PURE__ */ (0, import_react2.mdx)("h2", {
    ...{
      "id": "webfolder"
    }
  }, `WebFolder`), /* @__PURE__ */ (0, import_react2.mdx)("p", null, `Defaut root folder of the 4D Web server for pages, pictures, etc. It is automatically created when the Web server is launched for the first time.`));
}
;
