...
const metadata = {
  ...
  "id": "Concepts/shared",
  "title": "Shared objects and collections",
  "description": "Shared objects and shared collections are specific objects and collections whose contents are shared between processes. In contrast to interprocess variables, shared objects and shared collections have the advantage of being compatible with preemptive 4D processes: they can be passed by reference as parameters to commands such as New process or CALL WORKER.",
  "source": "@site/docs/Concepts/shared.md",
...
function MDXContent({
  ...
  return /* @__PURE__ */ (0, import_react2.mdx)(MDXLayout, {
    ...
    parentName: "p",
    ...{
      "href": "/docs/ja/next/Concepts/variables#interprocess-variables"
    }
    ...
    parentName: "p"
  }, `Storage`), ` command is always available throughout the application and its components, and can be used to store all shared objects and collections. `), /* @__PURE__ */ (0, import_react2.mdx)("h2", {
    ...{
      "id": "using-shared-objects-or-collections"
    }
...
`)), /* @__PURE__ */ (0, import_react2.mdx)("p", null, `A shared object/collection can only be modified by one process at a time. `, /* @__PURE__ */ (0, import_react2.mdx)("inlineCode", {
    parentName: "p"
  }, `Use`), ` locks the shared object/collection from other threads, while `, /* @__PURE__ */ (0, import_react2.mdx)("inlineCode", {
    parentName: "p"
  }, `End use`), ` unlocks the shared object/collection (if the locking counter is at 0, see below). . Trying to modify a shared object/collection without at least one `, /* @__PURE__ */ (0, import_react2.mdx)("inlineCode", {
    parentName: "p"
    ...
    parentName: "li"
  }, `Use`), ` on a shared object/collection belonging to a group locks properties/elements of all shared objects/collections of the group and increments its locking counter. Calling `, /* @__PURE__ */ (0, import_react2.mdx)("inlineCode", {
    parentName: "li"
  }, `End use`), ` decrements the locking counter of the group and when the counter is at 0, all the linked shared objects/collections are unlocked.`), /* @__PURE__ */ (0, import_react2.mdx)("li", {
    parentName: "ul"
...
`)), /* @__PURE__ */ (0, import_react2.mdx)("p", null, `The `, /* @__PURE__ */ (0, import_react2.mdx)("inlineCode", {
    ...
    parentName: "li"
  }, `Shared_object_or_Shared_collection`), ` properties and all objects of the same group.`), /* @__PURE__ */ (0, import_react2.mdx)("li", {
    parentName: "ul"
  }, `Several `, /* @__PURE__ */ (0, import_react2.mdx)("strong", {
    parentName: "li"
  }, `Use...End use`), ` structures can be nested in the 4D code. In the case of a group, each `, /* @__PURE__ */ (0, import_react2.mdx)("strong", {
    parentName: "li"
  }, `Use`), ` increments the locking counter of the group and each `, /* @__PURE__ */ (0, import_react2.mdx)("strong", {
    parentName: "li"
  }, `End use`), ` decrements it; all properties/elements will be released only when the last `, /* @__PURE__ */ (0, import_react2.mdx)("strong", {
    parentName: "li"
  }, `End use`), ` call sets the locking counter to 0. `)), /* @__PURE__ */ (0, import_react2.mdx)("p", null, /* @__PURE__ */ (0, import_react2.mdx)("strong", {
    parentName: "p"
