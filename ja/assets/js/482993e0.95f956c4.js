...
const metadata = {
  ...
  "id": "version-19-R6/Concepts/error-handling",
  "title": "Error handling",
  ...
  "source": "@site/versioned_docs/version-19-R6/Concepts/error-handling.md",
  "sourceDirName": "Concepts",
  "slug": "/Concepts/error-handling",
  "permalink": "/docs/ja/Concepts/error-handling",
  "draft": false,
  "tags": [],
  "version": "19-R6",
  "frontMatter": {
  ...
  "previous": {
    ...
    "permalink": "/docs/ja/Concepts/looping"
  },
  "next": {
    "title": "Interpreted and Compiled modes",
    "permalink": "/docs/ja/Concepts/interpreted-compiled"
  }
};
const assets = {};
const toc = [{
...
function MDXContent({
  ...
  }, `Error or status`), /* @__PURE__ */ (0, import_react2.mdx)("p", null, `Many 4D class functions, such as `, /* @__PURE__ */ (0, import_react2.mdx)("inlineCode", {
    parentName: "p"
  }, `entity.save()`), ` or `, /* @__PURE__ */ (0, import_react2.mdx)("inlineCode", {
    parentName: "p"
  }, `transporter.send()`), `, return a `, /* @__PURE__ */ (0, import_react2.mdx)("em", {
    parentName: "p"
  }, `status`), ` object. This object is used to store "predictable" errors in the runtime context, e.g. invalid password, locked entity, etc., that do not stop program execution. This category of errors can be handled by regular code.`), /* @__PURE__ */ (0, import_react2.mdx)("p", null, `Other "unpredictable" errors include disk write error, network failure, or in general any unexpected interruption. This category of errors generates exceptions and needs to be handled through an error-handling method.  `), /* @__PURE__ */ (0, import_react2.mdx)("h2", {
    ...{
      "id": "installing-an-error-handling-method"
    }
  }, `Installing an error-handling method`), /* @__PURE__ */ (0, import_react2.mdx)("p", null, `In 4D, all errors can be caught and handled in a specific project method, the `, /* @__PURE__ */ (0, import_react2.mdx)("strong", {
    parentName: "p"
...
`)), /* @__PURE__ */ (0, import_react2.mdx)("p", null, `The  `, /* @__PURE__ */ (0, import_react2.mdx)("inlineCode", {
    parentName: "p"
  }, `Method called on error`), ` command allows you to know the name of the method installed by `, /* @__PURE__ */ (0, import_react2.mdx)("inlineCode", {
    parentName: "p"
  }, `ON ERR CALL`), ` for the current process. It is particularly useful in the context of generic code because it enables you to temporarily change and then restore the error-catching method:`), /* @__PURE__ */ (0, import_react2.mdx)("pre", null, /* @__PURE__ */ (0, import_react2.mdx)("code", {
    parentName: "pre",
    ...{
      "className": "language-4d"
    }
...
`)), /* @__PURE__ */ (0, import_react2.mdx)("h3", {
    ...
    parentName: "p"
  }, `ON ERR CALL`), ` command only applies to the running application. In the case of an error generated by a `, /* @__PURE__ */ (0, import_react2.mdx)("strong", {
    parentName: "p"
  }, `component`), `, the `, /* @__PURE__ */ (0, import_react2.mdx)("inlineCode", {
    parentName: "p"
  }, `ON ERR CALL`), ` error-handling method of the host application is not called, and vice versa. `), /* @__PURE__ */ (0, import_react2.mdx)("h3", {
    ...{
      "id": "handling-errors-within-the-method"
    }
  }, `Handling errors within the method`), /* @__PURE__ */ (0, import_react2.mdx)("p", null, `Within the custom error method, you have access to several pieces of information that will help you identifying the error:`), /* @__PURE__ */ (0, import_react2.mdx)("ul", null, /* @__PURE__ */ (0, import_react2.mdx)("li", {
    parentName: "ul"
  }, /* @__PURE__ */ (0, import_react2.mdx)("p", {
    parentName: "li"
  }, `dedicated system variables(*):`), /* @__PURE__ */ (0, import_react2.mdx)("ul", {
    parentName: "li"
    ...
    parentName: "li"
  }, `Error formula`), ` (text): formula of the 4D code (raw text) which is at the origin of the error. `)))), /* @__PURE__ */ (0, import_react2.mdx)("p", null, `(`, /* @__PURE__ */ (0, import_react2.mdx)("em", {
    parentName: "p"
  }, `) 4D automatically maintains a number of variables called `, /* @__PURE__ */ (0, import_react2.mdx)("strong", {
    parentName: "em"
  }, `system variables`), `, meeting different needs. See the `), `4D Language Reference manual*.`), /* @__PURE__ */ (0, import_react2.mdx)("ul", null, /* @__PURE__ */ (0, import_react2.mdx)("li", {
    parentName: "ul"
