...
const metadata = {
  ...
  "source": "@site/versioned_docs/version-19/Users/overview.md",
  "sourceDirName": "Users",
  "slug": "/Users/overview",
  ...
  "previous": {
    ...
    "permalink": "/docs/ja/19/Admin/debugLogFiles"
  },
  "next": {
...
function MDXContent({
  ...
  return /* @__PURE__ */ (0, import_react2.mdx)(MDXLayout, {
    ...
    components,
    mdxType: "MDXLayout"
  }, /* @__PURE__ */ (0, import_react2.mdx)("p", null, `If more than one person uses an application, which is usually the case in client-server architecture or Web interfaces, you need to control access or provide different features according to the connected users. It is also essential to provide security for sensitive data. You can provide this security by assigning passwords to users and creating access groups that have different levels of access to information in the application or to application operations.`), /* @__PURE__ */ (0, import_react2.mdx)("blockquote", null, /* @__PURE__ */ (0, import_react2.mdx)("p", {
...
The whole users and groups configuration can also be edited during application execution using 4D language commands of the `, /* @__PURE__ */ (0, import_react2.mdx)("a", {
    parentName: "p",
    ...{
      "href": "https://doc.4d.com/4Dv18R3/4D/18-R3/Users-and-Groups.201-4900438.en.html"
    }
  }, `Users and Groups`), ` theme.  `)), /* @__PURE__ */ (0, import_react2.mdx)("h2", {
    ...{
      "id": "directoryjson-file"
    }
    ...
    parentName: "ul"
  }, `in the user settings folder, i.e. in the "Settings" folder at the same level as the "Project" folder. These settings are used by default for the application.`), /* @__PURE__ */ (0, import_react2.mdx)("li", {
    parentName: "ul"
  }, `in the data settings folder,  i.e. in the "Settings" folder in the "Data" folder. If a `, /* @__PURE__ */ (0, import_react2.mdx)("strong", {
    parentName: "li"
  }, `directory.json`), ` file is present at this location, it takes priority over the file in the user settings folder. This feature allows you to define custom/local Users and Groups configurations. The custom configuration will left untouched by an application upgrade.  `)), /* @__PURE__ */ (0, import_react2.mdx)("blockquote", null, /* @__PURE__ */ (0, import_react2.mdx)("p", {
    parentName: "blockquote"
  }, `If 4D password access control is not enabled, the `, /* @__PURE__ */ (0, import_react2.mdx)("strong", {
    parentName: "p"
  }, `directory.json`), ` is not created.`)));
}
;
