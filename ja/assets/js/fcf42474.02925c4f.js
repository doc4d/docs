...
const metadata = {
  ...
  "id": "version-18/MSC/encrypt",
  "title": "Encrypt Page",
  "description": 'You can use this page to encrypt or decrypt (i.e. remove encryption from) the data file, according to the Encryptable attribute status defined for each table in the database. For detailed information about data encryption in 4D, please refer to the "Encrypting data" section.',
  "source": "@site/versioned_docs/version-18/MSC/encrypt.md",
  "sourceDirName": "MSC",
  "slug": "/MSC/encrypt",
  "permalink": "/docs/ja/18/MSC/encrypt",
  "draft": false,
  "tags": [],
  "version": "18",
  "frontMatter": {
  ...
  "previous": {
    "title": "Repair Page",
    "permalink": "/docs/ja/18/MSC/repair"
  },
  "next": {
    "title": "Overview",
    "permalink": "/docs/ja/18/Backup/overview"
  }
};
const assets = {};
const toc = [{
...
function MDXContent({
  ...
  return /* @__PURE__ */ (0, import_react2.mdx)(MDXLayout, {
    ...
    parentName: "p"
  }, `Encryptable`), ` attribute status defined for each table in the database. For detailed information about data encryption in 4D, please refer to the "Encrypting data" section.`), /* @__PURE__ */ (0, import_react2.mdx)("p", null, `A new folder is created each time you perform an encryption/decryption operation. It is named "Replaced Files (Encrypting) `, /* @__PURE__ */ (0, import_react2.mdx)("em", {
    parentName: "p"
    ...
    parentName: "p",
    ...{
      "href": "/docs/ja/18/MSC/overview#display-in-maintenance-mode"
    }
  }, `maintenance mode`), `. If you attempt to carry out this operation in standard mode, a warning dialog will inform you that the database will be closed and restarted in maintenance mode`)), /* @__PURE__ */ (0, import_react2.mdx)("p", null, /* @__PURE__ */ (0, import_react2.mdx)("strong", {
    parentName: "p"
  }, `Warning:`)), /* @__PURE__ */ (0, import_react2.mdx)("ul", null, /* @__PURE__ */ (0, import_react2.mdx)("li", {
    parentName: "ul"
  }, `Encrypting a database is a lengthy operation. It displays a progress indicator (which could be interrupted by the user). Note also that a database encryption operation always includes a compacting step.`), /* @__PURE__ */ (0, import_react2.mdx)("li", {
    parentName: "ul"
...
`, /* @__PURE__ */ (0, import_react2.mdx)("img", {
    src: (__webpack_require__(26920)/* ["default"] */ .Z),
    width: "578",
    height: "78"
  }), `
Otherwise, the following message is displayed:
`, /* @__PURE__ */ (0, import_react2.mdx)("img", {
    src: (__webpack_require__(5800)/* ["default"] */ .Z),
    width: "559",
    height: "79"
  }), `
...
`, /* @__PURE__ */ (0, import_react2.mdx)("strong", {
    ...
    src: (__webpack_require__(22565)/* ["default"] */ .Z),
    width: "159",
    height: "81"
...
`, /* @__PURE__ */ (0, import_react2.mdx)("img", {
    src: (__webpack_require__(88779)/* ["default"] */ .Z),
    width: "556",
    height: "256"
  }), `
...
(deep green is the highest level)`), /* @__PURE__ */ (0, import_react2.mdx)("li", {
    ...
    parentName: "p"
  }, `Warning:`), ` During the encryption operation, 4D creates a new, empty data file and fills it with data from the original data file. Records belonging to "encryptable" tables are encrypted then copied, other records are only copied (a compacting operation is also executed). If the operation is successful, the original data file is moved to a "Replaced Files (Encrypting)" folder. If you intend to deliver an encrypted data file, make sure to move/remove any unencrypted data file from the database folder beforehand.`), /* @__PURE__ */ (0, import_react2.mdx)("h2", {
    ...{
      "id": "encryption-maintenance-operations"
    }
  }, `Encryption maintenance operations`), /* @__PURE__ */ (0, import_react2.mdx)("p", null, `When a database is encrypted (see above), the Encrypt page provides several encryption maintenance operations, corresponding to standard scenarios.
`, /* @__PURE__ */ (0, import_react2.mdx)("img", {
    src: (__webpack_require__(35474)/* ["default"] */ .Z),
    width: "462",
    height: "318"
...
`, /* @__PURE__ */ (0, import_react2.mdx)("img", {
    src: (__webpack_require__(41145)/* ["default"] */ .Z),
    width: "556",
    height: "256"
...
`, /* @__PURE__ */ (0, import_react2.mdx)("img", {
    src: (__webpack_require__(68182)/* ["default"] */ .Z),
    width: "284",
    height: "37"
  })), /* @__PURE__ */ (0, import_react2.mdx)("h3", {
    ...{
...
`, /* @__PURE__ */ (0, import_react2.mdx)("img", {
    src: (__webpack_require__(47748)/* ["default"] */ .Z),
    width: "556",
    height: "256"
  }), `
...
`, /* @__PURE__ */ (0, import_react2.mdx)("img", {
    src: (__webpack_require__(75943)/* ["default"] */ .Z),
    width: "224",
    height: "32"
  ...
  }, `Saving the encryption key`), /* @__PURE__ */ (0, import_react2.mdx)("p", null, `4D allows you to save the data encryption key in a dedicated file. Storing this file on an external device such a USB key will facilitate the use of an encrypted database, since the user would only need to connect the device to provide the key before opening the database in order to access encrypted data.`), /* @__PURE__ */ (0, import_react2.mdx)("p", null, `You can save the encryption key each time a new passphrase has been provided:`), /* @__PURE__ */ (0, import_react2.mdx)("ul", null, /* @__PURE__ */ (0, import_react2.mdx)("li", {
    parentName: "ul"
  }, `when the database is encrypted for the first time,`), /* @__PURE__ */ (0, import_react2.mdx)("li", {
    parentName: "ul"
  }, `when the database is re-encrypted with a new passphrase.`)), /* @__PURE__ */ (0, import_react2.mdx)("p", null, `Successive encryption keys can be stored on the same device.`), /* @__PURE__ */ (0, import_react2.mdx)("h2", {
    ...{
      "id": "log-file"
    }
  }, `Log file`), /* @__PURE__ */ (0, import_react2.mdx)("p", null, `After an encryption operation has been completed, 4D generates a file in the Logs folder of the database. It is created in XML format and named "`, /* @__PURE__ */ (0, import_react2.mdx)("em", {
    parentName: "p"
  }, `DatabaseName_Encrypt_Log_yyyy-mm-dd hh-mm-ss.xml`), `" or "`, /* @__PURE__ */ (0, import_react2.mdx)("em", {
    parentName: "p"
  }, `DatabaseName_Decrypt_Log_yyyy-mm-dd hh-mm-ss.xml`), `".`), /* @__PURE__ */ (0, import_react2.mdx)("p", null, `An Open log file button is displayed on the MSC page each time a new log file has been generated.`), /* @__PURE__ */ (0, import_react2.mdx)("p", null, `The log file lists all internal operations executed pertaining to the encryption/decryption process, as well as errors (if any).`));
}
;
