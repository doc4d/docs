...
const metadata = {
  ...
  "next": {
    ...
    "permalink": "/docs/ja/next/FormObjects/picturePopupMenuOverview"
  }
};
const assets = {};
const toc = [{
...
`, ``))), /* @__PURE__ */ (0, import_react2.mdx)("p", null, `You can organize pictures as columns, rows, or a row-by-column grid (as shown above). When organizing pictures as a grid, they  are numbered from left to right, row by row, beginning with 0. For example, the second picture of the second row of a grid that consists of two rows and three columns, is numbered 4 (The UK flag in the example above). `), /* @__PURE__ */ (0, import_react2.mdx)("ol", {
    ...
    parentName: "p",
    ...{
      "href": "/docs/ja/next/FormObjects/propertiesCrop"
    }
    ...
    parentName: "p",
    ...{
      "href": "/docs/ja/next/FormObjects/propertiesAnimation"
    }
    ...
    parentName: "li",
    ...{
      "href": "/docs/ja/next/FormObjects/propertiesAnimation#loopBackToFirstFrame"
    }
    ...
    parentName: "p",
    ...{
      "href": "/docs/ja/next/FormObjects/propertiesAnimation#switchBackWhenReleased"
    }
    ...
    parentName: "p",
    ...{
      "href": "/docs/ja/next/FormObjects/propertiesAnimation#switchWhenRollOver"
    }
