...
const metadata = {
  ...
  "source": "@site/versioned_docs/version-19/API/MailAttachmentClass.md",
  "sourceDirName": "API",
  "slug": "/API/MailAttachmentClass",
  "permalink": "/docs/ja/19/API/MailAttachmentClass",
  "draft": false,
  "tags": [],
  "version": "19",
  "frontMatter": {
  ...
  "previous": {
    ...
    "permalink": "/docs/ja/19/API/IMAPTransporterClass"
  },
  "next": {
...
function MDXContent({
  ...
  return /* @__PURE__ */ (0, import_react2.mdx)(MDXLayout, {
    ...
    parentName: "p",
    ...{
      "href": "/docs/ja/19/API/EmailObjectClass"
    }
  ...
  }, `MAIL New attachment`), /* @__PURE__ */ (0, import_react2.mdx)("p", null, /* @__PURE__ */ (0, import_react2.mdx)("strong", {
    parentName: "p"
    ...
    parentName: "p"
  }, `blob`), ` : Blob { ; `, /* @__PURE__ */ (0, import_react2.mdx)("em", {
    parentName: "p"
  }, `name`), ` : Text {; `, /* @__PURE__ */ (0, import_react2.mdx)("em", {
    parentName: "p"
  }, `cid`), ` : Text{ ; `, /* @__PURE__ */ (0, import_react2.mdx)("em", {
    ...
    parentName: "p",
    ...{
      "href": "/docs/ja/19/API/EmailObjectClass#email-object"
    }
  }, `Email object`), `.`), /* @__PURE__ */ (0, import_react2.mdx)("p", null, `You can pass either a path or a Blob to define the attachment.`), /* @__PURE__ */ (0, import_react2.mdx)("ul", null, /* @__PURE__ */ (0, import_react2.mdx)("li", {
    parentName: "ul"
  }, /* @__PURE__ */ (0, import_react2.mdx)("p", {
    parentName: "li"
  }, `If you use a `, /* @__PURE__ */ (0, import_react2.mdx)("em", {
    parentName: "p"
  }, `path`), `, pass a `, /* @__PURE__ */ (0, import_react2.mdx)("strong", {
    parentName: "p"
  }, `text`), ` value containing the path of the attachment file, expressed with the system syntax. You can pass a full path name or a simple file name (in which case 4D will search for the file in the same directory as the project file).`)), /* @__PURE__ */ (0, import_react2.mdx)("li", {
    parentName: "ul"
  }, /* @__PURE__ */ (0, import_react2.mdx)("p", {
    parentName: "li"
  }, `If you use a `, /* @__PURE__ */ (0, import_react2.mdx)("em", {
    parentName: "p"
  }, `blob`), `, pass a `, /* @__PURE__ */ (0, import_react2.mdx)("strong", {
    parentName: "p"
  }, `BLOB`), ` value containing the attachment itself.`))), /* @__PURE__ */ (0, import_react2.mdx)("p", null, `The optional `, /* @__PURE__ */ (0, import_react2.mdx)("em", {
    parentName: "p"
...
`)), /* @__PURE__ */ (0, import_react2.mdx)("h2", {
  ...
  }, `4D.MailAttachment.new()`), /* @__PURE__ */ (0, import_react2.mdx)("p", null, /* @__PURE__ */ (0, import_react2.mdx)("strong", {
    parentName: "p"
    ...
    parentName: "p"
  }, `.getContent()`), ` function `, `returns the contents of the attachment object in a BLOB`, `. You can use this method with attachment objects received by the `, /* @__PURE__ */ (0, import_react2.mdx)("a", {
    parentName: "p",
    ...{
