...
const metadata = {
  ...
  "id": "version-18/REST/configuration",
  "title": "Server Configuration",
  "description": "Using standard HTTP requests, the 4D REST Server allows external applications to access the data of your database directly, i.e. to retrieve information about the dataclasses in your project, manipulate data, log into your web application, and much more.",
  "source": "@site/versioned_docs/version-18/REST/configuration.md",
  "sourceDirName": "REST",
  "slug": "/REST/configuration",
  "permalink": "/docs/ja/18/REST/configuration",
  "draft": false,
  "tags": [],
  "version": "18",
  "frontMatter": {
  ...
  "previous": {
    ...
    "permalink": "/docs/ja/18/REST/gettingStarted"
  },
  "next": {
    "title": "Users and sessions",
    "permalink": "/docs/ja/18/REST/authUsers"
  }
};
const assets = {};
const toc = [{
  ...
  value: "Using the Database settings",
  id: "using-the-database-settings",
  level: 3
}, {
...
function MDXContent({
  ...
  return /* @__PURE__ */ (0, import_react2.mdx)(MDXLayout, {
    ...
    components,
    mdxType: "MDXLayout"
  }, /* @__PURE__ */ (0, import_react2.mdx)("p", null, `Using standard HTTP requests, the 4D REST Server allows external applications to access the data of your database directly, `, /* @__PURE__ */ (0, import_react2.mdx)("em", {
    parentName: "p"
...
You need to manage the `, /* @__PURE__ */ (0, import_react2.mdx)("a", {
    parentName: "li",
    ...{
      "href": "/docs/ja/18/REST/authUsers#session-cookie"
    }
  }, `session cookie`), ` to use the same session for your requesting application.  `))), /* @__PURE__ */ (0, import_react2.mdx)("h2", {
    ...{
      "id": "starting-the-rest-server"
    }
    ...
    parentName: "p"
  }, `Expose as REST server`), ` option in the "Web/REST resource" page of the database settings in order for REST requests to be processed.`), /* @__PURE__ */ (0, import_react2.mdx)("p", null, /* @__PURE__ */ (0, import_react2.mdx)("img", {
    alt: "alt-text",
    src: (__webpack_require__(9338)/* ["default"] */ .Z),
    width: "862",
    height: "377"
  })), /* @__PURE__ */ (0, import_react2.mdx)("blockquote", null, /* @__PURE__ */ (0, import_react2.mdx)("p", {
    parentName: "blockquote"
  }, `REST services use the 4D HTTP server, so you need to make sure that the 4D Web server is started.`)), /* @__PURE__ */ (0, import_react2.mdx)("p", null, `The warning message "Caution, check the access privileges" is displayed when you check this option to draw your attention to the fact that when REST services are activated, by default access to database objects is free as long as the REST accesses have not been configured.`), /* @__PURE__ */ (0, import_react2.mdx)("h2", {
    ...{
      "id": "configuring-rest-access"
    }
    ...
    parentName: "li"
  }, `Read/Write`), ` user group to REST services in the "Web/REST resource" page of the Database Settings;`), /* @__PURE__ */ (0, import_react2.mdx)("li", {
    parentName: "ul"
    ...
    parentName: "p"
  }, `On REST Authentication`), ` database method has been defined, 4D fully delegates control of REST requests to it: any setting made using the "Read/Write" menu on the Web/REST resource page of the Database Settings is ignored.`)), /* @__PURE__ */ (0, import_react2.mdx)("h3", {
    ...{
      "id": "using-the-database-settings"
    }
  }, `Using the Database settings`), /* @__PURE__ */ (0, import_react2.mdx)("p", null, `The `, /* @__PURE__ */ (0, import_react2.mdx)("strong", {
    parentName: "p"
  }, `Read/Write`), ` menu in the "Web/REST resource" page of the database settings specifies a group of 4D users that is authorized to establish the link to the 4D database using REST queries.`), /* @__PURE__ */ (0, import_react2.mdx)("p", null, `By default, the menu displays `, /* @__PURE__ */ (0, import_react2.mdx)("inlineCode", {
    parentName: "p"
    ...
    parentName: "p",
    ...{
      "href": "/docs/ja/18/REST/authUsers"
    }
    ...
    parentName: "p"
  }, `On REST Authentication`), ` database method must not be defined. If it exists, 4D ignores access settings defined in the Database Settings.`)), /* @__PURE__ */ (0, import_react2.mdx)("h3", {
    ...{
      "id": "using-the-on-rest-authentication-database-method"
    }
    ...
    parentName: "p"
  }, `On REST Authentication`), ` database method is called so that you can evaluate these identifiers. You can use the list of users for the 4D database or you can use your own table of identifiers.
For more information, refer to the `, /* @__PURE__ */ (0, import_react2.mdx)("inlineCode", {
  ...
  }, `Exposing tables and fields`), /* @__PURE__ */ (0, import_react2.mdx)("p", null, `Once REST services are enabled in the 4D database, by default a REST session can access all tables and fields of the datastore, and thus use their data. For example, if your database contains an `, `[Employee]`, ` table, it is possible to write:`), /* @__PURE__ */ (0, import_react2.mdx)("pre", null, /* @__PURE__ */ (0, import_react2.mdx)("code", {
    parentName: "pre",
    ...{}
...
`, /* @__PURE__ */ (0, import_react2.mdx)("img", {
    alt: "alt-text",
    src: (__webpack_require__(47981)/* ["default"] */ .Z),
    width: "279",
    height: "330"
  }), `
...
`, /* @__PURE__ */ (0, import_react2.mdx)("img", {
    alt: "alt-text",
    src: (__webpack_require__(26696)/* ["default"] */ .Z),
    width: "279",
    height: "271"
  }), `
