...
const metadata = {
  ...
  "id": "version-18/Concepts/looping",
  "title": "Looping structures",
  "description": "While...End while",
  "source": "@site/versioned_docs/version-18/Concepts/cf_looping.md",
  "sourceDirName": "Concepts",
  "slug": "/Concepts/looping",
  "permalink": "/docs/ja/18/Concepts/looping",
  "draft": false,
  "tags": [],
  "version": "18",
  "frontMatter": {
  ...
  "previous": {
    ...
    "permalink": "/docs/ja/18/Concepts/branching"
  },
  "next": {
...
`)), /* @__PURE__ */ (0, import_react2.mdx)("p", null, `If you find yourself in such a situation, where a method is executing uncontrolled, you can use the trace facilities to stop the loop and track down the problem. For more information about tracing a method, see the `, /* @__PURE__ */ (0, import_react2.mdx)("a", {
    parentName: "p",
    ...{
      "href": "/docs/ja/18/Concepts/error-handling"
    }
...
`)), /* @__PURE__ */ (0, import_react2.mdx)("p", null, `A `, /* @__PURE__ */ (0, import_react2.mdx)("inlineCode", {
    ...
    parentName: "p"
  }, `Repeat...Until`), ` loop is that the loop continues until the Boolean expression is TRUE.`), /* @__PURE__ */ (0, import_react2.mdx)("h3", {
    ...{
      "id": "example-1"
    }
...
`)), /* @__PURE__ */ (0, import_react2.mdx)("p", null, `The `, /* @__PURE__ */ (0, import_react2.mdx)("inlineCode", {
    ...
    parentName: "li"
  }, `Increment_Expression`), `. See the examples.`)), /* @__PURE__ */ (0, import_react2.mdx)("h3", {
    ...{
      "id": "basic-examples"
    }
...
`)), /* @__PURE__ */ (0, import_react2.mdx)("p", null, `Most of the `, /* @__PURE__ */ (0, import_react2.mdx)("inlineCode", {
    parentName: "p"
  }, `For...End for`), ` loops you will write in your databases will look like the ones listed in these examples.`), /* @__PURE__ */ (0, import_react2.mdx)("h3", {
    ...{
      "id": "decrementing-variable-counter"
    }
...
`)), /* @__PURE__ */ (0, import_react2.mdx)("h3", {
    ...
    parentName: "p"
  }, `For...End for`), ` loops. To avoid mistakes, make sure to use different counter variables for each looping structure.`), /* @__PURE__ */ (0, import_react2.mdx)("p", null, `Here are two examples:`), /* @__PURE__ */ (0, import_react2.mdx)("ol", {
    ...{
      "start": 11
    }
  }, /* @__PURE__ */ (0, import_react2.mdx)("li", {
...
`)), /* @__PURE__ */ (0, import_react2.mdx)("p", null, `The `, /* @__PURE__ */ (0, import_react2.mdx)("inlineCode", {
    ...
    parentName: "ul"
  }, `within the loop when only some elements/properties need to be modified and no integrity management is required.`)))), /* @__PURE__ */ (0, import_react2.mdx)("h3", {
    ...{
      "id": "loop-through-collections"
    }
