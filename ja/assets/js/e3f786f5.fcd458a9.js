...
const metadata = {
  ...
  "sourceDirName": "Admin",
  "slug": "/Admin/tls",
  "permalink": "/docs/ja/19/Admin/tls",
  "draft": false,
  "tags": [],
  "version": "19",
  "frontMatter": {
...
function MDXContent({
  ...
  return /* @__PURE__ */ (0, import_react2.mdx)(MDXLayout, {
    ...
    parentName: "p",
    ...{
      "href": "/docs/ja/19/WebServer/webServerConfig#minimum-tls-version"
    }
...
You can receive a certificate in different ways (usually by email or HTML form). 4D accepts all platform-related text formats for certificates (OS X, PC, Linux, etc.). However, the certificate must be in PEM format, `, /* @__PURE__ */ (0, import_react2.mdx)("em", {
    ...
    parentName: "li",
    ...{
      "href": "/docs/ja/19/WebServer/webServerConfig#enable-hsts"
    }
    ...
    parentName: "p",
    ...{
      "href": "/docs/ja/19/WebServer/webServerConfig##cipher-list"
    }
