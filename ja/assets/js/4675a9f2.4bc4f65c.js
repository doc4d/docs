...
var properties_Footers_exports = {};
__export(properties_Footers_exports, {
  assets: () => assets,
...
module.exports = __toCommonJS(properties_Footers_exports);
...
const metadata = {
  "unversionedId": "FormObjects/propertiesFooters",
  "id": "version-18/FormObjects/propertiesFooters",
  "title": "Footers",
  "description": "Display Footers",
  "source": "@site/versioned_docs/version-18/FormObjects/properties_Footers.md",
  "sourceDirName": "FormObjects",
  "slug": "/FormObjects/propertiesFooters",
  ...
  "next": {
    "title": "Gridlines",
    "permalink": "/docs/ja/18/FormObjects/propertiesGridlines"
  }
};
const assets = {};
const toc = [{
  value: "Display Footers",
  id: "display-footers",
  level: 2
}, {
  value: "JSON Grammar",
...
function MDXContent({
  ...
  }, `Display Footers`), /* @__PURE__ */ (0, import_react2.mdx)("p", null, `This property is used to display or hide `, /* @__PURE__ */ (0, import_react2.mdx)("a", {
    parentName: "p",
    ...{
      "href": "/docs/ja/18/FormObjects/listboxOverview#list-box-footers"
    }
  }, `list box column footers`), `. There is one footer per column; each footer is configured separately.`), /* @__PURE__ */ (0, import_react2.mdx)("h4", {
    ...{
      "id": "json-grammar"
    }
  ...
  }, `Height`), /* @__PURE__ */ (0, import_react2.mdx)("p", null, `This property is used to set the row height for a list box footer in `, /* @__PURE__ */ (0, import_react2.mdx)("strong", {
    parentName: "p"
...
`)), /* @__PURE__ */ (0, import_react2.mdx)("h4", {
    ...
    parentName: "p",
    ...{
      "href": "/docs/ja/18/FormObjects/propertiesHeaders"
    }
  }, `Headers`), ` - `, /* @__PURE__ */ (0, import_react2.mdx)("a", {
    parentName: "p",
    ...{
      "href": "/docs/ja/18/FormObjects/listboxOverview#list-box-footers"
    }
