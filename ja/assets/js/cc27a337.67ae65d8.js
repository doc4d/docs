...
const metadata = {
  ...
  "source": "@site/versioned_docs/version-19/Admin/webAdmin.md",
  "sourceDirName": "Admin",
  "slug": "/Admin/webAdmin",
  ...
  "next": {
    ...
    "permalink": "/docs/ja/19/Admin/dataExplorer"
  }
};
const assets = {};
const toc = [{
...
function MDXContent({
  ...
  return /* @__PURE__ */ (0, import_react2.mdx)(MDXLayout, {
    ...
    alt: "alt-text",
    src: (__webpack_require__(99173)/* ["default"] */ .Z),
    width: "470",
    height: "294"
    ...
    alt: "alt-text",
    src: (__webpack_require__(18785)/* ["default"] */ .Z),
    width: "702",
    height: "205"
...
`)), /* @__PURE__ */ (0, import_react2.mdx)("blockquote", null, /* @__PURE__ */ (0, import_react2.mdx)("p", {
    ...
    alt: "alt-text",
    src: (__webpack_require__(54733)/* ["default"] */ .Z),
    width: "473",
    height: "354"
    ...
    parentName: "a"
  }, `access key`)), `. By default when the access key is not set, access via an url is not allowed.`), /* @__PURE__ */ (0, import_react2.mdx)("p", null, `You can configure the `, /* @__PURE__ */ (0, import_react2.mdx)("inlineCode", {
    parentName: "p"
    ...
    alt: "alt-text",
    src: (__webpack_require__(93686)/* ["default"] */ .Z),
    width: "702",
    height: "462"
    ...
    parentName: "p"
  }, `WebAdmin`), ` web server through an URL (access via a 4D menu command does not require an access key). When no access key is defined, no web client is allowed to connect through an URL to a web administration interface like the `, /* @__PURE__ */ (0, import_react2.mdx)("a", {
    parentName: "p",
    ...{
      "href": "/docs/ja/19/Admin/dataExplorer"
    }
    ...
    alt: "alt-text",
    src: (__webpack_require__(54473)/* ["default"] */ .Z),
    width: "193",
    height: "126"
...
`)), /* @__PURE__ */ (0, import_react2.mdx)("h2", {
    ...
    parentName: "li"
  }, `When a web management page is accessed by entering an URL and without prior identification, an authentication is required. The user must enter the `, /* @__PURE__ */ (0, import_react2.mdx)("a", {
    parentName: "p",
    ...{
      "href": "#access-key"
    }
