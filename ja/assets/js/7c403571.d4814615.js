...
const metadata = {
  ...
  "slug": "/Backup/restore",
  "permalink": "/docs/ja/next/Backup/restore",
  "draft": false,
  "tags": [],
  "version": "current",
  "frontMatter": {
  ...
  "previous": {
    ...
    "permalink": "/docs/ja/next/Backup/log"
  },
  "next": {
    "title": "Overview",
    "permalink": "/docs/ja/next/Extensions/overview"
  }
};
const assets = {};
const toc = [{
...
function MDXContent({
  ...
  return /* @__PURE__ */ (0, import_react2.mdx)(MDXLayout, {
    ...
    parentName: "p",
    ...{
      "href": "/docs/ja/next/Backup/settings#automatic-restore"
    }
...
`, `If the incident is the result of an inappropriate operation performed on the data (deletion of a record, for example), you can attempt to repair the data file using the "rollback" function in the log file. This function is available on the `, /* @__PURE__ */ (0, import_react2.mdx)("a", {
    parentName: "p",
    ...{
      "href": "/docs/ja/next/MSC/rollback"
    }
...
5. Click `, /* @__PURE__ */ (0, import_react2.mdx)("strong", {
    ...
    parentName: "p",
    ...{
      "href": "/docs/ja/next/MSC/restore#successive-intergration-of-several-data-log-files"
    }
