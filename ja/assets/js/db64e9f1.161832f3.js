...
const metadata = {
  ...
  "id": "version-19/API/IMAPTransporterClass",
  "title": "IMAPTransporter",
  "description": "The IMAPTransporter class allows you to retrieve messages from a IMAP email server.",
  "source": "@site/versioned_docs/version-19/API/IMAPTransporterClass.md",
  "sourceDirName": "API",
...
`)), /* @__PURE__ */ (0, import_react2.mdx)("h2", {
    ...
    parentName: "a"
  }, `Email`), ` objects`), `. If no Email objects are found, an empty collection is returned.`)))), /* @__PURE__ */ (0, import_react2.mdx)("p", null, `|notFound |Collection| Collection of:`, /* @__PURE__ */ (0, import_react2.mdx)("br", null), /* @__PURE__ */ (0, import_react2.mdx)("ul", null, /* @__PURE__ */ (0, import_react2.mdx)("li", null, `first syntax - previously passed message IDs that do not exist`), /* @__PURE__ */ (0, import_react2.mdx)("li", null, `second syntax - sequence numbers of messages between startMsg and endMsg that do not exist`)), `An empty collection is returned if all messages are found.|`), /* @__PURE__ */ (0, import_react2.mdx)("h4", {
    ...{
      "id": "example-10"
    }
