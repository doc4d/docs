...
const metadata = {
  ...
  "id": "version-19/Desktop/clientServer",
  "title": "Client/Server Management",
  ...
  "source": "@site/versioned_docs/version-19/Desktop/clientServer.md",
  "sourceDirName": "Desktop",
  "slug": "/Desktop/clientServer",
  "permalink": "/docs/ja/19/Desktop/clientServer",
  "draft": false,
  "tags": [],
  "version": "19",
  "frontMatter": {
  ...
  "previous": {
    "title": "$version",
    "permalink": "/docs/ja/19/REST/version"
  },
  "next": {
    "title": "About 4D Forms",
    "permalink": "/docs/ja/19/FormEditor/forms"
  }
};
const assets = {};
const toc = [{
...
function MDXContent({
  ...
  return /* @__PURE__ */ (0, import_react2.mdx)(MDXLayout, {
    ...
    parentName: "p",
    ...{
      "href": "/docs/ja/19/Desktop/building#clientserver-page"
    }
    ...
    parentName: "p",
    ...{
      "href": "/docs/ja/19/Desktop/building#build-compiled-structure"
    }
    ...
    src: (__webpack_require__(79022)/* ["default"] */ .Z),
    width: "581",
    height: "249"
    ...
    parentName: "p",
    ...{
      "href": "/docs/ja/19/Desktop/building#what-is-a-clientserver-application"
    }
    ...
    parentName: "li"
  }, `Connect to 4D Server`), ` in the Welcome Wizard dialog, OR
Select `, /* @__PURE__ */ (0, import_react2.mdx)("strong", {
    parentName: "li"
    ...
    src: (__webpack_require__(71998)/* ["default"] */ .Z),
    width: "522",
    height: "482"
    ...
    src: (__webpack_require__(59606)/* ["default"] */ .Z),
    width: "522",
    height: "482"
    ...
    parentName: "li"
  }, `Network address`), `: The IP address of the machine where the 4D Server was launched. If two servers are executed simultaneously on the same machine, the IP address must be followed by a colon and port number, for example: `, /* @__PURE__ */ (0, import_react2.mdx)("inlineCode", {
    parentName: "li"
  }, `192.168.92.104:19814`), `. By default, the publishing port of a 4D Server is 19813. This number can be modified in the Project settings.`)), /* @__PURE__ */ (0, import_react2.mdx)("p", null, `Once this page assigns a server, clicking the `, /* @__PURE__ */ (0, import_react2.mdx)("strong", {
    parentName: "p"
  }, `OK`), ` button will allow you to connect to the server.`), /* @__PURE__ */ (0, import_react2.mdx)("blockquote", null, /* @__PURE__ */ (0, import_react2.mdx)("p", {
    parentName: "blockquote"
  }, `If the project is published with the encryption option enabled, you must add a circumflex accent (^) before the name, otherwise the connection will be refused. For more information, refer to the Encrypting Client/Server Connections section.`)), /* @__PURE__ */ (0, import_react2.mdx)("p", null, `Once a connection to the server has been established, the remote project will be listed on the `, /* @__PURE__ */ (0, import_react2.mdx)("strong", {
    parentName: "p"
...
/* harmony export */   "Z": () => (__WEBPACK_DEFAULT_EXPORT__)
/* harmony export */ });
/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = (__webpack_require__.p + "assets/images/serverConnect2-9dc60df13672f8189273aec3efcab19d.png");
