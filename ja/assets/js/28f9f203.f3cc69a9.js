...
const metadata = {
  ...
  "slug": "/Backup/restore",
  "permalink": "/docs/ja/18/Backup/restore",
  "draft": false,
  "tags": [],
  "version": "18",
  "frontMatter": {
  ...
  "previous": {
    ...
    "permalink": "/docs/ja/18/Backup/log"
  },
  "next": {
    "title": "Overview",
    "permalink": "/docs/ja/18/Users/overview"
  }
};
const assets = {};
const toc = [{
...
function MDXContent({
  ...
  return /* @__PURE__ */ (0, import_react2.mdx)(MDXLayout, {
    ...
    parentName: "p",
    ...{
      "href": "/docs/ja/18/Backup/settings#automatic-restore"
    }
...
The destination folder is displayed. During the restore, 4D places all backup files in this folder, regardless of the position of the original files on the disk when the backup starts. This way your files will be easier to find.`), /* @__PURE__ */ (0, import_react2.mdx)("h2", {
    ...
    parentName: "p",
    ...{
      "href": "/docs/ja/18/MSC/restore#successive-intergration-of-several-data-log-files"
    }
