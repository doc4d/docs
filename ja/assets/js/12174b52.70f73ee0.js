...
const metadata = {
  ...
  "id": "version-18/REST/gettingStarted",
  "title": "Getting Started",
  "description": "4D provides you with a powerful REST server, that allows direct access to data stored in your 4D databases.",
  "source": "@site/versioned_docs/version-18/REST/gettingStarted.md",
  "sourceDirName": "REST",
  ...
  "previous": {
    ...
    "permalink": "/docs/ja/18/Users/editing"
  },
  "next": {
...
const assets = {};
const toc = [{
  value: "Creating and configuring the 4D database",
  id: "creating-and-configuring-the-4d-database",
  level: 2
}, {
...
function MDXContent({
  ...
  return /* @__PURE__ */ (0, import_react2.mdx)(MDXLayout, {
    ...
    components,
    mdxType: "MDXLayout"
  }, /* @__PURE__ */ (0, import_react2.mdx)("p", null, `4D provides you with a powerful REST server, that allows direct access to data stored in your 4D databases.`), /* @__PURE__ */ (0, import_react2.mdx)("p", null, `The REST server is included in the 4D and 4D Server applications, it is automatically available in your 4D databases `, /* @__PURE__ */ (0, import_react2.mdx)("a", {
    parentName: "p",
    ...{
      "href": "/docs/ja/18/REST/configuration"
    }
    ...
    parentName: "ul"
  }, `create and configure a basic 4D database`), /* @__PURE__ */ (0, import_react2.mdx)("li", {
    parentName: "ul"
  }, `access data from the 4D database through REST using a standard browser.`)), /* @__PURE__ */ (0, import_react2.mdx)("p", null, `To keep the example simple, we\u2019re going to use a 4D application and a browser that are running on the same machine. Of course, you could also use a remote architecture.`), /* @__PURE__ */ (0, import_react2.mdx)("h2", {
    ...{
      "id": "creating-and-configuring-the-4d-database"
    }
  }, `Creating and configuring the 4D database`), /* @__PURE__ */ (0, import_react2.mdx)("ol", null, /* @__PURE__ */ (0, import_react2.mdx)("li", {
    parentName: "ol"
  }, /* @__PURE__ */ (0, import_react2.mdx)("p", {
    parentName: "li"
  }, `Launch your 4D or 4D Server application and create a new database. You can name it "Emp4D", for example.`)), /* @__PURE__ */ (0, import_react2.mdx)("li", {
    parentName: "ol"
  }, /* @__PURE__ */ (0, import_react2.mdx)("p", {
    parentName: "li"
    ...
    src: (__webpack_require__(82763)/* ["default"] */ .Z),
    width: "122",
    height: "169"
    ...
    src: (__webpack_require__(94523)/* ["default"] */ .Z),
    width: "812",
    height: "185"
    ...
    parentName: "p"
  }, `Web/REST resource`), ` page of the Database Settings dialog box and `, /* @__PURE__ */ (0, import_react2.mdx)("a", {
    parentName: "p",
    ...{
      "href": "/docs/ja/18/REST/configuration#starting-the-rest-server"
    }
...
`)), /* @__PURE__ */ (0, import_react2.mdx)("p", null, `The 4D `, /* @__PURE__ */ (0, import_react2.mdx)("a", {
    parentName: "p",
    ...{
      "href": "/docs/ja/18/REST/REST_requests"
    }
  }, `REST API`), ` provides various commands to interact with the 4D database.`));
}
;
