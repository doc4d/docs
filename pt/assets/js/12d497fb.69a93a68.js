...
const metadata = {
  ...
  "id": "version-18/Concepts/parameters",
  "title": "Parameters",
  "description": "Using parameters",
  "source": "@site/versioned_docs/version-18/Concepts/parameters.md",
  "sourceDirName": "Concepts",
  "slug": "/Concepts/parameters",
  "permalink": "/docs/pt/18/Concepts/parameters",
  "draft": false,
  "tags": [],
  "version": "18",
  "frontMatter": {
  ...
  "previous": {
    "title": "Methods",
    "permalink": "/docs/pt/18/Concepts/methods"
  },
  "next": {
    "title": "Shared objects and collections",
    "permalink": "/docs/pt/18/Concepts/shared"
  }
};
const assets = {};
const toc = [{
  ...
  value: "Declaring parameters",
  id: "declaring-parameters",
  level: 2
}, {
  ...
  value: "Parameter indirection",
  id: "parameter-indirection",
  level: 2
}, {
...
function MDXContent({
  ...
  }, `Using parameters`), /* @__PURE__ */ (0, import_react2.mdx)("p", null, `You'll often find that you need to pass data to your methods. This is easily done with parameters.`), /* @__PURE__ */ (0, import_react2.mdx)("p", null, /* @__PURE__ */ (0, import_react2.mdx)("strong", {
    parentName: "p"
  }, `Parameters`), ` (or `, /* @__PURE__ */ (0, import_react2.mdx)("strong", {
    parentName: "p"
  }, `arguments`), `) are pieces of data that a method needs in order to perform its task. The terms `, /* @__PURE__ */ (0, import_react2.mdx)("em", {
    parentName: "p"
...
`)), /* @__PURE__ */ (0, import_react2.mdx)("p", null, `Parameters are passed to methods in the same way. For example, if a project method named DO SOMETHING accepted three parameters, a call to the method might look like this:`), /* @__PURE__ */ (0, import_react2.mdx)("pre", null, /* @__PURE__ */ (0, import_react2.mdx)("code", {
    parentName: "pre",
    ...{
      "className": "language-4d"
    }
  }, `DO SOMETHING(WithThis;AndThat;ThisWay)
`)), /* @__PURE__ */ (0, import_react2.mdx)("p", null, `The parameters are separated by semicolons (;). Their value is evaluated at the moment of the call.`), /* @__PURE__ */ (0, import_react2.mdx)("p", null, `In the subroutine (the method that is called), the value of each parameter is automatically copied into sequentially numbered local variables: $1, $2, $3, and so on. The numbering of the local variables represents the order of the parameters.`), /* @__PURE__ */ (0, import_react2.mdx)("pre", null, /* @__PURE__ */ (0, import_react2.mdx)("code", {
    parentName: "pre",
    ...{
      "className": "language-4d"
    }
...
`)), /* @__PURE__ */ (0, import_react2.mdx)("p", null, `Within the subroutine, you can use the parameters $1, $2... in the same way you would use any other local variable. However, in the case where you use commands that modify the value of the variable passed as parameter (for example `, /* @__PURE__ */ (0, import_react2.mdx)("inlineCode", {
    parentName: "p"
    ...
    parentName: "p"
  }, `$myvar:=$1`), `).`), /* @__PURE__ */ (0, import_react2.mdx)("p", null, `The same principles are used when methods are executed through dedicated commands, for example:`), /* @__PURE__ */ (0, import_react2.mdx)("pre", null, /* @__PURE__ */ (0, import_react2.mdx)("code", {
    parentName: "pre",
    ...{
      "className": "language-4d"
    }
...
`)), /* @__PURE__ */ (0, import_react2.mdx)("p", null, /* @__PURE__ */ (0, import_react2.mdx)("strong", {
    parentName: "p"
  }, `Note:`), ` For a good execution of code, you need to make sure that all `, /* @__PURE__ */ (0, import_react2.mdx)("inlineCode", {
    parentName: "p"
  }, `$1`), `, `, /* @__PURE__ */ (0, import_react2.mdx)("inlineCode", {
    parentName: "p"
  }, `$2`), `... parameters are correctly declared within called methods (see `, /* @__PURE__ */ (0, import_react2.mdx)("a", {
    parentName: "p",
    ...{
      "href": "#declaring-parameters"
    }
  }, `Declaring parameters`), ` below).`), /* @__PURE__ */ (0, import_react2.mdx)("h3", {
    ...{
      "id": "supported-expressions"
    }
  }, `Supported expressions`), /* @__PURE__ */ (0, import_react2.mdx)("p", null, `You can use any `, /* @__PURE__ */ (0, import_react2.mdx)("a", {
    parentName: "p",
    ...{
      "href": "/docs/pt/18/Concepts/quick-tour#expression-types"
    }
  }, `expression`), ` as parameter, except:`), /* @__PURE__ */ (0, import_react2.mdx)("ul", null, /* @__PURE__ */ (0, import_react2.mdx)("li", {
    parentName: "ul"
    ...
    parentName: "p",
    ...{
      "href": "/docs/pt/18/Concepts/pointer#pointers-as-parameters-to-methods"
    }
  }, `as reference using a pointer`), `.`), /* @__PURE__ */ (0, import_react2.mdx)("h2", {
    ...{
      "id": "functions"
    }
  }, `Functions`), /* @__PURE__ */ (0, import_react2.mdx)("p", null, `Data can be returned from methods. A method that returns a value is called a function.`), /* @__PURE__ */ (0, import_react2.mdx)("p", null, `4D or 4D Plug-in commands that return a value are also called functions.`), /* @__PURE__ */ (0, import_react2.mdx)("p", null, `For example, the following line is a statement that uses the built-in function, `, /* @__PURE__ */ (0, import_react2.mdx)("inlineCode", {
    parentName: "p"
...
`)), /* @__PURE__ */ (0, import_react2.mdx)("p", null, `Any subroutine can return a value. The value to be returned is put into the local variable `, /* @__PURE__ */ (0, import_react2.mdx)("inlineCode", {
    parentName: "p"
  }, `$0`), `.`), /* @__PURE__ */ (0, import_react2.mdx)("p", null, `For example, the following function, called `, /* @__PURE__ */ (0, import_react2.mdx)("inlineCode", {
    parentName: "p"
...
`)), /* @__PURE__ */ (0, import_react2.mdx)("p", null, `The following is an example that uses the Uppercase4 function:`), /* @__PURE__ */ (0, import_react2.mdx)("pre", null, /* @__PURE__ */ (0, import_react2.mdx)("code", {
    parentName: "pre",
    ...{
      "className": "language-4d"
    }
...
`)), /* @__PURE__ */ (0, import_react2.mdx)("p", null, `In this example, the variable `, /* @__PURE__ */ (0, import_react2.mdx)("em", {
    parentName: "p"
  }, `NewPhrase`), ` gets \u201CTHIS is good.\u201D`), /* @__PURE__ */ (0, import_react2.mdx)("p", null, `The function result, `, /* @__PURE__ */ (0, import_react2.mdx)("inlineCode", {
    parentName: "p"
  }, `$0`), `, is a local variable within the subroutine. It can be used as such within the subroutine. For example, in the previous `, /* @__PURE__ */ (0, import_react2.mdx)("inlineCode", {
    parentName: "p"
  }, `DO SOMETHING`), ` example, `, /* @__PURE__ */ (0, import_react2.mdx)("inlineCode", {
    parentName: "p"
  }, `$0`), ` was first assigned the value of `, /* @__PURE__ */ (0, import_react2.mdx)("inlineCode", {
    parentName: "p"
    ...
    parentName: "p"
  }, `$0`), ` (as it is when the subroutine ends) to the called method.`), /* @__PURE__ */ (0, import_react2.mdx)("h2", {
    ...{
      "id": "declaring-parameters"
    }
  }, `Declaring parameters`), /* @__PURE__ */ (0, import_react2.mdx)("p", null, `Even if it is not mandatory in `, /* @__PURE__ */ (0, import_react2.mdx)("a", {
    parentName: "p",
    ...{
      "href": "/docs/pt/18/Concepts/interpreted-compiled"
    }
  }, `interpreted mode`), `, you must declare each parameter in the called methods to prevent any trouble.`), /* @__PURE__ */ (0, import_react2.mdx)("p", null, `In the following example, the `, /* @__PURE__ */ (0, import_react2.mdx)("inlineCode", {
    parentName: "p"
  }, `OneMethodAmongOthers`), ` project method declares three parameters:`), /* @__PURE__ */ (0, import_react2.mdx)("pre", null, /* @__PURE__ */ (0, import_react2.mdx)("code", {
    parentName: "pre",
    ...{
      "className": "language-4d"
    }
...
`)), /* @__PURE__ */ (0, import_react2.mdx)("p", null, `In the following example, the `, /* @__PURE__ */ (0, import_react2.mdx)("inlineCode", {
    parentName: "p"
...
`)), /* @__PURE__ */ (0, import_react2.mdx)("p", null, /* @__PURE__ */ (0, import_react2.mdx)("strong", {
    parentName: "p"
  }, `Note:`), ` For compiled mode, you can group all local variable parameters for project methods in a specific method with a name starting with "Compiler". Within this method, you can predeclare the parameters for each method, for example:`), /* @__PURE__ */ (0, import_react2.mdx)("pre", null, /* @__PURE__ */ (0, import_react2.mdx)("code", {
    parentName: "pre",
    ...{
      "className": "language-4d"
    }
...
The $0 parameter (Longint), which is the result of a trigger, will be typed by the compiler if the parameter has not been explicitly declared. Nevertheless, if you want to declare it, you must do so in the trigger itself.`)), /* @__PURE__ */ (0, import_react2.mdx)("li", {
    parentName: "ul"
  }, /* @__PURE__ */ (0, import_react2.mdx)("p", {
    parentName: "li"
  }, `Form objects that accept the `, /* @__PURE__ */ (0, import_react2.mdx)("inlineCode", {
    parentName: "p"
  }, `On Drag Over`), ` form event
The $0 parameter (Longint), which is the result of the `, /* @__PURE__ */ (0, import_react2.mdx)("inlineCode", {
    parentName: "p"
...
`)), /* @__PURE__ */ (0, import_react2.mdx)("h2", {
    ...
    parentName: "p"
  }, `resulting value`), ` to the $1, $2... local variables in the subroutine (see `, /* @__PURE__ */ (0, import_react2.mdx)("a", {
    parentName: "p",
    ...{
...
`)), /* @__PURE__ */ (0, import_react2.mdx)("p", null, `This second technique of returning a value by a subroutine is called \u201Cusing a function.\u201D This is described in the `, /* @__PURE__ */ (0, import_react2.mdx)("a", {
  ...
  }, `Functions`), ` paragraph.`), /* @__PURE__ */ (0, import_react2.mdx)("h3", {
    ...{
      "id": "particular-cases-objects-and-collections"
    }
...
`)), /* @__PURE__ */ (0, import_react2.mdx)("p", null, `When you execute the `, /* @__PURE__ */ (0, import_react2.mdx)("inlineCode", {
    ...
    parentName: "p"
  }, `4D Server:`), ` When parameters are passed between methods that are not executed on the same machine (using for example the "Execute on Server" option), references are not usable. In these cases, copies of object and collection parameters are sent instead of references.`), /* @__PURE__ */ (0, import_react2.mdx)("h2", {
    ...{
      "id": "named-parameters"
    }
  }, `Named parameters`), /* @__PURE__ */ (0, import_react2.mdx)("p", null, `Using objects as parameters allow you to handle `, /* @__PURE__ */ (0, import_react2.mdx)("strong", {
    parentName: "p"
...
`)), /* @__PURE__ */ (0, import_react2.mdx)("p", null, `4D project methods also accept such optional parameters, starting from the right. The issue with optional parameters is how to handle the case where some of them are missing in the called method - it should never produce an error. A good practice is to assign default values to unused parameters.`), /* @__PURE__ */ (0, import_react2.mdx)("blockquote", null, /* @__PURE__ */ (0, import_react2.mdx)("p", {
  ...
  }, `Named parameters`), ` which provide a flexible way to handle variable numbers of parameters.  `)), /* @__PURE__ */ (0, import_react2.mdx)("p", null, `Using the `, /* @__PURE__ */ (0, import_react2.mdx)("inlineCode", {
    parentName: "p"
...
`)), /* @__PURE__ */ (0, import_react2.mdx)("h2", {
  ...
  }, `Parameter indirection`), /* @__PURE__ */ (0, import_react2.mdx)("p", null, `4D project methods accept a variable number of parameters of the same type, starting from the right. This principle is called `, /* @__PURE__ */ (0, import_react2.mdx)("strong", {
    parentName: "p"
  }, `parameter indirection`), `. Using the `, /* @__PURE__ */ (0, import_react2.mdx)("inlineCode", {
    parentName: "p"
  }, `Count parameters`), ` command you can then address those parameters with a `, /* @__PURE__ */ (0, import_react2.mdx)("inlineCode", {
    parentName: "p"
  }, `For...End for`), ` loop and the parameter indirection syntax.`), /* @__PURE__ */ (0, import_react2.mdx)("p", null, `In the following example, the project method `, /* @__PURE__ */ (0, import_react2.mdx)("inlineCode", {
    parentName: "p"
  }, `SEND PACKETS`), ` accepts a time parameter followed by a variable number of text parameters:`), /* @__PURE__ */ (0, import_react2.mdx)("pre", null, /* @__PURE__ */ (0, import_react2.mdx)("code", {
    parentName: "pre",
    ...{
      "className": "language-4d"
    }
...
`)), /* @__PURE__ */ (0, import_react2.mdx)("p", null, `In this case, the calling method will get the string \u201C182.70\u201D, which is the sum of the numbers, formatted as specified. The function's parameters must be passed in the correct order: first the format and then the values.`), /* @__PURE__ */ (0, import_react2.mdx)("p", null, `Here is the function, named `, /* @__PURE__ */ (0, import_react2.mdx)("inlineCode", {
 ...
 End for
 $0:=String($Sum;$1)
`)), /* @__PURE__ */ (0, import_react2.mdx)("p", null, `This function can now be called in various ways:`), /* @__PURE__ */ (0, import_react2.mdx)("pre", null, /* @__PURE__ */ (0, import_react2.mdx)("code", {
    parentName: "pre",
    ...{
      "className": "language-4d"
    }
...
`)), /* @__PURE__ */ (0, import_react2.mdx)("h3", {
  ...
  }, `Declaring generic parameters`), /* @__PURE__ */ (0, import_react2.mdx)("p", null, `As with other local variables, it is not mandatory to declare generic parameters by compiler directive. However, it is recommended to avoid any ambiguity. To declare these parameters, you use a compiler directive to which you pass \${N} as a parameter, where N specifies the first generic parameter.`), /* @__PURE__ */ (0, import_react2.mdx)("pre", null, /* @__PURE__ */ (0, import_react2.mdx)("code", {
    parentName: "pre",
    ...{
      "className": "language-4d"
    }
