...
const metadata = {
  ...
  "source": "@site/docs/Backup/restore.md",
  "sourceDirName": "Backup",
  "slug": "/Backup/restore",
  "permalink": "/docs/pt/next/Backup/restore",
  "draft": false,
  "tags": [],
  "version": "current",
  "frontMatter": {
  ...
  "previous": {
    ...
    "permalink": "/docs/pt/next/Backup/log"
  },
  "next": {
    "title": "Overview",
    "permalink": "/docs/pt/next/Extensions/overview"
  }
};
const assets = {};
const toc = [{
...
function MDXContent({
  ...
  return /* @__PURE__ */ (0, import_react2.mdx)(MDXLayout, {
    ...
    parentName: "p",
    ...{
      "href": "/docs/pt/next/Backup/settings#automatic-restore"
    }
...
`, `If the incident is the result of an inappropriate operation performed on the data (deletion of a record, for example), you can attempt to repair the data file using the "rollback" function in the log file. This function is available on the `, /* @__PURE__ */ (0, import_react2.mdx)("a", {
    parentName: "p",
    ...{
      "href": "/docs/pt/next/MSC/rollback"
    }
...
A dialog box appears, which allows you to specify the location where files will be restored. By default, 4D restores the files in a folder named `, /* @__PURE__ */ (0, import_react2.mdx)("em", {
    ...
    src: (__webpack_require__(7856)/* ["default"] */ .Z),
    width: "547",
    height: "242"
...
5. Click `, /* @__PURE__ */ (0, import_react2.mdx)("strong", {
    ...
    parentName: "p",
    ...{
      "href": "/docs/pt/next/MSC/restore#successive-intergration-of-several-data-log-files"
    }
    ...
    src: (__webpack_require__(86724)/* ["default"] */ .Z),
    width: "512",
    height: "242"
