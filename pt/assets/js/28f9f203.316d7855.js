...
const metadata = {
  ...
  "id": "version-18/Backup/restore",
  "title": "Restore",
  "description": "4D allows you to restore entire sets of database data in case of any incidents, regardless of the cause of the incident. Two primary categories of incidents can occur:",
  "source": "@site/versioned_docs/version-18/Backup/restore.md",
  "sourceDirName": "Backup",
  "slug": "/Backup/restore",
  "permalink": "/docs/pt/18/Backup/restore",
  "draft": false,
  "tags": [],
  "version": "18",
  "frontMatter": {
  ...
  "previous": {
    ...
    "permalink": "/docs/pt/18/Backup/log"
  },
  "next": {
    "title": "Overview",
    "permalink": "/docs/pt/18/Users/overview"
  }
};
const assets = {};
const toc = [{
...
function MDXContent({
  ...
  return /* @__PURE__ */ (0, import_react2.mdx)(MDXLayout, {
    ...
    components,
    mdxType: "MDXLayout"
  }, /* @__PURE__ */ (0, import_react2.mdx)("p", null, `4D allows you to restore entire sets of database data in case of any incidents, regardless of the cause of the incident. Two primary categories of incidents can occur:`), /* @__PURE__ */ (0, import_react2.mdx)("ul", null, /* @__PURE__ */ (0, import_react2.mdx)("li", {
    parentName: "ul"
  }, /* @__PURE__ */ (0, import_react2.mdx)("p", {
    parentName: "li"
  }, `The unexpected stoppage of a database while in use. This incident can occur because of a power outage, system element failure, etc. In this case, depending on the current state of the data cache at the moment of the incident, the restore of the database can require different operations:`), /* @__PURE__ */ (0, import_react2.mdx)("ul", {
    parentName: "li"
  }, /* @__PURE__ */ (0, import_react2.mdx)("li", {
    parentName: "ul"
  }, `If the cache was empty, the database opens normally. Any changes made in the database were recorded. This case does not require any particular operation.`), /* @__PURE__ */ (0, import_react2.mdx)("li", {
    parentName: "ul"
    ...
    parentName: "li"
  }, `The loss of database file(s). This incident can occur because of defective sectors on the disk containing the database, a virus, manipulation error, etc. The last backup must be restored and then the current log file must be integrated. To find out if a database was damaged following an incident, simply relaunch the database using 4D. The program performs a self-check and details the necessary restore operations to perform. In automatic mode, these operations are performed directly without any intervention on the part of the user. If a regular backup strategy was put into place, the 4D restore tools will allow you to recover (in most cases) the database in the exact state it was in before the incident.`))), /* @__PURE__ */ (0, import_react2.mdx)("blockquote", null, /* @__PURE__ */ (0, import_react2.mdx)("p", {
    parentName: "blockquote"
  }, `4D can launch procedures automatically to recover databases following incidents. These mechanisms are managed using two options available on the `, /* @__PURE__ */ (0, import_react2.mdx)("strong", {
    parentName: "p"
  }, `Backup/Backup & Restore`), ` page of the Database Settings. For more information, refer to the `, /* @__PURE__ */ (0, import_react2.mdx)("a", {
    parentName: "p",
    ...{
      "href": "/docs/pt/18/Backup/settings#automatic-restore"
    }
  }, `Automatic Restore`), ` paragraph.`, /* @__PURE__ */ (0, import_react2.mdx)("br", {
    parentName: "p"
  }), `
`, `If the incident is the result of an inappropriate operation performed on the data (deletion of a record, for example), you can attempt to repair the database using the "rollback" function in the log file. This function is available on the `, /* @__PURE__ */ (0, import_react2.mdx)("a", {
    parentName: "p",
    ...{
      "href": "/docs/pt/18/MSC/rollback"
    }
  ...
  }, `Restore`), ` page of the MSC. Restoring via the MSC provides more options and allows the archive contents to be previewed. On the other hand, only archives associated with the open database can be restored.`), /* @__PURE__ */ (0, import_react2.mdx)("p", null, `To restore a database manually via a standard dialog box:`), /* @__PURE__ */ (0, import_react2.mdx)("ol", null, /* @__PURE__ */ (0, import_react2.mdx)("li", {
    parentName: "ol"
...
A dialog box appears, which allows you to specify the location where files will be restored. By default, 4D restores the files in a folder named `, /* @__PURE__ */ (0, import_react2.mdx)("em", {
    ...
    src: (__webpack_require__(67841)/* ["default"] */ .Z),
    width: "547",
    height: "242"
...
4.(Optional) Click `, /* @__PURE__ */ (0, import_react2.mdx)("strong", {
    parentName: "p"
  }, `OK`), ` to integrate the log file into the restored database.
...
The destination folder is displayed. During the restore, 4D places all backup files in this folder, regardless of the position of the original files on the disk when the backup starts. This way your files will be easier to find.`), /* @__PURE__ */ (0, import_react2.mdx)("h2", {
    ...{
      "id": "manually-restoring-a-backup-msc"
    }
  }, `Manually restoring a backup (MSC)`), /* @__PURE__ */ (0, import_react2.mdx)("p", null, `You can manually restore an archive of the current database using the `, /* @__PURE__ */ (0, import_react2.mdx)("a", {
    parentName: "p",
    ...{
      "href": "/docs/pt/18/MSC/restore"
    }
    ...
    parentName: "p",
    ...{
      "href": "/docs/pt/18/MSC/restore#successive-intergration-of-several-data-log-files"
    }
  }, `Successive integration of several log files`), `), a warning dialog box appears during the opening of the database when 4D notices that the log file contains more operations than have been carried out in the database.`), /* @__PURE__ */ (0, import_react2.mdx)("p", null, /* @__PURE__ */ (0, import_react2.mdx)("img", {
    src: (__webpack_require__(52048)/* ["default"] */ .Z),
    width: "512",
    height: "242"
