...
const metadata = {
  ...
  "source": "@site/versioned_docs/version-18/MSC/repair.md",
  "sourceDirName": "MSC",
  "slug": "/MSC/repair",
  ...
  "previous": {
    "title": "Restore Page",
    "permalink": "/docs/pt/18/MSC/restore"
  },
  "next": {
    "title": "Encrypt Page",
...
function MDXContent({
  ...
  }, `Repairing is only available in maintenance mode. If you attempt to carry out this operation in standard mode, a warning dialog will inform you that the database will be closed and restarted in maintenance mode.`)), /* @__PURE__ */ (0, import_react2.mdx)("blockquote", null, /* @__PURE__ */ (0, import_react2.mdx)("p", {
    parentName: "blockquote"
  ...
  }, `Original files backup folder`), /* @__PURE__ */ (0, import_react2.mdx)("p", null, `By default, the original data file will be duplicated before the repair operation. It will be placed in a subfolder named \u201CReplaced files (repairing)\u201D in the database folder. The second `, /* @__PURE__ */ (0, import_react2.mdx)("strong", {
    parentName: "p"
...
`, /* @__PURE__ */ (0, import_react2.mdx)("img", {
    src: (__webpack_require__(25044)/* ["default"] */ .Z),
    width: "225",
    height: "45"
  })), /* @__PURE__ */ (0, import_react2.mdx)("h2", {
    ...{
    ...
    parentName: "p"
  }, `Records definitively deleted`), ` option in the properties of a table in the database structure, performing a recovery by header markers may cause records that were previously deleted to reappear.
Recovery by headers does not take integrity constraints into account. More specifically, after this operation you may get duplicated values with unique fields or NULL values with fields declared `, /* @__PURE__ */ (0, import_react2.mdx)("strong", {
    ...
    src: (__webpack_require__(37137)/* ["default"] */ .Z),
    width: "906",
    height: "683"
...
To do this, first select an unassigned group of records in the first table. The "Content of the records" area then displays a preview of the contents of the first records of the group to make it easier to assign them:`), /* @__PURE__ */ (0, import_react2.mdx)("p", null, /* @__PURE__ */ (0, import_react2.mdx)("img", {
    src: (__webpack_require__(8263)/* ["default"] */ .Z),
    width: "903",
    height: "682"
...
Use the `, /* @__PURE__ */ (0, import_react2.mdx)("strong", {
  ...
  }, `Open log file`), /* @__PURE__ */ (0, import_react2.mdx)("p", null, `After repair is completed, 4D generates a log file in the Logs folder of the database. This file allows you to view all the operations carried out. It is created in XML format and named:  `, /* @__PURE__ */ (0, import_react2.mdx)("em", {
    parentName: "p"
  }, `DatabaseName**_Repair_Log_yyyy-mm-dd hh-mm-ss.xml`), `" where:`), /* @__PURE__ */ (0, import_react2.mdx)("ul", null, /* @__PURE__ */ (0, import_react2.mdx)("li", {
    parentName: "ul"
