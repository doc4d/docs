...
const metadata = {
  ...
  "id": "version-19-R6/Backup/settings",
  "title": "Backup Settings",
  "description": "Backup settings are defined through three pages in the Settings dialog box. You can set:",
  "source": "@site/versioned_docs/version-19-R6/Backup/settings.md",
  "sourceDirName": "Backup",
  "slug": "/Backup/settings",
  "permalink": "/docs/pt/Backup/settings",
  "draft": false,
  "tags": [],
  "version": "19-R6",
  "frontMatter": {
  ...
  "previous": {
    "title": "Backup",
    "permalink": "/docs/pt/Backup/backup"
  },
  "next": {
...
function MDXContent({
  ...
  return /* @__PURE__ */ (0, import_react2.mdx)(MDXLayout, {
    ...
    components,
    mdxType: "MDXLayout"
  }, /* @__PURE__ */ (0, import_react2.mdx)("p", null, `Backup settings are defined through three pages in the `, /* @__PURE__ */ (0, import_react2.mdx)("a", {
    parentName: "p",
    ...{
      "href": "/docs/pt/settings/overview"
    }
  }, `Settings dialog box`), `. You can set:`), /* @__PURE__ */ (0, import_react2.mdx)("ul", null, /* @__PURE__ */ (0, import_react2.mdx)("li", {
    parentName: "ul"
    ...
    parentName: "p"
  }, `Backup/Scheduler`), ` page of the Structure Settings:`), /* @__PURE__ */ (0, import_react2.mdx)("p", null, /* @__PURE__ */ (0, import_react2.mdx)("img", {
    src: (__webpack_require__(33235)/* ["default"] */ .Z),
    width: "862",
    height: "293"
    ...
    parentName: "li"
  }, `Every X hour(s)`), `: Allows programming backups on an hourly basis. You can enter a value between 1 and 24.`)), /* @__PURE__ */ (0, import_react2.mdx)("ul", {
    parentName: "li"
  }, /* @__PURE__ */ (0, import_react2.mdx)("li", {
    parentName: "ul"
  }, /* @__PURE__ */ (0, import_react2.mdx)("strong", {
  ...
  }, `Configuration`), /* @__PURE__ */ (0, import_react2.mdx)("p", null, `The Backup/Configuration page of the Structure Settings lets you set the backup files and their location, as well as that of the log file. These parameters are specific to each application opened by 4D or 4D Server.`), /* @__PURE__ */ (0, import_react2.mdx)("p", null, /* @__PURE__ */ (0, import_react2.mdx)("img", {
    src: (__webpack_require__(19823)/* ["default"] */ .Z),
    width: "862",
    height: "659"
    ...
    parentName: "li"
  }, `Data`), `: Application data file. When this option is checked, the following elements are automatically backed up at the same time as the data:`, /* @__PURE__ */ (0, import_react2.mdx)("ul", {
    parentName: "li"
  }, /* @__PURE__ */ (0, import_react2.mdx)("li", {
    parentName: "ul"
  }, `the current log file of the application (if it exists),`), /* @__PURE__ */ (0, import_react2.mdx)("li", {
    parentName: "ul"
  }, `the full `, /* @__PURE__ */ (0, import_react2.mdx)("inlineCode", {
    parentName: "li"
  }, `Settings`), ` folder located `, /* @__PURE__ */ (0, import_react2.mdx)("a", {
    parentName: "li",
    ...{
      "href": "/docs/pt/Project/architecture#settings-folder"
    }
  }, `next to the data file`), ` (if it exists), i.e. the `, /* @__PURE__ */ (0, import_react2.mdx)("em", {
    parentName: "li"
  }, `user settings for data`), `. `))), /* @__PURE__ */ (0, import_react2.mdx)("li", {
    parentName: "ul"
  }, /* @__PURE__ */ (0, import_react2.mdx)("strong", {
    parentName: "li"
  }, `Structure`), `: Application project folders and files. In cases where projects are compiled, this option allows you to backup the .4dz file. When this option is checked, the full `, /* @__PURE__ */ (0, import_react2.mdx)("inlineCode", {
    parentName: "li"
  }, `Settings`), ` folder located `, /* @__PURE__ */ (0, import_react2.mdx)("a", {
    parentName: "li",
    ...{
      "href": "/docs/pt/Project/architecture#settings-folder-1"
    }
  }, `at the same level as the Project folder`), `, i.e. the `, /* @__PURE__ */ (0, import_react2.mdx)("em", {
    parentName: "li"
  }, `user settings`), `, is automatically backed up. `), /* @__PURE__ */ (0, import_react2.mdx)("li", {
    parentName: "ul"
  }, /* @__PURE__ */ (0, import_react2.mdx)("strong", {
    parentName: "li"
    ...
    parentName: "p"
  }, `Use Log`), ` option, when checked, indicates that the application uses a log file. Its pathname is specified below the option. When this option is checked, it is not possible to open the application without a log file. `), /* @__PURE__ */ (0, import_react2.mdx)("p", null, `By default, any project created with 4D uses a log file (option `, /* @__PURE__ */ (0, import_react2.mdx)("strong", {
    parentName: "p"
  }, `Use Log File`), ` checked in the `, /* @__PURE__ */ (0, import_react2.mdx)("strong", {
    parentName: "p"
    ...
    src: (__webpack_require__(23366)/* ["default"] */ .Z),
    width: "862",
    height: "644"
...
To disable the mechanism, simply deselect the option.`), /* @__PURE__ */ (0, import_react2.mdx)("blockquote", {
    ...
    parentName: "p"
  }, `If backup fails`), `: This option allows setting the mechanism used to handle failed backups (backup impossible). When a backup cannot be performed, 4D lets you carry out a new attempt. `), /* @__PURE__ */ (0, import_react2.mdx)("pre", {
    parentName: "li"
...
`)), /* @__PURE__ */ (0, import_react2.mdx)("p", {
    ...
    parentName: "blockquote"
  }, `4D considers a backup as failed if the application was not launched at the time when the scheduled automatic backup was set to be carried out.`)), /* @__PURE__ */ (0, import_react2.mdx)("h3", {
    ...{
      "id": "archive"
    }
...
By default, 4D compresses backups to help save disk space. However, the file compression phase can noticeably slow down backups when dealing with large volumes of data. The `, /* @__PURE__ */ (0, import_react2.mdx)("strong", {
    parentName: "p"
  }, `Compression Rate`), ` option allows you to adjust file compression:`), /* @__PURE__ */ (0, import_react2.mdx)("pre", {
    parentName: "li"
  }, /* @__PURE__ */ (0, import_react2.mdx)("code", {
    parentName: "pre",
    ...{}
...
4D generates archives using specific algorithms that are based on optimization (interlacing) and security (redundancy) mechanisms. You can set these mechanisms according to your needs. The menus for these options contain rates of `, /* @__PURE__ */ (0, import_react2.mdx)("strong", {
    ...
    parentName: "p"
  }, `None`), ` (default).`), /* @__PURE__ */ (0, import_react2.mdx)("pre", {
    parentName: "li"
  }, /* @__PURE__ */ (0, import_react2.mdx)("code", {
    parentName: "pre",
    ...{}
...
`)))), /* @__PURE__ */ (0, import_react2.mdx)("h3", {
    ...
    parentName: "p"
  }, `Restore last backup if database is damaged`), `: When this option is checked, the program automatically starts the restore of the data file of the last valid backup of the application, if an anomaly is detected (corrupted file, for example) during application launch. No intervention is required on the part of the user; however, the operation is logged in the backup journal.`)), /* @__PURE__ */ (0, import_react2.mdx)("li", {
    parentName: "ul"
  }, /* @__PURE__ */ (0, import_react2.mdx)("p", {
    parentName: "li"
  }, /* @__PURE__ */ (0, import_react2.mdx)("strong", {
    parentName: "p"
  }, `Integrate last log file if database is incomplete`), `: When this option is checked, the program automatically integrates the log file when opening or restoring the application.`), /* @__PURE__ */ (0, import_react2.mdx)("ul", {
    parentName: "li"
  }, /* @__PURE__ */ (0, import_react2.mdx)("li", {
    parentName: "ul"
    ...
    parentName: "ul"
  }, `When restoring an application, if the current log file or a log backup file having the same number as the backup file is stored in the same folder, 4D examines its contents. If it contains operations not found in the data file, the program automatically integrates it.`)))), /* @__PURE__ */ (0, import_react2.mdx)("p", null, `The user does not see any dialog box; the operation is completely automatic. The goal is to make use as easy as possible. The operation is logged in the backup journal.`), /* @__PURE__ */ (0, import_react2.mdx)("blockquote", null, /* @__PURE__ */ (0, import_react2.mdx)("p", {
    parentName: "blockquote"
  }, `In the case of an automatic restore, only the following elements are restored:`), /* @__PURE__ */ (0, import_react2.mdx)("pre", {
    parentName: "blockquote"
  }, /* @__PURE__ */ (0, import_react2.mdx)("code", {
    parentName: "pre",
    ...{}
...
`)), /* @__PURE__ */ (0, import_react2.mdx)("p", {
    parentName: "blockquote"
  }, `If you wish to get the attached files or the project files, you must perform a `, /* @__PURE__ */ (0, import_react2.mdx)("a", {
    parentName: "p",
    ...{
      "href": "/docs/pt/Backup/restore#manually-restoring-a-backup-standard-dialog"
    }
  }, `manual restore`), `.`)));
}
;
