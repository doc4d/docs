...
const metadata = {
  ...
  "id": "version-19-R6/Concepts/parameters",
  "title": "Parameters",
  ...
  "source": "@site/versioned_docs/version-19-R6/Concepts/parameters.md",
...
const toc = [{
  ...
  value: "<code>return {expression}</code>",
...
`)), /* @__PURE__ */ (0, import_react2.mdx)("p", null, `The following rules apply:`), /* @__PURE__ */ (0, import_react2.mdx)("ul", null, /* @__PURE__ */ (0, import_react2.mdx)("li", {
    ...
    parentName: "li",
    ...{
      "href": "/docs/pt/Concepts/identifiers#object-properties"
    }
...
`)), /* @__PURE__ */ (0, import_react2.mdx)("p", null, `You can also declare the return parameter only by adding `, /* @__PURE__ */ (0, import_react2.mdx)("inlineCode", {
    parentName: "p"
  }, `: type`), `, in which case it can be handled by a `, /* @__PURE__ */ (0, import_react2.mdx)("a", {
    parentName: "p",
    ...{
      "href": "#return-expression"
    }
  }, `return statement`), ` or through `, /* @__PURE__ */ (0, import_react2.mdx)("inlineCode", {
    parentName: "p"
  }, `$0`), `in the `, /* @__PURE__ */ (0, import_react2.mdx)("a", {
    parentName: "p",
    ...{
      "href": "#returned-value-1"
    }
  }, `sequential syntax`), `). For example:`), /* @__PURE__ */ (0, import_react2.mdx)("pre", null, /* @__PURE__ */ (0, import_react2.mdx)("code", {
    parentName: "pre",
    ...{
      "className": "language-4d"
    }
...
`)), /* @__PURE__ */ (0, import_react2.mdx)("h3", {
    ...
    parentName: "p",
    ...{
      "href": "/docs/pt/Concepts/variables#using-the-var-keyword"
    }
...
`)), /* @__PURE__ */ (0, import_react2.mdx)("p", null, `In this example, `, /* @__PURE__ */ (0, import_react2.mdx)("inlineCode", {
    ...
    parentName: "p",
    ...{
      "href": "/docs/pt/Concepts/quick-tour#expression-types"
    }
    ...
    parentName: "p",
    ...{
      "href": "/docs/pt/Concepts/pointer#pointers-as-parameters-to-methods"
    }
    ...
    parentName: "h2"
  }, `return {expression}`)), /* @__PURE__ */ (0, import_react2.mdx)("details", null, /* @__PURE__ */ (0, import_react2.mdx)("summary", null, "History"), /* @__PURE__ */ (0, import_react2.mdx)("table", null, /* @__PURE__ */ (0, import_react2.mdx)("thead", {
    parentName: "table"
  ...
  }, `Added`))))), /* @__PURE__ */ (0, import_react2.mdx)("p", null, `The `, /* @__PURE__ */ (0, import_react2.mdx)("inlineCode", {
    parentName: "p"
  }, `return`), ` statement ends function or method execution and can be used to return an expression to the caller.`), /* @__PURE__ */ (0, import_react2.mdx)("p", null, `For example, the following function returns the square of its argument, $x, where $x is a number.`), /* @__PURE__ */ (0, import_react2.mdx)("pre", null, /* @__PURE__ */ (0, import_react2.mdx)("code", {
    parentName: "pre",
    ...{
      "className": "language-4d"
    }
...
`)), /* @__PURE__ */ (0, import_react2.mdx)("blockquote", null, /* @__PURE__ */ (0, import_react2.mdx)("p", {
    parentName: "blockquote"
  }, `Internally, `, /* @__PURE__ */ (0, import_react2.mdx)("inlineCode", {
    parentName: "p"
  }, `return x`), ` executes `, /* @__PURE__ */ (0, import_react2.mdx)("inlineCode", {
    parentName: "p"
  }, `$0:=x`), ` or (if declared) `, /* @__PURE__ */ (0, import_react2.mdx)("inlineCode", {
    parentName: "p"
  }, `myReturnValue:=x`), `, and returns to the caller. If `, /* @__PURE__ */ (0, import_react2.mdx)("inlineCode", {
    parentName: "p"
  }, `return`), ` is used without an expression, the function or method returns a null value of the declared return type (if any), otherwise `, /* @__PURE__ */ (0, import_react2.mdx)("em", {
    parentName: "p"
  }, `undefined`), `.`)), /* @__PURE__ */ (0, import_react2.mdx)("p", null, `The `, /* @__PURE__ */ (0, import_react2.mdx)("inlineCode", {
    parentName: "p"
  }, `return`), ` statement can be used along with the standard syntax for `, /* @__PURE__ */ (0, import_react2.mdx)("a", {
    parentName: "p",
    ...{
      "href": "#returned-value"
    }
  }, `returned values`), ` (the returned value must be of the declared type). However, note that it ends immediately the code execution. For example:`), /* @__PURE__ */ (0, import_react2.mdx)("pre", null, /* @__PURE__ */ (0, import_react2.mdx)("code", {
    parentName: "pre",
    ...{
      "className": "language-4d"
    }
...
`)), /* @__PURE__ */ (0, import_react2.mdx)("blockquote", null, /* @__PURE__ */ (0, import_react2.mdx)("p", {
    ...
    parentName: "p",
    ...{
      "href": "/docs/pt/Concepts/interpreted-compiled"
    }
...
`)), /* @__PURE__ */ (0, import_react2.mdx)("blockquote", null, /* @__PURE__ */ (0, import_react2.mdx)("p", {
    parentName: "blockquote"
  }, `For compiled mode, you can group all local variable parameters for project methods in a specific method with a name starting with "Compiler". Within this method, you can predeclare the parameters for each method, for example:`)), /* @__PURE__ */ (0, import_react2.mdx)("pre", null, /* @__PURE__ */ (0, import_react2.mdx)("code", {
    parentName: "pre",
    ...{
      "className": "language-4d"
    }
...
`)), /* @__PURE__ */ (0, import_react2.mdx)("h2", {
    ...
    parentName: "p",
    ...{
      "href": "/docs/pt/Concepts/error-handling"
    }
...
`)), /* @__PURE__ */ (0, import_react2.mdx)("blockquote", null, /* @__PURE__ */ (0, import_react2.mdx)("p", {
    parentName: "blockquote"
  }, `You can also call a method or function with more parameters than declared. They will be available within the called code through the `, /* @__PURE__ */ (0, import_react2.mdx)("a", {
    parentName: "p",
    ...{
      "href": "#parameter-indirection-n"
    }
  }, `\${N} syntax`), `.`)), /* @__PURE__ */ (0, import_react2.mdx)("p", null, `Using the `, /* @__PURE__ */ (0, import_react2.mdx)("inlineCode", {
    parentName: "p"
...
`)), /* @__PURE__ */ (0, import_react2.mdx)("blockquote", null, /* @__PURE__ */ (0, import_react2.mdx)("p", {
  ...
  }, `object properties as named parameters`), ` which provide a flexible way to handle variable numbers of parameters.  `)), /* @__PURE__ */ (0, import_react2.mdx)("h2", {
    ...{
      "id": "values-or-references"
    }
