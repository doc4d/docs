...
const metadata = {
  ...
  "title": "BLOB",
  "description": "A BLOB (Binary Large OBjects) field, variable or expression is a contiguous series of bytes which can be treated as one whole object or whose bytes can be addressed individually. A BLOB can be empty (null length) or can contain up to 2147483647 bytes (2 GB).",
  "source": "@site/versioned_docs/version-19/Concepts/dt_blob.md",
  ...
  "next": {
    "title": "Boolean",
    "permalink": "/docs/pt/19/Concepts/boolean"
  }
};
const assets = {};
const toc = [{
