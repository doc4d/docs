...
const metadata = {
  ...
  "id": "version-19/FormObjects/ruler",
  "title": "Ruler",
  "description": "The ruler is a standard interface object used to set or get values using a cursor moved along its graduations.",
  "source": "@site/versioned_docs/version-19/FormObjects/ruler.md",
  ...
  "next": {
    "title": "Shapes",
    "permalink": "/docs/pt/19/FormObjects/shapesOverview"
  }
};
const assets = {};
const toc = [{
...
function MDXContent({
  ...
  return /* @__PURE__ */ (0, import_react2.mdx)(MDXLayout, {
    ...
    components,
    mdxType: "MDXLayout"
  }, /* @__PURE__ */ (0, import_react2.mdx)("p", null, `The ruler is a standard interface object used to set or get values using a cursor moved along its graduations.`), /* @__PURE__ */ (0, import_react2.mdx)("p", null, /* @__PURE__ */ (0, import_react2.mdx)("img", {
    src: (__webpack_require__(9512)/* ["default"] */ .Z),
    width: "144",
    height: "55"
    ...
    parentName: "p",
    ...{
      "href": "/docs/pt/19/FormObjects/progressIndicator#using-indicatire"
    }
