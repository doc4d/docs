...
const metadata = {
  ...
  "id": "version-18/Project/architecture",
  "title": "Architecture of a 4D project",
  "description": "A 4D project is made of several folders and files, stored within a single parent database folder (package folder). For example:",
  "source": "@site/versioned_docs/version-18/Project/architecture.md",
  "sourceDirName": "Project",
  "slug": "/Project/architecture",
  "permalink": "/docs/pt/18/Project/architecture",
  "draft": false,
  "tags": [],
  "version": "18",
  "frontMatter": {
  ...
  "previous": {
    ...
    "permalink": "/docs/pt/18/Project/creating"
  },
  "next": {
    "title": "Developing a project",
    "permalink": "/docs/pt/18/Project/developing"
  }
};
const assets = {};
const toc = [{
  ...
  value: "<em>databaseName</em>.4DProject file",
  id: "databasename4dproject-file",
  level: 3
}, {
  value: "Sources folder",
  id: "sources-folder",
  level: 3
}, {
  value: "DatabaseMethods folder",
  id: "databasemethods-folder",
  level: 4
}, {
  value: "Methods folder",
  id: "methods-folder",
  level: 4
}, {
  value: "Classes folder",
  id: "classes-folder",
  level: 4
}, {
  value: "Forms folder",
  ...
  value: "TableForms folder",
  id: "tableforms-folder",
  level: 4
}, {
  value: "Triggers folder",
  id: "triggers-folder",
  level: 4
}, {
  value: "Trash folder",
  ...
  value: "DerivedData folder",
  id: "deriveddata-folder",
  level: 3
}, {
  ...
  value: "Settings folder",
  id: "settings-folder-1",
  level: 2
}, {
  value: "userPreferences.<em>userName</em> folder",
  id: "userpreferencesusername-folder",
  level: 2
}, {
...
function MDXContent({
  ...
  return /* @__PURE__ */ (0, import_react2.mdx)(MDXLayout, {
    ...
    components,
    mdxType: "MDXLayout"
  }, /* @__PURE__ */ (0, import_react2.mdx)("p", null, `A 4D project is made of several folders and files, stored within a single parent database folder (package folder). For example:`), /* @__PURE__ */ (0, import_react2.mdx)("ul", null, /* @__PURE__ */ (0, import_react2.mdx)("li", {
    parentName: "ul"
    ...
    parentName: "ul"
  }, `userPreferences.username`), /* @__PURE__ */ (0, import_react2.mdx)("li", {
    parentName: "ul"
    ...
    parentName: "li"
  }, `databaseName`), `.4DProject file`), /* @__PURE__ */ (0, import_react2.mdx)("li", {
    parentName: "ul"
    ...
    parentName: "h3"
  }, `databaseName`), `.4DProject file`), /* @__PURE__ */ (0, import_react2.mdx)("p", null, `Project development file, used to designate and launch the project. This file can be opened by:`), /* @__PURE__ */ (0, import_react2.mdx)("ul", null, /* @__PURE__ */ (0, import_react2.mdx)("li", {
    parentName: "ul"
  }, `4D Developer`), /* @__PURE__ */ (0, import_react2.mdx)("li", {
    parentName: "ul"
  }, `4D Server (read-only, see `, /* @__PURE__ */ (0, import_react2.mdx)("a", {
    parentName: "li",
    ...{
      "href": "/docs/pt/18/Project/developing"
    }
  }, `Developing a project`), `)`)), /* @__PURE__ */ (0, import_react2.mdx)("p", null, /* @__PURE__ */ (0, import_react2.mdx)("strong", {
    parentName: "p"
  }, `Note:`), ` In 4D projects, development is done with 4D Developer and multi-user development is managed through source control tools. 4D Server can open .4DProject files for testing purposes.`), /* @__PURE__ */ (0, import_react2.mdx)("h3", {
    ...{
      "id": "sources-folder"
    }
  }, `Sources folder`), /* @__PURE__ */ (0, import_react2.mdx)("table", null, /* @__PURE__ */ (0, import_react2.mdx)("thead", {
    parentName: "table"
  ...
  }, `user settings for data`)), ` are defined. `, /* @__PURE__ */ (0, import_react2.mdx)("strong", {
    parentName: "td"
  ...
  }, `DatabaseMethods folder`), /* @__PURE__ */ (0, import_react2.mdx)("table", null, /* @__PURE__ */ (0, import_react2.mdx)("thead", {
    parentName: "table"
  }, /* @__PURE__ */ (0, import_react2.mdx)("tr", {
    parentName: "thead"
  }, /* @__PURE__ */ (0, import_react2.mdx)("th", {
  ...
  }, `Database methods defined in the database. One file per database method`), /* @__PURE__ */ (0, import_react2.mdx)("td", {
    parentName: "tr",
    ...{
      "align": null
    }
  ...
  }, `Methods folder`), /* @__PURE__ */ (0, import_react2.mdx)("table", null, /* @__PURE__ */ (0, import_react2.mdx)("thead", {
    parentName: "table"
  }, /* @__PURE__ */ (0, import_react2.mdx)("tr", {
    parentName: "thead"
  }, /* @__PURE__ */ (0, import_react2.mdx)("th", {
  ...
  }, `Project methods defined in the database. One file per method`), /* @__PURE__ */ (0, import_react2.mdx)("td", {
    parentName: "tr",
    ...{
      "align": null
    }
  ...
  }, `Classes folder`), /* @__PURE__ */ (0, import_react2.mdx)("table", null, /* @__PURE__ */ (0, import_react2.mdx)("thead", {
    parentName: "table"
  }, /* @__PURE__ */ (0, import_react2.mdx)("tr", {
    parentName: "thead"
  }, /* @__PURE__ */ (0, import_react2.mdx)("th", {
  ...
  }, `Forms folder`), /* @__PURE__ */ (0, import_react2.mdx)("table", null, /* @__PURE__ */ (0, import_react2.mdx)("thead", {
    parentName: "table"
  }, /* @__PURE__ */ (0, import_react2.mdx)("tr", {
    parentName: "thead"
  }, /* @__PURE__ */ (0, import_react2.mdx)("th", {
  ...
  }, `TableForms folder`), /* @__PURE__ */ (0, import_react2.mdx)("table", null, /* @__PURE__ */ (0, import_react2.mdx)("thead", {
    parentName: "table"
  }, /* @__PURE__ */ (0, import_react2.mdx)("tr", {
    parentName: "thead"
  }, /* @__PURE__ */ (0, import_react2.mdx)("th", {
  ...
  }, `Triggers folder`), /* @__PURE__ */ (0, import_react2.mdx)("table", null, /* @__PURE__ */ (0, import_react2.mdx)("thead", {
    parentName: "table"
  }, /* @__PURE__ */ (0, import_react2.mdx)("tr", {
    parentName: "thead"
  }, /* @__PURE__ */ (0, import_react2.mdx)("th", {
  ...
  }, `Trigger methods defined in the database. One trigger file per table (n is the table number)`), /* @__PURE__ */ (0, import_react2.mdx)("td", {
    parentName: "tr",
    ...{
      "align": null
    }
...
The .4dm file extension is a text-based file format, containing the code of a 4D method. It is compliant with source control tools.`), /* @__PURE__ */ (0, import_react2.mdx)("h3", {
  ...
  }, `Trash folder`), /* @__PURE__ */ (0, import_react2.mdx)("p", null, `The Trash folder contains methods and forms that were deleted from the project (if any). It can contain the following folders:`), /* @__PURE__ */ (0, import_react2.mdx)("ul", null, /* @__PURE__ */ (0, import_react2.mdx)("li", {
    parentName: "ul"
  }, `Methods`), /* @__PURE__ */ (0, import_react2.mdx)("li", {
    parentName: "ul"
  }, `Forms`), /* @__PURE__ */ (0, import_react2.mdx)("li", {
  ...
  }, `Database resource files and folders`), /* @__PURE__ */ (0, import_react2.mdx)("td", {
    parentName: "tr",
    ...{
      "align": null
    }
  ...
  }, `Data folder`), /* @__PURE__ */ (0, import_react2.mdx)("p", null, `The data folder contains the data file and all files and folders relating to the data.`), /* @__PURE__ */ (0, import_react2.mdx)("table", null, /* @__PURE__ */ (0, import_react2.mdx)("thead", {
    parentName: "table"
  }, /* @__PURE__ */ (0, import_react2.mdx)("tr", {
    parentName: "thead"
  }, /* @__PURE__ */ (0, import_react2.mdx)("th", {
  ...
  }, `Settings folder`), /* @__PURE__ */ (0, import_react2.mdx)("p", null, `This folder contains `, /* @__PURE__ */ (0, import_react2.mdx)("strong", {
    parentName: "p"
  }, `user settings files for data`), ` used for database administration.`), /* @__PURE__ */ (0, import_react2.mdx)("blockquote", null, /* @__PURE__ */ (0, import_react2.mdx)("p", {
    parentName: "blockquote"
    ...
    parentName: "td",
    ...{
      "href": "/docs/pt/18/Backup/settings"
    }
  ...
  }, `Description of 4D groups, users, and their access rights when the database is run with this data file.`), /* @__PURE__ */ (0, import_react2.mdx)("td", {
    parentName: "tr",
    ...{
      "align": null
    }
  }, `JSON`)))), /* @__PURE__ */ (0, import_react2.mdx)("h3", {
    ...{
      "id": "logs-folder"
    }
  }, `Logs folder`), /* @__PURE__ */ (0, import_react2.mdx)("p", null, `The Logs folder contains all log files used by the project. Log files include, in particular:`), /* @__PURE__ */ (0, import_react2.mdx)("ul", null, /* @__PURE__ */ (0, import_react2.mdx)("li", {
    parentName: "ul"
    ...
    parentName: "li",
    ...{
      "href": "/docs/pt/18/Backup/backup#backup-journal"
    }
    ...
    parentName: "p"
  }, `user settings files`), ` used for database administration. File are added to the folder when necessary.`), /* @__PURE__ */ (0, import_react2.mdx)("blockquote", null, /* @__PURE__ */ (0, import_react2.mdx)("p", {
    parentName: "blockquote"
  }, `If a data settings file exists in a Settings folder `, /* @__PURE__ */ (0, import_react2.mdx)("a", {
    parentName: "p",
    ...{
      "href": "#settings-folder"
    }
  }, `in the data folder`), `, it takes priority over user settings file.`)), /* @__PURE__ */ (0, import_react2.mdx)("table", null, /* @__PURE__ */ (0, import_react2.mdx)("thead", {
    parentName: "table"
  }, /* @__PURE__ */ (0, import_react2.mdx)("tr", {
    parentName: "thead"
  }, /* @__PURE__ */ (0, import_react2.mdx)("th", {
  ...
  }, `Description of 4D groups and users for the database, as well as their access rights`), /* @__PURE__ */ (0, import_react2.mdx)("td", {
    parentName: "tr",
    ...{
      "align": null
    }
  ...
  }, `userPreferences.`, /* @__PURE__ */ (0, import_react2.mdx)("em", {
    parentName: "h2"
  }, `userName`), ` folder`), /* @__PURE__ */ (0, import_react2.mdx)("p", null, `This folder contains files that memorize user configurations, e.g. break point or window positions. You can just ignore this folder. It contains for example:`), /* @__PURE__ */ (0, import_react2.mdx)("table", null, /* @__PURE__ */ (0, import_react2.mdx)("thead", {
    parentName: "table"
  }, /* @__PURE__ */ (0, import_react2.mdx)("tr", {
    parentName: "thead"
  }, /* @__PURE__ */ (0, import_react2.mdx)("th", {
  ...
  }, `Current user method editor preferences`), /* @__PURE__ */ (0, import_react2.mdx)("td", {
    parentName: "tr",
    ...{
      "align": null
    }
  ...
  }, `Components folder`), /* @__PURE__ */ (0, import_react2.mdx)("p", null, `This folder contains the components to be available in the project database only. It must be stored at the same level as the Project folder.`), /* @__PURE__ */ (0, import_react2.mdx)("blockquote", null, /* @__PURE__ */ (0, import_react2.mdx)("p", {
    parentName: "blockquote"
  }, `A project database can be used itself as a component:`), /* @__PURE__ */ (0, import_react2.mdx)("ul", {
    parentName: "blockquote"
  }, /* @__PURE__ */ (0, import_react2.mdx)("li", {
    parentName: "ul"
  }, `for development: put an alias of the .4dproject file in the Components folder of the host database.`), /* @__PURE__ */ (0, import_react2.mdx)("li", {
    parentName: "ul"
  }, `for deployment: build the component (see `, /* @__PURE__ */ (0, import_react2.mdx)("a", {
    parentName: "li",
    ...{
      "href": "/docs/pt/18/Project/building"
    }
  }, `Building a project package`), `) and put the resulting .4dz file in a .4dbase folder in the Components folder of the host database.`))), /* @__PURE__ */ (0, import_react2.mdx)("h2", {
    ...{
      "id": "plugins-folder"
    }
  }, `Plugins folder`), /* @__PURE__ */ (0, import_react2.mdx)("p", null, `This folder contains the plug-ins to be available in the project database only. It must be stored at the same level as the Project folder.`));
}
;
