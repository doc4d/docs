...
const metadata = {
  ...
  "id": "version-18/Concepts/plug-ins",
  "title": "Plug-ins",
  ...
  "source": "@site/versioned_docs/version-18/Concepts/plug-ins.md",
  "sourceDirName": "Concepts",
  "slug": "/Concepts/plug-ins",
  "permalink": "/docs/pt/18/Concepts/plug-ins",
  "draft": false,
  "tags": [],
  "version": "18",
  "frontMatter": {
...
function MDXContent({
  ...
  return /* @__PURE__ */ (0, import_react2.mdx)(MDXLayout, {
    ...
    parentName: "p"
  }, `PA_Yield()`), ` to give time to the 4D scheduler unless its task is critical for both it and the database.`), /* @__PURE__ */ (0, import_react2.mdx)("h2", {
    ...{
      "id": "how-to-create-a-plug-in"
    }
