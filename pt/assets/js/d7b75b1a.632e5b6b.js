...
const metadata = {
  ...
  "id": "version-19/FormObjects/picturePopupMenuOverview",
  "title": "Picture Pop-up Menu",
  "description": "A picture pop-up menu is a pop-up menu that displays a two-dimensional array of pictures. A picture pop-up menu can be used instead of a picture button. The creation of the picture to use with a picture pop-up menu is similar to the creation of a picture for a picture button. The concept is the same as for button grids, except that the graphic is used as a pop-up menu instead of a form object.",
  "source": "@site/versioned_docs/version-19/FormObjects/picturePopupMenu_overview.md",
...
function MDXContent({
  ...
  return /* @__PURE__ */ (0, import_react2.mdx)(MDXLayout, {
    ...
    components,
    mdxType: "MDXLayout"
  }, /* @__PURE__ */ (0, import_react2.mdx)("p", null, `A picture pop-up menu is a pop-up menu that displays a two-dimensional array of pictures. A picture pop-up menu can be used instead of a `, /* @__PURE__ */ (0, import_react2.mdx)("a", {
    parentName: "p",
    ...{
    ...
    src: (__webpack_require__(3945)/* ["default"] */ .Z),
    width: "217",
    height: "140"
    ...
    parentName: "p",
    ...{
      "href": "https://doc.4d.com/4Dv19R4/4D/19-R4/Standard-actions.300-5736871.en.html"
    }
