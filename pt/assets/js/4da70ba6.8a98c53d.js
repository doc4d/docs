...
const metadata = {
  ...
  "previous": {
    "title": "Backup",
    "permalink": "/docs/pt/19/Backup/backup"
  },
  "next": {
...
function MDXContent({
  ...
  return /* @__PURE__ */ (0, import_react2.mdx)(MDXLayout, {
    ...
    components,
    mdxType: "MDXLayout"
  }, /* @__PURE__ */ (0, import_react2.mdx)("p", null, `Backup settings are defined through three pages in the Settings dialog box. You can set:`), /* @__PURE__ */ (0, import_react2.mdx)("ul", null, /* @__PURE__ */ (0, import_react2.mdx)("li", {
    parentName: "ul"
    ...
    parentName: "p",
    ...{
      "href": "/docs/pt/19/Project/architecture#settings-folder"
    }
    ...
    parentName: "p",
    ...{
      "href": "/docs/pt/19/Backup/backup#handling-backup-issues"
    }
    ...
    src: (__webpack_require__(13024)/* ["default"] */ .Z),
    width: "862",
    height: "293"
    ...
    src: (__webpack_require__(89613)/* ["default"] */ .Z),
    width: "862",
    height: "659"
    ...
    parentName: "li",
    ...{
      "href": "/docs/pt/19/Project/architecture#settings-folder-1"
    }
    ...
    src: (__webpack_require__(56611)/* ["default"] */ .Z),
    width: "862",
    height: "644"
...
To disable the mechanism, simply deselect the option.`)), /* @__PURE__ */ (0, import_react2.mdx)("blockquote", null, /* @__PURE__ */ (0, import_react2.mdx)("p", {
    parentName: "blockquote"
  }, `This parameter concerns both application and log file backups.`)), /* @__PURE__ */ (0, import_react2.mdx)("ul", null, /* @__PURE__ */ (0, import_react2.mdx)("li", {
    parentName: "ul"
  }, /* @__PURE__ */ (0, import_react2.mdx)("strong", {
    parentName: "li"
...
4D generates archives using specific algorithms that are based on optimization (interlacing) and security (redundancy) mechanisms. You can set these mechanisms according to your needs. The menus for these options contain rates of `, /* @__PURE__ */ (0, import_react2.mdx)("strong", {
    ...
    parentName: "blockquote"
  }, `In the case of an automatic restore, only the following elements are restored:`), /* @__PURE__ */ (0, import_react2.mdx)("ul", {
    parentName: "blockquote"
  }, /* @__PURE__ */ (0, import_react2.mdx)("li", {
    parentName: "ul"
  }, `.4DD file`), /* @__PURE__ */ (0, import_react2.mdx)("li", {
    parentName: "ul"
  }, `.4DIndx file`), /* @__PURE__ */ (0, import_react2.mdx)("li", {
    parentName: "ul"
  }, `.4DSyncData file`), /* @__PURE__ */ (0, import_react2.mdx)("li", {
    parentName: "ul"
  }, `.4DSyncHeader file`), /* @__PURE__ */ (0, import_react2.mdx)("li", {
    parentName: "ul"
  }, `External Data folder`)), /* @__PURE__ */ (0, import_react2.mdx)("p", {
    parentName: "blockquote"
  }, `If you wish to get the attached files or the project files, you must perform a `, /* @__PURE__ */ (0, import_react2.mdx)("a", {
    parentName: "p",
    ...{
      "href": "/docs/pt/19/Backup/restore#manually-restoring-a-backup-standard-dialog"
    }
  }, `manual restore`), `.`)));
}
;
