...
const metadata = {
  ...
  "permalink": "/docs/pt/FormObjects/progressIndicator",
  "draft": false,
  "tags": [],
  "version": "19-R6",
  "frontMatter": {
  ...
  "previous": {
    "title": "Plug-in Area",
    "permalink": "/docs/pt/FormObjects/pluginAreaOverview"
  },
  "next": {
    "title": "Radio Button",
    "permalink": "/docs/pt/FormObjects/radiobuttonOverview"
  }
};
const assets = {};
const toc = [{
...
`)), /* @__PURE__ */ (0, import_react2.mdx)("p", null, `The method assigns the value of the indicator to the Salary field. As the user drags the indicator, the value in the Salary field changes.`), /* @__PURE__ */ (0, import_react2.mdx)("h2", {
    ...
    parentName: "p",
    ...{
      "href": "/docs/pt/FormObjects/propertiesScale#barber-shop"
    }
    ...
    parentName: "p",
    ...{
      "href": "/docs/pt/FormObjects/propertiesScale"
    }
