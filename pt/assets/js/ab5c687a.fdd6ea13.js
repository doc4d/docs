...
function MDXContent({
  ...
  return /* @__PURE__ */ (0, import_react2.mdx)(MDXLayout, {
    ...
    parentName: "ul"
  }, `A Date field, variable or expression can be in the range of 1/1/100 to 12/31/32,767.`), /* @__PURE__ */ (0, import_react2.mdx)("li", {
    parentName: "ul"
  }, `Although the representation mode for dates by can work with dates up to the year 32 767, certain operations passing through the system impose a lower limit.  `)), /* @__PURE__ */ (0, import_react2.mdx)("p", null, /* @__PURE__ */ (0, import_react2.mdx)("strong", {
    parentName: "p"
...
`)), /* @__PURE__ */ (0, import_react2.mdx)("p", null, `A null date is specified by `, /* @__PURE__ */ (0, import_react2.mdx)("em", {
    ...
    parentName: "ul"
  }, `If you have checked the "Use regional system settings" option (see Methods Page), you must use the date format defined in your system. Generally, in a US environment, dates are entered in the form month/day/year, with a slash "/" separating the values.`)), /* @__PURE__ */ (0, import_react2.mdx)("h2", {
    ...{
      "id": "date-operators"
    }
