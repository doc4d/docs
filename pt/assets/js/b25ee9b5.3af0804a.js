...
const metadata = {
  ...
  "id": "version-19/FormObjects/listOverview",
  "title": "Hierarchical List",
  ...
  "source": "@site/versioned_docs/version-19/FormObjects/list_overview.md",
...
function MDXContent({
  ...
  return /* @__PURE__ */ (0, import_react2.mdx)(MDXLayout, {
    ...
    src: (__webpack_require__(431)/* ["default"] */ .Z),
    width: "168",
    height: "162"
...
`)), /* @__PURE__ */ (0, import_react2.mdx)("blockquote", null, /* @__PURE__ */ (0, import_react2.mdx)("p", {
    ...
    parentName: "ol"
  }, `You do not need to identify each item with a unique number (beginner level).`)), /* @__PURE__ */ (0, import_react2.mdx)("ul", null, /* @__PURE__ */ (0, import_react2.mdx)("li", {
    parentName: "ul"
    ...
    parentName: "li"
  }, `itemRef`), ` parameter.  `)), /* @__PURE__ */ (0, import_react2.mdx)("ol", {
    ...{
      "start": 2
    }
  }, /* @__PURE__ */ (0, import_react2.mdx)("li", {
...
`, `You program an elaborate management of hierarchical lists in which you absolutely must be able to identify each item individually at every level of the list. A simple way of implementing this is to maintain a personal counter. Suppose that you create a `, /* @__PURE__ */ (0, import_react2.mdx)("em", {
    ...
    parentName: "p",
    ...{
      "href": "/docs/pt/19/FormObjects/propertiesAction#draggable-and-droppable"
    }
