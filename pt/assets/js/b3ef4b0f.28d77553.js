...
var onDoubleClicked_exports = {};
__export(onDoubleClicked_exports, {
  assets: () => assets,
...
module.exports = __toCommonJS(onDoubleClicked_exports);
...
const metadata = {
  "unversionedId": "Events/onDoubleClicked",
  "id": "version-19/Events/onDoubleClicked",
  "title": "On Double Clicked",
  "description": "|Code|Can be called by|Definition|",
  "source": "@site/versioned_docs/version-19/Events/onDoubleClicked.md",
  "sourceDirName": "Events",
  "slug": "/Events/onDoubleClicked",
  ...
  "next": {
    "title": "On Drag Over",
    "permalink": "/docs/pt/19/Events/onDragOver"
  }
};
const assets = {};
const toc = [{
...
function MDXContent({
  ...
  return /* @__PURE__ */ (0, import_react2.mdx)(MDXLayout, {
  ...
  }, `A double click occurred on an object`)))), /* @__PURE__ */ (0, import_react2.mdx)("h2", {
    ...{
      "id": "description"
    }
  }, `Description`), /* @__PURE__ */ (0, import_react2.mdx)("p", null, `The `, /* @__PURE__ */ (0, import_react2.mdx)("inlineCode", {
    parentName: "p"
  }, `On Double Clicked`), ` event is generated when the user double-clicks on an object. The maximum length of time separating a double-click is defined in the system preferences.`), /* @__PURE__ */ (0, import_react2.mdx)("p", null, `If the `, /* @__PURE__ */ (0, import_react2.mdx)("a", {
    parentName: "p",
    ...{
    ...
    parentName: "a"
  }, `On Clicked`)), ` or `, /* @__PURE__ */ (0, import_react2.mdx)("inlineCode", {
    parentName: "p"
  }, `On Double Clicked`), ` onDoubleClicked.md object event property is selected for an object, you can detect and handle the clicks within or on the object, using the `, /* @__PURE__ */ (0, import_react2.mdx)("inlineCode", {
    parentName: "p"
  }, `FORM event`), ` command that returns `, /* @__PURE__ */ (0, import_react2.mdx)("a", {
    parentName: "p",
    ...{
      "href": "/docs/pt/19/Events/onClicked"
    }
  ...
  }, `4D View Pro`), /* @__PURE__ */ (0, import_react2.mdx)("p", null, `This event is generated when the user doubl-clicks anywhere on a 4D View Pro document. On this context, the `, /* @__PURE__ */ (0, import_react2.mdx)("a", {
    parentName: "p",
    ...{
      "href": "/docs/pt/19/Events/overview#event-object"
    }
  ...
  }, `13`)), /* @__PURE__ */ (0, import_react2.mdx)("tr", {
    parentName: "tbody"
  }, /* @__PURE__ */ (0, import_react2.mdx)("td", {
    parentName: "tr",
    ...{
