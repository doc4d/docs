...
const metadata = {
  ...
  "id": "version-19/FormObjects/pictureButtonOverview",
  "title": "Picture Button",
  ...
  "source": "@site/versioned_docs/version-19/FormObjects/pictureButton_overview.md",
  ...
  "next": {
    ...
    "permalink": "/docs/pt/19/FormObjects/picturePopupMenuOverview"
  }
};
const assets = {};
const toc = [{
...
function MDXContent({
  ...
  return /* @__PURE__ */ (0, import_react2.mdx)(MDXLayout, {
    ...
    parentName: "p",
    ...{
      "href": "/docs/pt/19/FormObjects/buttonOverview"
    }
...
For example, a table of thumbnails that has one row of four columns, each thumbnail corresponds to the Default, Clicked, Roll over, and Disabled states.`), /* @__PURE__ */ (0, import_react2.mdx)("table", {
    ...
    parentName: "p",
    ...{
      "href": "/docs/pt/19/FormObjects/picturePopupMenuOverview"
    }
  }, `Picture Pop-up Menus`), `, all choices are displayed simultaneously (as the items in the pop-up menu), while the picture button displays the choices consecutively (as the user clicks the button).
Here is an example of a picture button. Suppose you want to give the users of a custom application the opportunity to choose the interface language for the application. You implement the option as a picture button in a custom properties dialog box:`))), /* @__PURE__ */ (0, import_react2.mdx)("p", null, /* @__PURE__ */ (0, import_react2.mdx)("img", {
    src: (__webpack_require__(69262)/* ["default"] */ .Z),
    width: "97",
    height: "118"
    ...
    src: (__webpack_require__(57741)/* ["default"] */ .Z),
    width: "242",
    height: "108"
    ...
    parentName: "p",
    ...{
      "href": "/docs/pt/19/FormObjects/propertiesCrop"
    }
    ...
    parentName: "p",
    ...{
      "href": "/docs/pt/19/FormObjects/propertiesAnimation"
    }
    ...
    parentName: "li",
    ...{
      "href": "/docs/pt/19/FormObjects/propertiesAnimation#loopBackToFirstFrame"
    }
    ...
    parentName: "p",
    ...{
      "href": "/docs/pt/19/FormObjects/propertiesTextAndPicture#button-style"
    }
    ...
    parentName: "p",
    ...{
      "href": "/docs/pt/19/FormObjects/propertiesAnimation#switchBackWhenReleased"
    }
    ...
    parentName: "p",
    ...{
      "href": "/docs/pt/19/FormObjects/propertiesAnimation#switchWhenRollOver"
    }
