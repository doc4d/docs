...
const metadata = {
  ...
  "id": "version-19/MSC/compact",
  "title": "Compact Page",
  "description": "You use this page to access the data file compacting functions.",
  "source": "@site/versioned_docs/version-19/MSC/compact.md",
  "sourceDirName": "MSC",
  "slug": "/MSC/compact",
  ...
  "next": {
    "title": "Rollback Page",
    "permalink": "/docs/pt/19/MSC/rollback"
  }
};
const assets = {};
const toc = [{
...
The \u201CInformation\u201D area summarizes the data concerning the fragmentation of the file and suggests operations to be carried out. The `, /* @__PURE__ */ (0, import_react2.mdx)("a", {
    parentName: "p",
    ...{
      "href": "/docs/pt/19/MSC/information#data"
    }
    ...
    src: (__webpack_require__(71482)/* ["default"] */ .Z),
    width: "158",
    height: "88"
  ...
  }, `Open log file`), /* @__PURE__ */ (0, import_react2.mdx)("p", null, `After compacting is completed, 4D generates a log file in the Logs folder of the project. This file allows you to view all the operations carried out. It is created in XML format and named:  `, /* @__PURE__ */ (0, import_react2.mdx)("em", {
    parentName: "p"
  }, `ApplicationName**_Compact_Log_yyyy-mm-dd hh-mm-ss.xml`), `" where:`), /* @__PURE__ */ (0, import_react2.mdx)("ul", null, /* @__PURE__ */ (0, import_react2.mdx)("li", {
    parentName: "ul"
...
In this case, 4D does not convert data already entered retroactively; data is converted only when records are loaded and then saved. This option forces all data to be converted.`)), /* @__PURE__ */ (0, import_react2.mdx)("li", {
    ...
    parentName: "ul"
  }, `Using this option makes the address table, and thus the database, incompatible with the current journal file (if there is one). It will be saved automatically and a new journal file will have to be created the next time the application is launched.`), /* @__PURE__ */ (0, import_react2.mdx)("li", {
    parentName: "ul"
    ...
    parentName: "li",
    ...{
      "href": "/docs/pt/19/MSC/information"
    }
